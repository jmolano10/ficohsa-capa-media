...
{
  "pk": "COUNTRY#XRS#DOMAIN#REGULATORY_COMPLIANCE_ADMIN#PARAM#evaluate-customer-bulk",
  "sk": "V#0001",
  "name": "evaluate-customer-bulk",
  "value": [
    {
      "region": "HN01-HN01",
      "enabled": false
...
```json
"ban-xrs-ic-comp-param-theta-db-<env>"
{
