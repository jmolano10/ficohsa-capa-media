...
**Archivo XQuery:** `MWHostToHost/v1/Resources/CargaLoteProductos/xq/cargaLoteProductosIN.xq`
 <br> businessName <br> partyAddressInfo.neighborhoodCode <br> partyAddressInfo.streetName <br> partyAddressInfo.blockNumber <br> partyAddressInfo.houseNumber <br> partyAddressInfoaddressReferences <br> contactPhoneInfo.phoneNumber
#### Tabla de Mapeo - Parámetros Simples

| Campo Origen (API) | Origen Campo | Campo Destino (SP) |
|-------------------|----------------------|-------------------|
| body.corporateCustomerReference | data() | PV_CODIGOCLIENTE |
| body.payrollGroupReference | data() | PV_CODIGOGRUPOPLANILLA |
| header.Application-User| fn:string() | PV_USUARIO |
| body.customerPortfolio | fn:count(customerRecord) | PN_NUMEROCLIENTES |
| businessName | Response Get Customer | PV_NOMBREEMPRESA |
| neighborhoodCode | Response Get Customer| PV_DIRECCIONEMPRESA |
| streetName | Response Get Customer | PV_CALLEEMPRESA |
| blockNumber | Response Get Customer | PV_BLOQUEEMPRESA |
| houseNumber | Response Get Customer | PV_CASAEMPRESA |
| phoneNumber | Response Get Customer | PV_TELEFONO_EMPRESA |
| partyAddressInfoaddressReferences | Response Get Customer | PV_REFERENCIAEMPRESA |
...
|-------------------|----------------------|-------------------|-----------|
| body.customerRecord.customerType | data() | PT_TIPOIDENTIFICACION/PT_TVARCHAR20_ITEM | TVARCHAR20 |
| body.customerRecord.customerLegalReference  | data() | PT_NUMEROIDENTIFICACION/PT_TVARCHAR13_ITEM | TVARCHAR13 |
| body.customerRecord.customerType  | data() | PT_FECHAEMISION/PT_TDATE_ITEM | TDATE |
| body.customerRecord.partyGivenNames  | data() | PT_NOMBRECLIENTE/PT_TVARCHAR40_ITEM | TVARCHAR40 |
| body.customerRecord.partyFamilyName  | data() | PT_APELLIDOSCLIENTE/PT_TVARCHAR40_ITEM | TVARCHAR40 |
| body.customerRecord.birthDate  | data() | PT_FECHANACIMIENTO/PT_TDATE_ITEM | TDATE |
| body.customerRecord.gender  | data() | PT_GENERO/PT_TNUMBER_ITEM | TNUMBER |
| body.customerRecord.maritalStatus  | data() | PT_ESTADOCIVIL/PT_TVARCHAR20_ITEM | TVARCHAR20 |
| body.customerRecord.addressLine  | data() | PT_DIRECCIONHOGAR/PT_TVARCHAR60_ITEM | TVARCHAR60 |
| body.customerRecord.mobilePhoneNumber | data() | PT_CELULAR/PT_TVARCHAR11_ITEM | TVARCHAR11 |
| body.customerRecord.phoneNumber  | data() | PT_TELEFONO/PT_TVARCHAR11_ITEM | TVARCHAR11 |
| body.customerRecord.customerReferencePhoneNumber  | data() | PT_REFERENCIATELEFONO/PT_TVARCHAR20_ITEM | TVARCHAR20 |
| body.customerRecord.educationLevelCode  | data() | PT_NIVELEDUCATIVO/PT_TVARCHAR20_ITEM | TVARCHAR20 |
| body.customerRecord.professionCode  | data() | PT_PROFESION/PT_TNUMBER_ITEM | TNUMBER |
| body.customerRecord.employmentStartDate  | data() | PT_FECHAINGRESOEMPRESA/PT_TDATE_ITEM | TDATE |
| body.customerRecord.jobPositionCode  | data() | PT_CARGO/PT_TNUMBER_ITEM | TNUMBER |
| body.customerRecord.salaryCurrencyCode  | data() | PT_MONEDAINGRESO/PT_TVARCHAR3_ITEM | TVARCHAR3 |
| body.customerRecord.salaryAmount  | data() | PT_MONTOINGRESO/PT_TVARCHAR20_ITEM | TVARCHAR20 |
| body.customerRecord.customerMarriedName  | data() | PT_NOMBRECONYUGUE/PT_TVARCHAR40_ITEM | TVARCHAR40 |
| body.customerRecord.customerMarriedLastname  | data() | PT_APELLIDOSCONYUGUE/PT_TVARCHAR40_ITEM | TVARCHAR40 |
| body.customerRecord.referenceGivenNames  | data() | PT_NOMBREREFERENCIA/PT_TVARCHAR40_ITEM | TVARCHAR40 |
| body.customerRecord.referenceFamilyNames  | data() | PT_APELLIDOSREFERENCIA/PT_TVARCHAR40_ITEM | TVARCHAR40 |
| body.customerRecord.referencePhoneNumber  | data() | PT_TELEFONOREFERENCIA/PT_TVARCHAR11_ITEM | TVARCHAR11 |
| body.customerRecord.referenceRelationship  | data() | PT_PARENTESCOREFERENCIA/PT_TNUMBER_ITEM | TNUMBER |
| body.customerRecord.beneficiaryName  | data() | PT_NOMBREBENEFICIARIO/PT_TVARCHAR50_ITEM | TVARCHAR50 |
| body.customerRecord.beneficiaryRelationshipType  | data() | PT_PARENTESCOBENEFICIARIO/PT_TNUMBER_ITEM | TNUMBER |
