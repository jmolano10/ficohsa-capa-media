...
(:: pragma bea:global-element-return element="ns1:EmbosserAddL8VGRequest" location="../../../BusinessServices/VisionPlus/visionPlus/xsd/XMLSchema_769155616.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/SolicitudTC/xq/embosserAddL8VGIn/";
...
declare function xf:embosserAddL8VGIn($org as xs:integer,
    $solicitudTCRequest as element(ns0:solicitudTC))
    as element(ns1:EmbosserAddL8VGRequest) {
        <ns1:EmbosserAddL8VGRequest>
            ...
            <AZXAPI-CARDHOLDER-FLAG>
                {
                    if ($solicitudTCRequest/CARD_HOLDER_TYPE/text() = 'PRINCIPAL') then
                        ...
                        if ($solicitudTCRequest/CARD_HOLDER_TYPE/text() = 'ADDITIONAL') then
                            (0)
                        else 
                            ()
                }
            ...
            <AZXAPI-PIN-SUPPRESSION>
                {
                    if ($solicitudTCRequest/GENERATE_PIN/text() = "YES") then
                        ...
                        if ($solicitudTCRequest/GENERATE_PIN/text() = "NO") then
                            (1)
                        else 
                            ()
                }
            ...
            <AZXAPI-USER-3>{ data($solicitudTCRequest/LEGAL_ID) }</AZXAPI-USER-3>
            ...
            <AZXAPI-SDP-PROCESS-TYPE>
                {
                    if ($solicitudTCRequest/PROCESS_TYPE/text() = 'EMERGENCY') then
                        ...
                        if ($solicitudTCRequest/PROCESS_TYPE/text() = 'NORMAL') then
                            (0)
                        else 
                            ()
                }
            ...
            <AZXAPI-FALC-MARK>0</AZXAPI-FALC-MARK>
            <AZXAPI-FALC-MARK-ST-DATE>2001-01-01</AZXAPI-FALC-MARK-ST-DATE>
            <AZXAPI-FALC-MARK-END-DATE>2001-01-01</AZXAPI-FALC-MARK-END-DATE>
            ...
            <AZXAPI-AUTH-GLBSPL-AMT>0</AZXAPI-AUTH-GLBSPL-AMT>
            <AZXAPI-AUTH-GLBSPL-NBR>0</AZXAPI-AUTH-GLBSPL-NBR>
            <AZXAPI-AUTH-GLBSPL-SNGL-TXN>0</AZXAPI-AUTH-GLBSPL-SNGL-TXN>
            <AZXAPI-BUS-RULE-NAME>{ fn:string('') }</AZXAPI-BUS-RULE-NAME>
            <AZXAPI-OVRD-BUS-RULE-NAME>{ fn:string('') }</AZXAPI-OVRD-BUS-RULE-NAME>
            <AZXAPI-OVRD-BUS-RULE-STR-DT xsi:nil="true"/>
            <AZXAPI-OVRD-BUS-RULE-END-DT xsi:nil="true"/>
            <AZXAPI-PROFILE-ID>0</AZXAPI-PROFILE-ID>
            <AZXAPI-ECOMM-IND>0</AZXAPI-ECOMM-IND>
            <AZXAPI-CONTLS-IND>0</AZXAPI-CONTLS-IND>
            <AZXAPI-AUTH-RSTR-TBL>000</AZXAPI-AUTH-RSTR-TBL>
            <AZXAPI-AUTH-CR-LM>
                {
                    if ($solicitudTCRequest/SPENDING_LIMIT/text()) then
                        (data($solicitudTCRequest/SPENDING_LIMIT))
                    else 
                        0
                }
</AZXAPI-AUTH-CR-LM>
