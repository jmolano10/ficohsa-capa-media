...
declare function local:funcErrorToGetTicket($responseError as element() (:: schema-element(ns1:errorMappingRegionalOutput) ::),
...
local:funcErrorToGetTicket($responseError, $codeError, $messageError, $targetSystem, $status, $globalId)
