...
declare function local:funcErrorToGetStatusTicket($responseError as element() (:: schema-element(ns1:errorMappingRegionalOutput) ::),
...
local:funcErrorToGetStatusTicket($responseError, $codeError, $messageError, $targetSystem, $status, $globalId)
