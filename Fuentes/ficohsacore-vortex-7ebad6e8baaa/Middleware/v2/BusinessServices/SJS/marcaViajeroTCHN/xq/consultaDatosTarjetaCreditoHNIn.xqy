...
declare namespace xf = "http://tempuri.org/Middleware/v2/BusinessServices/SJS/marcaViajeroTCHN/xq/consultaDatosTarjetaCreditoHNIn/";

declare function xf:consultaDatosTarjetaCreditoHNIn($card as xs:string)
...
xf:consultaDatosTarjetaCreditoHNIn($card)