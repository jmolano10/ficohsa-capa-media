...
(:: pragma bea:global-element-return element="ns0:sjConsultaSaldosTarjetaCreditoResponse" location="../xsd/sjConsultaSaldosTarjetaCreditoTypes.xsd" ::)
(:: pragma bea:global-element-parameter parameter="$sjConsultaSaldosTC" element="ns0:sjConsultaSaldosTarjetaCredito" location="../xsd/sjConsultaSaldosTarjetaCreditoTypes.xsd" ::)
...
declare function xf:sjConsultaSaldosTarjetaCreditoOut($resultGroup as element(*), $sjConsultaSaldosTC as element(ns0:sjConsultaSaldosTarjetaCredito))
		            	  		  ...
		            	  		  <ns0:consultaSaldosTarjetaCreditoResponseRecordType>
								{
									...
									return(
						                ...
						                if(not(empty($accountInquiryL8VLAlt)))then(
				                  		...
				                  		if(not(empty($accountInquiryL8VLAlt)))then(
						                	(:<WITHDRAWAL_LIMIT>{ data($accountInquiryL8VLAlt/AZXAIO-AVAIL-CREDIT-WO-OVL) }</WITHDRAWAL_LIMIT>:)
...
xf:sjConsultaSaldosTarjetaCreditoOut($resultGroup, $sjConsultaSaldosTC)