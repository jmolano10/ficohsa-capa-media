...
declare function xf:sjConsultaCuentaTCNIOut($resultGroup as element(*), $sjconsultaCuentaTC as element(ns0:sjconsultaCuentaTC))
	        	...
	        	return
        	 		<BALANCE_INFORMATION>
			            ...
			            }
			            {
                            ...
                            {
                                for $rmt in string($accountInquiryL8VLResponse/AZXAIO-USER-CODE-4/text())
                                    return
                                        <RMT>{ $rmt } </RMT>
                            }   
			         </BALANCE_INFORMATION>
...
xf:sjConsultaCuentaTCNIOut($resultGroup, $sjconsultaCuentaTC)