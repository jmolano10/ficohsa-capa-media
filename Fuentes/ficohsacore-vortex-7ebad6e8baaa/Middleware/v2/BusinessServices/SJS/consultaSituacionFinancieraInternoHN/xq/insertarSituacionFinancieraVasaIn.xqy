...
declare namespace xf = "http://tempuri.org/Middleware/v2/BusinessServices/SJS/consultaSituacionFinancieraInternoHN/xq/insertarSituacionFinancieraVasaIn/";
				...
				let $responseXML := fn-bea:inlinedXML($response)
	            	return (
			            ...
			            <ns1:PT_SALDO_DISPONIBLE>
			                    <ns1:PT_SALDO_DISPONIBLE_ITEM></ns1:PT_SALDO_DISPONIBLE_ITEM>
			                    <ns1:PT_SALDO_DISPONIBLE_ITEM></ns1:PT_SALDO_DISPONIBLE_ITEM>
			            </ns1:PT_SALDO_DISPONIBLE>,
			            <ns1:PT_SALDO_TOTAL>
