...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/TransferenciasACH/xq/consDestACHIN/";
...
declare function xf:consDestACHIN($requestHeader1 as element(ns2:RequestHeader),
        ...
        <ns0:ConsultadedestinosACH>
            ...
            <WSACHBANKLISTType>
                <enquiryInputCollection>
                    ...
                    <criteriaValue>{ data($transferenciasACHRequest1/DESTINATION_BANK) }</criteriaValue>
                    <operand>EQ</operand>
                </enquiryInputCollection>
            </WSACHBANKLISTType>
        </ns0:ConsultadedestinosACH>
...
xf:consDestACHIN($requestHeader1,
