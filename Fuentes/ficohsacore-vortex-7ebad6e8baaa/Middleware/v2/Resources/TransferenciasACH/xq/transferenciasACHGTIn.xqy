...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/ABKGT/transferenciasACH/xsd/TransferenciasACH_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/abanksGT/transferenciasACH/xq/transferenciasACHIn/";
...
declare function xf:transferenciasACHIn($transferenciasACHRequest1 as element(ns0:transferenciasACHRequest),
    ...
    as element(ns1:InputParameters) {
        <ns1:InputParameters>
            ...
            <ns1:USERNAME>{ $usuarioCanal }</ns1:USERNAME>
            <ns1:TRANSFER_TYPE>{ data($transferenciasACHRequest1/TRANSFER_TYPE) }</ns1:TRANSFER_TYPE>
