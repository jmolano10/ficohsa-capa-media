...
(:: pragma bea:global-element-parameter parameter="$conDatoCuentaOut" element="ns4:OutputParameters" location="../../../BusinessServices/MasterData/conDatoCuenta/xsd/conDatoCuenta_sp.xsd" ::)
(:: pragma bea:global-element-parameter parameter="$conEncabezadoEstadoCuentaOut" element="ns2:OutputParameters" location="../../../BusinessServices/MasterData/conEncabezadoEstadoCuenta/xsd/conEncabezadoEstadoCuenta_sp.xsd" ::)
    ...
    as element(ns1:InputParameters) {
        <ns1:InputParameters>
            ...
            <ns1:PT_CUENTA_TC>
               ...
               {
	                for $rowDatosCuenta in $conDatoCuentaOut/ns1:RowSet/ns1:Row[1]
					return (
