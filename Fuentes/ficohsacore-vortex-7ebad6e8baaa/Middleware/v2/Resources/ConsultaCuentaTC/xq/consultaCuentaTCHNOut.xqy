...
(:: pragma bea:global-element-parameter parameter="$conDatoCuenta" element="ns4:OutputParameters" location="../../../BusinessServices/MasterDataHN/conDatoCuenta/xsd/conDatoCuenta_sp.xsd" ::)
(:: pragma bea:global-element-parameter parameter="$conEncabezadoEstadoCuenta" element="ns0:OutputParameters" location="../../../BusinessServices/MasterDataHN/conEncabezadoEstadoCuenta/xsd/conEncabezadoEstadoCuenta_sp.xsd" ::)
(:: pragma bea:schema-type-parameter parameter="$ptEquivalencias" type="ns2:OT_EQUIVALENCIAS_CATALOGOS_OUT" location="../../../BusinessServices/MDW/consultaEquivalenciasCatalogos_v2/xsd/consultaEquivalenciasCatalogos_v2_sp.xsd" ::)
...
(:: pragma bea:global-element-parameter parameter="$consultaSaldoSPMD" element="ns6:OutputParameters" location="../../../../v3/BusinessServices/MasterData/conConsultaSaldoTCRG/xsd/conConsultaSaldosCuentaTC_sp.xsd" ::)
...
declare namespace ns6 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/conConsultaSaldosCuentaTC";
...
declare function xf:consultaCuentaTCHNOut($sjconsultaCuentaTCResponse as element(ns5:sjconsultaCuentaTCResponse)?,
	...
	$consultaSaldoSPMD as element(ns6:OutputParameters))
        ...
        <ns3:consultaCuentaTCResponse>
        {
        	if(not(empty($consultaCuentaTC/ns1:PT_CUENTA_TC/ns1:ACCOUNT_NUMBER))) then (
                ...
                return(
              	 ...
              	 let $BALANCE_INFORMATION:=  fn-bea:inlinedXML($consultaCuentaTC/ns1:PT_CUENTA_TC/ns1:BALANCE_INFORMATION)
              	 for $balanceInformationItem in $BALANCE_INFORMATION
              	 return(
                    <BALANCE_INFORMATION>
                    	<CURRENCY>{ string($balanceInformationItem/CURRENCY/text())}</CURRENCY>
                    	<ORG>{ string($balanceInformationItem/ORG/text())}</ORG>
                    		<BLOCKING_INFORMATION>
									<BLOCK1>
										<BLOCK_CODE>{ string($balanceInformationItem/BLOCKING_INFORMATION/BLOCK1/BLOCK_CODE/text())}</BLOCK_CODE>
										<BLOCK_DATE>{ string($balanceInformationItem/BLOCKING_INFORMATION/BLOCK1/BLOCK_DATE/text()) }</BLOCK_DATE>
										<BLOCK_REASON>{ string($balanceInformationItem/BLOCKING_INFORMATION/BLOCK1/BLOCK_REASON/text()) }</BLOCK_REASON>
									</BLOCK1>
									<BLOCK2>
										<BLOCK_CODE>{ string($balanceInformationItem/BLOCKING_INFORMATION/BLOCK2/BLOCK_CODE/text())}</BLOCK_CODE>
										<BLOCK_DATE>{ string($balanceInformationItem/BLOCKING_INFORMATION/BLOCK2/BLOCK_DATE/text()) }</BLOCK_DATE>
										<BLOCK_REASON>{ string($balanceInformationItem/BLOCKING_INFORMATION/BLOCK2/BLOCK_REASON/text()) }</BLOCK_REASON>
									</BLOCK2>
								</BLOCKING_INFORMATION>
						<INTRAFINANCING_BALANCE>{ string($balanceInformationItem/INTRAFINANCING_BALANCE/text()) }</INTRAFINANCING_BALANCE>
						<DISPUTE_AMOUNT>{ string($balanceInformationItem/DISPUTE_AMOUNT/text()) }</DISPUTE_AMOUNT>
						<DISPUTE_QTY>{ string($balanceInformationItem/DISPUTE_QTY/text()) }</DISPUTE_QTY>
						<INITIAL_BALANCE>{ string($balanceInformationItem/INITIAL_BALANCE/text()) }</INITIAL_BALANCE>
						<CURRENT_BALANCE>{ string($balanceInformationItem/CURRENT_BALANCE/text()) }</CURRENT_BALANCE>
				        <MIN_PAYMENT>{ string($balanceInformationItem/MIN_PAYMENT/text()) }</MIN_PAYMENT> 		
						<CURRENT_MIN_PAYMENT>{ string($balanceInformationItem/CURRENT_MIN_PAYMENT/text()) }</CURRENT_MIN_PAYMENT>
						<PAYMENT_CUTOFF_AMOUNT>{ string($balanceInformationItem/PAYMENT_CUTOFF_AMOUNT/text()) }</PAYMENT_CUTOFF_AMOUNT>	
						<PAYMENTS_AMOUNT>{ string($balanceInformationItem/PAYMENTS_AMOUNT/text()) }</PAYMENTS_AMOUNT>			
						<PENDING_AUTHORIZATIONS>{ string($balanceInformationItem/PENDING_AUTHORIZATIONS/text()) }</PENDING_AUTHORIZATIONS>
						<PENDING_PAYMENTS>{ string($balanceInformationItem/PENDING_PAYMENTS/text()) }</PENDING_PAYMENTS>
						<LATE_FEE_BALANCE>{ string($balanceInformationItem/LATE_FEE_BALANCE/text()) }</LATE_FEE_BALANCE>
						<LATE_FEE_CUTOFF_BALANCE>{ string($balanceInformationItem/LATE_FEE_CUTOFF_BALANCE/text()) }</LATE_FEE_CUTOFF_BALANCE>
						<CICLE>{ string($balanceInformationItem/CICLE/text()) }</CICLE>
						<LAST_CUTOFF_LATE_FEE_DATE>{ string($balanceInformationItem/LAST_CUTOFF_LATE_FEE_DATE/text()) }</LAST_CUTOFF_LATE_FEE_DATE>
						<LAST_CUTOFF_PAYMENT_DATE>{ string($balanceInformationItem/LAST_CUTOFF_PAYMENT_DATE/text()) }</LAST_CUTOFF_PAYMENT_DATE>
						<LAST_TXN_DATE>{ string($balanceInformationItem/LAST_TXN_DATE/text()) }</LAST_TXN_DATE>		
						<TEMP_CRLIM_DATE>{ string($balanceInformationItem/TEMP_CRLIM_DATE/text()) }</TEMP_CRLIM_DATE>	
						<TEMP_CRLIM_AMOUNT>{ string($balanceInformationItem/TEMP_CRLIM_AMOUNT/text()) }</TEMP_CRLIM_AMOUNT>
						<PURCHASE_AVAILABLE_AMOUNT>{ string($balanceInformationItem/PURCHASE_AVAILABLE_AMOUNT/text()) }</PURCHASE_AVAILABLE_AMOUNT>
						<OPEN_TO_BUY>{ string($balanceInformationItem/OPEN_TO_BUY/text()) } </OPEN_TO_BUY>		
						<AVAILABLE_WITHDRAWAL>{ string($balanceInformationItem/AVAILABLE_WITHDRAWAL/text()) }</AVAILABLE_WITHDRAWAL>
						<CREDIT_LIMIT>{ string($balanceInformationItem/CREDIT_LIMIT/text()) }</CREDIT_LIMIT>
						<LAST_CRLIM_AMOUNT>{ string($balanceInformationItem/LAST_CRLIM_AMOUNT/text()) }</LAST_CRLIM_AMOUNT>
						<LATE_FEE_INFORMATION>
							<LATE_FEE_TYPE>{ string($balanceInformationItem/LATE_FEE_INFORMATION[1]/LATE_FEE_TYPE/text()) }</LATE_FEE_TYPE>
							<LATE_FEE_COUNTER>{ string($balanceInformationItem/LATE_FEE_INFORMATION[1]/LATE_FEE_COUNTER/text()) }</LATE_FEE_COUNTER>
							<LATE_FEE_AMOUNT>{ string($balanceInformationItem/LATE_FEE_INFORMATION[1]/LATE_FEE_AMOUNT/text()) }</LATE_FEE_AMOUNT>
						</LATE_FEE_INFORMATION>
						<LATE_FEE_INFORMATION>
							<LATE_FEE_TYPE>{ string($balanceInformationItem/LATE_FEE_INFORMATION[2]/LATE_FEE_TYPE/text()) }</LATE_FEE_TYPE>
							<LATE_FEE_COUNTER>{ string($balanceInformationItem/LATE_FEE_INFORMATION[2]/LATE_FEE_COUNTER/text()) }</LATE_FEE_COUNTER>
							<LATE_FEE_AMOUNT>{ string($balanceInformationItem/LATE_FEE_INFORMATION[2]/LATE_FEE_AMOUNT/text()) }</LATE_FEE_AMOUNT>
						</LATE_FEE_INFORMATION>
						<LATE_FEE_INFORMATION>
							<LATE_FEE_TYPE>{ string($balanceInformationItem/LATE_FEE_INFORMATION[3]/LATE_FEE_TYPE/text()) }</LATE_FEE_TYPE>
							<LATE_FEE_COUNTER>{ string($balanceInformationItem/LATE_FEE_INFORMATION[3]/LATE_FEE_COUNTER/text()) }</LATE_FEE_COUNTER>
							<LATE_FEE_AMOUNT>{ string($balanceInformationItem/LATE_FEE_INFORMATION[3]/LATE_FEE_AMOUNT/text()) }</LATE_FEE_AMOUNT>
						</LATE_FEE_INFORMATION>
						<LATE_FEE_INFORMATION>
							<LATE_FEE_TYPE>{ string($balanceInformationItem/LATE_FEE_INFORMATION[4]/LATE_FEE_TYPE/text()) }</LATE_FEE_TYPE>
							<LATE_FEE_COUNTER>{ string($balanceInformationItem/LATE_FEE_INFORMATION[4]/LATE_FEE_COUNTER/text()) }</LATE_FEE_COUNTER>
							<LATE_FEE_AMOUNT>{ string($balanceInformationItem/LATE_FEE_INFORMATION[4]/LATE_FEE_AMOUNT/text()) }</LATE_FEE_AMOUNT>
						</LATE_FEE_INFORMATION>
						<LATE_FEE_INFORMATION>
							<LATE_FEE_TYPE>{ string($balanceInformationItem/LATE_FEE_INFORMATION[5]/LATE_FEE_TYPE/text()) }</LATE_FEE_TYPE>
							<LATE_FEE_COUNTER>{ string($balanceInformationItem/LATE_FEE_INFORMATION[5]/LATE_FEE_COUNTER/text()) }</LATE_FEE_COUNTER>
							<LATE_FEE_AMOUNT>{ string($balanceInformationItem/LATE_FEE_INFORMATION[5]/LATE_FEE_AMOUNT/text()) }</LATE_FEE_AMOUNT>
						</LATE_FEE_INFORMATION>
						<LATE_FEE_INFORMATION>
							<LATE_FEE_TYPE>{ string($balanceInformationItem/LATE_FEE_INFORMATION[6]/LATE_FEE_TYPE/text()) }</LATE_FEE_TYPE>
							<LATE_FEE_COUNTER>{ string($balanceInformationItem/LATE_FEE_INFORMATION[6]/LATE_FEE_COUNTER/text()) }</LATE_FEE_COUNTER>
							<LATE_FEE_AMOUNT>{ string($balanceInformationItem/LATE_FEE_INFORMATION[6]/LATE_FEE_AMOUNT/text()) }</LATE_FEE_AMOUNT>
						</LATE_FEE_INFORMATION>
						<LATE_FEE_INFORMATION>
							<LATE_FEE_TYPE>{ string($balanceInformationItem/LATE_FEE_INFORMATION[7]/LATE_FEE_TYPE/text()) }</LATE_FEE_TYPE>
							<LATE_FEE_COUNTER>{ string($balanceInformationItem/LATE_FEE_INFORMATION[7]/LATE_FEE_COUNTER/text()) }</LATE_FEE_COUNTER>
							<LATE_FEE_AMOUNT>{ string($balanceInformationItem/LATE_FEE_INFORMATION[7]/LATE_FEE_AMOUNT/text()) }</LATE_FEE_AMOUNT>
						</LATE_FEE_INFORMATION>
						<STATUS>{ string($balanceInformationItem/STATUS/text())}</STATUS>
						<LAST_PAYMENT_AMOUNT>{ string($balanceInformationItem/LAST_PAYMENT_AMOUNT/text())}</LAST_PAYMENT_AMOUNT>
						<LAST_PAYMENT_DATE>{ string($balanceInformationItem/LAST_PAYMENT_DATE/text())}</LAST_PAYMENT_DATE>
						<AMOUNT_LAST_WITHDRAWAL>{ string($balanceInformationItem/AMOUNT_LAST_WITHDRAWAL/text())}</AMOUNT_LAST_WITHDRAWAL>
						<DATE_LAST_WITHDRAWAL>{ string($balanceInformationItem/DATE_LAST_WITHDRAWAL/text())}</DATE_LAST_WITHDRAWAL>
						<LAST_PURCHASE_AMOUNT>{ string($balanceInformationItem/LAST_PURCHASE_AMOUNT/text())}</LAST_PURCHASE_AMOUNT>
						<LAST_PURCHASE_DATE>{ string($balanceInformationItem/LAST_PURCHASE_DATE/text())}</LAST_PURCHASE_DATE>
                    </BALANCE_INFORMATION>
				...
				for $rowDatosCuenta at $i in $conDatoCuenta/ns4:RowSet/ns4:Row
	 			let $org := data($rowDatosCuenta/ns4:Column[upper-case(@name) = 'ORG'])
				let $rowconEncabezadoEstadoCuentaOut := $conEncabezadoEstadoCuenta/ns0:RowSet/ns0:Row[ns0:Column[@name = 'org']/text() = $org]
				let $rowConsultaSaldoSPMD := $consultaSaldoSPMD/ns6:RowSet/ns6:Row[ns6:Column[@name = 'Org']/text() = $org]
				...
				return(
					<BALANCE_INFORMATION>
			            ...
			            {
			            	let $currentBalance := $rowDatosCuenta/ns4:Column[@name = 'billed_bal']/text() - $rowConsultaSaldoSPMD/ns6:Column[@name = 'PagosDia']/text()
			            	return
			            		if(string($currentBalance) != '')then(
			            			<CURRENT_BALANCE>{ fn-bea:decimal-round(xs:decimal($currentBalance), 2) }</CURRENT_BALANCE>
			            		)else(
			            			<CURRENT_BALANCE>{ $rowDatosCuenta/ns4:Column[@name = 'billed_bal']/text() }</CURRENT_BALANCE>
			            		)
			            }
			            {
            	...
            	for $rsncharges in $conDatoCuenta/ns4:RowSet/ns4:Row
                where $rsncharges/ns4:Column[upper-case(@name) = 'TIPOORG']/text() = "BASE"
				return
        	        <RSN_CHARGES>{ string($rsncharges/ns4:Column[@name = 'misc_user_1']/text())}</RSN_CHARGES>,
			    ...
			    for $accountHolderName in $conDatoCuenta/ns4:RowSet/ns4:Row
			 	...
			 	return
			 		<ACCOUNT_HOLDER_NAME>{ string($accountHolderName/ns1:Column[@name = 'nombre_cliente']/text()) }</ACCOUNT_HOLDER_NAME>,
			 	for $afpId in $conDatoCuenta/ns4:RowSet/ns4:Row
			 	return
...
declare variable $consultaSaldoSPMD as element(ns6:OutputParameters)? external;

xf:consultaCuentaTCHNOut($sjconsultaCuentaTCResponse,
    $conDatoCuenta,
    $conEncabezadoEstadoCuenta,
    $ptEquivalencias,
    $consultaCuentaTC, $consultaSaldoSPMD)