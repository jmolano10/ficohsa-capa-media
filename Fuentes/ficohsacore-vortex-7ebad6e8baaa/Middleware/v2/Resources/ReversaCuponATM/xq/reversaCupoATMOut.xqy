...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ReversaCuponATM/xsd/reversaCupoATMOut/";
...
declare function xf:reversaCupoATMOut($procesaMensajeGenericoSwitchFacadeRequest1 as element(ns0:procesaMensajeGenericoSwitchFacadeRequest),
                ...
                return
                    <ISO8583_XML_CONTENT>
                        ...
                        }
                        {
                            ...
                            return
                                <AmountSettlement_005>{ data($AmountSettlement_005) div 100 }</AmountSettlement_005>
                        }
                        {
                            for $AmountCardholderBilling_006 in $ISO8583_XML_CONTENT/AmountCardholderBilling_006
                            return
                                <AmountCardholderBilling_006>{ data($AmountCardholderBilling_006) div 100 }</AmountCardholderBilling_006>
                        }
                        ...
                        <ResponseCode_039>
                            {
                                if (upper-case($succesIndicator) = 'SUCCESS') then (
                                	'00'
                                ) else if (upper-case($succesIndicator) = 'ERROR') then (
                                	'80'
                                ) else ( 
									$succesIndicator
								)
...
xf:reversaCupoATMOut($procesaMensajeGenericoSwitchFacadeRequest1,
    $succesIndicator)