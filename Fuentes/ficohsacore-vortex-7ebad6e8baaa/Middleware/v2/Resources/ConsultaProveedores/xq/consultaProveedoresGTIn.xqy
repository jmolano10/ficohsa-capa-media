...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaProveedores/xq/consultaProveedoresGTIn/";

declare function xf:consultaProveedoresGTIn($requestHeader as element(ns0:RequestHeader),
...
xf:consultaProveedoresGTIn($requestHeader,
