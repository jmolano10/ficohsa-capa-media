            ...
            <ns2:consultaDatosTarjetaCreditoResponseType>
                <ns2:consultaDatosTarjetaCreditoResponseRecordType>
                    ...
                    }
                    {
                        ...
                        return
                            <ACCOUNT_HOLDER_NAME>{ fn:replace(data($valCuentaHabiente), "[Ññ]", "#") }</ACCOUNT_HOLDER_NAME>
                    ...
                    }
                    {
                        ...
                        return
                            <CARD_HOLDER_NAME>{ fn:replace(data($valNombreTarjetaHabiente), "[Ññ]", "#") }</CARD_HOLDER_NAME>
                    }
                    {
