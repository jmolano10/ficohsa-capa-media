...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ModificacionEstadoCAPFacade/xq/modificacionEstadoCAPFacadeOut/";

declare function xf:modificacionEstadoCAPFacadeOut($transactionId as xs:string,
...
xf:modificacionEstadoCAPFacadeOut($transactionId,
    $sessionId,
    $errorCode,
    $validationMessage)