...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ProcesaMensajeGenericoT24/xq/autorizarDevolucionTSPHeaderOUT/";

declare function xf:autorizarDevolucionTSPHeaderOUT($outputParameters1 as element(ns0:OutputParameters))
...
xf:autorizarDevolucionTSPHeaderOUT($outputParameters1)