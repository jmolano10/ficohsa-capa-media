...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CreacionClienteBanco/xq/consultaUsuarioIn/";
        ...
        <ns1:Consultadeusuariosdelsistema>
            ...
            <WSUSERType>
                <enquiryInputCollection>
                    ...
                    <criteriaValue>{ fn-bea:fail-over( getUsername($username),$username) }</criteriaValue>
                    <operand>EQ</operand>
                </enquiryInputCollection>
            </WSUSERType>
        </ns1:Consultadeusuariosdelsistema>
