...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CambioFactorSeguridad/xq/ConsultaServicioAfiliadosSaraHeaderIN/";
...
declare function xf:ConsultaServicioAfiliadosSaraHeaderIN($serviceAccount as xs:string)
    as element(*) {
        <soap-env:Header>
			...
			<wsa:Action>urn:tailored.icbanking.services.sara.SaraService.GetServicePaymentEntitiesForSaraByDocumentNumber</wsa:Action>
		</soap-env:Header>
};

declare variable $serviceAccount as xs:string external;

xf:ConsultaServicioAfiliadosSaraHeaderIN($serviceAccount)