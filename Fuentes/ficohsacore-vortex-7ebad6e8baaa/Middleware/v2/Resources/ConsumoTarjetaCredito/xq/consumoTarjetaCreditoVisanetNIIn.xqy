...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsumoTarjetaCredito/xq/consumoTarjetaCreditoVisanetNIIn/";
...
declare function xf:consumoTarjetaCreditoVisanetNIIn($consumoTarjetaCredito as element(ns1:consumoTarjetaCredito),
...
xf:consumoTarjetaCreditoVisanetNIIn($consumoTarjetaCredito,
    $posEntryMode,
    $track2Data,
    $paymentgwIP,
    $shopperIP,
