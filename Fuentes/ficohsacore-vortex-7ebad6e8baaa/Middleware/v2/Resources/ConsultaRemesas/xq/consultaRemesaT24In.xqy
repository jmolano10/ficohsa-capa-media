...
(:: pragma bea:global-element-return element="ns1:Consultaderemesa" location="../../../../Business_Resources/remesas/Resoruces/XMLSchema_-1855765488.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaRemesas/xq/ConsultaRemesaT24In/";
...
declare function xf:ConsultaRemesaT24In($requestHeader1 as element(ns2:RequestHeader),
    ...
    as element(ns1:Consultaderemesa) {
        <ns1:Consultaderemesa>
			...
			{
            	let $REMITTANCE_ID := fn:string($consultaRemesas1/REMITTANCE_ID/text())
            	return
...
xf:ConsultaRemesaT24In($requestHeader1,
    $consultaRemesas1)