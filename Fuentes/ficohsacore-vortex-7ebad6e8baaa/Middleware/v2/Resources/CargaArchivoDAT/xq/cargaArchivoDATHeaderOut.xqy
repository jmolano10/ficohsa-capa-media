...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CargaArchivoDAT/xq/cargaArchivoDATHeaderOut/";

declare function xf:cargaArchivoDATHeaderOut($outputParameters as element(ns0:OutputParameters))
...
xf:cargaArchivoDATHeaderOut($outputParameters)