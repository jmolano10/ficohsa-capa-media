...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/RetiroEfectivoCBS/xq/actualizaEstadoTransaccion/";

declare function xf:actualizaEstadoTransaccion($tipoTransaccion as xs:string,
...
xf:actualizaEstadoTransaccion($tipoTransaccion,
    $tipoConsulta,
    $codigoOperacion,
    $estadoTransaccion,
    $FT,
