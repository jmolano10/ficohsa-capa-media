...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoTarjetaCredito/xq/pagoTarjetaCitiConsultaCuentaIn/";
...
declare function xf:pagoTarjetaCitiConsultaCuentaIn($requestHeader as element(ns0:RequestHeader),
        ...
        <ns1:Consultadedetallesdelacuenta>
            ...
            <WSACCOUNTLISTType>
                <enquiryInputCollection>
                    ...
                    <criteriaValue>{ data($pagoTarjetaCredito/DEBIT_ACCOUNT) }</criteriaValue>
                    <operand>EQ</operand>
                </enquiryInputCollection>
            </WSACCOUNTLISTType>
        </ns1:Consultadedetallesdelacuenta>
...
xf:pagoTarjetaCitiConsultaCuentaIn($requestHeader,
    $pagoTarjetaCredito)