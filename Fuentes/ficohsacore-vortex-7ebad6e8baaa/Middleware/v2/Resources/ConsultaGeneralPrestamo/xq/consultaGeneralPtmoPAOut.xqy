...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/abanksPA/consultaGeneralPrestamo/xq/consultaGeneralPrestamoOut/";
...
declare function xf:consultaGeneralPrestamoOut($outputParameters1 as element(ns1:OutputParameters))
    as element(ns0:consultaGeneralPrestamoResponse) {
        if (fn:string($outputParameters1/ns1:ERROR_CODE) = "SUCCESS") then (
