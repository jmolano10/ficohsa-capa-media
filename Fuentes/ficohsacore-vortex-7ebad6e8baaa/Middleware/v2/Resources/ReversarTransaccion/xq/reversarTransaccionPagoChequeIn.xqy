...
(:: pragma bea:global-element-return element="ns1:ReversiondePagodeCheques" location="../../../../Business_Resources/ReversarTransaccion/Resources/XMLSchema_-193201527.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ReversarTransaccion/xq/reversarTransaccionPagoChequeIn/";
...
declare function xf:reversarTransaccionPagoChequeIn($requestHeader as element(ns0:RequestHeader),
    $reversarTransaccion as element(ns2:reversarTransaccion))
    as element(ns1:ReversiondePagodeCheques) {
        <ns1:ReversiondePagodeCheques>
              <WebRequestCommon>
...
xf:reversarTransaccionPagoChequeIn($requestHeader,
    $reversarTransaccion)