...
(:: pragma bea:global-element-return element="ns1:Reversionpagorecaudorefdbcta" location="../../../../Business_Resources/ReversarTransaccion/Resources/XMLSchema_-193201527.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ReversarTransaccion/xq/reversarTransaccionPagoRecaudoIn/";
...
declare function xf:reversarTransaccionPagoRecaudoIn($requestHeader as element(ns0:RequestHeader),
    $reversarTransaccion as element(ns2:reversarTransaccion))
    as element(ns1:Reversionpagorecaudorefdbcta) {
        <ns1:Reversionpagorecaudorefdbcta>
            <WebRequestCommon>
...
xf:reversarTransaccionPagoRecaudoIn($requestHeader,
    $reversarTransaccion)