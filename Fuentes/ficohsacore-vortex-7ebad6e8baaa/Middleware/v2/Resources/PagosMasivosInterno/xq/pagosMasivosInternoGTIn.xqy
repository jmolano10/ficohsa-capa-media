...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagosMasivosInterno/xq/pagosMasivosInternoGTIn/";

declare function xf:pagosMasivosInternoGTIn($requestHeader as element(ns0:RequestHeader),
...
xf:pagosMasivosInternoGTIn($requestHeader,
    $pagosMasivos)