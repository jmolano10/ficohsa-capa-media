...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/PMSV/registraBitacoraPagosMasivos/xsd/registraBitacoraPagosMasivos_sp.xsd" ::)

declare namespace ns0 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/registraBitacoraPagosMasivos";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagosMasivosInterno/xq/registrarBitacoraPagosMasivosIn/";

declare function xf:registrarBitacoraPagosMasivosIn($id as xs:string?,
...
xf:registrarBitacoraPagosMasivosIn($id,
    $customerId,
    $globalId,
    $recordDate,
    $username,
