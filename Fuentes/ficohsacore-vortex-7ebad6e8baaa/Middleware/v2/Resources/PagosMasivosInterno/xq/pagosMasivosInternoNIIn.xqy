...
(:: pragma bea:global-element-return element="ns2:cargarLotes" location="../../../BusinessServices/MTR/cargadorArchivoLote/wsdl/cargadorArchivoLoteEndpoint.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagosMasivosInterno/xq/pagosMasivosInternoNIIn/";

declare function xf:pagosMasivosInternoNIIn($requestHeader as element(ns0:RequestHeader),
    $pagosMasivos as element(ns1:pagosMasivos))
    as element(ns2:cargarLotes) {
        <ns2:cargarLotes>
            <solicitudHostToHost>
                        ...
                        <lotes>
                            {
                                ...
                                return
                                    <lote>
                                        <conceptolote>{ data($BATCH/CONCEPT_BATCH) }</conceptolote>
                                        {
...
xf:pagosMasivosInternoNIIn($requestHeader,
    $pagosMasivos)