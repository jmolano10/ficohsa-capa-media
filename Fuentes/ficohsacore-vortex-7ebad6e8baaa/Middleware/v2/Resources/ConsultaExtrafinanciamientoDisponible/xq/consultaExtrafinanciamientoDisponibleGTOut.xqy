...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../BusinessServices/MasterDataGT/obtenerBlazeData/xsd/obtenerBlazeData_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaExtrafinanciamientoDisponible/xq/consultaExtrafinanciamientoDisponibleGTOut/";
...
declare function xf:consultaExtrafinanciamientoDisponibleGTOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaExtrafinanciamientoDisponibleGTOut($outputParameters)