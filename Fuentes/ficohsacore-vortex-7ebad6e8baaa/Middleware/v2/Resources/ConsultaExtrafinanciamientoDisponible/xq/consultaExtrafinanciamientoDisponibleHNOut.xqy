...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../BusinessServices/ProcesosHN/obtenerBlazeData/xsd/obtenerBlazeData_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaExtrafinanciamientoDisponible/xq/consultaExtrafinanciamientoDisponibleHNOut/";
...
declare function xf:consultaExtrafinanciamientoDisponibleHNOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaExtrafinanciamientoDisponibleHNOut($outputParameters)