...
(:: pragma bea:global-element-parameter parameter="$consultaResponse" element="ns1:ConsultaResponse" location="../../../BusinessServices/External/SalesforceGTMarcaViajeroTC/wsdl/SalesforceGTMarcaViajeroTC.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/SalesforceMarcaViajeroTC/xq/salesforceMarcaViajeroTCGTOut/";

declare function xf:salesforceMarcaViajeroTCGTOut($consultaResponse as element(ns1:ConsultaResponse))
...
xf:salesforceMarcaViajeroTCGTOut($consultaResponse)