...
(:: pragma bea:global-element-parameter parameter="$consultaResponse" element="ns1:ConsultaResponse" location="../../../BusinessServices/External/SalesforcePAMarcaViajeroTC/wsdl/SalesforcePAMarcaViajeroTC.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/SalesforceMarcaViajeroTC/xq/salesforceMarcaViajeroTCPAOut/";

declare function xf:salesforceMarcaViajeroTCPAOut($consultaResponse as element(ns1:ConsultaResponse))
...
xf:salesforceMarcaViajeroTCPAOut($consultaResponse)