...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CargarArchivoLote/xq/cargarArchivoLoteGTIn/";

declare function xf:cargarArchivoLoteGTIn($requestHeader as element(ns0:RequestHeader),
        ...
        <ns2:cargarArchivoLote>
            <solicitudCargaArchivoLote>
                ...
                <nombreArchivo>{ data($cargarArchivoLote/FILE_NAME) }</nombreArchivo>
                {
                 ...
                 <concepto>{data($cargarArchivoLote/CONCEPT)}</concepto>
            </solicitudCargaArchivoLote>
        </ns2:cargarArchivoLote>
};
...
xf:cargarArchivoLoteGTIn($requestHeader,
    $cargarArchivoLote)