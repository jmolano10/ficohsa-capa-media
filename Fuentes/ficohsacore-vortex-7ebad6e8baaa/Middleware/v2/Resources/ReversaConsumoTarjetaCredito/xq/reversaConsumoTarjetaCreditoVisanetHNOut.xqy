...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ReversaConsumoTarjetaCredito/xq/reversaConsumoTarjetaCreditoVisanetHNOut/";

declare function xf:reversaConsumoTarjetaCreditoVisanetHNOut($authorizationResponse as element(ns0:AuthorizationResponse),
    $creditCard as xs:string)
    as element(ns1:reversaConsumoTarjetaCreditoResponse) {
...
xf:reversaConsumoTarjetaCreditoVisanetHNOut($authorizationResponse,
    $creditCard)