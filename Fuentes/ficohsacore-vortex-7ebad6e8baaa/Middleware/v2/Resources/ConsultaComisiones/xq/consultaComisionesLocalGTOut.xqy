...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaComisiones/xq/consultaComisionesLocalGTOut/";

declare function xf:consultaComisionesLocalGTOut($outputParameters as element(ns1:OutputParameters),
...
xf:consultaComisionesLocalGTOut($outputParameters,
    $consultaComisiones)