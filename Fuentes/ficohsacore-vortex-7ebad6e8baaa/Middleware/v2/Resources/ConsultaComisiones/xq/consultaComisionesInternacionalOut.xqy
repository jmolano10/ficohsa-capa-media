...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaComisiones/xq/consultaComisionInternacionalOut/";

declare function xf:consultaComisionesInternacionalOut($consultaComisionSwiftResponse as element(ns1:consultaComisionSwiftResponse))
...
xf:consultaComisionesInternacionalOut($consultaComisionSwiftResponse)