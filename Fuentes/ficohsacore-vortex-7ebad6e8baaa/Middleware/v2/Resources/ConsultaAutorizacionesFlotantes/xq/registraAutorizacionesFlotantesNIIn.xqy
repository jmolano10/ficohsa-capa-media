...
(:: pragma bea:global-element-parameter parameter="$ConDatoCuentaOut" element="ns1:OutputParameters" location="../../../BusinessServices/MasterData/conDatoCuenta/xsd/conDatoCuenta_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaAutorizacionesFlotantes/xq/registraAutorizacionesFlotantesNIIn/";

declare function xf:registraAutorizacionesFlotantesNIIn($resultGroup as element(*),
...
xf:registraAutorizacionesFlotantesNIIn($resultGroup,
    $Country,
    $ConDatoCuentaOut,
    $VPFlotantesOut,
    $startdate,
