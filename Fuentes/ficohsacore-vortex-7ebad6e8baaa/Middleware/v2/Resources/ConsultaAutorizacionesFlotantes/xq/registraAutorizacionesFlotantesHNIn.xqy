...
(:: pragma bea:global-element-parameter parameter="$ConDatocuentaOut" element="ns2:OutputParameters" location="../../../BusinessServices/MasterDataHN/conDatoCuenta/xsd/conDatoCuenta_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaAutorizacionesFlotantes/xq/registraAutorizacionesFlotantesHNIn/";

declare function xf:registraAutorizacionesFlotantesHNIn($resultGroup as element(*),
...
xf:registraAutorizacionesFlotantesHNIn($resultGroup,
    $Country,
    $ConDatocuentaOut,
    $VPFlotantesOut,
    $startdate,
