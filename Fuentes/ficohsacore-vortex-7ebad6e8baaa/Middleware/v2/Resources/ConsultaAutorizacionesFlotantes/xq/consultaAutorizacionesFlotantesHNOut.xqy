...
(:: pragma bea:global-element-parameter parameter="$FlotantesDBOut" element="ns1:OutputParameters" location="../../../BusinessServices/ConsultaFlotanteTC/xsd/consultaAutorizacionesFlotantes_sp.xsd" ::)
(:: pragma bea:global-element-return element="ns0:consultaAutorizacionesFlotantesResponse" location="../xsd/consultaAutorizacionesFlotantesTypes.xsd" ::)

declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/consultaAutorizacionesFlotantesTypes";
declare namespace ns1 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/consultaAutorizacionesFlotantes";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaAutorizacionesFlotantes/xq/consultaAutorizacionesFlotantesHNOut/";
declare namespace ns2 = "http://www.procesa.com/fdcs";

declare function xf:consultaAutorizacionesFlotantesHNOut($resultGroup as element(*),
    $FlotantesDBOut as element(ns1:OutputParameters))
    as element(ns0:consultaAutorizacionesFlotantesResponse) {
        <ns0:consultaAutorizacionesFlotantesResponse>
            <AUTHORIZATIONS>
                   {
                      if(not(empty($FlotantesDBOut/ns1:PT_CAF/ns1:ACCOUNT_NUMBER))) then (
                        fn-bea:inlinedXML(data($FlotantesDBOut/ns1:PT_CAF/ns1:AUTHORIZATION_ITEMS1))
                      )else(
...
declare variable $FlotantesDBOut as element(ns1:OutputParameters) external;

xf:consultaAutorizacionesFlotantesHNOut($resultGroup,
    $FlotantesDBOut)