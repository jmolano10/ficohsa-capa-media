...
(:: pragma bea:global-element-return element="ns0:registrarChequeOtroBcoVirtual" location="../../../BusinessServices/SACE/WS-QUICKDEPOSIT.asmx.wsdl" ::)

declare namespace ns0 = "http://tempuri.org/";
declare namespace ns1 = "http://www.ficohsa.com.hn/middleware.services/depositoVirtualChequesTypes";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/DepositoChequeVirtualOtrosBancos/xq/registrarChequeOtroBancoVirtualIn/";

declare function xf:registrarChequeOtroBancoVirtualIn($depositoVirtualCheques as element(ns1:depositoVirtualCheques),
    $id as xs:string)
    as element(ns0:registrarChequeOtroBcoVirtual) {
        <ns0:registrarChequeOtroBcoVirtual>
...
xf:registrarChequeOtroBancoVirtualIn($depositoVirtualCheques,
    $id)