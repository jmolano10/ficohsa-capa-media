...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/EnvioNotificacionPush/xq/envioNotificacionPushHeaderIN/";
...
declare function getAction($operation as xs:string) as xs:string {
	if ($operation = "SendPushNotificationCustom") then
		"urn:tailored.icbanking.services.externalnotifications.SendPushNotification"
	else 
		"Invalid Operation"
};
declare function xf:creaUsuarioSistemaHeaderIN($serviceAccount as xs:string,
    ...
    as element(*) {
        <soap-env:Header>
			...
			<wsa:To soap-env:mustUnderstand="1">https://pabnkpa10app.gfficohsa.hn/Tailored.ICBanking.ServiceHost/External/ExternalNotificationsService.svc</wsa:To>
