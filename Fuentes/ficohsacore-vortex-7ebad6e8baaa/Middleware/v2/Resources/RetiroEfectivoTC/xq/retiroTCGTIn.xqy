...
(:: pragma bea:global-element-parameter parameter="$onlinePaymentV4Response1" element="ns3:OnlinePaymentV4Response" location="../../../BusinessServices/VisionPlusGT/onlineTransactions_v4/wsdl/OnlineTransactions_v4.wsdl" ::)
(:: pragma bea:global-element-return element="ns2:InputParameters" location="../../../BusinessServices/PWS/retiroTC/xsd/retiroTC_sp.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/RetiroEfectivoTC/xq/retiroTCGTIn/";
...
declare function xf:retiroTCGTIn($retiroEfectivoTC1 as element(ns0:retiroEfectivoTC),
...
xf:retiroTCGTIn($retiroEfectivoTC1,
    $outputParameters1,
