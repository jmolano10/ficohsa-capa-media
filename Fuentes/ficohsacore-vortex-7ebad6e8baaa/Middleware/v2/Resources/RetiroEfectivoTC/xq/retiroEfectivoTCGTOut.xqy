...
(:: pragma bea:global-element-parameter parameter="$onlinePaymentV4Response1" element="ns2:OnlinePaymentV4Response" location="../../../BusinessServices/VisionPlusGT/onlineTransactions_v4/wsdl/OnlineTransactions_v4.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/RetiroEfectivoTC/xq/retiroEfectivoTCGTOut/";
...
declare function xf:retiroEfectivoTCGTOut($onlinePaymentV4Response1 as element(ns2:OnlinePaymentV4Response),
...
xf:retiroEfectivoTCGTOut($onlinePaymentV4Response1,
    $outputParameters1,
    $dateTimeAut,
    $dateTimeCore)