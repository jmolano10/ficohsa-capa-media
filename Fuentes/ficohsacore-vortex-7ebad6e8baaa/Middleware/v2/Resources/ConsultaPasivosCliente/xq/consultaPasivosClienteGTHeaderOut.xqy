...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaPasivosCliente/xq/consultaPasivosClienteGTHeaderOut/";
...
declare function xf:consultaPasivosClienteGTHeaderOut($outputParameters1 as element(ns2:OutputParameters),
...
xf:consultaPasivosClienteGTHeaderOut($outputParameters1,
    $outputParameters2)