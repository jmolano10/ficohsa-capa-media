...
(:: pragma bea:global-element-return element="ns1:CreateUser" location="../../../BusinessServices/CREDITFORCEPA/GestionAccesosUsuarios/xsd/XMLSchema_-336569570.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CreaAccesoUsuario/xq/createUserCFPAIn/";
...
declare function xf:createUserCFPAIn($creaAccesoUsuario as element(ns2:creaAccesoUsuario),
    $token as xs:string,
...
xf:createUserCFPAIn($creaAccesoUsuario,
    $token,
    $userName)