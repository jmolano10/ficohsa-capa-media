...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaContratosCliente/xq/consultaContratosClienteHeaderOut/";

declare function xf:consultaContratosClienteHeaderOut($outputParameters as element(ns1:OutputParameters))
        ...
        <ns0:ResponseHeader>
            {
                ...
                return
                    <successIndicator>
                      { 
                         if (data($PV_CODIGOMENSAJE) = 'SUCCESS') then
                            "Success"
                         else
                            data($PV_CODIGOMENSAJE)
                      }                    
                    </successIndicator>
            }
            {
...
xf:consultaContratosClienteHeaderOut($outputParameters)