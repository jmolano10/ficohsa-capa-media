...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaMovimientosRecientesTC/xq/consultaMovsRecientesTCNIOut/";
...
declare function xf:consultaMovsRecientesTCNIOut($resultGroup as element(*)?,
...
xf:consultaMovsRecientesTCNIOut($resultGroup,
    $rspConDatoTarjeta,
