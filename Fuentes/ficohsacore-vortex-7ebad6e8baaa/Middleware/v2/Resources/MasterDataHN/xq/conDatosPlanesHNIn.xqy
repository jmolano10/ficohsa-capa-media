...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/MasterDataHN/conDatosPlanes/xsd/conDatosPlanes_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/MasterDataHN/xq/conDatosPlanesHNIn/";

declare function xf:conDatosPlanesHNIn($consultaPlanesCredito as element(ns0:consultaPlanesCredito),
...
xf:conDatosPlanesHNIn($consultaPlanesCredito,
    $codigoPais)