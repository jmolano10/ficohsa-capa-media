...
(:: pragma bea:global-element-parameter parameter="$bloqueoCAPRequest" element="ns1:bloqueoCAPRequest" location="../xsd/operacionesCAPTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/OperacionesCAP/xq/bloqueoCAPIn/";
...
declare function xf:bloqueoCAPIn($requestHeader as element(ns2:RequestHeader),
    $bloqueoCAPRequest as element(ns1:bloqueoCAPRequest))
    as element(ns0:DesbloqueodecuentasAOP) {
        <ns0:DesbloqueodecuentasAOP>
            ...
            <ACCOUNTDESBLOQAHOPWSType id = "{ data($bloqueoCAPRequest/CUENTA_AP) }">
                <PostingRestrict>16</PostingRestrict>
            </ACCOUNTDESBLOQAHOPWSType>
       </ns0:DesbloqueodecuentasAOP>
};

declare variable $requestHeader as element(ns2:RequestHeader) external;
declare variable $bloqueoCAPRequest as element(ns1:bloqueoCAPRequest) external;

xf:bloqueoCAPIn($requestHeader,
    $bloqueoCAPRequest)