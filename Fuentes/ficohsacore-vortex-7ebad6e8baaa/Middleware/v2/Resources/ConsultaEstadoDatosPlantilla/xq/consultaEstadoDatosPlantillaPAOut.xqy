...
(:: pragma bea:global-element-parameter parameter="$eCConRequestControl" element="ns1:OutputParameters" location="../../../BusinessServices/ProcesosPA/eCConRequestControl/xsd/eCConRequestControl_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaEstadoDatosPlantilla/xq/consultaEstadoDatosPlantillaPAOut/";

declare function xf:consultaEstadoDatosPlantillaPAOut($eCConRequestControl as element(ns1:OutputParameters),
...
xf:consultaEstadoDatosPlantillaPAOut($eCConRequestControl,
    $batch_id)