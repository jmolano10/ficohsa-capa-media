...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../BusinessServices/ABKGT/consultaFechaSistema/xsd/consultaFechaSistema_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaFechaSistema/xq/consultaFechaSistemaGTOut/";

declare function xf:consultaFechaSistemaGTOut($outputParameters as element(ns0:OutputParameters))
...
xf:consultaFechaSistemaGTOut($outputParameters)