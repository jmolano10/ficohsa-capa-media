        ...
        <ns1:ResponseHeader>
            {
                let $successIndicatorAhorro := $ahorroResponse/Status/successIndicator,
                    ...
                    $successIndicatorPensiones := $outputParameters/ns2:error
                return
                	if ( data($successIndicatorAhorro) != "Success" and data($successIndicatorCorriente) != "Success" and data($successIndicatorDeposito) != "Success" and ($successIndicatorPensiones) != "false") then (
                    	<successIndicator>ERROR</successIndicator>,
                    	for $messages in $ahorroResponse/Status/messages union $depositoResponse/Status/messages union $corrienteResponse/Status/messages union $outputParameters/ns2:mensaje
                    	return
                    	...
                    	let $pensiones := count($outputParameters/ns2:datos/ns2:cuentas)
                    	return 
