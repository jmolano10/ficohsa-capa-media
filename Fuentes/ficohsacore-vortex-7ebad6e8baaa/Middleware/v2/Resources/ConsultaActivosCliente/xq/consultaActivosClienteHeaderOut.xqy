...
(:: pragma bea:global-element-parameter parameter="$ahorroResponse" element="ns0:ConsultadectasahorroporclienteResponse" location="../../../../Business_Resources/consultasCliente/Resources/XMLSchema_1144838292.xsd" ::)
(:: pragma bea:global-element-parameter parameter="$corrienteResponse" element="ns0:ConsultactascorrienteporclienteResponse" location="../../../../Business_Resources/consultasCliente/Resources/XMLSchema_1144838292.xsd" ::)
        ...
        <ns1:ResponseHeader>
            {
                let $successIndicatorAhorro := $ahorroResponse/Status/successIndicator,
                    ...
                    $successIndicatorPensiones := $outputParameters/ns2:CODIGO_ERROR
                return
                	if ( data($successIndicatorAhorro) != "Success" and data($successIndicatorCorriente) != "Success" and data($successIndicatorDeposito) != "Success" and ($successIndicatorPensiones) != "SUCCESS") then (
                    	...
                    	let $pensiones := count($outputParameters/ns2:PT_CUENTAS/ns2:CUENTA)
                    	return 
