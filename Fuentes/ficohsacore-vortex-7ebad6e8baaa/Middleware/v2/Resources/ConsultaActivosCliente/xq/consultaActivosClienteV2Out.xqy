...
(:: pragma bea:global-element-parameter parameter="$consultadectasahorroporclienteResponse1" element="ns0:ConsultaCuentaAhorroxClienteResponse" location="../../../BusinessServices/T24/ConsultaCuentaAhorro/xsd/services_1.xsd" ::)

(:: pragma bea:global-element-parameter parameter="$consultadectasahorroporclienteResponse1" element="ns0:ConsultaCuentaCorrientexClienteResponse" location="../../../BusinessServices/T24/ConsultaCuentaCorriente/xsd/services_1.xsd" ::)
...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns2:cuentasSaldosResponse" location="../../../BusinessServices/FPC/CloudCode/Schemas/CloudCodeTypes.xsd" ::)
...
declare function xf:consultaActivosClienteOut($functionalityDisplayIndicator as xs:string,
    $consultadectasahorroporclienteResponse1 as element(ns0:ConsultaCuentaAhorroxClienteResponse),
    $consultactascorrienteporclienteResponse1 as element(ns0:ConsultaCuentaCorrientexClienteResponse),
    $consultadecertifdepporclienteResponse1 as element(ns0:ConsultadecertifdepporclienteResponse),
    $outputParameters as element(ns2:cuentasSaldosResponse))
    as element(ns1:consultaActivosClienteResponse) {
        <ns1:consultaActivosClienteResponse>
            <ns1:consultaActivosClienteAhorrosResponseType>
            	{
                    ...
                    return
                        <SUCCESS_INDICATOR>{ mensajeRespuesta(data($successIndicator), $consultadectasahorroporclienteResponse1/WSFICOLINKSAVINGSACCOUNTType[1]/gWSFICOLINKSAVINGSACCOUNTDetailType/mWSFICOLINKSAVINGSACCOUNTDetailType)  }</SUCCESS_INDICATOR>
                }
                {
                    for $mFICOLINKSAVINGSACCTDetailType in $consultadectasahorroporclienteResponse1/WSFICOLINKSAVINGSACCOUNTType[1]/gWSFICOLINKSAVINGSACCOUNTDetailType/mWSFICOLINKSAVINGSACCOUNTDetailType
                    return
            ...
            <ns1:consultaActivosClienteCorrienteResponseType>
            	{
                    ...
                    return
                        <SUCCESS_INDICATOR>{ mensajeRespuesta(data($successIndicator),  $consultactascorrienteporclienteResponse1/WSFICOLINKCURRENTACCOUNTType[1]/gWSFICOLINKCURRENTACCOUNTDetailType/mWSFICOLINKCURRENTACCOUNTDetailType) }</SUCCESS_INDICATOR>
                }
                {
                    for $mFICOLINKCURRENTACCTDetailType in $consultactascorrienteporclienteResponse1/WSFICOLINKCURRENTACCOUNTType[1]/gWSFICOLINKCURRENTACCOUNTDetailType/mWSFICOLINKCURRENTACCOUNTDetailType
                    return
                        <ns1:consultaActivosClienteResponseRecordType>
            ...
            <ns1:consultaActivosClientePensionesResponseType>
            	{
                    let $status := data($outputParameters/ns2:error)
                    return
                        <SUCCESS_INDICATOR>{ mensajeRespuesta(if($status = 'false')then('Success')else($status), $outputParameters/ns2:datos/ns2:cuentas) }</SUCCESS_INDICATOR>
                }
                {
                    for $CUENTA in $outputParameters/ns2:datos/ns2:cuentas
                    return
                        <ns1:consultaActivosClienteResponseRecordType>
                        	<ASSET_TYPE>FPC</ASSET_TYPE>
                            <ASSET_NUMBER>{ data($CUENTA/ns2:cuenta) }</ASSET_NUMBER>
                            <ASSET_NAME>{  concat(fn:data($CUENTA/ns2:primerNombre)," ",fn:data($CUENTA/ns2:segundoNombre)," ",fn:data($CUENTA/ns2:primerApellido)," ",
                        fn:data($CUENTA/ns2:segundoApellido)) }</ASSET_NAME>
                            <ASSET_CURRENCY>{ data($CUENTA/ns2:moneda) }</ASSET_CURRENCY>
						    <ASSET_TOTAL_BALANCE>{ data($CUENTA/ns2:saldoTotal) }</ASSET_TOTAL_BALANCE>																			
                        </ns1:consultaActivosClienteResponseRecordType>
                }
            </ns1:consultaActivosClientePensionesResponseType> 
        </ns1:consultaActivosClienteResponse>
...
declare variable $consultadectasahorroporclienteResponse1 as element(ns0:ConsultaCuentaAhorroxClienteResponse) external;
declare variable $consultactascorrienteporclienteResponse1 as element(ns0:ConsultaCuentaCorrientexClienteResponse) external;
declare variable $consultadecertifdepporclienteResponse1 as element(ns0:ConsultadecertifdepporclienteResponse) external;
declare variable $outputParameters as element(ns2:cuentasSaldosResponse) external;
