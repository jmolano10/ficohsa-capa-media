...
(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns0:OutputParameters" location="../../../BusinessServices/ABKPA/consultaListaCuentas/xsd/consultaListaCuentas_sp.xsd" ::)
(:: pragma bea:global-element-return element="ns1:consultaActivosClienteResponse" location="../xsd/consultaClientesTypes.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaActivosCliente/xq/consultaListaCuentasPAOut1/";
...
declare function xf:consultaListaCuentasPAOut1($outputParameters1 as element(ns0:OutputParameters))
...
xf:consultaListaCuentasPAOut1($outputParameters1)