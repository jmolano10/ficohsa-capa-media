...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../BusinessServices/ABKPA/consultaDetalleTarjetas/xsd/consultaDetalleTarjetas_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaDetalleTarjetas/xq/consultaDetalleTarjetasPAOut/";

declare function xf:consultaDetalleTarjetasPAOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaDetalleTarjetasPAOut($outputParameters)