...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../BusinessServices/MasterDataGT/conHeaderEncabezadoEstadoCuenta/xsd/conHeaderEncabezadoEstadoCuenta_sp.xsd" ::)
(:: pragma bea:global-element-return element="ns0:consultaSaldosHistEstadoCuentaResponse" location="../../ConsultaSaldosHistEstadoCuenta/xsd/consultaSaldosHistEstadoCuentaTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaSaldosHistEstadoCuentaGT/xq/consultaSaldosHistEstadoCuentaGTOut/";

declare function xf:consultaSaldosHistEstadoCuentaGTOut($outputParameters as element(ns0:OutputParameters))
...
xf:consultaSaldosHistEstadoCuentaGTOut($outputParameters)