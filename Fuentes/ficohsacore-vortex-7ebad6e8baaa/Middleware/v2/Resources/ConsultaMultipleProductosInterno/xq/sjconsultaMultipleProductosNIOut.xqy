...
(:: pragma bea:global-element-parameter parameter="$sjConsultaMultipleProductosNIResponse" element="ns0:sjConsultaMultipleProductosNIResponse" location="../../../BusinessServices/SJS/consultaMultipleProductosNI/xsd/sjConsultaMultipleProductosNI.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaMultipleProductosInterno/xq/sjconsultaMultipleProductosNIOut/";

declare function xf:sjconsultaMultipleProductosNIOut($sjConsultaMultipleProductosNIResponse as element(ns0:sjConsultaMultipleProductosNIResponse))
    as element(ns1:consultaMultipleProductosInternoResponse) {
        <ns1:consultaMultipleProductosInternoResponse>
            {
                for $ASSETS in $sjConsultaMultipleProductosNIResponse/ns0:ASSETS
                return
                    <ASSETS>
                        {
            ...
            {
                for $LIABILITIES in $sjConsultaMultipleProductosNIResponse/ns0:LIABILITIES
                return
                    <LIABILITIES>
                        {
                            ...
                            return
                                <LIABILITY>
                                    ...
                                    }
                                    {
                                        ...
                                        return
                                            let $__nullable := ( data($CANCELATION_TOTAL) )
                                            return
                                                if (fn:boolean($__nullable))
                                                then
                                                    <CANCELATION_TOTAL>{ $__nullable }</CANCELATION_TOTAL>
                                                else
                                                    ()
                                    }
                                    {
...
declare variable $sjConsultaMultipleProductosNIResponse as element(ns0:sjConsultaMultipleProductosNIResponse) external;

xf:sjconsultaMultipleProductosNIOut($sjConsultaMultipleProductosNIResponse)