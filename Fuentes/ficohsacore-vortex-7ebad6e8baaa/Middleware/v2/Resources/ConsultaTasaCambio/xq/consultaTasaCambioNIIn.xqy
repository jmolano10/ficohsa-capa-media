...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaTasaCambio/xq/consultaTasaCambioNIIn/";
...
declare function xf:consultaTasaCambioNIIn($consultaTasaCambio1 as element(ns1:consultaTasaCambio))
    as element(ns2:opBuscarTasaCambioSolicitud) {
        <ns2:opBuscarTasaCambioSolicitud>
            ...
            <ns0:monedaCompra>{ convertirMoneda(fn:string($consultaTasaCambio1/SOURCE_CURRENCY/text())) }</ns0:monedaCompra>
            <ns0:indicador>3</ns0:indicador>
            <ns0:codMonedaDebito>{ convertirMoneda(fn:string($consultaTasaCambio1/TARGET_CURRENCY/text())) }</ns0:codMonedaDebito>
        </ns2:opBuscarTasaCambioSolicitud>
};

declare variable $consultaTasaCambio1 as element(ns1:consultaTasaCambio) external;

xf:consultaTasaCambioNIIn($consultaTasaCambio1)