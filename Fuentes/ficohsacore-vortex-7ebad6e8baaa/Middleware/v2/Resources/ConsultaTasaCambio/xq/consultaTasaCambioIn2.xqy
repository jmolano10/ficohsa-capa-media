...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaTasaCambio/xq/consultaTasaCambioIn2/";
...
declare function xf:consultaTasaCambioIn2($requestHeader as element(ns2:RequestHeader),
        ...
        <ns1:Consultadetasadecambiolcy>
            ...
            <WSLCYEXCHRATEType>
                <enquiryInputCollection>
                	...
                	<criteriaValue>{ data($consultaTasaCambio/SOURCE_CURRENCY) }</criteriaValue>
                	<operand>EQ</operand>
                </enquiryInputCollection>
            </WSLCYEXCHRATEType>
        </ns1:Consultadetasadecambiolcy>
...
xf:consultaTasaCambioIn2($requestHeader,
    $consultaTasaCambio)