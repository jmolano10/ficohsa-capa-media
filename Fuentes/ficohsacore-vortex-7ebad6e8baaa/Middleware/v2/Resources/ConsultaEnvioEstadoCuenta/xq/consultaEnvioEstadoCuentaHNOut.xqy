...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../BusinessServices/Strongview/obtenerbfemBitacoraEC/xsd/obtenerbfemBitacoraEC_sp.xsd" ::)
(:: pragma bea:global-element-return element="ns1:consultaEnvioEstadoCuentaResponse" location="../xsd/consultaEnvioEstadoCuentaTypes.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaEnvioEstadoCuenta/xq/consultaEnvioEstadoCuentaHNOut/";
...
declare function xf:consultaEnvioEstadoCuentaHNOut($outputParameters as element(ns1:OutputParameters))
            ...
            <BALANCE_INFORMATION>
   				...
   				}
                {
   					...
   					<LEGAL_ID>{ $LEGAL_ID }</LEGAL_ID>
   						...
   						<EMAIL>{ string($row/ns1:Column[upper-case(@name)='EMAIL']/text()) }</EMAIL>
...
xf:consultaEnvioEstadoCuentaHNOut($outputParameters)