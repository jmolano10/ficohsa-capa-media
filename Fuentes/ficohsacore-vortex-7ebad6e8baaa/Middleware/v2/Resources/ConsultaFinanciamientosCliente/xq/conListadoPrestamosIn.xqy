...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/MasterData/conListadoPrestamos/xsd/conListadoPrestamos_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaFinanciamientosCliente/xq/conListadoPrestamosIn/";

declare function xf:conListadoPrestamosIn($consultaFinanciamientosCliente as element(ns0:consultaFinanciamientosCliente),
    $pais as xs:string)
    as element(ns1:InputParameters) {
        <ns1:InputParameters>
            <ns1:Pais>{ $pais }</ns1:Pais>
            <ns1:NumeroB>{ data($consultaFinanciamientosCliente/SEARCH_VALUE) }</ns1:NumeroB>
            {
           ...
           <ns1:Tipo>
            { 
                let $search_criterial := upper-case(string($consultaFinanciamientosCliente/SEARCH_CRITERIA/text()))
                return
...
xf:conListadoPrestamosIn($consultaFinanciamientosCliente,
    $pais)