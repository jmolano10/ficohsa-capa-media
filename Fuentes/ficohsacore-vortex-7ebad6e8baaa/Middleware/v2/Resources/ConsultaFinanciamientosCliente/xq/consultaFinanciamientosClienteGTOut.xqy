...
(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns1:OutputParameters" location="../../../BusinessServices/MasterDataGT/conListadoPrestamos/xsd/conListadoPrestamos_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaFinanciamientosCliente/xq/consultaFinanciamientosClienteGTOut/";
...
declare function xf:consultaFinanciamientosClienteGTOut($outputParameters1 as element(ns1:OutputParameters))
...
xf:consultaFinanciamientosClienteGTOut($outputParameters1)