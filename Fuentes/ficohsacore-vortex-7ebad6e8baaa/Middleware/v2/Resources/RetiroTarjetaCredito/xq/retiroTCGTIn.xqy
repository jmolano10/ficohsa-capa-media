...
(:: pragma bea:global-element-parameter parameter="$onlinePaymentV4Response" element="ns2:OnlinePaymentV4Response" location="../../../BusinessServices/VisionPlusGT/onlineTransactions_v4/wsdl/OnlineTransactions_v4.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/RetiroTarjetaCredito/xq/retiroTCGTIn/";

declare function xf:retiroTCGTIn($retiroTarjetaCredito as element(ns0:retiroTarjetaCredito),
    ...
    as element(ns1:InputParameters) {
        <ns1:InputParameters>
            ...
            <ns1:PV_NUMERO_TARJETA>{ fn-bea:pad-left(data($retiroTarjetaCredito/CREDIT_CARD_INFO/VALUE), 19, '0') }</ns1:PV_NUMERO_TARJETA>
...
xf:retiroTCGTIn($retiroTarjetaCredito,
