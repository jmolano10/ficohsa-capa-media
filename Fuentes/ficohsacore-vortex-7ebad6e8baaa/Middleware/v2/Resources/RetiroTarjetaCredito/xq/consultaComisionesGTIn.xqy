...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/RetiroTarjetaCredito/xq/consultaComisionesGTIn/";
...
declare function xf:consultaComisionesGTIn($retiroTarjetaCredito as element(ns1:retiroTarjetaCredito),
...
xf:consultaComisionesGTIn($retiroTarjetaCredito,
    $TransactionType,
    $nameAdditionalInfo)