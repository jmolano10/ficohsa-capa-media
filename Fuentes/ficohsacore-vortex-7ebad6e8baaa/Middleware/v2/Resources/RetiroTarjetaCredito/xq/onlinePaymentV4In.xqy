...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/RetiroTarjetaCredito/xq/onlinePaymentV4In/";

declare function xf:onlinePaymentV4In($retiroTarjetaCredito1 as element(ns0:retiroTarjetaCredito),
    $org as xs:string,
    ...
    as element(ns1:OnlinePaymentV4Request) {
        <ns1:OnlinePaymentV4Request>
            ...
            <CardExpirationDate>{ data($retiroTarjetaCredito1/CREDIT_CARD_INFO/EXPIRATION_DATE) }</CardExpirationDate>
...
xf:onlinePaymentV4In($retiroTarjetaCredito1,
    $org,
    $sequenceValue,
    $merchantNumber)