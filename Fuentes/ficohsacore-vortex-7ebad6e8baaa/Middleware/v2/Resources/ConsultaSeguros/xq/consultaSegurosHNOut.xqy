...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaSeguros/xq/consultaSegurosHNOut/";
declare namespace ns2 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/consultaSeguros";

declare function xf:consultaSegurosHNOut($outputParameters as element(ns2:OutputParameters)?,
...
xf:consultaSegurosHNOut($outputParameters, $insuranceInquiryResponse)