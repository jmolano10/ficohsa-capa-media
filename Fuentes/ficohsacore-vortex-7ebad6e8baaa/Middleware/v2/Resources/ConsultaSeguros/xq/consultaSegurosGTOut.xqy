...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaSeguros/xq/consultaSegurosGTOut/";
...
declare function xf:consultaSegurosGTOut($outputParameters as element(ns2:OutputParameters)?,
...
xf:consultaSegurosGTOut($outputParameters, $insuranceInquiryResponse)