...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaSeguros/xq/consultaSegurosNIOut/";
...
declare function xf:consultaSegurosNIOut($outputParameters as element(ns2:OutputParameters)?,
...
xf:consultaSegurosNIOut($outputParameters,
