...
(:: pragma bea:global-element-parameter parameter="$consultarEstadosCuentaUltimoCorteResponse1" element="ns0:ConsultarEstadosCuentaUltimoCorteResponse" location="../../../BusinessServices/ABKHN/transaccionesAlcance/wsdl/wsinfotarjetas.asmx.wsdl" ::)
(:: pragma bea:global-element-parameter parameter="$conInfoHistoricaTCResponse" element="ns2:OutputParameters" location="../../../BusinessServices/ProcesosHN/conInfoHistoricaTC/xsd/conInfoHistoricaTC_sp.xsd" ::)
(:: pragma bea:global-element-parameter parameter="$conTransaccionesHistoricasResponse" element="ns1:OutputParameters" location="../../../BusinessServices/ProcesosHN/conTransaccionesHistoricas/xsd/conTransaccionesHistoricas_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaEstadoCuentaTC/xq/consultaEstCuentaTCHNOut/";
...
declare function xf:consultaEstCuentaTCHNOut($conInfoHistoricaTCResponse as element(ns2:OutputParameters)?,
       ...
       if(not(empty($consultarEstadosCuentaUltimoCorteResponse1/*))) then(
       	...
       	<ns0:consultaEstadoCuentaTCResponse>
            ...
            <POINTS_AVAILABLE>{ data($result/ns3:puntosAcumulados) }</POINTS_AVAILABLE>
            {
            	for $limites in $result/ns3:saldos/ns3:ArrayOfStrucSaldosEstado
            	return
            		if ( local:getMoneda($limites/ns3:moneda) = "HNL") then 
            		(
	    	...
	    	<CUSTOMER_NAME>{data($conInfoHistoricaTC/ns2:Column[@name = 'account_name'])}</CUSTOMER_NAME>
	            ...
	            <PAYMENT_LIMIT_DATE>{string($conInfoHistoricaTC/ns2:Column[@name = 'fechamaximapago']/text())}</PAYMENT_LIMIT_DATE>
	            {
	            	...
	            	let $rowInfoHistoricaLocal := $conInfoHistoricaTCResponse/ns2:RowSet/ns2:Row[ns2:Column[@name = 'CodMoneda']/text() = 'HNL'][1]
...
xf:consultaEstCuentaTCHNOut($conInfoHistoricaTCResponse,
