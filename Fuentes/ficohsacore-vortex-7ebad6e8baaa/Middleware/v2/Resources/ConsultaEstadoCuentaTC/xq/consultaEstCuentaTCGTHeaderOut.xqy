...
(:: pragma bea:global-element-parameter parameter="$consultarEstadosCuentaUltimoCorteResponse1" element="ns1:ConsultarEstadosCuentaUltimoCorteResponse" location="../../../BusinessServices/ABKGT/transaccionesAlcance/wsdl/wsinfotarjetas.asmx.wsdl" ::)
(:: pragma bea:global-element-return element="ns0:ResponseHeader" location="../../esquemas_generales/HeaderElements.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/abanksGT/consultaEstadoCuentaTC/xq/consultaEstadoCuentaTCHeaderOut/";
        ...
        <ns0:ResponseHeader>
        	{
        		if (fn:empty(data($consultarEstadosCuentaUltimoCorteResponse1/ns1:ConsultarEstadosCuentaUltimoCorteResult/ns1:estatusConfirmacion))) then (
        			 ...
        			 <successIndicator>
        			 {
        			 	if (data($consultarEstadosCuentaUltimoCorteResponse1/ns1:ConsultarEstadosCuentaUltimoCorteResult/ns1:estatusConfirmacion) = "97") then
        			 		"NO RECORDS"
        			 	else
        			 		local:getSuccessIndicator(data($consultarEstadosCuentaUltimoCorteResponse1/ns1:ConsultarEstadosCuentaUltimoCorteResult/ns1:estatusConfirmacion)) 
        			 }
        			 </successIndicator>,
