...
(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns1:OutputParameters" location="../../../BusinessServices/MasterDataGT/obtenerTarjetaTitular/xsd/obtenerTarjetaTitular_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ActualizaProductoTC/xq/embosserInquiryL8V6GTIn/";

declare function xf:embosserInquiryL8V6GTIn($outputParameters1 as element(ns1:OutputParameters))
...
xf:embosserInquiryL8V6GTIn($outputParameters1)