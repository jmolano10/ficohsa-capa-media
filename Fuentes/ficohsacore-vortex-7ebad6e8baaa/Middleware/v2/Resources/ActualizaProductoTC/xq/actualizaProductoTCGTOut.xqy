...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ActualizaProductoTC/xq/actualizaProductoTCGTOut/";

declare function xf:actualizaProductoTCGTOut($accountNumber as xs:string,
...
xf:actualizaProductoTCGTOut($accountNumber,
    $previusCardNumber,
    $currentCardNumber,
    $productType)