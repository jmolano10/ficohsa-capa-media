...
declare function getAction($operation as xs:string) as xs:string {
	if ($operation = "GetThirdPartyProductsForSaraByDocumentNumber") then
		"urn:tailored.icbanking.services.sara.SaraService.GetThirdPartyProductsForSaraByDocumentNumber"
	else 
		"Invalid Operation"
};
...
declare function xf:usersValidationCustomServiceHeaderIn($serviceAccount as xs:string,
    ...
    as element(*) {
        <soap-env:Header>
			...
			<wsa:To soap-env:mustUnderstand="1">https://pabnkpa10app.gfficohsa.hn/Tailored.ICBanking.ServiceHost/Sara/SaraService.svc</wsa:To>
