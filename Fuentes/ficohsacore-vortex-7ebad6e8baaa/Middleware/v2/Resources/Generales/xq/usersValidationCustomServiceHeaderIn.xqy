...
declare function xf:usersValidationCustomServiceHeaderIn($serviceAccount as xs:string,
    ...
    as element(*) {
        <soap-env:Header>
			...
			<wsa:To soap-env:mustUnderstand="1">https://pabnkpa10app.gfficohsa.hn/Tailored.ICBanking.ServiceHost/Administration/UsersValidationCustomService.svc</wsa:To>
