...
declare function xf:registraSaldosGTTCIn($sjConsultaSaldosTarjetaCreditoResponse as element(ns1:sjConsultaSaldosTarjetaCreditoResponse),
	            	...
	            	<ns2:PT_SALDOS_TARJETA_ITEM>
			        {
	                	...
	                	if(not(empty(data($sjConsultaSaldosTarjetaCreditoResponse/CREDIT_LIMIT_CCY/text()))))then(
	                		...
	                		if(not(empty($rowAlt))) then (
	                			...
	                			<ns2:CREDIT_LIMIT_CCY>GTQ</ns2:CREDIT_LIMIT_CCY>
	                		)
	                	),
...
xf:registraSaldosGTTCIn($sjConsultaSaldosTarjetaCreditoResponse,
