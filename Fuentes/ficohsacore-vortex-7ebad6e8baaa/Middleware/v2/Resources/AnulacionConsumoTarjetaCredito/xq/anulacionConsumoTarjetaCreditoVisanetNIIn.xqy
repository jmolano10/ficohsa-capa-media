...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/AnulacionConsumoTarjetaCredito/xq/anulacionConsumoTarjetaCreditoVisanetNIIn/";
...
declare function xf:anulacionConsumoTarjetaCreditoVisanetNIIn($anulacionConsumoTarjetaCredito as element(ns1:anulacionConsumoTarjetaCredito),
...
xf:anulacionConsumoTarjetaCreditoVisanetNIIn($anulacionConsumoTarjetaCredito,
    $posEntryMode,
    $paymentgwIP,
    $shopperIP,
    $merchantServerIP,
