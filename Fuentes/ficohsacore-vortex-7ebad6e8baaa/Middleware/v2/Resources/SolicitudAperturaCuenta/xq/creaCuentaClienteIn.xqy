...
(:: pragma bea:global-element-return element="ns0:CrearCuentaSimplificada" location="../../../BusinessServices/T24/creacionCuenta/xsd/XMLSchema_157462005.xsd" ::)
    ...
    as element(ns0:CrearCuentaSimplificada) {
        <ns0:CrearCuentaSimplificada>
            ...
            <ACCOUNTFICOINDSBWSType>
                ...
                <gLR.TIN.ACT>
                    {
                        for $BENEFICIARY_DETAIL in $solicitudAperturaCuenta/ACCOUNT_DETAILS/ACCOUNT_DETAIL[1]/BENEFICIARY_DETAILS/BENEFICIARY_DETAIL
                        return
                            <mLR.TIN.ACT>
                                <LRTINACT>{ data($BENEFICIARY_DETAIL/LEGAL_ID) }</LRTINACT>
                                <LRNUMACT>{ data($BENEFICIARY_DETAIL/DOCUMENT_TYPE) }</LRNUMACT>
                            </mLR.TIN.ACT>
                    }
                </gLR.TIN.ACT>
