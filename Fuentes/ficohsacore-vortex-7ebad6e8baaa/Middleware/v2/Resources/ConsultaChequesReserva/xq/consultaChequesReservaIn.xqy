...
(:: pragma bea:global-element-return element="ns1:Consultadechequesenreserva" location="../../../../Business_Resources/consultaCheque/Resources/XMLSchema_1569843523.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaChequesReserva/xq/consultaChequesReservaIn/";
...
declare function xf:consultaChequesReservaIn($requestHeader as element(ns0:RequestHeader),
    $consultaChequesReserva as element(ns2:consultaChequesReserva))
    as element(ns1:Consultadechequesenreserva) {
        <ns1:Consultadechequesenreserva>
             <WebRequestCommon>
...
xf:consultaChequesReservaIn($requestHeader,
