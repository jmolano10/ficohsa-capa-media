...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../BusinessServices/ProcesosPA/conHeaderEncabezadoEstadoCuenta/xsd/conHeaderEncabezadoEstadoCuenta_sp.xsd" ::)
(:: pragma bea:global-element-return element="ns1:consultaSaldosHistEstadoCuentaResponse" location="../../ConsultaSaldosHistEstadoCuenta/xsd/consultaSaldosHistEstadoCuentaTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaSaldosHistEstadoCuentaPA/xq/consultaSaldosHistEstadoCuentaPAOut/";

declare function xf:consultaSaldosHistEstadoCuentaPAOut($outputParameters as element(ns0:OutputParameters))
...
xf:consultaSaldosHistEstadoCuentaPAOut($outputParameters)