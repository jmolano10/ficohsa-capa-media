...
declare function xf:settlementQuoteInquiryL8V1NIIn($consultaDetalleFinanciamiento1 as element(ns1:consultaDetalleFinanciamiento))
...
xf:settlementQuoteInquiryL8V1NIIn($consultaDetalleFinanciamiento1)