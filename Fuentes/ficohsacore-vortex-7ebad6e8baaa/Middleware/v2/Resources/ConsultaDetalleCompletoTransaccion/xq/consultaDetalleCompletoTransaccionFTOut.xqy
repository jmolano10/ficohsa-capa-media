...
(:: pragma bea:global-element-parameter parameter="$consultadetransaccionFTResponse" element="ns1:ConsultadetransaccionFTResponse" location="../../../../Business_Resources/consultaTransacciones/Resources/XMLSchema_-1217682313.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaDetalleCompletoTransaccion/consultaDetalleCompletoTransaccionFTOut/";
...
declare function xf:consultaDetalleCompletoTransaccionFTOut($consultadetransaccionFTResponse as element(ns1:ConsultadetransaccionFTResponse))
    as element(ns0:consultaDetalleCompletoTransaccionResponse) {
        <ns0:consultaDetalleCompletoTransaccionResponse>
            <TYPE>FT</TYPE>
            {
                for $TRANSACTIONCODE in $consultadetransaccionFTResponse/WSFTTRANSACTIONType[1]/gWSFTTRANSACTIONDetailType/mWSFTTRANSACTIONDetailType[1]/TRANSACTIONTYPE
                return
