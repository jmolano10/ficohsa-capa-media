...
(:: pragma bea:global-element-parameter parameter="$consultadetransaccionhistTTResponse" element="ns1:ConsultadetransaccionhistTTResponse" location="../../../../Business_Resources/consultaTransacciones/Resources/XMLSchema_-1217682313.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaDetalleCompletoTransaccion/consultaDetalleCompletoTransaccionHistTTOut/";
...
declare function xf:consultaDetalleCompletoTransaccionHistTTOut($consultadetransaccionhistTTResponse as element(ns1:ConsultadetransaccionhistTTResponse))
    as element(ns0:consultaDetalleCompletoTransaccionResponse) {
        <ns0:consultaDetalleCompletoTransaccionResponse>
            <TYPE>TT</TYPE>
            {
                for $TRANSACTIONCODE in $consultadetransaccionhistTTResponse/WSTTTRANSACTIONHISTType[1]/gWSTTTRANSACTIONHISTDetailType/mWSTTTRANSACTIONHISTDetailType[1]/TRANSACTIONCODE
                return
