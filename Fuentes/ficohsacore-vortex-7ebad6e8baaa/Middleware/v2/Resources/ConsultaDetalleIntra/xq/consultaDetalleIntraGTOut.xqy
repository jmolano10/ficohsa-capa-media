...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../BusinessServices/MasterDataGT/conDetalleComprasCuotas/xsd/conDetalleComprasCuotas_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaDetalleIntra/xq/consultaDetalleIntraGTOut/";

declare function xf:consultaDetalleIntraGTOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaDetalleIntraGTOut($outputParameters)