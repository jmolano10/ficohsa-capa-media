...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ActivacionTarjetaDebito/xq/consultaMaestraTDIn/";
...
declare function xf:consultaMaestraTDIn($requestHeader as element(ns1:RequestHeader),
