...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/ABKGT/consultaComisionSwift/xsd/consultaComisionSwift_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaComisionSwift/xq/consultaComisionSwiftGTIn/";

declare function xf:consultaComisionSwiftGTIn($consultaComisionSwift as element(ns1:consultaComisionSwift))
...
xf:consultaComisionSwiftGTIn($consultaComisionSwift)