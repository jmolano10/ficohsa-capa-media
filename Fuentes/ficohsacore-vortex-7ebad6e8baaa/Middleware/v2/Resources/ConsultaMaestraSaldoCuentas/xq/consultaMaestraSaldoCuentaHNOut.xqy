    ...
    as element(ns1:consultaMaestraSaldoCuentaResponse) {
        <ns1:consultaMaestraSaldoCuentaResponse>
            ...
            <AUTHORIZED_OVERDRAFT>
                ...
                {
                	for $EXPOVRDFVAL in $consultadesaldodecuentaResponse/WSFICOACCTBASICDETAILSType[1]/gWSFICOACCTBASICDETAILSDetailType/mWSFICOACCTBASICDETAILSDetailType[1]/EXPOVRDFVAL
                	return
            ...
            <CLEARING_FUNDS>
                ...
                {
                	for $EXPDRESVAL in $consultadesaldodecuentaResponse/WSFICOACCTBASICDETAILSType[1]/gWSFICOACCTBASICDETAILSDetailType/mWSFICOACCTBASICDETAILSDetailType[1]/EXPDRESVAL
                	return
