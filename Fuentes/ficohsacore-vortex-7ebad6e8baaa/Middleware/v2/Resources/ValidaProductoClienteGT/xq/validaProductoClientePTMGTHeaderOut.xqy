...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ValidaProductoClienteGT/xq/validaProductoClientePTMGTHeaderOut/";

declare function xf:validaProductoClientePTMGTHeaderOut($outputParameters as element(ns1:OutputParameters))
...
xf:validaProductoClientePTMGTHeaderOut($outputParameters)