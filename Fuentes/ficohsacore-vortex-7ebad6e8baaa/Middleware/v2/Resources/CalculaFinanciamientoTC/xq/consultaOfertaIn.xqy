...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CalculaFinanciamientoTC/xq/consultaOfertaIn/";

declare function xf:consultaOfertaIn($calculaFinanciamientoTC as element(ns0:calculaFinanciamientoTC))
...
xf:consultaOfertaIn($calculaFinanciamientoTC)