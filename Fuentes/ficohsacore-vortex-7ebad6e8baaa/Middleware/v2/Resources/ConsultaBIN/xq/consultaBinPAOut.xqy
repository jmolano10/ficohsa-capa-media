...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../BusinessServices/ABKPA/consultaBin/xsd/consultaBin_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaBIN/xq/consultaBinPAOut/";
...
declare function xf:consultaBinPAOut($outputParameters as element(ns1:OutputParameters))
                ...
                <BIN_DETAILS>
                    {
                        ...
                        return
                            <BIN_ITEM>
                                ...
                                <STATUS>{ data($PV_BIN_DETAILS_ITEM/ns1:STATUS) }</STATUS>
                            </BIN_ITEM>
                    }
                </BIN_DETAILS>
            }
...
xf:consultaBinPAOut($outputParameters)