...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoRecaudoLocal/xq/pagoRecaudoLocalDbCtaIn/";
...
declare function xf:pagoRecaudoLocalDbCtaIn($requestHeader as element(ns3:RequestHeader),
...
xf:pagoRecaudoLocalDbCtaIn($requestHeader,
    $pagoRecaudoInterno,
    $outputParameters,
    $uuid,
    $debitAcount)