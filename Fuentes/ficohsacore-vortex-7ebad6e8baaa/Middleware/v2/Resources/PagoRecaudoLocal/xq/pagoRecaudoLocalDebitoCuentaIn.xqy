...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoRecaudoLocal/xq/pagoRecaudoLocalDebitoCuentaIn/";
...
declare function xf:pagoRecaudoInternoLocalCuentaIn($requestHeader as element(ns0:RequestHeader),
...
xf:pagoRecaudoInternoLocalCuentaIn($requestHeader,
    $pagoRecaudoInterno,
    $outputParameters,
    $uuid)