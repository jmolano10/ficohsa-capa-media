...
(:: pragma bea:global-element-parameter parameter="$bloqueoFondosCuenta" element="ns1:bloqueoFondosCuenta" location="../xsd/bloqueoFondosCuentaTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns0:Bloqueodepasivos" location="../../../../Business_Resources/bloqueoPasivos/Resoruces/XMLSchema_524093592.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/BloqueoFondosCuenta/xq/bloqueoFondosCuentaIn/";
...
declare function xf:bloqueoFondosCuentaIn($requestHeader as element(ns2:RequestHeader),
    ...
    as element(ns0:Bloqueodepasivos) {
        <ns0:Bloqueodepasivos>
            <WebRequestCommon>
            	<userName>
            	{ 
            		fn-bea:fail-over( getUsername(data($requestHeader/Authentication/UserName)), data($requestHeader/Authentication/UserName)) 
				}
				</userName>
                <password>
                {
                	fn-bea:fail-over( getPassword(data($requestHeader/Authentication/UserName)), data($requestHeader/Authentication/Password)) 
                }
                </password>
            </WebRequestCommon>
            <OfsFunction>
...
xf:bloqueoFondosCuentaIn($requestHeader,
    $bloqueoFondosCuenta,
    $uuid)