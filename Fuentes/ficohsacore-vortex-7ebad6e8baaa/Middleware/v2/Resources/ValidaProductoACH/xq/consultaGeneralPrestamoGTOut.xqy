...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ValidaProductoACH/xq/consultaGeneralPrestamoGTOut/";

declare function xf:consultaGeneralPrestamoGTOut($outputParameters1 as element(ns1:OutputParameters),
...
xf:consultaGeneralPrestamoGTOut($outputParameters1,
    $validaProductoACH)