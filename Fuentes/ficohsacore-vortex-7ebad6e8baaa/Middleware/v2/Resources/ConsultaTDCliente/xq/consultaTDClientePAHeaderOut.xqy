...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaTDCliente/xq/consultaTDClientePAHeaderOut/";

declare function xf:consultaTDClientePAHeaderOut($outputParameters1 as element(ns1:OutputParameters))
...
xf:consultaTDClientePAHeaderOut($outputParameters1)