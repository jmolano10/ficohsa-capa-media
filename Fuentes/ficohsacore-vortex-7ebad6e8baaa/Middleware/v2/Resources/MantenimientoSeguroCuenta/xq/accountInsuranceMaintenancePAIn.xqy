...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/MantenimientoSeguroCuenta/xq/accountInsuranceMaintenancePAIn/";

declare function xf:accountInsuranceMaintenancePAIn($cancelacionSeguro1 as element(ns0:cancelacionSeguro),
    $Filler as xs:string,
...
xf:accountInsuranceMaintenancePAIn($cancelacionSeguro1,
    $Filler,
    $UserFiller)