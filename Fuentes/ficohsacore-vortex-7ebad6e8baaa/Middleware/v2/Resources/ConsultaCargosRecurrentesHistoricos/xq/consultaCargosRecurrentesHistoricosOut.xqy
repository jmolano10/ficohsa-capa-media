...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../BusinessServices/MasterData/conHistorialTxVnet/xsd/conHistorialTxVnet_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaCargosRecurrentesHistoricos/xq/consultaCargosRecurrentesHistoricosOut/";
...
declare function xf:consultaCargosRecurrentesHistoricosOut($outputParameters as element(ns0:OutputParameters))
...
xf:consultaCargosRecurrentesHistoricosOut($outputParameters)