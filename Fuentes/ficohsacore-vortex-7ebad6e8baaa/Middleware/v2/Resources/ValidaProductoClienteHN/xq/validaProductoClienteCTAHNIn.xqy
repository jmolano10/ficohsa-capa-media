...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ValidaProductoClienteHN/xq/validaProductoClienteCTAHNIn/";
...
declare function xf:validaProductoClienteCTAHNIn($requestHeader as element(ns0:RequestHeader),
...
xf:validaProductoClienteCTAHNIn($requestHeader,
