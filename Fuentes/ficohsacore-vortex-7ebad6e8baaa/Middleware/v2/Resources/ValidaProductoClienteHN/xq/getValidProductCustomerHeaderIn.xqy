...
(:: pragma bea:global-element-return element="ns0:RequestHeader" location="../../../BusinessServices/FPC/getValidProductCustomer12c/xsd/HeaderElements.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ValidaProductoClienteHN/xq/getValidProductCustomerHeaderIn/";
...
declare function xf:getValidProductCustomerHeaderIn($serviceAccountName as xs:string,
...
xf:getValidProductCustomerHeaderIn($serviceAccountName,
    $sourceBank,
    $destinationBank)