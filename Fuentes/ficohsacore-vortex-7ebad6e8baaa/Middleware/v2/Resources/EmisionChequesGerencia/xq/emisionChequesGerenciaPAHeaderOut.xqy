...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../BusinessServices/ABKPA/emisionChequesGerencia/xsd/emisionChequesGerencia_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/EmisionChequesGerencia/xq/emisionChequesGerenciaPAHeaderOut/";

declare function xf:emisionChequesGerenciaPAHeaderOut($outputParameters as element(ns1:OutputParameters))
...
xf:emisionChequesGerenciaPAHeaderOut($outputParameters)