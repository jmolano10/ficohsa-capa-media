...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../BusinessServices/MasterDataGT/conDatosPlanes/xsd/conDatosPlanes_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaPlanesCredito/xq/consultaPlanesCreditoGTOut/";

declare function xf:consultaPlanesCreditoGTOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaPlanesCreditoGTOut($outputParameters)