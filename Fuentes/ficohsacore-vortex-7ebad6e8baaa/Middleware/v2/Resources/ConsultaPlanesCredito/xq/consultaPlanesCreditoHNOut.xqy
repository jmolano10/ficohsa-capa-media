...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../BusinessServices/MasterDataHN/conDatosPlanes/xsd/conDatosPlanes_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaPlanesCredito/xq/consultaPlanesCreditoHNOut/";

declare function xf:consultaPlanesCreditoHNOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaPlanesCreditoHNOut($outputParameters)