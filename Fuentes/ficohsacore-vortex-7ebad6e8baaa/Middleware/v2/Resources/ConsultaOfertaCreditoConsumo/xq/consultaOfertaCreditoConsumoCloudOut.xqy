...
declare namespace ns2="http://www.ficohsa.com.hn/middleware.services/consultaOfertaCreditoConsumoTypes";
(:: import schema at "../xsd/consultaOfertaCreditoConsumoTypes.xsd" ::)

declare variable $epOriginacionesHondurasResponse as element() (:: schema-element(ns1:epOriginacionesHondurasResponse) ::) external;

declare function local:func($epOriginacionesHondurasResponse as element() (:: schema-element(ns1:epOriginacionesHondurasResponse) ::)) as element() (:: schema-element(ns2:consultaOfertaCreditoConsumoResponse) ::) {
    <ns2:consultaOfertaCreditoConsumoResponse>
...
local:func($epOriginacionesHondurasResponse)