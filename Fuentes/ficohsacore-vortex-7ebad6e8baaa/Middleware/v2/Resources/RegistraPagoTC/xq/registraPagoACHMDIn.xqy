...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../../v3/BusinessServices/MasterData/HN/conRegistraPagoTCRG/xsd/conRegistraPagoTCRG_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/RegistraPagoTC/xq/registraPagoACHMDIn/";
...
declare function xf:registraPagoACHMDIn($registraPagoTC1 as element(ns1:registraPagoTC))
    as element(ns0:InputParameters) {
        <ns0:InputParameters>
            <ns0:Pais>{ 'HND' }</ns0:Pais>
            <ns0:Org>{ data($registraPagoTC1/ORGANIZATIONS)}</ns0:Org>
...
xf:registraPagoACHMDIn($registraPagoTC1)