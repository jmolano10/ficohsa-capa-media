...
declare function xf:Tx_RegistraPagoTC_To_RegistraPagoDB($registraPagoTCRequest1 as element(ns2:registraPagoTCRequest),
    ...
    as element(ns1:InputParameters) {
        <ns1:InputParameters>
            ...
            <ns1:PV_TIPOOPERACION>{ data($outputParameters2/ns0:CONFIGURACIONES/ns0:CONFIGURACIONES_ITEM[ns0:NAME='FICBCO0067.HN01.BUY']/ns0:VALUE) }</ns1:PV_TIPOOPERACION>
            ...
            <ns1:PN_ORGANIZACION>{ data($outputParameters1/ns3:ORG) }</ns1:PN_ORGANIZACION>
            ...
            <ns1:PV_NUMEROAUTORIZACION>{$authorizationCode}</ns1:PV_NUMEROAUTORIZACION>
