...
declare function xf:Tx_RegistraPagoTC_To_RegistraPagoDBMD($registraPagoTCRequest1 as element(ns2:registraPagoTCRequest),
    ...
    as element(ns1:InputParameters) {
        <ns1:InputParameters>
	        { if (data($destinationBank) = 'HN01') 
	            then
	            	<ns1:Pais>HND</ns1:Pais>
	            else 
	            	''
	        }
	        { if (data($destinationBank) = 'GT01') 
            then
            ...
            <ns1:TipoOperacion>{ data($outputParameters2/ns0:CONFIGURACIONES/ns0:CONFIGURACIONES_ITEM[ns0:NAME='FICBCO0067.HN01.REVERSE']/ns0:VALUE) }</ns1:TipoOperacion>
