...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CreaRemesa/xq/registraBitacoraTerceroDetalleIn/";
declare namespace ns0 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/registraBitacoraTerceroDetalle";

declare function xf:registraBitacoraTerceroDetalleIn($uuid as xs:string,
...
xf:registraBitacoraTerceroDetalleIn($uuid,
    $serviceId,
    $primaryKey,
    $request,
    $response,
