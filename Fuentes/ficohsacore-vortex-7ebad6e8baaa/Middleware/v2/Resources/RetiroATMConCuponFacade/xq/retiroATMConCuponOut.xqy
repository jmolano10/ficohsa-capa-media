...
(:: pragma bea:global-element-parameter parameter="$retiroATMConCuponResponse" element="ns1:retiroATMConCuponResponse" location="../../RetiroATMConCupon/xsd/retiroATMConCuponTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/RetiroATMConCupon/xq/redimirCuponTengoOut/";
...
declare function xf:redimirCuponTengoOut($procesaMensajeGenericoSwitchFacadeRequest as element(ns0:procesaMensajeGenericoSwitchFacadeRequest),
    $retiroATMConCuponResponse as element(ns1:retiroATMConCuponResponse),
                    ...
                    <ISO8583_XML_CONTENT>
                        ...
                        }
                        {
                            if(upper-case($successIndicator) = 'SUCCESS') then(
                            	...
                            	return
                                	<ReservedForPrivateUse_121>{ fn:concat('Ficohsa;', data($ISO8583_XML_CONTENT/CardAcceptorNameLocation_043), ';', fn-bea:dateTime-to-string-with-format('yyyy-MM-dd HH:mm', data($retiroATMConCuponResponse/TRANSACTION_DATE) ), ';', data($ISO8583_XML_CONTENT/SystemTraceAuditNumber_011), ';', data($retiroATMConCuponResponse/AUTORIZATION_NUMBER), ';', 'RETIRO CUPON;', (data($ISO8583_XML_CONTENT/AmountTransaction_004) div 100), '; Comprometidos a ser los mejores "GRACIAS POR USAR NUESTROS CAJEROS"') }</ReservedForPrivateUse_121>
                            ) else(
...
declare variable $retiroATMConCuponResponse as element(ns1:retiroATMConCuponResponse) external;
declare variable $successIndicator as xs:string external;

xf:redimirCuponTengoOut($procesaMensajeGenericoSwitchFacadeRequest,
    $retiroATMConCuponResponse,
    $successIndicator)