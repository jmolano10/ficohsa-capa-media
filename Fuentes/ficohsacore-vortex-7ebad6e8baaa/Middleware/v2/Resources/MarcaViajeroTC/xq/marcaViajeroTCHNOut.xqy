...
(:: pragma bea:global-element-parameter parameter="$sjMarcaViajeroTCResponse" element="ns0:sjMarcaViajeroTCResponse" location="../../../BusinessServices/SJS/marcaViajeroTCHN/xsd/sjMarcaViajeroTCHNTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/marcaViajeroTCOut/";

declare function xf:marcaViajeroTCHNOut($sjMarcaViajeroTCResponse as element(ns0:sjMarcaViajeroTCResponse))
...
xf:marcaViajeroTCHNOut($sjMarcaViajeroTCResponse)