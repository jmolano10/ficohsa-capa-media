...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/MasterDataGT/conDatosPlanes/xsd/conDatosPlanes_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/MasterDataGT/xq/conDatosPlanesGTIn/";

declare function xf:conDatosPlanesGTIn($consultaPlanesCredito as element(ns0:consultaPlanesCredito),
...
xf:conDatosPlanesGTIn($consultaPlanesCredito,
    $codigoPais)