...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../BusinessServices/MasterDataPA/conDatoComportamientoCuenta/xsd/conDatoComportamientoCuenta_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaComportamientoCuenta/xq/consultaComportamientoCuentaPAOut/";
...
declare function xf:consultaComportamientoCuentaPAOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaComportamientoCuentaPAOut($outputParameters)