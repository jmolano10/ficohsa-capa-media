...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/MasterData/conDatoComportamientoCuenta/xsd/conDatoComportamientoCuenta_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaComportamientoCuenta/xq/conDatoComportamientoCuentaNIIn/";

declare function xf:conDatoComportamientoCuentaNIIn($consultaComportamientoCuenta1 as element(ns0:consultaComportamientoCuenta),
...
xf:conDatoComportamientoCuentaNIIn($consultaComportamientoCuenta1,
    $countryCode)