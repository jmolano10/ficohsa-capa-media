...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../BusinessServices/MasterDataGT/conDatoComportamientoCuenta/xsd/conDatoComportamientoCuenta_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaComportamientoCuenta/xq/consultaComportamientoCuentaGTOut/";
...
declare function xf:consultaComportamientoCuentaGTOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaComportamientoCuentaGTOut($outputParameters)