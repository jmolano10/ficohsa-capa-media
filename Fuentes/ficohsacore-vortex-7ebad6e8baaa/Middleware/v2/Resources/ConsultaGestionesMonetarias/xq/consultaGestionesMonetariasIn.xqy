...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaGestionesMonetarias/xq/consultaGestionesMonetariasIn/";

declare function xf:consultaGestionesMonetariasIn($consultaGestionesMonetarias as element(ns0:consultaGestionesMonetarias))
...
xf:consultaGestionesMonetariasIn($consultaGestionesMonetarias)