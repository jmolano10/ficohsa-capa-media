...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaGestionesMonetarias/xq/consultaGestionesMonetariasGTHeaderOut/";

declare function xf:consultaGestionesMonetariasGTHeaderOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaGestionesMonetariasGTHeaderOut($outputParameters)