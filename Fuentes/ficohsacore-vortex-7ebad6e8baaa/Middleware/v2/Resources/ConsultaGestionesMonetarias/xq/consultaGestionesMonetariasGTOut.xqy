...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaGestionesMonetarias/xq/consultaGestionesMonetariasGTOut/";

declare function xf:consultaGestionesMonetariasGTOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaGestionesMonetariasGTOut($outputParameters)