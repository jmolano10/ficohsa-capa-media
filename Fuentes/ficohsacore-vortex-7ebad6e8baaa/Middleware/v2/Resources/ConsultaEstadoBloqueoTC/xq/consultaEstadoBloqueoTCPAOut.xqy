...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaEstadoBloqueoTC/xq/consultaEstadoBloqueoTCPAOut/";

declare function xf:consultaEstadoBloqueoTCPAOut($estadoTC as xs:string,
...
xf:consultaEstadoBloqueoTCPAOut($estadoTC,
    $tipoBloqueo)