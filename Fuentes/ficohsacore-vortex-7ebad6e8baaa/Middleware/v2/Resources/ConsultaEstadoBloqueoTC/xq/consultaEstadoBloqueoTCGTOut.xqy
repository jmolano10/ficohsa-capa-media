...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaEstadoBloqueoTC/xq/consultaEstadoBloqueoTCGTOut/";

declare function xf:consultaEstadoBloqueoTCGTOut($estadoTC as xs:string,
...
xf:consultaEstadoBloqueoTCGTOut($estadoTC,
    $tipoBloqueo)