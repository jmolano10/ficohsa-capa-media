...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/TransferenciaCuentas/xq/transferenciaIntergrupalGTBodyOut/";

declare function xf:transferenciaIntergrupalGTBodyOut($outputParameters as element(ns0:OutputParameters))
...
xf:transferenciaIntergrupalGTBodyOut($outputParameters)