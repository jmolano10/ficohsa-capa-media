...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/abanksPA/transferenciaCuentas/xq/transferenciaCuentasHeaderOut/";

declare function xf:transferenciaCuentasHeaderOut($outputParameters1 as element(ns1:OutputParameters))
...
xf:transferenciaCuentasHeaderOut($outputParameters1)