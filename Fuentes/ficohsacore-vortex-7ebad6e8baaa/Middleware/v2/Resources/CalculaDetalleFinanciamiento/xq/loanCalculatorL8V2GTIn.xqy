...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CalculaDetalleFinanciamiento/xq/loanCalculatorL8V2GTIn/";

declare function xf:loanCalculatorL8V2GTIn($calculaDetalleFinanciamiento1 as element(ns1:calculaDetalleFinanciamiento))
...
xf:loanCalculatorL8V2GTIn($calculaDetalleFinanciamiento1)