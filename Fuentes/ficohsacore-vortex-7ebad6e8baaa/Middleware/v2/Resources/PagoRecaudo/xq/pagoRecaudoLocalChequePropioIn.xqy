...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/pagoRecaudos/pagoRecaudoLocalChequePropioIn/";
...
declare function xf:pagoRecaudoLocalChequePropioIn($requestHeader as element(ns0:RequestHeader),
...
xf:pagoRecaudoLocalChequePropioIn($requestHeader,
    $pagoRecaudo,
    $outputParameters,
    $uuid)