...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoRecaudo/xq/pagoRecaudoRefDbCtaIn/";
...
declare function xf:pagoRecaudoRefDbCtaIn($requestHeader as element(ns0:RequestHeader),
...
xf:pagoRecaudoRefDbCtaIn($requestHeader,
    $pagoRecaudo,
    $uuid)