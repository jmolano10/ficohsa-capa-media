...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/pagoRecaudos/pagoRecaudoLocalChequeOtroBancoIn/";
...
declare function xf:pagoRecaudoLocalChequeOtroBancoIn($requestHeader as element(ns0:RequestHeader),
...
xf:pagoRecaudoLocalChequeOtroBancoIn($requestHeader,
    $pagoRecaudo,
    $outputParameters,
    $uuid)