...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/pagoRecaudos/pagoRecaudoLocalChequeInternacionalUSIn/";
...
declare function xf:pagoRecaudoLocalChequeInternacionalUSIn($requestHeader as element(ns0:RequestHeader),
...
xf:pagoRecaudoLocalChequeInternacionalUSIn($requestHeader,
    $pagoRecaudo,
    $outputParameters,
    $uuid)