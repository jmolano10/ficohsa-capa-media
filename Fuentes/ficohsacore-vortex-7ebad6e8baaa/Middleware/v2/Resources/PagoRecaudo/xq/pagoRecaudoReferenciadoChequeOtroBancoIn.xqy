...
(:: pragma bea:global-element-return element="ns1:Pagorecaudoreferenciadochqotrbco" location="../../../../Business_Resources/pagoRecaudos/Resources/XMLSchema_-258408779.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/pagoRecaudos/pagoRecaudoReferenciadoChequeOtroBancoIn/";
...
declare function xf:pagoRecaudoReferenciadoChequeOtroBancoIn($requestHeader as element(ns0:RequestHeader),
    $pagoRecaudo as element(ns2:pagoRecaudo),
    $uuid as xs:string)
    as element(ns1:Pagorecaudoreferenciadochqotrbco) {
        <ns1:Pagorecaudoreferenciadochqotrbco>
            <WebRequestCommon>
...
xf:pagoRecaudoReferenciadoChequeOtroBancoIn($requestHeader,
    $pagoRecaudo,
    $uuid)