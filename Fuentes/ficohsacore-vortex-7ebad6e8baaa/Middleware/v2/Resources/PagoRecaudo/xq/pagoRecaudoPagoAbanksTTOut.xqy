...
(:: pragma bea:schema-type-parameter parameter="$tELLERType" type="ns0:TELLERType" location="../../../../Business_Resources/pagoRecaudos/Resources/XMLSchema_-258408779.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoRecaudo/xq/pagoRecaudoPagoAbanksTTOut/";

declare function xf:pagoRecaudoPagoAbanksTTOut($tELLERType as element(),
...
xf:pagoRecaudoPagoAbanksTTOut($tELLERType,
    $outputParameters,
    $pagoRecaudo,
    $authorizationCode,
