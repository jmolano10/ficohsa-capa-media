...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoRecaudo/xq/pagoRecaudoRefOBChqIn/";
...
declare function xf:pagoRecaudoRefOBChqIn($requestHeader as element(ns0:RequestHeader),
...
xf:pagoRecaudoRefOBChqIn($requestHeader,
    $pagoRecaudo,
    $uuid)