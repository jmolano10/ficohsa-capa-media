...
(:: pragma bea:global-element-return element="ns0:EliminacionpagorecaudorefTT" location="../../../../Business_Resources/pagoRecaudos/Resources/XMLSchema_-258408779.xsd" ::)
...
declare function xf:eliminacionPagoRecaudoReferenciadoTTIn($requestHeader as element(ns1:RequestHeader),
    $status as element())
...
xf:eliminacionPagoRecaudoReferenciadoTTIn($requestHeader,
    $status)