...
(:: pragma bea:global-element-return element="ns1:AddLoanPlanL8V1Request" location="../../../BusinessServices/VisionPlus/visionPlus/xsd/XMLSchema_769155616.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CreaFinanciamiento/xq/addLoanPlanGTIn/";
...
declare function xf:addLoanPlanGTIn($creaFinanciamiento as element(ns0:creaFinanciamiento))
    as element(ns1:AddLoanPlanL8V1Request) {
        <ns1:AddLoanPlanL8V1Request>
...
xf:addLoanPlanGTIn($creaFinanciamiento)