...
(:: pragma bea:global-element-return element="ns1:UpdateUser" location="../../../BusinessServices/CREDITFORCEGT/GestionAccesosUsuarios/xsd/XMLSchema_-336569634.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ModificaAccesoUsuario/xq/updateUserCFGTIn/";
...
declare function xf:updateUserCFGTIn($modificaAccesoUsuario as element(ns2:modificaAccesoUsuario),
    $token as xs:string,
...
xf:updateUserCFGTIn($modificaAccesoUsuario,
    $token,
    $userName)