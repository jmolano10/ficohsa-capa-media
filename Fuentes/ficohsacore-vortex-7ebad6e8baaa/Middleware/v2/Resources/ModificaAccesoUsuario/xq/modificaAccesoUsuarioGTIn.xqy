...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/ABKGT/modificaAccesoUsuario/xsd/PROXYABANKSGT_OSB_K_GIA_USUARIOS_P_CAMBIO_USUARIO.xsd" ::)
...
declare namespace ns1 = "http://xmlns.oracle.com/pcbpel/adapter/db/PROXYABANKSGT/OSB_K_GIA_USUARIOS/P_CAMBIO_USUARIO/";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ModificaAccesoUsuario/xq/modificaAccesoUsuarioGTIn/";

declare function xf:modificaAccesoUsuarioGTIn($modificaAccesoUsuario as element(ns0:modificaAccesoUsuario))
...
xf:modificaAccesoUsuarioGTIn($modificaAccesoUsuario)