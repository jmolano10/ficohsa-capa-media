...
(:: pragma bea:global-element-return element="ns1:UpdateUser" location="../../../BusinessServices/CREDITFORCEHN/GestionAccesosUsuarios/xsd/XMLSchema_820425240.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ModificaAccesoUsuario/xq/updateUserCFHNIn/";
...
declare function xf:updateUserCFHNIn($modificaAccesoUsuario as element(ns2:modificaAccesoUsuario),
    $token as xs:string,
...
xf:updateUserCFHNIn($modificaAccesoUsuario,
    $token,
    $userName)