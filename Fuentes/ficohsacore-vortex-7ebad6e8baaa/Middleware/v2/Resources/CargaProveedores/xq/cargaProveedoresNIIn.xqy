...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CargaProveedores/xq/cagaProveedoresNIIn/";

declare function xf:cagaProveedoresNIIn($requestHeader as element(ns0:RequestHeader),
...
xf:cagaProveedoresNIIn($requestHeader,
    $cargarProveedores)