...
declare function xf:ConsultaDetalleServicioAfiliadosSaraHeaderIN($serviceAccount as xs:string)
    as element(*) {
        <soap-env:Header>
			...
			<wsa:Action>urn:tailored.icbanking.services.sara.SaraService.GetSiteServicePaymentEntitiesForSaraById</wsa:Action>
		</soap-env:Header>
};

declare variable $serviceAccount as xs:string external;

xf:ConsultaDetalleServicioAfiliadosSaraHeaderIN($serviceAccount)