...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ActualizaEstadoTransferenciaInternacional/xq/actualizaEstadoTransferenciaInternacionalHeaderIn/";
...
declare function getAction($operation as xs:string) as xs:string {
	if ($operation = "UpdateTransaction") then
		"urn:tailored.icbanking.services.transactionscustom.TransactionsCustomService.UpdateTransaction"
	else 
		"Invalid Operation"
};

declare function xf:actualizaEstadoTransferenciaInternacionalHeaderIn($serviceAccount as xs:string,
    ...
    as element(*) {
        <soap-env:Header>
			...
			<urn:Context>
				...
				<urn:Channel>ExternalApplications</urn:Channel>
				...
				<urn:SessionTokenId>1</urn:SessionTokenId>
				<urn:SiteId>1071</urn:SiteId>
...
xf:actualizaEstadoTransferenciaInternacionalHeaderIn($serviceAccount,$operation,$uriICB)