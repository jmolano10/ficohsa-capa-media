...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/ABKGT/consultaDetalladaMovimientosCuenta/xsd/consultaDetalladaMovimientosCuenta_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaMovimientosCuenta/xq/consultaMovimientosCuentaAbanksGTIn/";

declare function xf:consultaMovimientosCuentaAbanksGTIn($consultaMovimientosCuenta as element(ns0:consultaMovimientosCuenta),
...
xf:consultaMovimientosCuentaAbanksGTIn($consultaMovimientosCuenta,
    $endDate,
    $beginDate,
    $ticket)