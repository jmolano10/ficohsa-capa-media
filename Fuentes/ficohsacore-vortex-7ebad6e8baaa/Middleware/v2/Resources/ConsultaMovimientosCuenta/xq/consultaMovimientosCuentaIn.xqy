        ...
        <ns2:ConsultaMovimientosCuenta>
            ...
            <WSACCOUNTENTRIESType>
				...
				<enquiryInputCollection>
	               ...
	               <criteriaValue>{ data($consultaMovimientosCuenta1/PAGING_INFO/PAGING) }</criteriaValue>
	               <operand>EQ</operand>
	            </enquiryInputCollection>
	            
	             <enquiryInputCollection>
	               <columnName>INICIOPAGINAR</columnName>
	               <criteriaValue>{ data($consultaMovimientosCuenta1/PAGING_INFO/INITIAL_RECORD) }</criteriaValue>
	               <operand>EQ</operand>
	            </enquiryInputCollection>
	            
	            <enquiryInputCollection>
	               <columnName>NUM.REGISTROS</columnName>
	               <criteriaValue>{ data($consultaMovimientosCuenta1/PAGING_INFO/RECORD_COUNT) }</criteriaValue>
	               <operand>EQ</operand>
	            </enquiryInputCollection>
