...
(:: pragma bea:global-element-parameter parameter="$consultaMovimientosCuenta1" element="ns1:consultaMovimientosCuenta" location="../../../../Business_Resources/ConsultasCuenta/Resources/consultasGeneralesCuentasTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns1:consultaMovimientosCuentaResponse" location="../xsd/consultasGeneralesCuentasTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaMovimientosCuenta/xq/consultaMovimientosCuentaAbanksDetalladoOut/";

declare function xf:consultaMovimientosCuentaAbanksDetalladoOut($outputParameters1 as element(ns0:OutputParameters),
    $consultaMovimientosCuenta1 as element(ns1:consultaMovimientosCuenta),
    $ticket as xs:string,
    ...
    as element(ns1:consultaMovimientosCuentaResponse) {
        <ns1:consultaMovimientosCuentaResponse>
            ...
            <RECORDS_INFO>   
                ...
                <RECORDS_TOTAL>{xs:string(data($outputParameters1/ns0:PN_TOTALRECORD))}</RECORDS_TOTAL>
...
xf:consultaMovimientosCuentaAbanksDetalladoOut($outputParameters1,
