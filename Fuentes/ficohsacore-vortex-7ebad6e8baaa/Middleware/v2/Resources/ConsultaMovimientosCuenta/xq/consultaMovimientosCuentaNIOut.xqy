    ...
    as element(ns0:consultaMovimientosCuentaResponse) {
        <ns0:consultaMovimientosCuentaResponse>
            ...
            }
            {
                ...
                return
                    <ACCOUNT_NAME>{ fn:replace(data($valCuentaHabiente),"[Ññ]","#") }</ACCOUNT_NAME>
            }
            {
            ...
            <STARTING_BALANCE>{ fn:round-half-to-even(xs:decimal(data($opConsultaMovimientoCuentaRespuesta/ns2:movimientoResumen/ns2:valBalanceInicial)),2) }</STARTING_BALANCE>
            <ENDING_BALANCE>{ fn:round-half-to-even(xs:decimal(data($opConsultaMovimientoCuentaRespuesta/ns2:movimientoResumen/ns2:valBalanceFinal)),2) }</ENDING_BALANCE>
            ...
            <DEBIT_TOTAL_AMOUNT>{ fn:round-half-to-even(xs:decimal(data($opConsultaMovimientoCuentaRespuesta/ns2:movimientoResumen/ns2:valTotalMontoDebitos)),2) }</DEBIT_TOTAL_AMOUNT>
            <CREDIT_TOTAL_AMOUNT>{ fn:round-half-to-even(xs:decimal(data($opConsultaMovimientoCuentaRespuesta/ns2:movimientoResumen/ns2:valTotalMontoCreditos)),2) }</CREDIT_TOTAL_AMOUNT>
            <RECORDS_INFO>
            ...
            <ns0:consultaMovimientosCuentaResponseType>
            {
                ...
                return
                    ...
                    <ns0:consultaMovimientosCuentaResponseRecordType>
                        ...
                        <AMOUNT>{ fn:round-half-to-even(xs:decimal(data($opConsultaMovimientoCuentaRespuesta/ns2:movimiento[$i]/ns2:valMonto)),2) }</AMOUNT>
                        ...
                        <RUNNING_BALANCE>{ fn:round-half-to-even(xs:decimal(data($opConsultaMovimientoCuentaRespuesta/ns2:movimiento[$i]/ns2:valSaldoDisponible)),2) }</RUNNING_BALANCE>
                    </ns0:consultaMovimientosCuentaResponseRecordType>
                    )
            }
            </ns0:consultaMovimientosCuentaResponseType>
