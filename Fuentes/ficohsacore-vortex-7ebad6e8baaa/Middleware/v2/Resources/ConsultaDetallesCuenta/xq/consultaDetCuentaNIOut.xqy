...
(:: pragma bea:global-element-parameter parameter="$opConsultaDetalleCuentaRespuesta1" element="ns2:opConsultaDetalleCuentaRespuesta" location="../../../BusinessServices/CTS/cuenta/xsd/services.xsd" ::)
        ...
        <ns1:consultaDetallesCuentaResponse>
            <ns1:consultaDetallesCuentaResponseType>
                <ns1:consultaDetallesCuentaResponseRecordType>
                    ...
                    <ACCOUNT_NAME>{ fn:replace(string(data($opConsultaDetalleCuentaRespuesta1/ns0:cuenta/ns0:valCuentaHabiente)),"[Ññ]","#") }</ACCOUNT_NAME>
...
xf:consultaDetCuentaNIOut($opConsultaDetalleCuentaRespuesta1)