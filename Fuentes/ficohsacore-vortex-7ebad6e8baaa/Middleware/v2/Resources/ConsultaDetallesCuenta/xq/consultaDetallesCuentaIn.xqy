...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaDetallesCuenta/xq/consultaDetallesCuentaIn/";
...
declare function xf:consultaDetallesCuentaIn($requestHeader as element(ns1:RequestHeader),
    $consultaDetallesCuenta as element(ns0:consultaDetallesCuenta))
        ...
        <ns2:Consultadedetallesdelacuenta>
            ...
            <WSACCOUNTLISTType>
                <enquiryInputCollection>
                    ...
                    <criteriaValue>{ data($consultaDetallesCuenta/ACCOUNT_NUMBER) }</criteriaValue>
                    <operand>EQ</operand>
                </enquiryInputCollection>
            </WSACCOUNTLISTType>
        </ns2:Consultadedetallesdelacuenta>
...
xf:consultaDetallesCuentaIn($requestHeader,
    $consultaDetallesCuenta)