...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/AutorizarLotePagosMasivos/xq/autorizarLoteGTIn/";

declare function xf:autorizarLoteGTIn($requestHeader as element(ns0:RequestHeader),
...
xf:autorizarLoteGTIn($requestHeader,
    $autorizarLote)