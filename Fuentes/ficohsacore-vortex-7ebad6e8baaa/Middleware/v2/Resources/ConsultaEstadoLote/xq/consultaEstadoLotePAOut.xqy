...
declare function xf:consultaEstadoLotePAOut($consultarLoteResponse as element(ns1:consultarLoteResponse))
...
xf:consultaEstadoLotePAOut($consultarLoteResponse)