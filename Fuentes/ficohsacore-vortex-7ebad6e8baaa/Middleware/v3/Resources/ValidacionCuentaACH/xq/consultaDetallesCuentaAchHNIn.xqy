...
(:: pragma bea:global-element-return element="ns0:DetalleValidacionCuentaACH" location="../../../../Business_Resources/ConsultasCuenta/ConsultaDetalleValidacionCuenta/xsd/services_1.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace ns1 = "http://www.ficohsa.com.hn/middleware.services/autType";
declare namespace ns0 = "T24WebServicesImpl";
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ValidacionCuentaACH/xq/consultaDetallesCuentaAchHNIn/";
...
declare function xf:consultaDetallesCuentaAchHNIn($requestHeader1 as element(ns1:RequestHeader),
    $accountNumber as xs:string)
    as element(ns0:DetalleValidacionCuentaACH) {
        <ns0:DetalleValidacionCuentaACH>
            <WebRequestCommon>
...
xf:consultaDetallesCuentaAchHNIn($requestHeader1,
    $accountNumber)