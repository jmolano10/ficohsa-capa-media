...
(:: pragma bea:global-element-parameter parameter="$conDatoCliente" element="ns1:OutputParameters" location="../../../../v2/BusinessServices/MasterData/conDatoCliente/xsd/conDatoCliente_sp.xsd" ::)
(:: pragma bea:global-element-parameter parameter="$customerDemographicInquiryL8V2Response" element="ns0:CustomerDemographicInquiryL8V2Response" location="../../../../v2/BusinessServices/VisionPlus/vmx/wsdl/VMX.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ConsultaClienteTarjetas/xq/consultaClienteTarjetasNIOut/";
...
declare function xf:consultaClienteTarjetasNIOut($conDatoCliente as element(ns1:OutputParameters)?,
        ...
        <ns2:consultaClienteTarjetasResponse>
        {
        	if(not(empty($outputParameters1/ns4:PT_CLIENTE_TARJETAS/ns4:ORG))) then (	
        		...
        		return(
        			...
        			<CUSTOMER_ID>{ data($clientesTarjetas/ns4:CUSTOMER_ID) }</CUSTOMER_ID>,
        				...
        				<addresInformationResidence>
		        			<ADDRESS_LINE_1>{ fn:replace(data($addresInformationResidence/ADDRESS_LINE_1), "[Ññ]", "#") }</ADDRESS_LINE_1>
		        			<ADDRESS_LINE_2>{ fn:replace(data($addresInformationResidence/ADDRESS_LINE_2), "[Ññ]", "#") }</ADDRESS_LINE_2>
		        			<ADDRESS_LINE_3>{ fn:replace(data($addresInformationResidence/ADDRESS_LINE_3), "[Ññ]", "#") }</ADDRESS_LINE_3>
		        			<ADDRESS_LINE_4>{ fn:replace(data($addresInformationResidence/ADDRESS_LINE_4), "[Ññ]", "#") }</ADDRESS_LINE_4>
		        			...
		        			<SUBURB>{ fn:replace(data($addresInformationResidence/SUBURB), "[Ññ]", "#") }</SUBURB>
        				...
        				return(
        					<addresInformationWork>
			        			...
			        			<ADDRESS_LINE_1>{ fn:replace(data($addresInformationWork/ADDRESS_LINE_1), "[Ññ]", "#") }</ADDRESS_LINE_1>
			        			<ADDRESS_LINE_2>{ fn:replace(data($addresInformationWork/ADDRESS_LINE_2), "[Ññ]", "#") }</ADDRESS_LINE_2>
			        			<ADDRESS_LINE_3>{ fn:replace(data($addresInformationWork/ADDRESS_LINE_3), "[Ññ]", "#") }</ADDRESS_LINE_3>
			        			...
			        			<EMPLOYERS_NAME>{ fn:replace(data($addresInformationWork/EMPLOYERS_NAME), "[Ññ]", "#") }</EMPLOYERS_NAME>
        				...
        				return(
        					<addresInformationAltern>
			        			<ALTERN_ADDRESS>{ fn:replace(data($addresInformationAltern/ALTERN_ADDRESS), "[Ññ]", "#") }</ALTERN_ADDRESS>
			        			<ADDRESS_LINE_1>{ fn:replace(data($addresInformationAltern/ADDRESS_LINE_1), "[Ññ]", "#") }</ADDRESS_LINE_1>
			        			<ADDRESS_LINE_2>{ fn:replace(data($addresInformationAltern/ADDRESS_LINE_2), "[Ññ]", "#") }</ADDRESS_LINE_2>
			        			<ADDRESS_LINE_3>{ fn:replace(data($addresInformationAltern/ADDRESS_LINE_3), "[Ññ]", "#") }</ADDRESS_LINE_3>
        				...
        				return(
        					<customerNames>
			        			<GIVEN_NAMES_1>{ fn:replace(data($customerNames/GIVEN_NAMES_1), "[Ññ]", "#") }</GIVEN_NAMES_1>
			        			<GIVEN_NAMES_2>{ fn:replace(data($customerNames/GIVEN_NAMES_2), "[Ññ]", "#") }</GIVEN_NAMES_2>
			        			<GIVEN_NAMES_3>{ fn:replace(data($customerNames/GIVEN_NAMES_3), "[Ññ]", "#") }</GIVEN_NAMES_3>
			        		</customerNames>
        				),
	        	...
	        	return(
	        		...
	        		<addresInformationResidence>
	        			<ADDRESS_LINE_1>{ fn:replace(data($demographic/AZXNDO-ADDR-1), "[Ññ]", "#") }</ADDRESS_LINE_1>
	        			<ADDRESS_LINE_2>{ fn:replace(data($demographic/AZXNDO-ADDR-2), "[Ññ]", "#") }</ADDRESS_LINE_2>
	        			<ADDRESS_LINE_3>{ fn:replace(data($demographic/AZXNDO-ADDR-3), "[Ññ]", "#") }</ADDRESS_LINE_3>
	        			<ADDRESS_LINE_4>{ fn:replace(data($demographic/AZXNDO-ADDR-4), "[Ññ]", "#") }</ADDRESS_LINE_4>
	        			{
		        			for $CITY in $demographic/AZXNDO-PSTL-CD
		        			return(
		        				<CITY>{ valorCatalogoAPPToOSB(string($CITY/text()), 'VISION+', '7', $ptEquivalencias) }</CITY>
		        			)
	       				}
	       				{
		        			for $STATE in $demographic/AZXNDO-CITY-STATE
		        			return(
		        				<STATE>{ valorCatalogoAPPToOSB(string($STATE/text()), 'VISION+', '8', $ptEquivalencias) }</STATE>
		        			)
	       				}
	       				{
		        			for $COUNTRY in $demographic/AZXNDO-CNTRY-CD
		        			return(
		        				<COUNTRY>{ valorCatalogoAPPToOSB(string($COUNTRY/text()), 'VISION+', '9', $ptEquivalencias) }</COUNTRY>
		        			)
	       				}           			
	        			...
	        			<SUBURB>{ fn:replace(data($demographic/AZXNDO-HOUSE-NAME), "[Ññ]", "#") }</SUBURB>
	        		...
	        		<addresInformationWork>
	        			...
	        			<ADDRESS_LINE_1>{ fn:replace(data($demographic/AZXNDO-ADDR-2-LINE-1), "[Ññ]", "#") }</ADDRESS_LINE_1>
	        			<ADDRESS_LINE_2>{ fn:replace(data($demographic/AZXNDO-ADDR-2-LINE-2), "[Ññ]", "#") }</ADDRESS_LINE_2>
	        			<ADDRESS_LINE_3>{ fn:replace(data($demographic/AZXNDO-ADDR-2-LINE-3), "[Ññ]", "#") }</ADDRESS_LINE_3>
	        			{
	        			...
	        			<EMPLOYERS_NAME>{ fn:replace(data($demographic/AZXNDO-EMPLOYER), "[Ññ]", "#") }</EMPLOYERS_NAME>
	        			<PHONE_NUMBER>{ data($demographic/AZXNDO-EMP-PHONE) }</PHONE_NUMBER>
	        			<PHONE_EXT>{ data($demographic/AZXNDO-EMP-PHONE-EXTN) }</PHONE_EXT>        			
	        		</addresInformationWork>,
	        		<addresInformationAltern>
	        			<ALTERN_ADDRESS>{ fn:replace(data($demographic/AZXNDO-ADDR-3-INDIC), "[Ññ]", "#") }</ALTERN_ADDRESS>
	        			<ADDRESS_LINE_1>{ fn:replace(data($demographic/AZXNDO-ADDR-3-LINE-1), "[Ññ]", "#") }</ADDRESS_LINE_1>
	        			<ADDRESS_LINE_2>{ fn:replace(data($demographic/AZXNDO-ADDR-3-LINE-2), "[Ññ]", "#") }</ADDRESS_LINE_2>
	        			<ADDRESS_LINE_3>{ fn:replace(data($demographic/AZXNDO-ADDR-3-LINE-3), "[Ññ]", "#") }</ADDRESS_LINE_3>
	        			{
	        		...
	        		<customerNames>
	        			<GIVEN_NAMES_1>{ fn:replace(data($conDatoCliente/ns1:Column[@name = 'nombre_1']), "[Ññ]", "#") }</GIVEN_NAMES_1>
	        			<GIVEN_NAMES_2>{ fn:replace(data($conDatoCliente/ns1:Column[@name = 'nombre_2']), "[Ññ]", "#") }</GIVEN_NAMES_2>
	        			<GIVEN_NAMES_3>{ fn:replace(data($conDatoCliente/ns1:Column[@name = 'Nombre_3']), "[Ññ]", "#") }</GIVEN_NAMES_3>
	        		</customerNames>,
	        		<BIRTH_DATE>{ data($demographic/AZXNDO-DOB) }</BIRTH_DATE>,
	        		
	        		for $MARITAL_STATUS in $conDatoCliente/ns1:Column[@name = 'estadocivil']
	        		return(
	        			<MARITAL_STATUS>{ valorCatalogoAPPToOSB(string($MARITAL_STATUS/text()), 'MASTERDATA+', '2', $ptEquivalencias) }</MARITAL_STATUS>
	        		),       		
	        		
	        		for $LEGAL_DOCUMENT_TYPE in $demographic/AZXNDO-SSAN-FLAG
	        		return(
	        			<LEGAL_DOCUMENT_TYPE>{ valorCatalogoAPPToOSB(string($LEGAL_DOCUMENT_TYPE/text()), 'VISION+', '4', $ptEquivalencias) }</LEGAL_DOCUMENT_TYPE>
	        		),
					...
					return(
						<TRAVELERS_STATUS>{ valorCatalogoAPPToOSB(string($TRAVELERS_STATUS/text()), 'MASTERDATA+', '5', $ptEquivalencias) }</TRAVELERS_STATUS>
					),				
					...
					return(
						<EDUCATION_LEVEL>{ valorCatalogoAPPToOSB(string($EDUCATION_LEVEL/text()), 'VISION+', '10', $ptEquivalencias) }</EDUCATION_LEVEL>
					),
					
					for $GENDER in $demographic/AZXNDO-GENDER-CODE
					return(
						<GENDER>{ valorCatalogoAPPToOSB(string($GENDER/text()), 'VISION+', '1', $ptEquivalencias) }</GENDER>				
					),
					...
					<LEGAL_DOCUMENT_COUNTRY_2>{ data($demographic/AZXNDO-DL-CNTRY) }</LEGAL_DOCUMENT_COUNTRY_2>,	
...
xf:consultaClienteTarjetasNIOut($conDatoCliente,
