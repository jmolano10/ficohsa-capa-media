...
(:: pragma bea:global-element-parameter parameter="$actualizacionClienteTarjetaCredito1" element="ns0:actualizacionClienteTarjetaCredito" location="../xsd/actualizacionClienteTarjetaCreditoTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ActualizacionClienteTarjetaCredito/xq/customerUpdateL8V2GTIn/";
...
declare function xf:customerUpdateL8V2GTIn($actualizacionClienteTarjetaCredito1 as element(ns0:actualizacionClienteTarjetaCredito),
    ...
    as element(ns1:CustomerUpdateL8V2Request) {
        <ns1:CustomerUpdateL8V2Request>
            ...
            <AZXGCI-TITLE xsi:nil="true"/>
            {
            	...
            	return
            		if($MARITAL_STATUS != "") then (  
            			<AZXGCI-MARITAL-STATUS>{ valorCatalogoOSBToAPP($MARITAL_STATUS, 'VISION+GT', '2', $ptEquivalencias) }</AZXGCI-MARITAL-STATUS>
            		) else (
            ...
            }
            {
            	...
            	return(
            		if($CITY != "") then (  
            			<AZXGCI-CITY>{ valorCatalogoOSBToAPP($CITY, 'VISION+GT', '8', $ptEquivalencias) }</AZXGCI-CITY>
            		) else (
            ...
            } 
            {
            	...
            	return(
            		if($ZIP_CODE != "") then (  
            			<AZXGCI-PSTL-CD>{ valorCatalogoOSBToAPP($ZIP_CODE, 'VISION+GT', '7', $ptEquivalencias) }</AZXGCI-PSTL-CD>
            		) else (
            ...
            }
            {
            	...
            	return(
            		if($GENDER != "") then (  
            			<AZXGCI-GENDER-CODE>{ valorCatalogoOSBToAPP($GENDER, 'VISION+GT', '1', $ptEquivalencias) }</AZXGCI-GENDER-CODE>
            		) else (
            ...
            }
           	{
            	...
            	return(
            		if($DOCUMENT_TYPE_1 != "") then (  
            			<AZXGCI-TAX-ID-TYP>{ valorCatalogoOSBToAPP($DOCUMENT_TYPE_1, 'VISION+GT', '4', $ptEquivalencias) }</AZXGCI-TAX-ID-TYP>
            		) else (
            ...
            <AZXGCI-EMP-PHONE-FLAG xsi:nil="true"/>
            {
            	...
            	return(
            		if($PROFESSION != "") then (  
            			<AZXGCI-POSITION>{ valorCatalogoOSBToAPP($PROFESSION, 'VISION+GT', '3', $ptEquivalencias) }</AZXGCI-POSITION>
            		) else (
            ...
            }
            {
            	...
            	if(string($CITY-2/text()) != "")then(
            		<AZXGCI-CITY-2>{ valorCatalogoOSBToAPP($CITY-2, 'VISION+GT', '8', $ptEquivalencias) }</AZXGCI-CITY-2>
            	)else(
            ...
            }
            {
            	...
            	if(string($PSTL-CD-2/text()) != "")then(
            		<AZXGCI-PSTL-CD-2>{ valorCatalogoOSBToAPP($PSTL-CD-2, 'VISION+GT', '7', $ptEquivalencias) }</AZXGCI-PSTL-CD-2>
            	)else(
            ...
            }
            {
            	...
            	if(string($ALTERNATE_CITY/text()) != "")then(
            		<AZXGCI-CITY-3>{ valorCatalogoOSBToAPP($ALTERNATE_CITY, 'VISION+GT', '8', $ptEquivalencias) }</AZXGCI-CITY-3>
            	)else(
            ...
            }
            {
            	...
            	if(string($PSTL-CD-3/text()) != "")then(
            		<AZXGCI-PSTL-CD-3>{ valorCatalogoOSBToAPP($PSTL-CD-3, 'VISION+GT', '7', $ptEquivalencias) }</AZXGCI-PSTL-CD-3>
            	)else(
...
declare variable $actualizacionClienteTarjetaCredito1 as element(ns0:actualizacionClienteTarjetaCredito) external;
declare variable $ptEquivalencias as element() external;

xf:customerUpdateL8V2GTIn($actualizacionClienteTarjetaCredito1,
    $ptEquivalencias)