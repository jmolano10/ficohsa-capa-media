...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ConsultaMaestraSaldosTarjetaCredito/xq/registraCacheMaestraSaldosTCHNIn/";

declare function xf:registraCacheMaestraSaldosTCHNIn($consultaMaestraSaldosTarjetaCreditoResponse as element(ns0:consultaMaestraSaldosTarjetaCreditoResponse),
...
xf:registraCacheMaestraSaldosTCHNIn($consultaMaestraSaldosTarjetaCreditoResponse,
    $PV_CODIGO_PAIS,
    $CARD_NUMBER)