...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ConsultaMaestraSaldosTarjetaCredito/xq/registraCacheMaestraSaldosTCGTIn/";

declare function xf:registraCacheMaestraSaldosTCGTIn($consultaMaestraSaldosTarjetaCreditoResponse as element(ns0:consultaMaestraSaldosTarjetaCreditoResponse),
        ...
        <ns1:InputParameters>
            ...
            <ns1:PT_MAESTRA_SALDOS_TC>
                <ns1:PT_MAESTRA_SALDOS_TC_ITEM>
                    <ns1:CARD_NUMBER>{ $cardNumer }</ns1:CARD_NUMBER>
                    {
...
xf:registraCacheMaestraSaldosTCGTIn($consultaMaestraSaldosTarjetaCreditoResponse,
    $cardNumer,
    $countryCode)