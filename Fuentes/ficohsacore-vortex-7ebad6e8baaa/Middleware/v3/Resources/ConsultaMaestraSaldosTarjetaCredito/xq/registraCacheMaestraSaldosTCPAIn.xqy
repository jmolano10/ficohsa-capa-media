...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ConsultaMaestraSaldosTarjetaCredito/xq/registraCacheMaestraSaldosTCPAIn/";

declare function xf:registraCacheMaestraSaldosTCPAIn($consultaMaestraSaldosTarjetaCreditoResponse as element(ns0:consultaMaestraSaldosTarjetaCreditoResponse),
...
xf:registraCacheMaestraSaldosTCPAIn($consultaMaestraSaldosTarjetaCreditoResponse,
    $PV_CODIGO_PAIS,
    $CARD_NUMBER)