...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/PagoRecaudo/xq/pagoRecaudoEnLineaDebitoCuentaIn/";
...
declare function xf:pagoRecaudoEnLineaDebitoCuentaIn($requestHeader as element(ns0:RequestHeader),
