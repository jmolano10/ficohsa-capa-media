...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../BusinessServices/MasterData/conDatoTarjetasActivasCliente_v2/xsd/conDatoTarjetasActivasCliente_V2_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ConsultaTarjetasCreditoPorCliente/xq/consultaTarjetasCreditoPorClienteOut/";
...
declare function xf:consultaTarjetasCreditoPorClienteOut($outputParameters as element(ns0:OutputParameters))
...
xf:consultaTarjetasCreditoPorClienteOut($outputParameters)