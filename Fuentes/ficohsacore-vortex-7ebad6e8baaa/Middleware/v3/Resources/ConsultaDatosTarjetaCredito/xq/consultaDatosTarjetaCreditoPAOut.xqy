...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ConsultaDatosTarjetaCredito/xq/consultaDatosTarjetaCreditoPAOut/";
...
declare function xf:consultaDatosTarjetaCreditoPAOut($ptEquivalencias as element()?,
    $datosCuenta as element(ns3:OutputParameters)?,
    $embosserInquiryL8V6Response as element(ns1:EmbosserInquiryL8V6Response)?,
    ...
    as element(ns0:consultaDatosTarjetaCreditoResponse) {
        ...
        <ns0:consultaDatosTarjetaCreditoResponse>
        {
            ...
            <CARD_CURRENCY_INFORMATION>
                <ORG_IND>{ $datoCuenta/ns3:Column[@name='TipoOrg']/text() }</ORG_IND>
                {
                ...
                <CURRENCY>{ $datoCuenta/ns3:Column[@name='CodMoneda']/text() }</CURRENCY>
				{
				...
				}
				{
					...
					return
	            	<PERCENTAGE_MONTHLY_PURCHASE_LIMIT>{ data($percentageMonthlyPurchaseLimit) }</PERCENTAGE_MONTHLY_PURCHASE_LIMIT>
				}
				{
				...
				}
				{
					...
					return
	            	<MONTHLY_WITHDRAWAL_LIMIT_PERCENTAGE>{ data($monthlyWithdrawalLimitPercentage) }</MONTHLY_WITHDRAWAL_LIMIT_PERCENTAGE>
				}
				{
...
xf:consultaDatosTarjetaCreditoPAOut($ptEquivalencias,
	$datosCuenta,
    $embosserInquiryL8V6Response, $outputParameters1)