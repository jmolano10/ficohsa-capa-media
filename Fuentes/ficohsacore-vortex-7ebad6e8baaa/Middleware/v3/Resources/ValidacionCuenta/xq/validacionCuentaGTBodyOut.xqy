...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../../v2/BusinessServices/ABKGT/consultaDetallesCuenta/xsd/consultaDetallesCuenta_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ValidacionCuenta/xq/validacionCuentaGTBodyOut/";

declare function xf:validacionCuentaGTBodyOut($outputParameters as element(ns0:OutputParameters))
...
xf:validacionCuentaGTBodyOut($outputParameters)