...
(:: pragma bea:global-element-parameter parameter="$conTransaccionesActualesResponse" element="ns2:OutputParameters" location="../../../BusinessServices/ProcesosHN/conTransaccionesActuales/xsd/conTransaccionesActuales_sp.xsd" ::)
(:: pragma bea:global-element-parameter parameter="$conDatoTarjetaResponse" element="ns0:OutputParameters" location="../../../../v2/BusinessServices/MasterDataHN/conDatoTarjeta/xsd/conDatoTarjeta_sp.xsd" ::)
        ...
        <ns1:InputParameters>
            <ns1:PT_MOVIMIENTOS_RECIENTES_TC>
                <ns1:PT_MOVIMIENTOS_RECIENTES_TC_ITEM>
        			...
        			{
        				let $localRow := $conDatoTarjetaResponse/ns0:RowSet/ns0:Row[ ns0:Column[@name='CodMoneda']/text() = 'GTQ' ]
