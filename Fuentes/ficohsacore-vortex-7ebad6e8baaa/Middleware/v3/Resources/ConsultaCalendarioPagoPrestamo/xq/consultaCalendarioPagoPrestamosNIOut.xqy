...
(:: pragma bea:global-element-parameter parameter="$loanScheduleInquiryResponse" element="ns1:LoanScheduleInquiryResponse" location="../../../../v2/BusinessServices/VisionPlus/visionPlus/xsd/XMLSchema_769155616.xsd" ::)
(:: pragma bea:global-element-return element="ns0:consultaCalendarioPagoPrestamoResponse" location="../xsd/consultaCalendarioPagoPrestamoTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ConsultaCalendarioPagoPrestamo/xq/consultaCalendarioPagoPrestamosNIOut/";

declare function xf:consultaCalendarioPagoPrestamosNIOut($loanScheduleInquiryResponse as element(ns1:LoanScheduleInquiryResponse))
        ...
        <ns0:consultaCalendarioPagoPrestamoResponse>
            ...
            }
            {
                ...
                return
                	...
                	<PAID_INTEREST_AMOUN>{ data($AZXLSO-EARNED-INT) }</PAID_INTEREST_AMOUN>
                	)else()
...
declare variable $loanScheduleInquiryResponse as element(ns1:LoanScheduleInquiryResponse) external;

xf:consultaCalendarioPagoPrestamosNIOut($loanScheduleInquiryResponse)