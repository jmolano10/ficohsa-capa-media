	...
	if ( fn:string($respuestaT24/Status/successIndicator) = "Success" and
		 ...
		 ( count($respuestaAbanks/ns2:REF_NO/ns2:ITEM) > 0  or fn:empty($respuestaT24/WSFICOESTMTGIVENDATESType[1]/ZERORECORDS) )) then (
	        ...
	        <ns1:consultaMovimientosCuentaResponse>
	            {
	                for $ACCOUNTNUMBER in $respuestaT24/WSFICOESTMTGIVENDATESType[1]/ACCOUNTNUMBER
	                return
	                    <ACCOUNT_NUMBER>{ data($ACCOUNTNUMBER) }</ACCOUNT_NUMBER>
	            }
	            {
	                for $ACCOUNTNAME in $respuestaT24/WSFICOESTMTGIVENDATESType[1]/ACCOUNTNAME
	                return
	                    <ACCOUNT_NAME>{ data($ACCOUNTNAME) }</ACCOUNT_NAME>
	            }
	            {
	                for $CURRENCY in $respuestaT24/WSFICOESTMTGIVENDATESType[1]/CURRENCY
	                return
	                    <CURRENCY>{ data($CURRENCY) }</CURRENCY>
	            }
	            {
	                let $STARTINGBALANCET24 := fn:string($respuestaT24/WSFICOESTMTGIVENDATESType[1]/STARTINGBALANCE/text())
	            ...
	            {
	                for $ENDINGBALANCE in $respuestaT24/WSFICOESTMTGIVENDATESType[1]/ENDINGBALANCE
	                return
	            ...
	            {
	            	let $valueDatesT24 := $respuestaT24/WSFICOESTMTGIVENDATESType[1]/gWSFICOESTMTGIVENDATESDetailType/mWSFICOESTMTGIVENDATESDetailType/BOOKINGDATE
	            	let $descriptionsT24 := $respuestaT24/WSFICOESTMTGIVENDATESType[1]/gWSFICOESTMTGIVENDATESDetailType/mWSFICOESTMTGIVENDATESDetailType/TXNDESCRIPTION
	            	let $refNosT24 := $respuestaT24/WSFICOESTMTGIVENDATESType[1]/gWSFICOESTMTGIVENDATESDetailType/mWSFICOESTMTGIVENDATESDetailType/TXNREFERENCE
	            	let $chqNumbersT24 := $respuestaT24/WSFICOESTMTGIVENDATESType[1]/gWSFICOESTMTGIVENDATESDetailType/mWSFICOESTMTGIVENDATESDetailType/CHEQUENUMBER
	            	let $amountsT24 := $respuestaT24/WSFICOESTMTGIVENDATESType[1]/gWSFICOESTMTGIVENDATESDetailType/mWSFICOESTMTGIVENDATESDetailType/TXNAMOUNT
	                return
	        			...
	        			return
	        				if(data($valueDatesT24[$i]) >= $fechaSalidaT24
			                    ...
			                    <ns1:consultaMovimientosCuentaResponseRecordType>
			                        ...
			                        <AMOUNT>{ data($amountsT24[$i]) }</AMOUNT>
