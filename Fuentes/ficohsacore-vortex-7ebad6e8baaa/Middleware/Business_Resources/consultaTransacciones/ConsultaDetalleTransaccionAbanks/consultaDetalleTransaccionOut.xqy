...
(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns1:OutputParameters" location="../Resources/ConsultaDetalleTransaccionAbanks/xsd/ORA_BANK_OSB_CON_DETALLE_MOV.xsd" ::)
(:: pragma bea:global-element-return element="ns0:consultaDetalleTransaccionResponse" location="consultaDetalleTransaccionTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/consultaTransacciones/ConsultaDetalleTransaccionAbanks/consultaDetalleTransaccionOut/";

declare function xf:consultaDetalleTransaccionOut($outputParameters1 as element(ns1:OutputParameters),
...
xf:consultaDetalleTransaccionOut($outputParameters1,
    $details)