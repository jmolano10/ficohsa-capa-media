...
(:: pragma bea:global-element-return element="ns1:ConsultadetransaccionTT" location="../Resources/XMLSchema_-1217682313.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/consultaTransacciones/ConsultaDetalleCompletoTransaccion/consultaDetalleCompletoTransaccionTTIn/";
...
declare function xf:consultaDetalleCompletoTransaccionTTIn($autenticacionRequestHeader as element(ns2:AutenticacionRequestHeader),
    $consultaDetalleCompletoTransaccion as element(ns0:consultaDetalleCompletoTransaccion))
    as element(ns1:ConsultadetransaccionTT) {
        <ns1:ConsultadetransaccionTT>
			<WebRequestCommon>
...
xf:consultaDetalleCompletoTransaccionTTIn($autenticacionRequestHeader,
