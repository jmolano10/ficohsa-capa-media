...
(:: pragma bea:global-element-parameter parameter="$consultaTasaCambio1" element="ns0:consultaTasaCambio" location="consultaTasaCambioTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns1:Consultadetasadecambiolcy" location="../Resources/XMLSchema_1632682327.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/Core/consultaTasaCambio/consultaTasaCambioIn2/";
...
declare function xf:consultaTasaCambioIn2($autenticacionRequestHeader1 as element(ns2:AutenticacionRequestHeader),
    $consultaTasaCambio1 as element(ns0:consultaTasaCambio))
        ...
        <ns1:Consultadetasadecambiolcy>
            ...
            <WSLCYEXCHRATEType>
                <enquiryInputCollection>
                	...
                	<criteriaValue>{ data($consultaTasaCambio1/SOURCE_CURRENCY) }</criteriaValue>
                	<operand>EQ</operand>
                </enquiryInputCollection>
            </WSLCYEXCHRATEType>
        </ns1:Consultadetasadecambiolcy>
...
xf:consultaTasaCambioIn2($autenticacionRequestHeader1,
    $consultaTasaCambio1)