                            ...
                            <BILLS>
                                {
                                    ...
                                    return
                                        <BILL>
                                            ...
                                            <ISSUE_DATE>{ fn-bea:date-from-string-with-format('yyyyMMdd', data($BILL_RECORD/BILL_DATE)) }</ISSUE_DATE>
                                            <DUE_DATE>{ fn-bea:date-from-string-with-format('yyyyMMdd', data($BILL_RECORD/DUE_DATE)) }</DUE_DATE>
                                            <BALANCES>
                                            	{
                                            		let $balances := (
                                            			<BALANCE>
