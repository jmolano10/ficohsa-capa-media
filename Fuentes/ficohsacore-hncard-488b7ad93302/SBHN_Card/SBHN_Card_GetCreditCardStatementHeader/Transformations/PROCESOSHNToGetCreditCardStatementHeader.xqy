...
declare function local:funcPROCESOSHNToGetCreditCardStatementHeader($Output as element() (:: schema-element(ns1:ObtenerEncabezadosV2Response) ::), 
...
local:funcPROCESOSHNToGetCreditCardStatementHeader($Output, $StatusService, $GlobalId)