...
declare function local:funcPagosWSToRollbackPurchase($PagosWS as element() (:: schema-element(ns1:OutputParameters) ::),
...
local:funcPagosWSToRollbackPurchase($PagosWS, $globalId)