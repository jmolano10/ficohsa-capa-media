...
declare function local:funcErrorToPurchaseCreditCard($responseError as element() (:: schema-element(ns1:errorMappingRegionalOutput) ::),
...
local:funcErrorToPurchaseCreditCard($responseError, $codeError, $messageError, $targetSystem, $status, $globalId)