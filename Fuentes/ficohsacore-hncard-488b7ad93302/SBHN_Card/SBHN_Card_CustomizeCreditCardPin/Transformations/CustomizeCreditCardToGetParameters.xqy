...
declare variable $CustomizeCreditCardToGetParameters as element() (:: schema-element(ns1:customizeCreditCardPin) ::) external;
declare variable $parametros as xs:string external;

declare function local:funcCustomizeCreditCardToGetParameters($CustomizeCreditCardToGetParameters as element() (:: schema-element(ns1:customizeCreditCardPin) ::),
...
local:funcCustomizeCreditCardToGetParameters($CustomizeCreditCardToGetParameters, $parametros)
