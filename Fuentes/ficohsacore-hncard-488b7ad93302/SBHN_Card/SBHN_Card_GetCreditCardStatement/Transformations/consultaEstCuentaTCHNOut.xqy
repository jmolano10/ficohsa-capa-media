...
declare variable $consultarEstadosCuentaUltimoCorteResponse1 as element(*)? external;
declare variable $conInfoHistoricaTCResponse as element() (:: schema-element(ns2:OutputParameters) ::)? external;
...
declare function local:consultaEstCuentaTCHNOut($conInfoHistoricaTCResponse as element(ns2:OutputParameters)?,
    $conTransaccionesHistoricasResponse as element(ns1:OutputParameters)?, $consultarEstadosCuentaUltimoCorteResponse1 as element(*) ?,$globalId as xs:string)
    as element() (:: schema-element(ns0:getCreditCardStatementResponse) ::)  {
...
local:consultaEstCuentaTCHNOut($conInfoHistoricaTCResponse,
