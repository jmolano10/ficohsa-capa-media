...
declare function local:registraMovimientosRecientesTCGTIn($conDatoTarjeta as element()(:: schema-element(ns0:OutputParameters) ::),
...
local:registraMovimientosRecientesTCGTIn($conDatoTarjeta,
