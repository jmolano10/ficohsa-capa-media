...
declare namespace car = "https://www.ficohsa.com/regional/common/cardCommonType";
...
declare function local:consultaMovsRecientesTCGTOut($resultGroup as element(), $conDatoTarjeta as element()(:: schema-element(ns0:OutputParameters) ::),
    $conTransaccionesActuales as element() (:: schema-element(ns2:OutputParameters) ::), 
     $outputParameters as element() (:: schema-element(ns4:OutputParameters) ::),$globalId as xs:string) as element() (:: schema-element(ns1:getCreditCardTransactionsResponse) ::) {
				        	...
				        	<Transactions>
				        	{
				        		...
				        		return
					        		<TransactionsRecordType>
					        		{
					        			...
					        			return
					        				<TransactionDate>{ fn-bea:dateTime-to-string-with-format('yyyyMMdd', xs:dateTime($transactionDate))}</TransactionDate>
					        		}
					        		{
...
local:consultaMovsRecientesTCGTOut($resultGroup,$conDatoTarjeta,$conTransaccionesActuales,$outputParameters,$globalId)