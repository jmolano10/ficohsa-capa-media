...
declare function local:funcRollbackToOnlinePayment($Rollback as element() (:: schema-element(ns1:getStatusTicket) ::),
...
local:funcRollbackToOnlinePayment($Rollback,$sequence,$org,$requestType,$creditCard,$merchant,$expiration,$payment)