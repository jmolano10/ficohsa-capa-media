...
declare function local:funcRollbackToActTicket($RollbackPurchase as element() (:: schema-element(ns1:getStatusTicket) ::),
...
local:funcRollbackToActTicket($RollbackPurchase, $statusTicket,$numeroAutorizacion)