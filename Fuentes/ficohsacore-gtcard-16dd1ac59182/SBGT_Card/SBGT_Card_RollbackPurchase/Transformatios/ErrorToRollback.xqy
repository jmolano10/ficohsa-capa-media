...
declare function local:funcErrorToRollback($ErrorToRollback as element() (:: schema-element(ns1:errorMappingRegionalOutput) ::),
...
local:funcErrorToRollback($ErrorToRollback, $codeError, $messageError, $targetSystem, $status, $globalId, $messaggeOnlinePayment)