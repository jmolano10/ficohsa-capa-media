...
declare variable $CustomizeCreditCardPinToCryptographicOperations as element() (:: schema-element(ns1:customizeCreditCardPin) ::) external;
...
declare function local:funcCustomizeCreditCardPinToCryptographicOperations($CustomizeCreditCardPinToCryptographicOperations as element() (:: schema-element(ns1:customizeCreditCardPin) ::),
    ...
    <keyAlias>{fn:data($keyAlias)}</keyAlias>
        <dataItems>
            <fieldItem>
                <value>{fn:data($CustomizeCreditCardPinToCryptographicOperations/Pin)}</value>
            </fieldItem>
        </dataItems>
    </ns2:processDataRequest>
};

local:funcCustomizeCreditCardPinToCryptographicOperations($CustomizeCreditCardPinToCryptographicOperations, $operationType, $cipher, $keyAlias)