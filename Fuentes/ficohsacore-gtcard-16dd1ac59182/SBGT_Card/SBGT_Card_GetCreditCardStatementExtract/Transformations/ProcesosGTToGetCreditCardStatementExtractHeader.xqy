...
declare function local:funcProcesosGTToGetCreditCardStatementExtractHeader($getHeaderV2Response as element() (:: schema-element(ns1:ObtenerEncabezadosV2Response) ::), 
     ...
     <ns2:getCreditCardStatementExtractResponse>
       ...
       <CardNumber>{fn:data($cardNumber)}</CardNumber>
        ...
        <FileLink>{fn:data($getHeaderV2Response/ns1:ObtenerEncabezadosV2Result/bf.:Encabezados/bf.:DatoObtenerEncabezadosV2/bf.:FileLink)}</FileLink>
    </ns2:getCreditCardStatementExtractResponse>
};

local:funcProcesosGTToGetCreditCardStatementExtractHeader($getHeaderV2Response, $cardNumber, $fileType, $getHeaders, $statusService, $globalId)