...
declare function local:funcGetCreditCardStatementExtractToProcesosGTHeader($getCreditCardStatementExtract as element() (:: schema-element(ns1:getCreditCardStatementExtract) ::), 
...
local:funcGetCreditCardStatementExtractToProcesosGTHeader($getCreditCardStatementExtract, $generateAccountStatement, $codeCountry, $productTypeValue)