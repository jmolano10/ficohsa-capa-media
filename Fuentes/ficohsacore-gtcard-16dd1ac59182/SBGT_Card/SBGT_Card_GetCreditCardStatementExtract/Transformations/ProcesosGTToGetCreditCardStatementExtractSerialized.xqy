...
declare function local:funcProcesosGTToGetCreditCardStatementExtractSerialized($getSerializedResponse as element() (:: schema-element(ns1:ObtenerSerializadoResponse) ::),
...
local:funcProcesosGTToGetCreditCardStatementExtractSerialized($getSerializedResponse, $statusService, $globalId)