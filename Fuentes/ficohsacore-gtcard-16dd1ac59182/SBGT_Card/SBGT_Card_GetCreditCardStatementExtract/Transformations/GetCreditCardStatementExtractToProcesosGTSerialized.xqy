...
declare function local:funcGetCreditCardStatementExtractToProcesosGTSerialized($getCreditCardStatementExtract as element() (:: schema-element(ns1:getCreditCardStatementExtract) ::), 
...
local:funcGetCreditCardStatementExtractToProcesosGTSerialized($getCreditCardStatementExtract, $codeCountry)