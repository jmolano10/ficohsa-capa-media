...
declare function local:funcErrorGetCreditCardStatementHeader($MapeoErrorOutput as element() (:: schema-element(ns1:errorMappingRegionalOutput) ::), 
...
local:funcErrorGetCreditCardStatementHeader($MapeoErrorOutput, $StatusService, $GlobalId, $TarguetSystem, $CodeError, $MessageError)