...
declare function local:funcPROCESOSGTToGetCreditCardStatementHeader($Output as element() (:: schema-element(ns1:ObtenerEncabezadosV2Response) ::), 
...
local:funcPROCESOSGTToGetCreditCardStatementHeader($Output, $GlobalId, $StatusService)