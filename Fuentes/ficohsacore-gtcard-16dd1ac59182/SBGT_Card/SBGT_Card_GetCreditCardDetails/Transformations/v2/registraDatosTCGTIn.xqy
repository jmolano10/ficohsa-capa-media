...
(:: import schema at "../../Schemas/v2/registroDatosTC_sp.xsd" ::)
...
declare function local:registraDatosTCGTIn($resultGroup as element(*),
...
local:registraDatosTCGTIn($resultGroup,
    $ptEquivalencias,
    $datosCuenta,
    $countryCode)