...
declare namespace ns2="http://www.ficohsa.com.hn/middleware.services/customerTypesNI";
...
declare function local:func($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:createCustomerResponse) ::) {
