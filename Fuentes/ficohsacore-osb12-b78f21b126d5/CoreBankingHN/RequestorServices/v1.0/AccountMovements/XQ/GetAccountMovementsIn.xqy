    ...
    <ns2:ConsultaMovimientosCuenta>
		...
		<operand>EQ</operand>
            ...
            <enquiryInputCollection>
                ...
                <criteriaValue>{fn:upper-case(fn:data($GetAccountMovementsRequest/PagingInfo/Paging))}</criteriaValue>
                <operand>EQ</operand>
            </enquiryInputCollection>
            <enquiryInputCollection>
                <columnName>INICIOPAGINAR</columnName>
                <criteriaValue>{fn:data($GetAccountMovementsRequest/PagingInfo/InitialRecord)}</criteriaValue>
                <operand>EQ</operand>
            </enquiryInputCollection>
            <enquiryInputCollection>
                <columnName>NUM.REGISTROS</columnName>
                <criteriaValue>{fn:data($GetAccountMovementsRequest/PagingInfo/RecordCount)}</criteriaValue>
                <operand>EQ</operand>
            </enquiryInputCollection>
            <enquiryInputCollection>
...
local:func($GetAccountMovementsRequest, $userName, $password, $endDate, $beginDate, $ticket)