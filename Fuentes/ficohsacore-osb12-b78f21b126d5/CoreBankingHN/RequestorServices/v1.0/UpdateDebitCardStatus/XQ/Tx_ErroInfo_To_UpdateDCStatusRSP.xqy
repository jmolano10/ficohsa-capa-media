...
declare function xq:Tx_ErroInfo_To_GetCustomerAssetsResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:updateDebitCardStatusResponse) ::) {
    <ns2:updateDebitCardStatusResponse>
        <ns2:ErrorInfo>
            {
...
xq:Tx_ErroInfo_To_GetCustomerAssetsResponse($errorInfo)