...
declare function xq:Tx_ErrorInfo_To_transfersAccountResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:transfersAccountResponse) ::) {
...
xq:Tx_ErrorInfo_To_transfersAccountResponse($errorInfo)
