    ...
    <ns2:Pagoderecaudoreferenciadodbcta>
          <WebRequestCommon>
            ...
            <FUNDSTRANSFERREFCOLLACTRFWSCOPYType>
		                {
		                    for $DEBIT_ACCOUNT in $paymentCollectionRequest/ns1:PaymentInformation/ns1:DebitAccount
		                    return
		                ...
		                <gLRINVOICENO>
		                    <mLRINVOICENO>
		                        <LRINVOICENO>
		                        {
		                            if (data($paymentCollectionRequest/ns1:BillInformation/ns1:BillNumber) != "") then
		                                (data($paymentCollectionRequest/ns1:BillInformation/ns1:BillNumber))
		                            else 
		                                data($paymentCollectionRequest/ns1:DebtorCode)
		                        }
								</LRINVOICENO>
		                        <LRDUEDATE>20140708</LRDUEDATE>
		                        <LRAMT>{ concat(data($paymentCollectionRequest/ns1:PaymentInformation/ns1:PaymentCurrency) , $paymentCollectionRequest/ns1:PaymentInformation/ns1:PaymentAmount) }</LRAMT>
		                        <LRPAYYN>Y</LRPAYYN>
		                    </mLRINVOICENO>
		                </gLRINVOICENO>
		                <gLRTAXPAYNAME>
