...
declare namespace ns2="http://www.ficohsa.com.hn/middleware.services/getRemittanceFieldsTypes";
...
declare function xq:Tx_ErroInfo_To_GetRemittanceFieldsResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:getRemittanceFieldsResponse) ::) {
    <ns2:getRemittanceFieldsResponse>
...
xq:Tx_ErroInfo_To_GetRemittanceFieldsResponse($errorInfo)
