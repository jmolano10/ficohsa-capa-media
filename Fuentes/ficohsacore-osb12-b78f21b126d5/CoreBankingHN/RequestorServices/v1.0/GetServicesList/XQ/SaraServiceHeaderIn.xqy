...
declare function local:getAction($operation as xs:string) as xs:string {
...
declare function local:func($operation as xs:string, 
         ...
         <soap-env:Header>
			<wsse:Security soap-env:mustUnderstand="true">
				<wsse:UsernameToken>
					<wsse:Username>{ 
						fn-bea:fail-over( local:getUsername($serviceAccount), $serviceAccount) }
					</wsse:Username>
					<wsse:Password Type="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordText">
						{ fn-bea:fail-over( local:getPassword($serviceAccount), $serviceAccount) }
					</wsse:Password>
				</wsse:UsernameToken>
			</wsse:Security>
			<urn:Context>
			...
			<wsa:Action>{ local:getAction($operation) }</wsa:Action>
		</soap-env:Header>                   
};

local:func($operation, $serviceAccount)