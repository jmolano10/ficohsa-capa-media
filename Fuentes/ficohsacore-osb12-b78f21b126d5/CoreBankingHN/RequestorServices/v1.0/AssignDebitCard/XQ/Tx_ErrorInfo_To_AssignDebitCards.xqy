...
declare function xq:Tx_ErrorInfo_To_AssignDebitCards($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:assignDebitCardResponse) ::) {
...
xq:Tx_ErrorInfo_To_AssignDebitCards($errorInfo)
