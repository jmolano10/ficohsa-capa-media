...
declare function local:func($accountNumber as xs:string, 
                            $userName as xs:string,
                            $password as xs:string) as element() (:: schema-element(ns1:Consultadedetallesdelacuenta) ::) {
...
local:func($accountNumber, $userName, $password)