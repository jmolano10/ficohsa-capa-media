...
declare function xq:Tx_ErrorInfo_To_CreateChequeBooksResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:createCheckBooksResponse) ::) {
...
xq:Tx_ErrorInfo_To_CreateChequeBooksResponse($errorInfo)
