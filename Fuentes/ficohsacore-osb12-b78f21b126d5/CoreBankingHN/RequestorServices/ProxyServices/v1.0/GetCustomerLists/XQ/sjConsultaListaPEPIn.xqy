...
declare function ns1:sjConsultaListaPEPIn($legalId as xs:string, $username as xs:string, $password as xs:string) as element() (:: schema-element(ns3:ConsultadelistaPEP) ::) {
    <ns3:ConsultadelistaPEP>
        <WebRequestCommon>
...
ns1:sjConsultaListaPEPIn($legalId, $username, $password)