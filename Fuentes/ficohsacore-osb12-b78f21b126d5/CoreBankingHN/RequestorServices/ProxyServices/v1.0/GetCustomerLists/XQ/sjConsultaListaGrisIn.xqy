...
declare function ns1:sjConsultaListaGrisIn($legalId as xs:string, $username as xs:string, $password as xs:string) as element() (:: schema-element(ns3:ConsultaListaGris) ::) {
    <ns3:ConsultaListaGris>
        <WebRequestCommon>
...
ns1:sjConsultaListaGrisIn($legalId, $username, $password)