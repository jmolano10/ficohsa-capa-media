...
declare function xq:Tx_ErroInfo_To_GetCustomerDebitCardsResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:getCustomerDebitCardsResponse) ::) {
...
xq:Tx_ErroInfo_To_GetCustomerDebitCardsResponse($errorInfo)