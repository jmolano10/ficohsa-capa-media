...
declare namespace ns1="http://www.ficohsa.com/midleware.services/ConsultaCertifDepIn";
...
declare function ns1:consultaCertifDepIn($username as xs:string, $password as xs:string, $customerId as xs:string) as element() (:: schema-element(ns2:Consultadecertifdepporcliente) ::) {
    <ns2:Consultadecertifdepporcliente>
        <WebRequestCommon>
...
ns1:consultaCertifDepIn($username, $password, $customerId)