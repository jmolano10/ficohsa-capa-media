...
declare namespace ns1="http://www.ficohsa.como/midleware.services/ConsultaCtasCorrienteIn";
...
declare function ns1:consultaCtasCorrienteIn($username as xs:string, $password as xs:string, $customerId as xs:string) as element() (:: schema-element(ns2:ConsultaClienteCuentasCorriente) ::) {
    <ns2:ConsultaClienteCuentasCorriente>
        <WebRequestCommon>
...
ns1:consultaCtasCorrienteIn($username, $password, $customerId)