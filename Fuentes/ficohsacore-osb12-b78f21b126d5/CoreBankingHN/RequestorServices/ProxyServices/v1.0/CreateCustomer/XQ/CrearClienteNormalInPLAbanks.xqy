...
declare function xq:CrearClienteNormalInAbanks($cdCliente as xs:string, $crearCliente as element() (:: schema-element(ns1:createCustomerRequest) ::), $user as xs:string) as element() (:: schema-element(ns2:InputParameters) ::) {
    <ns2:InputParameters>
        ...
        <ns2:PV_NOMBRE_COMERCIAL></ns2:PV_NOMBRE_COMERCIAL>
        {
            ...
            then <ns2:PV_ADICIONADO_POR>{$user}</ns2:PV_ADICIONADO_POR>
            else ()
        }
        ...
        <ns2:PV_CELULAR>{fn:data($crearCliente/ns1:CustomerInfo/ns1:ContactInfo/ns1:PhoneList[fn:upper-case(ns1:Type)='MOBILE']/ns1:Number[1])}</ns2:PV_CELULAR>
        ...
        <ns2:PV_RTN>{fn:data($crearCliente/ns1:CustomerInfo/ns1:IdList[ns1:DocumentName='RTN']/ns1:LegalId)}</ns2:PV_RTN>
