...
declare namespace ns1="http://www.ficohsa.com.hn/middleware.services/customerTypesCCHN";
(:: import schema at "../../../../../../MWBanking/Customers/RequestorServices/XSD/createCustomerCCHN.xsd" ::)
    ...
    <ns3:CustomerAddL8V2Request>
        {
        	...
        	return(
	            <AZXNAI-LOCAL-ACCT-ORG>340</AZXNAI-LOCAL-ACCT-ORG>,
	            ...
	            return(
		            if($MARITAL_STATUS  != "")then(
		            	<AZXNAI-M-MARITAL-STATUS>{ local:CatalogValueOSBToAPP($MARITAL_STATUS, 'VISION+HN', '2', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-MARITAL-STATUS>    	
		            )else(
            	   ...
            	   if($COLONY_DESCRIPTION  != "")then(
					...
					return(
	           		...
	           		if($DEPARMENT_CODE != "")then(
		            		<AZXNAI-M-CITY>{ local:CatalogValueOSBToAPP($DEPARMENT_CODE, 'VISION+HN', '8', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-CITY>
		           	)else(
		           			<AZXNAI-M-CITY/>	
		           	),
		           	<AZXNAI-M-STATE/>,
	            	if($MUNICIPALITY_CODE != "")then(
	            	 	<AZXNAI-M-PSTL-CD>{ local:CatalogValueOSBToAPP($MUNICIPALITY_CODE, 'VISION+HN', '7', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-PSTL-CD>
	           		)else(
	           			<AZXNAI-M-PSTL-CD/>
	           		),
	           	    if($COUNTRY_CODE != "")then(
		            		 <AZXNAI-M-CNTRY-CD>{ local:CatalogValueOSBToAPP($COUNTRY_CODE, 'VISION+HN', '9', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-CNTRY-CD>
	           		)else(
	           			<AZXNAI-M-CNTRY-CD/>
	           		) ,
		            ...
		            return(
			            if($GENDER  != "")then(
			            	<AZXNAI-M-GENDER-CODE>{ local:CatalogValueOSBToAPP($GENDER, 'VISION+HN', '1', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-GENDER-CODE>
			            )else(
					...
					return(
						<AZXNAI-M-SSAN-FLAG>{ local:CatalogValueOSBToAPP($LEGAL_ID_TYPE, 'VISION+HN', '4', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-SSAN-FLAG>,
					...
					return(
					 ...
					 return(
						if($PROFESSION_CODE  != "")then(
							<AZXNAI-M-POSITION>{ local:CatalogValueOSBToAPP($PROFESSION_CODE, 'VISION+HN', '3', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-POSITION>
						)else(
							<AZXNAI-M-POSITION/>           	
						)
					 ),
					...
					return(
						if($JOB_TITLE != "")then(
							<AZXNAI-M-USER-3>{ local:CatalogValueOSBToAPP($JOB_TITLE, 'VISION+HN', '11', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-USER-3>
						)else(
							<AZXNAI-M-USER-3/>	            	
						)
					),
					...
					return(
						if($COUNTRY_CODE_ISSUANCE != "")then(
							<AZXNAI-M-USER-12>{ local:CatalogValueOSBToAPP($COUNTRY_CODE_ISSUANCE, 'VISION+HN', '9', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-USER-12>
						)else(
							<AZXNAI-M-USER-12/>	            	
						)
					),
					...
					return(
						if($LEVEL_OF_EDUCATION != "")then(
							<AZXNAI-M-USER-14>{ local:CatalogValueOSBToAPP($LEVEL_OF_EDUCATION, 'VISION+HN', '10', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-USER-14>
						)else(
							<AZXNAI-M-USER-14/>	            	
						)
					),
					...
					return(
						if($OTHERS_INCOMES != "")then(
							...
							<AZXNAI-M-USER-DEMO-1/>	            	
                                        ...
                                        if($COUNTRY_CODE != "")then(
                                                <AZXNAI-M-USER-DEMO-2>{ local:CatalogValueOSBToAPP($COUNTRY_CODE, 'VISION+HN', '9', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-USER-DEMO-2>
                                        )else(
					...
					if($DEPARMENT_CODE_WORK != "")then(
		            		<AZXNAI-M-CITY-2>{ local:CatalogValueOSBToAPP($DEPARMENT_CODE_WORK, 'VISION+HN', '8', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-CITY-2>
		           		)else(
		           			<AZXNAI-M-CITY-2/>  
		           	),
		           	if($MUNICIPALITY_CODE_WORK != "")then(
		            		<AZXNAI-M-PSTL-CD-2>{ local:CatalogValueOSBToAPP($MUNICIPALITY_CODE_WORK, 'VISION+HN', '7', $GetCatalogsEquivalenceResponse)}</AZXNAI-M-PSTL-CD-2>
			            )else(
			            	<AZXNAI-M-PSTL-CD-2/>  	            	
			        ),
			        if($COUNTRY_CODE_WORK != "")then(
		            	<AZXNAI-M-CNTRY-CD-2>{ local:CatalogValueOSBToAPP($COUNTRY_CODE_WORK, 'VISION+HN', '9', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-CNTRY-CD-2>
			        )else(
			            <AZXNAI-M-CNTRY-CD-2/>  	            	
			        ),
			        ...
			        if($DEPARMENT_CODE_OTHER != "")then(	
		            		<AZXNAI-M-CITY-3>{ local:CatalogValueOSBToAPP($DEPARMENT_CODE_OTHER, 'VISION+HN', '8', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-CITY-3>
			        )else(
			            	<AZXNAI-M-CITY-3/>         	
			        ),
			        if($MUNICIPALITY_CODE_OTHER != "")then(
		            		<AZXNAI-M-PSTL-CD-3>{ local:CatalogValueOSBToAPP($MUNICIPALITY_CODE_OTHER, 'VISION+HN', '7', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-PSTL-CD-3>
			        )else(
			            	<AZXNAI-M-PSTL-CD-3/>         	
			        ),
			        if($COUNTRY_CODE_OTHER != "")then(
		            		<AZXNAI-M-CNTRY-CD-3>{ local:CatalogValueOSBToAPP($COUNTRY_CODE_OTHER, 'VISION+HN', '9', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-CNTRY-CD-3>
			            )else(
			            	<AZXNAI-M-CNTRY-CD-3>{ local:CatalogValueOSBToAPP($COUNTRY_CODE, 'VISION+HN', '9', $GetCatalogsEquivalenceResponse) }</AZXNAI-M-CNTRY-CD-3>         	
			         ),
