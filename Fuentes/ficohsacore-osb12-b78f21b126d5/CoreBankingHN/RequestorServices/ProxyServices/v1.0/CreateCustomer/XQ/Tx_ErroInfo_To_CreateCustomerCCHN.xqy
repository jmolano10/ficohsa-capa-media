...
declare namespace ns2="http://www.ficohsa.com.hn/middleware.services/customerTypesCCHN";
...
declare function xq:Tx_ErroInfo_To_CreateBankingUserResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:createCustomerResponse) ::) {
...
xq:Tx_ErroInfo_To_CreateBankingUserResponse($errorInfo)