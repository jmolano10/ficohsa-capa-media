...
declare function xq:Tx_GetAccountDetails_To_T24($accountNumber as xs:string, 
                                                $userName as xs:string, 
                                                $password as xs:string) 
                                                as element() (:: schema-element(ns1:Consultadetallecuenta) ::) {
    <ns1:Consultadetallecuenta>
        <WebRequestCommon>
...
xq:Tx_GetAccountDetails_To_T24($accountNumber, $userName, $password)
