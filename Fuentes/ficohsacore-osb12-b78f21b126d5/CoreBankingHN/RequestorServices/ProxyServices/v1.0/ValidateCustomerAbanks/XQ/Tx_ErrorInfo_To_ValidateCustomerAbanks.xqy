...
declare function xq:Tx_ErroInfo_To_UpdateDebitCards($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:validateCustomerAbanksResponse) ::) {
...
xq:Tx_ErroInfo_To_UpdateDebitCards($errorInfo)