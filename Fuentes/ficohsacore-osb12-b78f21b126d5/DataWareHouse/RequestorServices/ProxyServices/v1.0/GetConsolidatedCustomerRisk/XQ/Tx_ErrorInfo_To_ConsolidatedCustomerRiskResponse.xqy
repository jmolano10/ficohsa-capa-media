...
declare function xq:Tx_ErrorInfo_To_ConsolidatedCustomerRiskResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:getConsolidatedCustomerRiskResponse) ::) {
...
xq:Tx_ErrorInfo_To_ConsolidatedCustomerRiskResponse($errorInfo)