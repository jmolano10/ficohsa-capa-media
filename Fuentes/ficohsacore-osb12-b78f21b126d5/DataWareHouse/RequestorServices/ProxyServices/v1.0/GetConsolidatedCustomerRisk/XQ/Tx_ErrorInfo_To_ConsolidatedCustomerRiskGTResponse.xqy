...
declare function local:Tx_ErrorInfo_To_ConsolidatedCustomerRiskGTResponse.xqy($ErrorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:GetConsolidatedCustomerRiskGTResponse) ::) {
    <ns2:GetConsolidatedCustomerRiskGTResponse>
<ns2:ErrorInfo>
            {
...
local:Tx_ErrorInfo_To_ConsolidatedCustomerRiskGTResponse.xqy($ErrorInfo)
