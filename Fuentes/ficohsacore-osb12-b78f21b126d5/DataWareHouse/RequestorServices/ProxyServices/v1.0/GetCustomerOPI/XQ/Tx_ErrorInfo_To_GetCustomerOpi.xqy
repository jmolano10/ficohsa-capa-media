...
declare function gco:GetCustomerOpi($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:getCustomerOpiResponse) ::) {
