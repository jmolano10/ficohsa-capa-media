...
declare function xq:Tx_ErrorInfo_To_UpdateBankingUserResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:upateBankingUserResponse) ::) {
    <ns2:upateBankingUserResponse>
        <ns2:ErrorInfo>
            {
...
xq:Tx_ErrorInfo_To_UpdateBankingUserResponse($errorInfo)
