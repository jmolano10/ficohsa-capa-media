...
declare function xq:Tx_ErroInfo_To_CreateBankingUserResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:createBankingUserResponse) ::) {
