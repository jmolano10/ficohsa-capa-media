...
declare function xq:Tx_ErrorInfo_To_GetUser($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:getUserResponse) ::) {
    <ns2:getUserResponse>
        <ns2:ErrorInfo>
            {
...
xq:Tx_ErrorInfo_To_GetUser($errorInfo)