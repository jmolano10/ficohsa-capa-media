...
declare function xq:TX_DummyResponseCOMPOSE($uuid as xs:string) as element() (:: schema-element(ns1:documentResponse) ::) {
    <ns1:documentResponse>
        ...
        <ns1:DocumentResult>
            <ns1:Documents>
                <ns1:DocumentHandler>630</ns1:DocumentHandler>
                <ns1:Revisions>
                    <ns1:Page>JVBERi0xLjUNCjQgMCBvYmoNCjw8L1R5c</ns1:Page>
                </ns1:Revisions>
            </ns1:Documents>
            <ns1:Code>0</ns1:Code>
            <ns1:Description></ns1:Description>
            <ns1:Result>83274</ns1:Result>
        </ns1:DocumentResult>
    </ns1:documentResponse>
};

xq:TX_DummyResponseCOMPOSE($uuid)