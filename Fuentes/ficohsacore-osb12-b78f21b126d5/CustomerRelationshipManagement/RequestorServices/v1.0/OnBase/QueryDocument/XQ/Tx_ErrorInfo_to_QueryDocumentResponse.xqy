...
declare function xq:Tx_ErrorIfo_to_QueryDocumentResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) 
...
xq:Tx_ErrorIfo_to_QueryDocumentResponse($errorInfo)