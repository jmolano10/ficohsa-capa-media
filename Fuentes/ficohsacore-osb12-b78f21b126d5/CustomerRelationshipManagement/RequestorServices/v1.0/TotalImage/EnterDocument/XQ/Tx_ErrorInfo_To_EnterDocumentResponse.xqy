...
declare function xq:Tx_ErrorInfo_To_EnterDocumentResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:ingresaExpedienteResponse) ::) {
...
xq:Tx_ErrorInfo_To_EnterDocumentResponse($errorInfo)