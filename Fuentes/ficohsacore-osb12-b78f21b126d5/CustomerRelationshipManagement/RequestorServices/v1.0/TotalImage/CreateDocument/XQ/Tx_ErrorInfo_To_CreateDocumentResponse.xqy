...
declare namespace ns2="http://www.ficohsa.com.hn/middleware.services/digitalizacionExpedienteTypes";
...
declare function xq:Tx_ErrorInfo_To_CreateDocumentResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:creaExpedienteResponse) ::) {
    <ns2:creaExpedienteResponse>
        <ns2:ErrorInfo>
            {
...
xq:Tx_ErrorInfo_To_CreateDocumentResponse($errorInfo)