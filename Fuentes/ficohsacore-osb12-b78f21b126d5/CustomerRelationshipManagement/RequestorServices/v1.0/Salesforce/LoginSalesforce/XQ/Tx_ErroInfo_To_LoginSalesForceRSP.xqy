...
declare namespace ns2="http://www.ficohsa.com.hn/middleware.services/loginSalesForceTypes";
...
declare function xq:Tx_ErroInfo_To_GetCustomerLiabilitiesResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:loginSalesforceResponse) ::) {
    <ns2:loginSalesforceResponse>
        <ns2:ErrorInfo>
            {
