...
declare function xq:Tx_ErroInfo_To_GetCustomerAssetsResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:packingOrderResponse) ::) {
    <ns2:packingOrderResponse>
        <ns2:ErrorInfo>
            {
