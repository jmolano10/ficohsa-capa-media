...
declare function xq:Tx_ErrorInfo_To_CreateAutomaticCollectionsResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:automaticCollectionsResponse) ::) {
...
xq:Tx_ErrorInfo_To_CreateAutomaticCollectionsResponse($errorInfo)
