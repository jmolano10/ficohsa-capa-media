...
declare function xq:Tx_ErroInfo_To_GetCustomerLiabilitiesResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:createLoanResponse) ::) {
    <ns2:createLoanResponse>
        <ns2:ErrorInfo>
            {
