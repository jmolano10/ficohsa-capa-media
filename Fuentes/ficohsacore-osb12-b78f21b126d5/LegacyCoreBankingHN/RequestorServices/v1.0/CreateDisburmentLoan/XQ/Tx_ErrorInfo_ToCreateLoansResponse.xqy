...
declare namespace ns1="http://www.ficohsa.com.hn/middleware.services/loansTypes";
...
declare function xq:Tx_ErrorInfo_ToGetLoanDetailsResponse($errorInfo as element() (:: schema-element(ns2:ErrorInfo) ::)) as element() (:: schema-element(ns1:createDisbursementLoanResponse) ::) {
    <ns1:createDisbursementLoanResponse>
        <ns1:ErrorInfo>
            {
