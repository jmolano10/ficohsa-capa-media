...
declare function local:Tx_ErrorInfo_To_CalculaMaortizacionResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:amortizationScheduleResponse) ::) {
...
local:Tx_ErrorInfo_To_CalculaMaortizacionResponse($errorInfo)
