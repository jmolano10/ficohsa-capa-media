...
declare function xq:Tx_ErroInfo_To_CreateAccount($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:createAccountResponse) ::) {
...
xq:Tx_ErroInfo_To_CreateAccount($errorInfo)