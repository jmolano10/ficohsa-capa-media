...
declare function ns1:getCustomerDetailsOut($uuid as xs:string, 
    ...
    <ns3:getCustomerDetailsResponse>
        ...
        <ns3:BasicInfo>
            ...
            {
                if (fn:data($getCustomerDetailsRSP/ns2:PV_RTN) != '') then
                    <ns3:IdentificationInfo>
                        <ns3:LegalDocumentType>RTN</ns3:LegalDocumentType>
                        <ns3:LegalId>{fn:data($getCustomerDetailsRSP/ns2:PV_RTN)}</ns3:LegalId>
                    </ns3:IdentificationInfo>
                else ()    
            }
        ...
        <ns3:FinancialInfo>
            ...
            <ns3:JobTitleDescription>{ data($getCustomerDetailsRSP/ns2:PV_PUESTO_TRABAJO) }</ns3:JobTitleDescription>
        ...
        </ns3:FinancialInfo>
        {
            ...
            return
                <ns3:AddressesInfo>
                    ...
                    {
                        if (data($getCustomerDetailsRSP/ns2:PT_DIRECCION_PRINCIPAL/ns2:PT_DIRECCION_PRINCIPAL_ITEM[$i]) = 'S') then
                            <ns3:IsMainAddress>YES</ns3:IsMainAddress>
                        else if (data($getCustomerDetailsRSP/ns2:PT_DIRECCION_PRINCIPAL/ns2:PT_DIRECCION_PRINCIPAL_ITEM[$i]) = 'N') then
                    ...
                    <ns3:Zone>{ data($getCustomerDetailsRSP/ns2:PT_ZONE/ns2:PT_PAIS_ITEM[$i]) }</ns3:Zone>
                </ns3:AddressesInfo>
        }
        <ns3:PhoneInfo>
            <ns3:Id>1</ns3:Id>
            <ns3:Type>LANDLINE</ns3:Type>
            <ns3:PhoneNumber>{ data($getCustomerDetailsRSP/ns2:PV_TELEFONO) }</ns3:PhoneNumber>
        </ns3:PhoneInfo>
        <ns3:PhoneInfo>
            <ns3:Id>1</ns3:Id>
            <ns3:Type>MOBILE</ns3:Type>
            <ns3:PhoneNumber>{ data($getCustomerDetailsRSP/ns2:PV_CELULAR) }</ns3:PhoneNumber>
        </ns3:PhoneInfo>
        {
            if (fn:string($getCustomerDetailsRSP/ns2:PV_EMAIL/text()) != '') then
                <ns3:EmailInfo>
                    <ns3:Id>1</ns3:Id>
