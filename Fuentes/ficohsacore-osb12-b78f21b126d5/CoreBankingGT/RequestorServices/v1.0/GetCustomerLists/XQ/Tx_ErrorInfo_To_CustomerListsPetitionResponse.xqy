...
declare function xq:Tx_ErrorInfo_To_CustomerListsPetitionResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:customerListPetitionResponse) ::) {
...
xq:Tx_ErrorInfo_To_CustomerListsPetitionResponse($errorInfo)