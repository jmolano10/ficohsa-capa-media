...
declare function xq:Tx_ErrorInfo_To_GetListsPetitionStatusResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:getListsPetitionStatusResponse) ::) {
...
xq:Tx_ErrorInfo_To_GetListsPetitionStatusResponse($errorInfo)