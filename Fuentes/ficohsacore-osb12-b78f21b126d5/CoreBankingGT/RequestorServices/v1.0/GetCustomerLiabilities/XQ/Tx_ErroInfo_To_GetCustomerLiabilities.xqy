...
declare function xq:Tx_ErroInfo_To_GetCustomerLiabilities($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:getCustomerLiabilitiesResponse) ::) {
...
xq:Tx_ErroInfo_To_GetCustomerLiabilities($errorInfo)