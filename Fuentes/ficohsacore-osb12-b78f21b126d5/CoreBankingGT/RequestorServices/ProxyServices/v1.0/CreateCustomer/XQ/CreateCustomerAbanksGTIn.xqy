...
declare function local:func($CreateCustomerRequest as element() (:: schema-element(ns1:createCustomerRequest) ::), 
    ...
    <ns2:InputParameters>
        {      
            if (data($CreateCustomerRequest/ns1:ProcessType)='8.2') then(
		<PN_PROCESS_TYPE>8</PN_PROCESS_TYPE>
            )else (
		<PN_PROCESS_TYPE>{fn:data($CreateCustomerRequest/ns1:ProcessType)}</PN_PROCESS_TYPE>
            )
        }
        {
            for $Migrate in $CreateCustomerRequest/ns1:Migrate
            return
            <ns2:PN_CODIGO_CLIENTE>{fn:data($Migrate)}</ns2:PN_CODIGO_CLIENTE>
        }
        {
            for $Segment in $CreateCustomerRequest/ns1:CustomerInfo/ns1:Segment
            return
            <ns2:PN_SEGMENTO>{fn:data($Segment)}</ns2:PN_SEGMENTO>
        }
        {
            let $OpeningCountry := fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "OpeningCountry"]/ns1:Value)
            return
            <ns2:PN_PAIS>{ local:CatalogValueOSBToAPP($OpeningCountry, 'ABANKSGT', '9', $GetCatalogsEquivalenceResponse) }</ns2:PN_PAIS>
        }
        {
			for $DPI in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IdList[ns1:DocumentName = "DOCTO PERSONAL DE ID (DPI)"]
			return(
            let $CountyOfIssuance := fn:data($DPI/ns1:CountryOfIssuance)
            return
        ...
        }
        {
			for $DPI in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IdList[ns1:DocumentName = "DOCTO PERSONAL DE ID (DPI)"]
			return(
            let $CityOfIssuance := fn:data($DPI/ns1:CityOfIssuance)
            return
        ...
        }
        {
			for $DPI in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IdList[ns1:DocumentName = "DOCTO PERSONAL DE ID (DPI)"]
			return(
            let $StateOfIssuance := fn:data($DPI/ns1:StateOfIssuance)
            return
        ...
        {
            let $Nombres := fn:concat(fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:FirstName), ' ', fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:SecondName))
            return
            <ns2:PV_NOMBRES>{ $Nombres }</ns2:PV_NOMBRES>
        }
        {
            for $FirstLastName in $CreateCustomerRequest/ns1:CustomerInfo/ns1:FirstLastName
            return
            <ns2:PV_PRIMER_APELLIDO>{fn:data($FirstLastName)}</ns2:PV_PRIMER_APELLIDO>
        }
        {
            for $SecondLastName in $CreateCustomerRequest/ns1:CustomerInfo/ns1:SecondLastName
            return
            <ns2:PV_SEGUNDO_APELLIDO>{fn:data($SecondLastName)}</ns2:PV_SEGUNDO_APELLIDO>
        }
        {
            for $MarriedName in $CreateCustomerRequest/ns1:CustomerInfo/ns1:MarriedName
            return
            <ns2:PV_APELLIDO_CASADA>{fn:data($MarriedName)}</ns2:PV_APELLIDO_CASADA>
        }
        {
            for $BirthDate in $CreateCustomerRequest/ns1:CustomerInfo/ns1:BirthDate
            return
            <ns2:PD_FECHA_NACIMIENTO>{ fn-bea:dateTime-from-string-with-format('yyyy-MM-dd', fn:data($BirthDate)) }</ns2:PD_FECHA_NACIMIENTO>
        }
        {
            let $BirthCountry := fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:BirthCountry)
            return
        ...
        {
            for $BirthPlace in $CreateCustomerRequest/ns1:CustomerInfo/ns1:BirthPlace
            return
            <ns2:PN_DEPARTAMENTO_NACIMIENTO>{local:CatalogValueOSBToAPP($BirthPlace, 'ABANKSGT', '8', $GetCatalogsEquivalenceResponse)}</ns2:PN_DEPARTAMENTO_NACIMIENTO>
        }
        {
            let $BirthCity := fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:BirthCity)
            return
        ...
        {
            for $CountryCode in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "SecondNationality"]
            return
            <ns2:PN_CODIGO_PAIS_2>{ local:CatalogValueOSBToAPP(fn:data($CountryCode/ns1:Value), 'ABANKSGT', '9', $GetCatalogsEquivalenceResponse) }</ns2:PN_CODIGO_PAIS_2>
        }
        {
            for $ImmigrationStatus in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "ImmigrationStatus"]
            return
            <ns2:PV_CONDICION_MIGRATORIA>{fn:data($ImmigrationStatus/ns1:Value)}</ns2:PV_CONDICION_MIGRATORIA>
        }
        {
            let $IsFatcaCustomer := fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:FatcaInfo/ns1:IsFatcaCustomer)
            let $IsUSResident := fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:FatcaInfo/ns1:IsUSResident)
            return
        ...
        {
            for $USAPhoneNumber in $CreateCustomerRequest/ns1:CustomerInfo/ns1:ContactInfo/ns1:PhoneList[ns1:Location = "USA"]
            return
                <ns2:PV_TELEFONO_EEUU>{fn:data($USAPhoneNumber/ns1:Number)}</ns2:PV_TELEFONO_EEUU>
        }
        {
            let $Gender := fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:Gender)
            return
                <ns2:PV_SEXO>{ local:CatalogValueOSBToAPP($Gender, 'ABANKSGT', '1', $GetCatalogsEquivalenceResponse) }</ns2:PV_SEXO>
        }
        {
            let $MaritalStatus := fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:MaritalStatus)
            return
        ...
        {
            for $NumberOfChildren in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "NumberOfChildren"]
            return
        ...
        }
        {
			for $DPI in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IdList[ns1:DocumentName = "DOCTO PERSONAL DE ID (DPI)"]
			return(
            let $DocumentName := fn:data($DPI/ns1:DocumentName)
            return
        ...
        }
		{
			for $DPI in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IdList[ns1:DocumentName = "DOCTO PERSONAL DE ID (DPI)"]
			return(
			<ns2:PV_NUMERO_IDENTIFICACION>{fn:data($DPI/ns1:LegalId)}</ns2:PV_NUMERO_IDENTIFICACION>
			)
		}
        
        {
            for $Activity in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "Activity"]
            return
            <ns2:PN_CODIGO_TIPO_CLIENTE>{fn:data($Activity/ns1:Value)}</ns2:PN_CODIGO_TIPO_CLIENTE>
        }
        {
            for $NIT in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IdList[ns1:DocumentName = "NUMERO DE ID TRIBUTA (NIT)"]
            return
            <ns2:PV_NIT>{fn:data($NIT/ns1:LegalId)}</ns2:PV_NIT>
        }
        {
            if ($CreateCustomerRequest/ns1:CustomerInfo/ns1:ContactInfo/ns1:AddressList) then (
              <ns2:PT_DIRECCION>
              {
                  for $address in $CreateCustomerRequest/ns1:CustomerInfo/ns1:ContactInfo/ns1:AddressList
                  return (
                      <ns2:PT_DIRECCION_ITEM>
                          <ns2:PV_TYPE>{fn:data($address/ns1:Type)}</ns2:PV_TYPE>
                          {
                            let $CountryCode := fn:data($address/ns1:CountryCode)
                            return
                            <ns2:PN_CODIGO_PAIS>{ local:CatalogValueOSBToAPP($CountryCode, 'ABANKSGT', '9', $GetCatalogsEquivalenceResponse) }</ns2:PN_CODIGO_PAIS>
                          }
                          {
                            let $State := fn:data($address/ns1:StateCode)
                            return
                            <ns2:PN_CODIGO_DEPTO>{ local:CatalogValueOSBToAPP($State, 'ABANKSGT', '8', $GetCatalogsEquivalenceResponse) }</ns2:PN_CODIGO_DEPTO>
                          }
                          {
                            let $City := fn:data($address/ns1:CityCode)
                            return
                            <ns2:PN_CODIGO_MUNICIPIO>{ local:CatalogValueOSBToAPP($City, 'ABANKSGT', '7', $GetCatalogsEquivalenceResponse) }</ns2:PN_CODIGO_MUNICIPIO>
                          }
                          ...
                          {
                              for $email in $CreateCustomerRequest/ns1:CustomerInfo/ns1:ContactInfo/ns1:EmailList[ns1:Type = $address/ns1:Type]
                              return
                              <ns2:PV_EMAIL>{fn:data($email/ns1:Email)}</ns2:PV_EMAIL>
                          }
                          {
                            let $mobileMain := $CreateCustomerRequest/ns1:CustomerInfo/ns1:ContactInfo/ns1:PhoneList[ns1:Type = "Mobile" and ns1:Ismain = 'Yes']
                            let $mobileSec := $CreateCustomerRequest/ns1:CustomerInfo/ns1:ContactInfo/ns1:PhoneList[ns1:Type = "Mobile" and ns1:Ismain = 'No']
                            return
                          ...
                          {
                            let $phoneMain := $CreateCustomerRequest/ns1:CustomerInfo/ns1:ContactInfo/ns1:PhoneList[ns1:Type = "Landline" and ns1:Ismain = 'Yes']
                            let $phoneSec := $CreateCustomerRequest/ns1:CustomerInfo/ns1:ContactInfo/ns1:PhoneList[ns1:Type = "Landline" and ns1:Ismain = 'No']
                            return
                              if(fn:data($address/ns1:Type)= '1')then(
                          ...
                          {
                            let $faxMain := $CreateCustomerRequest/ns1:CustomerInfo/ns1:ContactInfo/ns1:PhoneList[ns1:Type = "Fax" and ns1:Ismain = 'Yes']
                            let $faxSec := $CreateCustomerRequest/ns1:CustomerInfo/ns1:ContactInfo/ns1:PhoneList[ns1:Type = "Fax" and ns1:Ismain = 'No']
                            return
                              if(fn:data($address/ns1:Type)= '1')then(
        ...
        {
            let $IsPepCustomer := fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:PepInfo/ns1:IsPepCustomer)
            return
        ...
        {
            for $PepInfo in $CreateCustomerRequest/ns1:CustomerInfo/ns1:PepInfo
            return
            if ($PepInfo/ns1:IsPepCustomer = "Yes") then (
                <ns2:PV_NOMBRE_PEP>
                { 
                    fn:concat(
                        fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:FirstName), 
                        ' ',
                        fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:SecondName), 
                        ' ',
                        fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:FirstLastName),
                        ' ',
                        fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:SecondLastName)
                    )
                }
                </ns2:PV_NOMBRE_PEP>,
                ...
                <ns2:PT_ORIGEN_RIQUEZA_PEP>
                    ...
                    {
                        for $WealthOrigin in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "WealthOrigin"]
                        return
                        <ns2:PV_DESCRIPCION>{fn:data($WealthOrigin/ns1:Value)}</ns2:PV_DESCRIPCION>
                    }
                    {
                        for $WealthValue in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "WealthValue"]
                        return
                ...
                return
                    <ns2:PT_PARIENTE_PEP>
                        <ns2:PT_PARIENTE_PEP_ITEM>
                            ...
                            {
                                for $PepAssociatedFirstName in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "PepAssociatedFirstName"]
                                return
                                <ns2:PV_PRIMER_NOMBRE_AS>{fn:data($PepAssociatedFirstName/ns1:Value)}</ns2:PV_PRIMER_NOMBRE_AS>   
                            }
                            {
                                for $PepAssociatedSecondName in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "PepAssociatedSecondName"]
                                return
                                <ns2:PV_SEGUNDO_NOMBRE_AS>{fn:data($PepAssociatedSecondName/ns1:Value)}</ns2:PV_SEGUNDO_NOMBRE_AS>
                            }
                            {
                                for $PepAssociatedFirstLastName in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "PepAssociatedFirstLastName"]
                                return
                                <ns2:PV_PRIMER_APELLIDO_AS>{fn:data($PepAssociatedFirstLastName/ns1:Value)}</ns2:PV_PRIMER_APELLIDO_AS>
                            }
                            {
                                for $PepAssociatedSecondLastName in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "PepAssociatedSecondLastName"]
                                return
                                <ns2:PV_SEGUNDO_APELLIDO_AS>{fn:data($PepAssociatedSecondLastName/ns1:Value)}</ns2:PV_SEGUNDO_APELLIDO_AS>
                            }
                            {
                                for $PepAssociatedSecondOtherName in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "PepAssociatedSecondOtherName"]
                                return
                                <ns2:PV_OTRO_NOMBRE_AS>{fn:data($PepAssociatedSecondOtherName/ns1:Value)}</ns2:PV_OTRO_NOMBRE_AS>
                            }
                            {
                                for $PepAssociatedMarriedName in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "PepAssociatedMarriedName"]
                                return
                            ...
                            {
                                for $PepAssociatedGender in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "PepAssociatedGender"]
                                return
                                <ns2:PV_SEXO_PEP_AS>{fn:data($PepAssociatedGender/ns1:Value)}</ns2:PV_SEXO_PEP_AS>
                            }
                            {
                                for $PepAssociatedImmigrationStatus in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "PepAssociatedImmigrationStatus"]
                                return
                                <ns2:PV_CONDICION_MIGRATORIA_AS>{fn:data($PepAssociatedImmigrationStatus/ns1:Value)}</ns2:PV_CONDICION_MIGRATORIA_AS>
                            }
                            {
                                for $PepAssociatedInstitutionName in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "PepAssociatedInstitutionName"]
                                return
                                <ns2:PV_NOMBRE_INSTITUCION_AS>{fn:data($PepAssociatedInstitutionName/ns1:Value)}</ns2:PV_NOMBRE_INSTITUCION_AS>
                            }
                            {
                                for $PepAssociatedJobTitle in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "PepAssociatedJobTitle"]
                                return
                                <ns2:PV_CARGO_AS>{fn:data($PepAssociatedJobTitle/ns1:Value)}</ns2:PV_CARGO_AS>
                            }
                            {
                                for $PepAssociatedCountry in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "PepAssociatedCountry"]
                                return
                                <ns2:PN_PAIS_AS>{fn:data($PepAssociatedCountry/ns1:Value)}</ns2:PN_PAIS_AS>
                            }
                            {
                                for $PepAssociatedRelationship in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "PepAssociatedRelationship"]
                                return
        ...
        {
            let $GovernmentContractor := fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:GovernmentContractor)
            return
        ...
        {
            for $CPEType in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "CPEType"]
            return
            <ns2:PV_TIPO_CPE>{fn:data($CPEType/ns1:Value)}</ns2:PV_TIPO_CPE>
        }
        {
            for $CPEAssociatedProduct in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "CPEAssociatedProduct"]
            return
            <ns2:PN_PRODUCTO_ASOCIADO_CPE>{fn:data($CPEAssociatedProduct/ns1:Value)}</ns2:PN_PRODUCTO_ASOCIADO_CPE>
        }
        {
            for $CPEProduct in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "CPEProduct"]
            return
            <ns2:PN_OTROS_PRODUCTOS_CPE>{fn:data($CPEProduct/ns1:Value)}</ns2:PN_OTROS_PRODUCTOS_CPE>
        }
        {
            for $CPEStatus in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "CPEStatus"]
            return
            <ns2:PN_ESTATUS_GUATECOMPRAS_CPE>{fn:data($CPEStatus/ns1:Value)}</ns2:PN_ESTATUS_GUATECOMPRAS_CPE>
        }
        {
            for $ApnfdCustomer in $CreateCustomerRequest/ns1:CustomerInfo/ns1:ApnfdCustomer
            return
            <ns2:PV_PORE_CLIENT>{fn:data($ApnfdCustomer)}</ns2:PV_PORE_CLIENT>
        }
        {
            for $ApnfdProfession in $CreateCustomerRequest/ns1:CustomerInfo/ns1:ApnfdProfession
            return
            <ns2:PV_PORES_ACTIVIDAD>{fn:data($ApnfdProfession)}</ns2:PV_PORES_ACTIVIDAD>
        }
        {
            let $ProfessionCode := fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:ProfessionCode)
            return 
        ...
        {
            for $LineOfBusiness in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:LineOfBusiness
            return
            <ns2:PN_CODIGO_SECTOR_E>{fn:data($LineOfBusiness)}</ns2:PN_CODIGO_SECTOR_E>
        }
        {
            for $CustomerRisk in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "CustomerRisk"]
            return
            <ns2:PV_TIPO_RIESGO>{fn:data($CustomerRisk/ns1:Value)}</ns2:PV_TIPO_RIESGO>
        }
        {
            for $EconomicActivityCode in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "EconomicActivityCode"]
            return
            <ns2:PN_COD_ACTIVIDAD_ECONOMICA>{fn:data($EconomicActivityCode/ns1:Value)}</ns2:PN_COD_ACTIVIDAD_ECONOMICA>
        }
        {
            for $EconomicActivityDesc in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "EconomicActivityDesc"]
            return
            <ns2:PV_DESC_ACTIVIDAD_ECO>{fn:data($EconomicActivityDesc/ns1:Value)}</ns2:PV_DESC_ACTIVIDAD_ECO>
        }
        {
            let $EducationLevel := fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:EducationLevel)
            return
        ...
        {
            for $Occupation in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:Occupation
            return
            <ns2:PN_CODIGO_OCUPACION>{fn:data($Occupation)}</ns2:PN_CODIGO_OCUPACION>
        }
        {
            for $Industry in $CreateCustomerRequest/ns1:CustomerInfo/ns1:Industry
            return
            <ns2:PV_TIPO_EMPRESA>{ fn:data($Industry) }</ns2:PV_TIPO_EMPRESA>
        }
        {
            let $CurrentlyEmployed := fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:CurrentlyEmployed)
            return
        ...
        {
            for $CompanyName in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:CompanyName
            return
            <ns2:PV_NOMBRE_EMPRESA>{fn:data($CompanyName)}</ns2:PV_NOMBRE_EMPRESA>
        }
        <ns2:PV_CARGO>{fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:JobTitle)}</ns2:PV_CARGO>
        <ns2:PT_INGRESOS>
            <ns2:PT_INGRESOS_ITEM>
                {
                    for $IncomeSource in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:OtherIncomeSourceList/ns1:IncomeSource
                    return
                    <ns2:PN_COD_TIPO_INGRESO>{fn:data($IncomeSource)}</ns2:PN_COD_TIPO_INGRESO>
                }
                {
                    for $SourceName in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:OtherIncomeSourceList/ns1:SourceName
                    return
                    <ns2:PV_DESCRIPCION>{fn:data($SourceName)}</ns2:PV_DESCRIPCION>
                }
                {
                    for $IncomeCurrency in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:OtherIncomeSourceList/ns1:IncomeCurrency
                    return
                    <ns2:PV_MONEDA>{fn:data($IncomeCurrency)}</ns2:PV_MONEDA>
                }
                <ns2:PN_MONTO>{fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:OtherIncomeSourceList/ns1:Amount)}</ns2:PN_MONTO>
                {
                    for $CountryCode in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:OtherIncomeSourceList/ns1:CountryCode
                    return
                    <ns2:PV_PAIS>{fn:data($CountryCode)}</ns2:PV_PAIS>
                }
                {
                    for $StateCode in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:OtherIncomeSourceList/ns1:StateCode
                    return
        ...
        {
            for $StartDate in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:StartDate
            return
            <ns2:PD_FECHA_INGRESO>{ fn-bea:dateTime-from-string-with-format('yyyy-MM-dd', fn:data($StartDate)) }</ns2:PD_FECHA_INGRESO>
        }
        <ns2:PN_INGRESOS>{fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:IncomeRange)}</ns2:PN_INGRESOS>
        {
            for $Expenses in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:Expenses
            return
            <ns2:PN_EGRESOS>{fn:data($Expenses)}</ns2:PN_EGRESOS>
        }
        {
            for $FundsTransfer in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "FundsTransfer"]
            return
            <ns2:PV_TRANF_FONDOS>{fn:data($FundsTransfer/ns1:Value)}</ns2:PV_TRANF_FONDOS>
        }
        {
            for $FundsTransferType in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "FundsTransferType"]
            return
            <ns2:PV_LOCA_INTER>{fn:data($FundsTransferType/ns1:Value)}</ns2:PV_LOCA_INTER>
        }
        {
            for $BusinessOwner in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "BusinessOwner"]
            return
            <ns2:PV_NEGOCIO_PROPIO>{fn:data($BusinessOwner/ns1:Value)}</ns2:PV_NEGOCIO_PROPIO>
        }
        {
            for $GeneratorType in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "GeneratorType"]
            return
            <ns2:PV_TIPO_GENERADOR>{fn:data($GeneratorType/ns1:Value)}</ns2:PV_TIPO_GENERADOR>
        }
        {
            if ($CreateCustomerRequest/ns1:CustomerInfo/ns1:ReferenceList) then (
                <ns2:PT_REFERENCIAS>
                    {
                        for $Reference in $CreateCustomerRequest/ns1:CustomerInfo/ns1:ReferenceList
                        return (
        ...
        {
            for $HouseOwner in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "HouseOwner"]
            return
            <ns2:PN_POSEE_CASA>{fn:data($HouseOwner/ns1:Value)}</ns2:PN_POSEE_CASA>
        }
        {
            for $CarOwner in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "CarOwner"]
            return
        ...
        {
            for $USFiscallId in $CreateCustomerRequest/ns1:CustomerInfo/ns1:FatcaInfo/ns1:USFiscallId
            return
            <ns2:LV_TIN>{fn:data($USFiscallId)}</ns2:LV_TIN>
        }
        {
            for $FatcaIndicator in $CreateCustomerRequest/ns1:CustomerInfo/ns1:FatcaInfo/ns1:FatcaIndicator
            return
        ...
        {
            for $ReviewedForValidation in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "ReviewedForValidation"]
            return
            <ns2:LV_REV_VALIDACION>{fn:data($ReviewedForValidation/ns1:Value)}</ns2:LV_REV_VALIDACION>
        }
        {
            for $FatcaDocumented in $CreateCustomerRequest/ns1:CustomerInfo/ns1:FatcaInfo/ns1:FatcaDocumented
            return
            <ns2:LV_DOC_FATCA>{fn:data($FatcaDocumented)}</ns2:LV_DOC_FATCA>
        }
        {
            for $FatcaReports in $CreateCustomerRequest/ns1:CustomerInfo/ns1:FatcaInfo/ns1:FatcaReports
            return
            <ns2:PV_REPT_FATCA>{fn:data($FatcaReports)}</ns2:PV_REPT_FATCA>
        }
        {
            let $IsInmigrant := fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:FatcaInfo/ns1:IsInmigrant)
            return
        ...
        {
            for $CountryOfResidence in $CreateCustomerRequest/ns1:CustomerInfo/ns1:FatcaInfo/ns1:CountryOfResidence
            return
            <ns2:PN_PAIS_RES_FISCAL>{fn:data($CountryOfResidence)}</ns2:PN_PAIS_RES_FISCAL>
        }
        {
            for $AdditionalFiscalID in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "AdditionalFiscalID"]
            return
            <ns2:PV_ID_FISCAL_OTRO_PAIS>{fn:data($AdditionalFiscalID/ns1:Value)}</ns2:PV_ID_FISCAL_OTRO_PAIS>
        }
        {
            for $OtherCompanies in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "OtherCompanies"]
            return
        ...
        }
        {
            ...
            then <ns2:PV_CODIGO_USUARIO>{fn:data($CreateCustomerRequest/ns1:CustomerInfo/ns1:AccountOfficer)}</ns2:PV_CODIGO_USUARIO>
            else ()
        }
        {
            for $Sector in $CreateCustomerRequest/ns1:CustomerInfo/ns1:Sector
            return
            <ns2:PV_TIPO_PERSONA>{fn:data($Sector)}</ns2:PV_TIPO_PERSONA>
        }
        {
            for $CompanyCode in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "CompanyCode"]
            return
            <ns2:PN_CODIGO_EMPRESA>{fn:data($CompanyCode/ns1:Value)}</ns2:PN_CODIGO_EMPRESA>
        }
        {
            for $Agency in $CreateCustomerRequest/ns1:AccountInfo/ns1:Agency
            return
            <ns2:PN_CODIGO_AGENCIA>{fn:data($Agency)}</ns2:PN_CODIGO_AGENCIA>
        }
        {
            for $SubApplication in $CreateCustomerRequest/ns1:AccountInfo/ns1:SubApplication
            return
            <ns2:PN_CODIGO_SUB_APLIC>{fn:data($SubApplication)}</ns2:PN_CODIGO_SUB_APLIC>
        }
        {
            for $Application in $CreateCustomerRequest/ns1:AccountInfo/ns1:Application
            return
            <ns2:PV_CODIGO_APLICACION>{fn:data($Application)}</ns2:PV_CODIGO_APLICACION>
        }
        {
            for $Currency in $CreateCustomerRequest/ns1:AccountInfo/ns1:Currency
            return
            <ns2:PV_MONEDA>{fn:data($Currency)}</ns2:PV_MONEDA>
        }
        {
            for $OperationType in $CreateCustomerRequest/ns1:AccountInfo/ns1:OperationType
            return
            <ns2:PV_TIPO_OPERACION>{fn:data($OperationType)}</ns2:PV_TIPO_OPERACION>
        }
        {
            for $Passbook in $CreateCustomerRequest/ns1:AccountInfo/ns1:Passbook
            return
            <ns2:PV_LIBRETA>{fn:data($Passbook)}</ns2:PV_LIBRETA>
        }
        {
            for $PassbookNumber in $CreateCustomerRequest/ns1:AccountInfo/ns1:PassbookNumber
            return
            <ns2:PN_NUM_LIBRETA>{fn:data($PassbookNumber)}</ns2:PN_NUM_LIBRETA>
        }
        {
            for $PayrollGroup in $CreateCustomerRequest/ns1:AccountInfo/ns1:PayrollGroup
            return
            <ns2:PV_CODIGO_G_PLANILLA>{fn:data($PayrollGroup)}</ns2:PV_CODIGO_G_PLANILLA>
        }
        {
            for $InitialDeposit in $CreateCustomerRequest/ns1:AccountInfo/ns1:InitialDeposit
            return
            <ns2:PN_DEP_INICIAL>{fn:data($InitialDeposit)}</ns2:PN_DEP_INICIAL>
        }
        {
            for $Purpose in $CreateCustomerRequest/ns1:AccountInfo/ns1:Purpose
            return
            <ns2:PV_PROPOSITO_CTA>{fn:data($Purpose)}</ns2:PV_PROPOSITO_CTA>
        }
        {
            for $OrigenOfFunds in $CreateCustomerRequest/ns1:AccountInfo/ns1:OrigenOfFunds
            return
            <ns2:PV_ORIGEN_FONDOS>{fn:data($OrigenOfFunds)}</ns2:PV_ORIGEN_FONDOS>
        }
        {
            for $MonthlyTxnVolume in $CreateCustomerRequest/ns1:AccountInfo/ns1:MonthlyTxnVolume
            return
            <ns2:PV_VOL_TRX_MENSUAL>{fn:data($MonthlyTxnVolume)}</ns2:PV_VOL_TRX_MENSUAL>
        }
        {
            if ($CreateCustomerRequest/ns1:AccountInfo/ns1:BeneficiaryDetails) then (
                <ns2:TR_BENEFICIARIOS>
                {
                    for $Beneficiary in $CreateCustomerRequest/ns1:AccountInfo/ns1:BeneficiaryDetails
                    return(
        ...
        {
            if ($CreateCustomerRequest/ns1:AccountInfo/ns1:SignatoryDetails) then (
                <ns2:TR_FIRMAS>
                {
                    for $Signatory in $CreateCustomerRequest/ns1:AccountInfo/ns1:SignatoryDetails
                    return(
                        <ns2:TR_FIRMAS_ITEM>
        ...
        {
            for $ElectricityBill in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "ElectricityBill"]
            return
            <ns2:PN_CORRE_RECB_LUZ>{fn:data($ElectricityBill/ns1:Value)}</ns2:PN_CORRE_RECB_LUZ>
        }
        {
            for $ElectricityCompany in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "ElectricityCompany"]
            return
            <ns2:PV_EMPRESA_ELECTRICA>{fn:data($ElectricityCompany/ns1:Value)}</ns2:PV_EMPRESA_ELECTRICA>
        }
        {
            for $EconomicActivity in $CreateCustomerRequest/ns1:CustomerInfo/ns1:AdditionalInfo[ns1:Name = "EconomicActivity"]
            return
            <ns2:PV_ACT_ECO_RUT>{fn:data($EconomicActivity/ns1:Value)}</ns2:PV_ACT_ECO_RUT>
        }
        {
            for $CompanyType in $CreateCustomerRequest/ns1:CustomerInfo/ns1:IncomeSourceList/ns1:CompanyType
            return
            if (fn:upper-case($CompanyType) = "PRIVADA") then (
                <ns2:PV_PRIVADA_PUBLICA>P</ns2:PV_PRIVADA_PUBLICA>
            ) else if (fn:upper-case($CompanyType) = "PUBLICA") then (
                <ns2:PV_PRIVADA_PUBLICA>G</ns2:PV_PRIVADA_PUBLICA>
            ) else (
                <ns2:PV_PRIVADA_PUBLICA/>
            )
        }
    </ns2:InputParameters>
};

local:func($CreateCustomerRequest, $GetCatalogsEquivalenceResponse)