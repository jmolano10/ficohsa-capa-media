...
declare function xq:Tx_ErrorInfo_ToGetCreditOffersResponse($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:getCreditOffersResponse) ::) {
...
xq:Tx_ErrorInfo_ToGetCreditOffersResponse($errorInfo)