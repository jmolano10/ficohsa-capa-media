...
declare namespace ns2="http://www.ficohsa.com.hn/middleware.services/getCustomerSecondOffer";
(:: import schema at "../../../../../../MWBanking/CreditManagement/RequestorServices/XSD/getCustomerSecondOffer.xsd" ::)

declare variable $errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::) external;

declare function local:func($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:getCustomerSecondOfferResponse) ::) {
    <ns2:getCustomerSecondOfferResponse>
        <ns2:ErrorInfo>
            {
