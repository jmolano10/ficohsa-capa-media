...
declare function local:func($GetParameterResponse as element() (:: schema-element(ns1:OutputParameters) ::), 
                            ...
                            as element() (:: schema-element(ns3:OnlinePaymentV4Request) ::) {
    <ns3:OnlinePaymentV4Request>
        ...
        <RequestType>{fn:data($GetParameterResponse/ns1:CONFIGURACIONES/ns1:CONFIGURACIONES_ITEM[ns1:NAME='FICBCO0067.HN01.REVERSE']/ns1:VALUE)}</RequestType>
...
local:func($GetParameterResponse, $PaymentRecordCreditCardRequest, $SEQ, $ORG, $merchantDefault, $merchant)