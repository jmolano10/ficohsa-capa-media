...
declare namespace ns2="http://www.ficohsa.com.hn/middleware.services/getCustomerCreditCardTypes";
...
declare function local:func($ErrorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:getCustomerCreditCardResponse) ::) {
    <ns2:getCustomerCreditCardResponse>
        <ns2:ErrorInfo>
            {
