...
declare namespace ns2="http://www.ficohsa.com.hn/middleware.services/activateCreditCardTypes";
(:: import schema at "../../../../../../MWBanking/CreditCards/RequestorServices/XSD/activateCreditCardTypes.xsd" ::)
...
declare function local:func($ErrorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:activateCreditCardResponse) ::) {
    <ns2:activateCreditCardResponse>
        <ns2:ErrorInfo>
            {
