...
declare function local:func($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:creditCardDigitalApplicationResponse) ::) {
    <ns2:creditCardDigitalApplicationResponse>
        ...
        <ns2:ErrorInfo>
            ...
            <ns1:Details>
                {
                    if ($errorInfo/ns1:Details/ns1:SystemId)
                    then <ns1:SystemId>{fn:data($errorInfo/ns1:Details/ns1:SystemId)}</ns1:SystemId>
                    else ()
                }
                {
                    if ($errorInfo/ns1:Details/ns1:SystemStatus)
                    then <ns1:SystemStatus>{fn:data($errorInfo/ns1:Details/ns1:SystemStatus)}</ns1:SystemStatus>
                    else ()
                }
                {
                    if ($errorInfo/ns1:Details/ns1:MessageId)
                    then <ns1:MessageId>{fn:data($errorInfo/ns1:Details/ns1:MessageId)}</ns1:MessageId>
                    else ()
                }
                {
                    if ($errorInfo/ns1:Details/ns1:Messages)
                    then <ns1:Messages>{fn:data($errorInfo/ns1:Details/ns1:Messages)}</ns1:Messages>
                    else ()
                }
            </ns1:Details>
        </ns2:ErrorInfo>
