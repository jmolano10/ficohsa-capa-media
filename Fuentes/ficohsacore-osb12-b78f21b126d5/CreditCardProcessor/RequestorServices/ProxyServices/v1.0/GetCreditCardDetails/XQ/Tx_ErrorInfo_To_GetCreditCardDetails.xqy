...
declare namespace ns2="http://www.ficohsa.com.hn/middleware.services/getCreditCardDetailsTypes";
...
declare function local:func($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:getCreditCardDetailsResponse) ::) {
