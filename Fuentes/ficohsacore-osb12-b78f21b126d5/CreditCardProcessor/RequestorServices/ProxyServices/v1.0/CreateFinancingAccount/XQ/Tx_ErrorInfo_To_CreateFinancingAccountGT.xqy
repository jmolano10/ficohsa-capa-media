...
declare function local:func($errorInfo as element() (:: schema-element(ns2:ErrorInfo) ::)) as element() (:: schema-element(ns1:createFinancingAccountResponse) ::) {
    <ns1:createFinancingAccountResponse>
        <ns1:ErrorInfo>
            {
