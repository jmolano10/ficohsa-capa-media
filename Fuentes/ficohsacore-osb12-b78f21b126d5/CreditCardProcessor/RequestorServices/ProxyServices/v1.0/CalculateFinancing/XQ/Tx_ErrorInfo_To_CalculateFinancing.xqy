...
declare namespace ns2="http://www.ficohsa.com.hn/middleware.services/calculateFinancingTypes";
...
declare function local:func($errorInfo as element() (:: schema-element(ns1:ErrorInfo) ::)) as element() (:: schema-element(ns2:calculateFinancingResponse) ::) {
    <ns2:calculateFinancingResponse>
    <ErrorInfo>
            {
