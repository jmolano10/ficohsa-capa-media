...
declare function local:deleteProvider(
    ...
    ) as element() (:: schema-element(ns2:deleteProviderResponse) ::) {
    <ns2:deleteProviderResponse>
        <StatusInfo>
...
local:deleteProvider($responseError, $state, $codeError, $messageError, $targetSystem, $globalId)