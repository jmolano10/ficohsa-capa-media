...
declare function local:func(
    ...
    ) as element() (:: schema-element(ns2:updateBatchRecordStatusResponse) ::) {
    <ns2:updateBatchRecordStatusResponse>
        <StatusInfo>
...
local:func($responseError, $state, $codeError, $messageError, $targetSystem, $globalId)