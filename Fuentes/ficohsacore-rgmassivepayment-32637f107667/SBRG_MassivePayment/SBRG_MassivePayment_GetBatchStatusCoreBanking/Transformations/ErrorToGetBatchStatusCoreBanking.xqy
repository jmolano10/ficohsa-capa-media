...
(:: import schema at "../Schemas/GetBatchStatusCoreBankingTypes.xsd" ::)
...
declare function local:func(
    ...
    ) as element() (:: schema-element(ns2:getBatchStatusCoreBankingResponse) ::) {
    <ns2:getBatchStatusCoreBankingResponse>
        <StatusInfo>
