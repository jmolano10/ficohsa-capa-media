...
declare variable $responseService as element() (:: schema-element(ns1:updateBatchRecordStatusResponse) ::) external;

declare function local:func(
    $responseService as element() (:: schema-element(ns1:updateBatchRecordStatusResponse) ::)
