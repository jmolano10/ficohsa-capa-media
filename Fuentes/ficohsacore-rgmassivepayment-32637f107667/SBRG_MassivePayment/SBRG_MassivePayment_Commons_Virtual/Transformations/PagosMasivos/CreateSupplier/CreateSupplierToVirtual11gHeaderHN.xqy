...
declare variable $responseService as element() (:: schema-element(ns1:createSupplierResponse) ::) external;

declare function local:func(
    $responseService as element() (:: schema-element(ns1:createSupplierResponse) ::)
