...
(:: pragma bea:global-element-return element="ns1:Pagoderecaudoamdcdbcta" location="../../xsds/PagoRecaudosAmdc/XMLSchema_-1803864288.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/PagoRecaudoAMDC/PagoRecaudoAMDCDebitoCuentaIn/";

declare function xf:PagoRecaudoAMDCDebitoCuentaIn($autenticacionRequestHeader as element(ns3:AutenticacionRequestHeader),
    $pagoRecaudoAMDC as element(ns0:pagoRecaudoAMDC),
    $outputParameters as element(ns2:OutputParameters),
    $uuid as xs:string)
    as element(ns1:Pagoderecaudoamdcdbcta) {
        <ns1:Pagoderecaudoamdcdbcta>
            <WebRequestCommon>
            ...
            <FUNDSTRANSFERLATAMPROPACWSType>
                {
...
xf:PagoRecaudoAMDCDebitoCuentaIn($autenticacionRequestHeader,
    $pagoRecaudoAMDC,
    $outputParameters,
    $uuid)