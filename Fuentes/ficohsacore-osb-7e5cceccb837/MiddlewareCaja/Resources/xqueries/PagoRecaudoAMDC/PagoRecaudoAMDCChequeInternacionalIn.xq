...
(:: pragma bea:global-element-return element="ns1:Pagoderecaudoamdcchqintl" location="../../xsds/PagoRecaudosAmdc/XMLSchema_-1803864288.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/PagoRecaudoAMDC/PagoRecaudoAMDCChequeInternacionalIn/";

declare function xf:PagoRecaudoAMDCChequeInternacionalIn($autenticacionRequestHeader as element(ns3:AutenticacionRequestHeader),
    $pagoRecaudoAMDC as element(ns0:pagoRecaudoAMDC),
    $outputParameters as element(ns2:OutputParameters),
    $uuid as xs:string)
    as element(ns1:Pagoderecaudoamdcchqintl) {
        <ns1:Pagoderecaudoamdcchqintl>
            <WebRequestCommon>
                ...
                <gCHEQUENUMBER>
                    <mCHEQUENUMBER>
                        ...
                        }
                        {
                            ...
                            return
                                <CHQACCOUNT>{ data($DEBIT_ACCOUNT) }</CHQACCOUNT>
                        }
                    </mCHEQUENUMBER>
                </gCHEQUENUMBER>
                <gLRINVOICENO>
...
xf:PagoRecaudoAMDCChequeInternacionalIn($autenticacionRequestHeader,
    $pagoRecaudoAMDC,
    $outputParameters,
    $uuid)