...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/ConsultaReciboRecaudo/ConsultaTransaccionTTIn/";

declare function xf:ConsultaTransaccionTTIn($autenticacionRequestHeader as element(ns1:AutenticacionRequestHeader),
