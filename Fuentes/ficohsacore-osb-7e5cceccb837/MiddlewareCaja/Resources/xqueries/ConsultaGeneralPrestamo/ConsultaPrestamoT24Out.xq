...
(:: pragma bea:global-element-return element="ns1:consultaGeneralPrestamoResponse" location="../../xsds/ConsultaGeneralPrestamo/ConsultaGeneralPrestamo.xsd" ::)

declare namespace ns1 = "http://www.ficohsa.com.hn/middleware.services/consultaGeneralPrestamoTypes";
declare namespace ns0 = "T24WebServicesImpl";
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/ConsultaGeneralPrestamo/ConsultaPrestamoT24Out/";
...
declare function xf:ConsultaPrestamoT24Out($consultadesaldodeprestamoResponse1 as element(ns0:ConsultadesaldodeprestamoResponse))
    as element(ns1:consultaGeneralPrestamoResponse) {
    	if (fn:string($consultadesaldodeprestamoResponse1/Status/successIndicator/text()) = "Success" and
    		fn:exists($consultadesaldodeprestamoResponse1/WSLOANDETAILSAAType[1]/gWSLOANDETAILSAADetailType[1]/mWSLOANDETAILSAADetailType[1]/CUSTOMERNAME/text())) then (
	            ...
	            <ns1:consultaGeneralPrestamoResponseType>
	                <ns1:consultaGeneralPrestamoResponseRecordType>
	                    ...
	                    }
	                    {
	                        ...
	                        return
	                            <NEXT_PAYMNT_ID>{ data(nextInsNo($PAIDINSNO)) }</NEXT_PAYMNT_ID>
	                    }
	                    {
