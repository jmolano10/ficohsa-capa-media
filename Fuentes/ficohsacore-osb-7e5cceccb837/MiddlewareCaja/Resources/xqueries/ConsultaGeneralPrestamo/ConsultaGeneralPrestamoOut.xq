(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../xsds/ConsultaGeneralPrestamo/consultaGeneralPrestamoAbanks/ORA_BANK_OSB_CON_GENERAL_PRESTAMO.xsd" ::)
(:: pragma bea:global-element-return element="ns0:consultaGeneralPrestamoResponse" location="../../xsds/ConsultaGeneralPrestamo/ConsultaGeneralPrestamo.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/ConsultaGeneralPrestamo/ConsultaGeneralPrestamoOut/";
        ...
        <ns0:consultaGeneralPrestamoResponse>
            <ns0:consultaGeneralPrestamoResponseType>
                <ns0:consultaGeneralPrestamoResponseRecordType>
                    ...
                    {
                        for $DETALLE_GNRAL in $outputParameters/ns1:DETALLE_GNRAL
                        return
                            <GENERAL_DETAILS>{ data($DETALLE_GNRAL) }</GENERAL_DETAILS>
                    }
                </ns0:consultaGeneralPrestamoResponseRecordType>
            </ns0:consultaGeneralPrestamoResponseType>
        </ns0:consultaGeneralPrestamoResponse>
