...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/PagoPrestamoCaja/DepositoCombinadoChequeInternacionalIn/";

declare function xf:DepositoCombinadoChequeInternacionalIn($autenticacionRequestHeader as element(ns2:AutenticacionRequestHeader),
    ...
    as element(ns1:Depositocombinado) {
        <ns1:Depositocombinado>
            ...
            <TELLERFINANCIALSERVICESFICOINPUTWSType>
                ...
                <gTRANSACTION>
                    <mTRANSACTION>
                        <TRANSACTION>CLEARING.INTL</TRANSACTION>
...
xf:DepositoCombinadoChequeInternacionalIn($autenticacionRequestHeader,
    $pagoPrestamo,
    $depositAccount,
    $accountCurrency,
    $uuid)