...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/ConsultaRecaudo/obtenerDebtorNameIn/";
declare namespace ns0 = "http://xmlns.oracle.com/pcbpel/adapter/db/FLINK/OSB_CONSULTAR_RPTA_TERCERO/";

declare function xf:obtenerDebtorNameIn($outputParameters as element(ns0:OutputParameters))
    as xs:string {
...
xf:obtenerDebtorNameIn($outputParameters)