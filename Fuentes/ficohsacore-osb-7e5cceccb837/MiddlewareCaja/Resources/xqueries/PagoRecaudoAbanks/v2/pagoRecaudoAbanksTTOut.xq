...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/PagoRecaudoAbanks/v2/pagoRecaudoAbanksTTOut/";

declare function xf:pagoRecaudoAbanksTTOut($tELLERType1 as element(),
    ...
    as element(ns2:pagoRecaudoAbanksResponse) {
        <ns2:pagoRecaudoAbanksResponse>
            ...
            {
                let $result :=
                    for $DATETIME in $tELLERType1/gDATETIME/DATETIME
                    return
            ...
            {
                for $RTEFORM in $tELLERType1/RTEFORM
                return
...
xf:pagoRecaudoAbanksTTOut($tELLERType1,
    $outputParameters1,
    $pagoRecaudoAbanks1,
