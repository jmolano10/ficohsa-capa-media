...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/DepositoDeEfecEnMonExtranjera/DepositoDeEfecEnMonExtranjeraAddOut/";

declare function xf:DepositoDeEfecEnMonExtranjeraAddOut($ACCOUNTNAME as xs:string,
...
xf:DepositoDeEfecEnMonExtranjeraAddOut($ACCOUNTNAME,
    $ALTACCOUNTID,
    $BRANCHNAME)