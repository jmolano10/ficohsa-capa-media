...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/DepositoEfecMonLocalEnMonExtranjera/DepositoEfecMonLocalEnMonExtranjeraAddOut/";

declare function xf:DepositoEfecMonLocalEnMonExtranjeraAddOut($ACCOUNTNAME as xs:string,
...
xf:DepositoEfecMonLocalEnMonExtranjeraAddOut($ACCOUNTNAME,
    $ALTACCOUNTID,
    $BRANCHNAME)