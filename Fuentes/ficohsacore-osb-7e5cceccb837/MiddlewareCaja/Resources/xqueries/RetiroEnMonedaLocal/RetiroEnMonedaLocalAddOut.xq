...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/RetiroEnMonedaLocal/RetiroEnMonedaLocalAddOut/";

declare function xf:RetiroEnMonedaLocalAddOut($ACCOUNTNAME as xs:string,
...
xf:RetiroEnMonedaLocalAddOut($ACCOUNTNAME,
    $ALTACCOUNTID,
    $BRANCHNAME)