...
(:: pragma bea:global-element-return element="ns0:Pagoderecaudolocalylineachqpr" location="../../xsds/PagoRecaudos/XMLSchema_-258408779.xsd" ::)

declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/PagoRecaudoMultiple/PagoRecaudoMultipleEnLineaChequePropioIn/";
...
declare function xf:PagoRecaudoMultipleEnLineaChequePropioIn($autenticacionRequestHeader as element(ns3:AutenticacionRequestHeader),
...
xf:PagoRecaudoMultipleEnLineaChequePropioIn($autenticacionRequestHeader,
    $pagoRecaudoMultiple,
    $outputParameters,
    $uuid)