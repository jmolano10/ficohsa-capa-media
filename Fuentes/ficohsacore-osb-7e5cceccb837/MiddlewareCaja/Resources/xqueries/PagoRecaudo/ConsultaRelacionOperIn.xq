...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../xsds/Recaudos/ConsultarRelacionOperacionRecaudo/FLINK_OSB_CONSULTAR_OPER_RECAUDO.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/PagoRecaudo/ConsultaRelacionOperIn/";

declare function xf:ConsultaRelacionOperIn($pagoRecaudo as element(ns0:pagoRecaudo))
...
xf:ConsultaRelacionOperIn($pagoRecaudo)