...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/PagoRecaudo/PagoRecaudoEnLineaChequeOtroBancoIn/";
...
declare function xf:PagoRecaudoEnLineaChequeOtroBancoIn($autenticacionRequestHeader as element(ns3:AutenticacionRequestHeader),
...
xf:PagoRecaudoEnLineaChequeOtroBancoIn($autenticacionRequestHeader,
    $pagoRecaudo,
    $outputParameters,
    $uuid)