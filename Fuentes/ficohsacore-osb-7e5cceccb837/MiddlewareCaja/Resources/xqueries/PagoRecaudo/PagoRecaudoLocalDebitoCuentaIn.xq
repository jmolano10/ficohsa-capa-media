...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/PagoRecaudo/PagoRecaudoLocalDebitoCuentaIn/";
...
declare function xf:PagoRecaudoLocalDebitoCuentaIn($autenticacionRequestHeader as element(ns3:AutenticacionRequestHeader),
...
xf:PagoRecaudoLocalDebitoCuentaIn($autenticacionRequestHeader,
    $pagoRecaudo,
    $outputParameters,
    $uuid)