...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/PagoRecaudo/ConsultaDetallesCuentaIOut/";
declare namespace ns0 = "T24WebServicesImpl";

declare function xf:ConsultaDetallesCuentaIOut($consultadedetallesdelacuentaResponse as element(ns0:ConsultadedetallesdelacuentaResponse))
    as xs:string {
...
xf:ConsultaDetallesCuentaIOut($consultadedetallesdelacuentaResponse)