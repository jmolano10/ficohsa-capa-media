...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/ConsultaRecaudoAbanks/v2/ConsultaParametrosCoreIn/";

declare function xf:ConsultaParametrosCoreIn($autenticacionRequestHeader1 as element(ns2:AutenticacionRequestHeader))
...
xf:ConsultaParametrosCoreIn($autenticacionRequestHeader1)