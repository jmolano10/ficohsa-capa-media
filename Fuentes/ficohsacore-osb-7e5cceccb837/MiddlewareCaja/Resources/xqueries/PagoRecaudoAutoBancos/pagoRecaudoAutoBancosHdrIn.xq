...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/PagoRecaudoAutoBancos/pagoRecaudoAutoBancosHdrIn/";

declare function xf:pagoRecaudoAutoBancosHdrIn($usuario as xs:string,
...
xf:pagoRecaudoAutoBancosHdrIn($usuario,
    $password)