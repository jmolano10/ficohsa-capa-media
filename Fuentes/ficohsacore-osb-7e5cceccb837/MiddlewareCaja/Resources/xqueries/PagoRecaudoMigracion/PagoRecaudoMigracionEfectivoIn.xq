...
(:: pragma bea:global-element-return element="ns0:Pagorecaudomigracionefec" location="../../xsds/PagoRecaudosMigracion/XMLSchema_-1578743007.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/PagoRecaudoMigracion/PagoRecaudoMigracionEfectivoIn/";

declare function xf:PagoRecaudoMigracionEfectivoIn($autenticacionRequestHeader as element(ns3:AutenticacionRequestHeader),
    $pagoRecaudoMigracion as element(ns2:pagoRecaudoMigracion),
    $outputParameters as element(ns1:OutputParameters),
    $uuid as xs:string)
    as element(ns0:Pagorecaudomigracionefec) {
        <ns0:Pagorecaudomigracionefec>
            <WebRequestCommon>
...
xf:PagoRecaudoMigracionEfectivoIn($autenticacionRequestHeader,
