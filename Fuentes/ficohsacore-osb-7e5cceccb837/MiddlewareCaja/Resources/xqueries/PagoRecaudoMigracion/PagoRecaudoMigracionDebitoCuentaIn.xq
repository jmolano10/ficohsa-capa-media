...
(:: pragma bea:global-element-return element="ns0:Pagorecaudomigraciondbcta" location="../../xsds/PagoRecaudosMigracion/XMLSchema_-1578743007.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/PagoRecaudoMigracion/PagoRecaudoMigracionDebitoCuentaIn/";

declare function xf:PagoRecaudoMigracionDebitoCuentaIn($autenticacionRequestHeader as element(ns3:AutenticacionRequestHeader),
    $pagoRecaudoMigracion as element(ns2:pagoRecaudoMigracion),
    $outputParameters as element(ns1:OutputParameters),
    $uuid as xs:string)
    as element(ns0:Pagorecaudomigraciondbcta) {
        <ns0:Pagorecaudomigraciondbcta>
            <WebRequestCommon>
            ...
            <FUNDSTRANSFERLATAMPPORTACWSType>
                {
                ...
                <PAYEECCY>{ data($pagoRecaudoMigracion/PAYMENT_INFORMATION/PAYMENT_CURRENCY) }</PAYEECCY>
                {
                    ...
                    return
                        <DEBITAMOUNT>{ data($PAYMENT_AMOUNT) }</DEBITAMOUNT>
                }
...
xf:PagoRecaudoMigracionDebitoCuentaIn($autenticacionRequestHeader,
