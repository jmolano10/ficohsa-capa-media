...
(:: pragma bea:global-element-return element="ns0:Pagorecaudomigracionchqintl" location="../../xsds/PagoRecaudosMigracion/XMLSchema_-1578743007.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/PagoRecaudoMigracion/PagoRecaudoMigracionChequeInternacionalIn/";

declare function xf:PagoRecaudoMigracionChequeInternacionalIn($autenticacionRequestHeader as element(ns3:AutenticacionRequestHeader),
    $pagoRecaudoMigracion as element(ns2:pagoRecaudoMigracion),
    $outputParameters as element(ns1:OutputParameters),
    $uuid as xs:string)
    as element(ns0:Pagorecaudomigracionchqintl) {
        <ns0:Pagorecaudomigracionchqintl>
            <WebRequestCommon>
            ...
            <TELLERLATAMDIRCHQINTLPPTWSType>
                <PAYEECCY>{ data($pagoRecaudoMigracion/PAYMENT_INFORMATION/PAYMENT_CURRENCY) }</PAYEECCY>
                {
                    ...
                    return
                        <AMOUNTLCY>{ data($PAYMENT_AMOUNT) }</AMOUNTLCY>
                }
                <gCHEQUENUMBER>
                    <mCHEQUENUMBER>
                        {
                        ...
                        }
                        {
                            ...
                            return
                                <CHEQUEACCOUNTNO>{ data($DEBIT_ACCOUNT) }</CHEQUEACCOUNTNO>
                        }
                    </mCHEQUENUMBER>
                </gCHEQUENUMBER>
...
xf:PagoRecaudoMigracionChequeInternacionalIn($autenticacionRequestHeader,
