...
(:: pragma bea:schema-type-parameter parameter="$tELLERType" type="ns0:TELLERType" location="../../xsds/ReversaTxnRecaudos/XMLSchema_728098728.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MiddlewareCaja/Resources/xqueries/ReversarTransaccion/ReversarTransaccionPagoRecaudoTellerHeaderOut/";

declare function xf:ReversarTransaccionPagoRecaudoTellerHeaderOut($status as element(),
...
xf:ReversarTransaccionPagoRecaudoTellerHeaderOut($status,
    $tELLERType)