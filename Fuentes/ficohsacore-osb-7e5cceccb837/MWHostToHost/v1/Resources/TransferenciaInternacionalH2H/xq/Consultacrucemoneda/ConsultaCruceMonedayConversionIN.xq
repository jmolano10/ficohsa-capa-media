...
declare namespace xf = "http://tempuri.org/MWHostToHost/v1/Resources/TransferenciaInternacionalH2H/xq/Consultacrucemoneda/tes/";

declare function xf:tes($transferenciaInternacionalH2HRequest as element(ns1:transferenciaInternacionalH2HRequest),
    ...
    as element(ns0:InputParameters) {
        <ns0:InputParameters>
            ...
            <ns0:PV_TASACAMBIO>{ $tasa }</ns0:PV_TASACAMBIO>
...
xf:tes($transferenciaInternacionalH2HRequest,
    $codigopais,
    $monto,
    $tasa)