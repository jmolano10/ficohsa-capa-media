(:: pragma bea:global-element-parameter parameter="$reversalRemitPayment" element="ns2:reversalRemitPayment" location="../../xsd/MoneyTransferOperationsTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns1:ReverseRemittance" location="../../../../BusinessServices/MoneyTransferOperations/wsdl/SwitchRemittanceService.asmx.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/MWCaja/v1/Resources/MoneyTransferOperations/ReversalRemitPayment/xq/reversalRemittanceGTIn/";

declare function xf:reversalRemittanceGTIn($reversalRemitPayment as element(ns2:reversalRemitPayment))
    as element(ns1:ReverseRemittance) {
        <ns1:ReverseRemittance>
            <ns1:pRequest>
                <ns1:transactionID>{ data($reversalRemitPayment/ns2:TRANSACTION_ID) }</ns1:transactionID>
                {
                    let $NSO_INFO := $reversalRemitPayment/ns2:NSO_INFO
                    return
                        <ns1:NsoInfo>
                            {
...
declare variable $reversalRemitPayment as element(ns2:reversalRemitPayment) external;

xf:reversalRemittanceGTIn($reversalRemitPayment)
