(:: pragma bea:global-element-parameter parameter="$cashReception" element="ns2:cashReception" location="../../xsd/BranchCashMgmtTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../../BusinessServices/AbanksGT/RecepcionEfectivo/xsd/MCRecepcionEfectivo_sp.xsd" ::)

declare namespace ns0 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/MCRecepcionEfectivo";
...
declare namespace xf = "http://tempuri.org/MWCaja/v1/Resources/BranchCashMgmt/CashReception/xq/mcRecepcionEfectivoGTIn/";

declare function xf:mcRecepcionEfectivoGTIn($cashReception as element(ns2:cashReception))
    as element(ns0:InputParameters) {
        <ns0:InputParameters>
            {
                let $OTHER_PARTY := $cashReception/ns2:OTHER_PARTY
                return
                    <ns0:PR_OTHER_PARTY>
            ...
            {
                let $PAYMENT := $cashReception/ns2:PAYMENT
                return
                    <ns0:PR_PAYMENT>
                        <ns0:PAY_ITEM>
                            {
            ...
            {
                let $NSO_INFO := $cashReception/ns2:NSO_INFO
                return
                    <ns0:PR_NSO_INFO>
                        {
...
declare variable $cashReception as element(ns2:cashReception) external;

xf:mcRecepcionEfectivoGTIn($cashReception)
