(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../../BusinessServices/AbanksGT/RecepcionEfectivo/xsd/MCRecepcionEfectivo_sp.xsd" ::)
(:: pragma bea:global-element-return element="ns2:cashReceptionResponse" location="../../xsd/BranchCashMgmtTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MWCaja/v1/Resources/BranchCashMgmt/CashReception/xq/cashReceptionGTOut/";

declare function xf:cashReceptionGTOut($outputParameters as element(ns0:OutputParameters))
    as element(ns2:cashReceptionResponse) {
        <ns2:cashReceptionResponse>
            {
...
xf:cashReceptionGTOut($outputParameters)
