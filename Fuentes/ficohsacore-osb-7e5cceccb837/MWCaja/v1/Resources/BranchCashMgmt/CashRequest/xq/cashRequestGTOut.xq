(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../../BusinessServices/AbanksGT/SolicitudEfectivo/xsd/MCSolicitudEfectivo_sp.xsd" ::)
(:: pragma bea:global-element-return element="ns2:cashRequestResponse" location="../../xsd/BranchCashMgmtTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MWCaja/v1/Resources/BranchCashMgmt/CashRequest/xq/cashRequestGTOut/";

declare function xf:cashRequestGTOut($outputParameters as element(ns1:OutputParameters))
    as element(ns2:cashRequestResponse) {
        <ns2:cashRequestResponse>
            {
...
xf:cashRequestGTOut($outputParameters)
