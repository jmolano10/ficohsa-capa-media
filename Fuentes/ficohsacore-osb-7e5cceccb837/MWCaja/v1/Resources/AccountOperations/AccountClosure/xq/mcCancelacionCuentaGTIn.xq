(:: pragma bea:global-element-parameter parameter="$accountClosure" element="ns1:accountClosure" location="../../xsd/AccountOperationsTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns2:InputParameters" location="../../../../BusinessServices/AbanksGT/CancelacionCuenta/xsd/MCCancelacionCuenta_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MWCaja/v1/Resources/AccountOperations/AccountClosure/xq/mcCancelacionCuentaGTIn/";
declare namespace ns3 = "http://www.ficohsa.com.hn/middleware.services/accountTypes";

declare function xf:mcCancelacionCuentaGTIn($accountClosure as element(ns1:accountClosure))
    as element(ns2:InputParameters) {
        <ns2:InputParameters>
            <ns2:PN_ACCOUNT_NUMBER>{ data($accountClosure/ns1:ACCOUNT_NUMBER) }</ns2:PN_ACCOUNT_NUMBER>
            {
                for $PASSBOOK in $accountClosure/ns1:PASSBOOK
                return
                    <ns2:PR_PASSBOOK>
            ...
            <ns2:PN_MOTIVE>{ xs:decimal(data($accountClosure/ns1:MOTIVE)) }</ns2:PN_MOTIVE>
            {
                let $PAYMENT := $accountClosure/ns1:PAYMENT
                return
                    <ns2:PR_PAYMENT>
                        <ns2:PAY_ITEM>
                            {
            ...
            {
                let $NSO_INFO := $accountClosure/ns1:NSO_INFO
                return
                    <ns2:PR_NSO_INFO>
                        {
...
declare variable $accountClosure as element(ns1:accountClosure) external;

xf:mcCancelacionCuentaGTIn($accountClosure)
