(:: pragma bea:global-element-parameter parameter="$negotiationQuery" element="ns2:negotiationQuery" location="../../xsd/ForeignExchangeTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../../BusinessServices/AbanksGT/CONSNegociacionFX/xsd/MCCONSNegociacionFX_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MWCaja/v1/Resources/ForeignExchange/NegotiationQuery/xq/mcCONSNegociacionFXGTIn/";

declare function xf:mcCONSNegociacionFXGTIn($negotiationQuery as element(ns2:negotiationQuery))
    as element(ns0:InputParameters) {
        <ns0:InputParameters>
            <ns0:PV_FOREX_TYPE>{ data($negotiationQuery/ns2:FOREX_TYPE) }</ns0:PV_FOREX_TYPE>
            <ns0:PV_NEGOTIATION_ID>{ data($negotiationQuery/ns2:NEGOTIATION_ID) }</ns0:PV_NEGOTIATION_ID>
            {
                let $NSO_INFO := $negotiationQuery/ns2:NSO_INFO
                return
                    <ns0:PR_NSO_INFO>
                        {
...
declare variable $negotiationQuery as element(ns2:negotiationQuery) external;

xf:mcCONSNegociacionFXGTIn($negotiationQuery)
