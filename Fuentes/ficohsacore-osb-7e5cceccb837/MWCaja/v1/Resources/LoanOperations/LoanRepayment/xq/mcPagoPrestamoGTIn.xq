(:: pragma bea:global-element-parameter parameter="$loanRepayment" element="ns2:loanRepayment" location="../../xsd/LoanOperationsTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../../BusinessServices/AbanksGT/PagoPrestamo/xsd/MCPagoPrestamo_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MWCaja/v1/Resources/LoanOperations/LoanRepayment/xq/mcPagoPrestamoGTIn/";

declare function xf:mcPagoPrestamoGTIn($loanRepayment as element(ns2:loanRepayment))
    as element(ns0:InputParameters) {
        <ns0:InputParameters>
            <ns0:PV_LOAN_NUMBER>{ data($loanRepayment/ns2:LOAN_NUMBER) }</ns0:PV_LOAN_NUMBER>
            <ns0:PV_REPAY_TYPE>{ data($loanRepayment/ns2:REPAY_TYPE) }</ns0:PV_REPAY_TYPE>
            {
                let $PAYMENT := $loanRepayment/ns2:PAYMENT
                return
                    <ns0:PR_PAYMENT>
                        <ns0:PAY_ITEM>
                            {
                                                ...
                                                <ns0:MORE_INFO>
                                                    {
                                                        ...
                                                        return
                                                            <ns0:ACCOUNT_VNUMBER>{ xs:string(data($ACCOUNT/ns1:NUMBER)) }</ns0:ACCOUNT_VNUMBER>
                                                    }
                                                    {
            ...
            {
                let $NSO_INFO := $loanRepayment/ns2:NSO_INFO
                return
                    <ns0:PR_NSO_INFO>
                        {
...
declare variable $loanRepayment as element(ns2:loanRepayment) external;

xf:mcPagoPrestamoGTIn($loanRepayment)
