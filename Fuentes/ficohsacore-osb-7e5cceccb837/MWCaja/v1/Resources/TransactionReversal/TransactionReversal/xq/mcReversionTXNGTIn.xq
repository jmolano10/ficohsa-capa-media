(:: pragma bea:global-element-parameter parameter="$transactionReversal" element="ns2:transactionReversal" location="../../xsd/TransactionReversalTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MWCaja/v1/Resources/TransactionReversal/TransactionReversal/xq/mcReversionTXNGTIn/";

declare function xf:mcReversionTXNGTIn($transactionReversal as element(ns2:transactionReversal))
    as element(ns0:InputParameters) {
        <ns0:InputParameters>
            <ns0:PV_TRANSACTION_ID>{ data($transactionReversal/ns2:TRANSACTION_ID) }</ns0:PV_TRANSACTION_ID>
            {
                let $NSO_INFO := $transactionReversal/ns2:NSO_INFO
                return
                    <ns0:PR_NSO_INFO>
                        {
...
declare variable $transactionReversal as element(ns2:transactionReversal) external;

xf:mcReversionTXNGTIn($transactionReversal)
