(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../../BusinessServices/AbanksGT/PagoCHQGerencia/xsd/MCPagoCHQGerencia_sp.xsd" ::)
(:: pragma bea:global-element-return element="ns2:cashierCheckPymtResponse" location="../../xsd/CheckOperationsTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MWCaja/v1/Resources/CheckOperations/CashierCheckPymt/xq/cashierCheckPymtGTOut/";

declare function xf:cashierCheckPymtGTOut($outputParameters as element(ns1:OutputParameters))
    as element(ns2:cashierCheckPymtResponse) {
        <ns2:cashierCheckPymtResponse>
        	{
            ...
            {
                for $PV_BENEFICIARY_NAME in $outputParameters/ns1:PV_BENEFICIARY_NAME
                return
...
xf:cashierCheckPymtGTOut($outputParameters)