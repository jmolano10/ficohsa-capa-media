(:: pragma bea:global-element-parameter parameter="$cashierCheckPymt" element="ns2:cashierCheckPymt" location="../../xsd/CheckOperationsTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../../BusinessServices/AbanksGT/PagoCHQGerencia/xsd/MCPagoCHQGerencia_sp.xsd" ::)
...
declare namespace ns1 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/MCPagoCHQGerencia";
declare namespace xf = "http://tempuri.org/MWCaja/v1/Resources/CheckOperations/CashierCheckPymt/xq/mcPagoCHQGerenciaGTIn/";

declare function xf:mcPagoCHQGerenciaGTIn($cashierCheckPymt as element(ns2:cashierCheckPymt))
    as element(ns1:InputParameters) {
        <ns1:InputParameters>
            <ns1:PN_CHECK_NUMBER>{ data($cashierCheckPymt/ns2:CHECK_NUMBER) }</ns1:PN_CHECK_NUMBER>
            {
                let $PAYMENT := $cashierCheckPymt/ns2:PAYMENT
                return
                    <ns1:PR_PAYMENT>
                        <ns1:PAY_ITEM>
                            {
            ...
            {
                let $NSO_INFO := $cashierCheckPymt/ns2:NSO_INFO
                return
                    <ns1:PR_NSO_INFO>
                        {
...
declare variable $cashierCheckPymt as element(ns2:cashierCheckPymt) external;

xf:mcPagoCHQGerenciaGTIn($cashierCheckPymt)