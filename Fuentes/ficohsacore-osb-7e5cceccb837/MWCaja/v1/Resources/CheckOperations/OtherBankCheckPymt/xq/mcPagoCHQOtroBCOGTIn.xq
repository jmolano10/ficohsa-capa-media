(:: pragma bea:global-element-parameter parameter="$otherBankCheckPymt" element="ns1:otherBankCheckPymt" location="../../xsd/CheckOperationsTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns2:InputParameters" location="../../../../BusinessServices/AbanksGT/PagoCHQOtroBCO/xsd/MCPagoCHQOtroBCO_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MWCaja/v1/Resources/CheckOperations/OtherbankCheckPymt/xq/mcPagoCHQOtroBCOGTIn/";

declare function xf:mcPagoCHQOtroBCOGTIn($otherBankCheckPymt as element(ns1:otherBankCheckPymt))
    as element(ns2:InputParameters) {
        <ns2:InputParameters>
            <ns2:PN_CHECK_NUMBER>{ xs:decimal(data($otherBankCheckPymt/ns1:CHECK_NUMBER)) }</ns2:PN_CHECK_NUMBER>
            <ns2:PV_BANK_CODE>{ xs:string(data($otherBankCheckPymt/ns1:BANK_CODE)) }</ns2:PV_BANK_CODE>
            {
                let $PAYMENT := $otherBankCheckPymt/ns1:PAYMENT
                return
                    <ns2:PR_PAYMENT>
                        <ns2:PAY_ITEM>
                            {
            ...
            {
                let $NSO_INFO := $otherBankCheckPymt/ns1:NSO_INFO
                return
                    <ns2:PR_NSO_INFO>
                        {
...
declare variable $otherBankCheckPymt as element(ns1:otherBankCheckPymt) external;

xf:mcPagoCHQOtroBCOGTIn($otherBankCheckPymt)