(:: pragma bea:global-element-parameter parameter="$ownCheckPymt" element="ns1:ownCheckPymt" location="../../xsd/CheckOperationsTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns2:InputParameters" location="../../../../BusinessServices/AbanksGT/PagoCHQPropio/xsd/MCPagoCHQPropio_sp.xsd" ::)

declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/generalTypes";
declare namespace ns2 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/MCPagoCHQPropio";
declare namespace ns1 = "http://www.ficohsa.com.hn/middleware.services/checkOperationsTypes";
declare namespace xf = "http://tempuri.org/MWCaja/v1/Resources/CheckOperations/OwnCheckPymt/xq/mcPagoCHQPropioGTIn/";

declare function xf:mcPagoCHQPropioGTIn($ownCheckPymt as element(ns1:ownCheckPymt))
    as element(ns2:InputParameters) {
        <ns2:InputParameters>
            <ns2:PN_ACCOUNT_NUMBER>{ xs:decimal(data($ownCheckPymt/ns1:ACCOUNT_NUMBER)) }</ns2:PN_ACCOUNT_NUMBER>
            <ns2:PN_CHECK_NUMBER>{ data($ownCheckPymt/ns1:CHECK_NUMBER) }</ns2:PN_CHECK_NUMBER>
            <ns2:PN_CHECK_AMOUNT>{ data($ownCheckPymt/ns1:CHECK_AMOUNT) }</ns2:PN_CHECK_AMOUNT>
            {
                let $PAYMENT := $ownCheckPymt/ns1:PAYMENT
                return
                    <ns2:PR_PAYMENT>
                        <ns2:PAY_ITEM>
                            {
            ...
            {
                let $NSO_INFO := $ownCheckPymt/ns1:NSO_INFO
                return
                    <ns2:PR_NSO_INFO>
                        {
...
declare variable $ownCheckPymt as element(ns1:ownCheckPymt) external;

xf:mcPagoCHQPropioGTIn($ownCheckPymt)