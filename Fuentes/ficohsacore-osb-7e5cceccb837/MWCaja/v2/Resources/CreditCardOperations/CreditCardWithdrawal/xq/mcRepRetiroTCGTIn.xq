...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../../../v1/BusinessServices/AbanksGT/RepRetiroTC/xsd/MCRepRetiroTC_sp.xsd" ::)

declare namespace ns0 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/MCRepRetiroTC";
...
declare namespace xf = "http://tempuri.org/MWCaja/v1/Resources/CreditCardOperations/CreditCardWithdrawal/xq/mcRepRetiroTCGTIn/";

declare function xf:mcRepRetiroTCGTIn($creditCardWithdrawal as element(ns2:creditCardWithdrawal))
    as element(ns0:InputParameters) {
        <ns0:InputParameters>
            <ns0:PN_CREDIT_CARD_NUMBER>{ data($creditCardWithdrawal/ns2:CREDIT_CARD_NUMBER) }</ns0:PN_CREDIT_CARD_NUMBER>
            <ns0:PV_EXPIRATION_DATE>{ data($creditCardWithdrawal/ns2:EXPIRATION_DATE) }</ns0:PV_EXPIRATION_DATE>
            {
                let $PAYMENT := $creditCardWithdrawal/ns2:PAYMENT
                return
                    <ns0:PR_PAYMENT>
                        <ns0:PAY_ITEM>
                            {
...
xf:mcRepRetiroTCGTIn($creditCardWithdrawal)
