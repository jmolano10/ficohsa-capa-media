(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../../../v1/BusinessServices/AbanksGT/RepRetiroTC/xsd/MCRepRetiroTC_sp.xsd" ::)
(:: pragma bea:global-element-return element="ns2:creditCardWithdrawalResponse" location="../../../../../v1/Resources/CreditCardOperations/xsd/CreditCardOperationsTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/MWCaja/v1/Resources/CreditCardOperations/CreditCardWithdrawal/xq/creditCardWithdrawalGTOut/";

declare function xf:creditCardWithdrawalGTOut($outputParameters as element(ns0:OutputParameters))
    as element(ns2:creditCardWithdrawalResponse) {
        <ns2:creditCardWithdrawalResponse>
        	{
        		for $CREDIT_CARD_NUMBER in $outputParameters/ns0:PN_CREDIT_CARD_NUMBER
        		return
        			<ns2:CREDIT_CARD_NUMBER>{ data($CREDIT_CARD_NUMBER) }</ns2:CREDIT_CARD_NUMBER>
        	}
...
xf:creditCardWithdrawalGTOut($outputParameters)
