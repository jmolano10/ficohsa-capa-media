...
declare namespace xf = "http://tempuri.org/MWCaja/v2/Resources/CreditCardOperations/CreditCardPayment/xq/reversionTXNGTIn/";
declare namespace ns3 = "http://www.ficohsa.com.hn/middleware.services/creditCardTypes";

declare function xf:reversionTXNGTIn($PV_TRANSACTION_ID as xs:string,
    $creditCardPayment as element(ns2:creditCardPayment))
    as element(ns0:InputParameters) {
        <ns0:InputParameters>
            <ns0:PV_TRANSACTION_ID>{ $PV_TRANSACTION_ID }</ns0:PV_TRANSACTION_ID>
             {
...
declare variable $PV_TRANSACTION_ID as xs:string external;
declare variable $creditCardPayment as element(ns2:creditCardPayment) external;

xf:reversionTXNGTIn($PV_TRANSACTION_ID,
    $creditCardPayment)
