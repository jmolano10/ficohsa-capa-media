...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/pagoPrestamo/pagoPrestamo/ConsultaCuentaIn/";
...
declare function xf:ConsultaCuentaIn($autenticacionRequestHeader1 as element(ns2:AutenticacionRequestHeader),
...
xf:ConsultaCuentaIn($autenticacionRequestHeader1,
    $pagoPrestamo1)