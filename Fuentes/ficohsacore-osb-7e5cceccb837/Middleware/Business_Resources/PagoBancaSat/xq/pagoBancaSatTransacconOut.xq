(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns0:OutputParameters" location="../../../v2/BusinessServices/ABKGT/BancaSat/transaccionBancaSat/xsd/TRANSACCION_BANCASAT_sp.xsd" ::)
