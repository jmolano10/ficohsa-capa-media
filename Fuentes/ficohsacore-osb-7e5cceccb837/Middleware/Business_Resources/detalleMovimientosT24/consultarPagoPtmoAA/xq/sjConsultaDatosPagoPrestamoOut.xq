...
(:: pragma bea:global-element-parameter parameter="$consultadepagodeprestamoAAResponse1" element="ns0:ConsultadepagodeprestamoAAResponse" location="../../../consultaGeneralPrestamo/Resources/consultaPrestamoT24/XMLSchema_448646516.xsd" ::)
(:: pragma bea:global-element-parameter parameter="$consultaaplicacionpagoptmoResponse1" element="ns0:ConsultaaplicacionpagoptmoResponse" location="../../../consultaGeneralPrestamo/Resources/consultaPrestamoT24/XMLSchema_448646516.xsd" ::)
(:: pragma bea:global-element-parameter parameter="$consultabackofficepagoptmoAAResponse1" element="ns0:ConsultabackofficepagoptmoAAResponse" location="../../../consultaGeneralPrestamo/Resources/consultaPrestamoT24/XMLSchema_448646516.xsd" ::)
(:: pragma bea:global-element-return element="ns1:sjConsultaPrestamoResponse" location="../xsd/sjConsultaPrestamo.xsd" ::)

declare namespace ns1 = "http://www.ficohsa.com.hn/middleware.services/sjConsultaPrestamoTypes";
declare namespace ns0 = "T24WebServicesImpl";
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/detalleMovimientosT24/consultarPagoPtmoAA/xq/sjConsultaDatosPagoPrestamoOut/";
		            ...
		            if ($transactionType = "TELLER") then (
		            	...
		            	<ns1:consultaPagoPrestamo>
		                    ...
		                    <PAYMENT_DETAILS>
		                    	...
		                    	{
		                    		if ( fn:string($consultabackofficepagoptmoAAResponse1/WSFICOBOPAYMENTDETAILSType[1]/gWSFICOBOPAYMENTDETAILSDetailType/mWSFICOBOPAYMENTDETAILSDetailType[1]/PAYMENTAMOUNT/text()) != "") then (
			                    		let $PAYMENTTYPE1 := fn:string($consultabackofficepagoptmoAAResponse1/WSFICOBOPAYMENTDETAILSType[1]/gWSFICOBOPAYMENTDETAILSDetailType/mWSFICOBOPAYMENTDETAILSDetailType[1]/PAYMENTTYPE1/text())
			                    		let $PAYMENTVALUE1 := fn:string($consultabackofficepagoptmoAAResponse1/WSFICOBOPAYMENTDETAILSType[1]/gWSFICOBOPAYMENTDETAILSDetailType/mWSFICOBOPAYMENTDETAILSDetailType[1]/PAYMENTVALUE1/text())
			                    		let $PAYMENTTYPE2 := fn:string($consultabackofficepagoptmoAAResponse1/WSFICOBOPAYMENTDETAILSType[1]/gWSFICOBOPAYMENTDETAILSDetailType/mWSFICOBOPAYMENTDETAILSDetailType[1]/PAYMENTTYPE2/text())
			                    		let $PAYMENTVALUE2 := fn:string($consultabackofficepagoptmoAAResponse1/WSFICOBOPAYMENTDETAILSType[1]/gWSFICOBOPAYMENTDETAILSDetailType/mWSFICOBOPAYMENTDETAILSDetailType[1]/PAYMENTVALUE2/text())
										...
										let $PAYMENTAMOUNT := xs:decimal(fn:string($consultabackofficepagoptmoAAResponse1/WSFICOBOPAYMENTDETAILSType[1]/gWSFICOBOPAYMENTDETAILSDetailType/mWSFICOBOPAYMENTDETAILSDetailType[1]/PAYMENTAMOUNT/text()))
																											
			                    		let $PAYMENTSUM := fn:sum(
			                    				for $j in (1 to fn:count($PAYMENTTYPE_LIST))
					                    		where $PAYMENTTYPE_LIST[$j] != ""  
												return xs:decimal($PAYMENTVALUE_LIST[$j]))
										
										return											
										if($PAYMENTSUM < $PAYMENTAMOUNT) then (
													let $OTHERCHARGES := $PAYMENTAMOUNT - $PAYMENTSUM
													return
													<PAYMENT_DETAIL>
						                    				<PAYMENT_TYPE>OTHER_CHARGES</PAYMENT_TYPE>
						                    				<PAYMENT_VALUE>{ $OTHERCHARGES }</PAYMENT_VALUE>
						                    		</PAYMENT_DETAIL>
