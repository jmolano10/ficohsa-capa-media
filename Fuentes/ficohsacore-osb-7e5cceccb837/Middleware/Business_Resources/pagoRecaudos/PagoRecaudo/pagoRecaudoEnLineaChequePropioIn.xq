...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/pagoRecaudos/PagoRecaudo/pagoRecaudoEnLineaChequePropioIn/";
...
declare function xf:pagoRecaudoEnLineaChequePropioIn($autenticacionRequestHeader as element(ns3:AutenticacionRequestHeader),
...
xf:pagoRecaudoEnLineaChequePropioIn($autenticacionRequestHeader,
    $pagoRecaudo,
    $outputParameters,
    $uuid)