...
(:: pragma bea:global-element-return element="ns0:Pagoderecaudolocalylineachqpr" location="../Resources/XMLSchema_-258408779.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/pagoRecaudos/PagoRecaudo/pagoRecaudoLocalChequePropioIn/";
...
declare function xf:pagoRecaudoLocalChequePropioIn($autenticacionRequestHeader as element(ns3:AutenticacionRequestHeader),
    $pagoRecaudo as element(ns1:pagoRecaudo),
    $outputParameters as element(ns2:OutputParameters),
    $uuid as xs:string)
    as element(ns0:Pagoderecaudolocalylineachqpr) {
        <ns0:Pagoderecaudolocalylineachqpr>
            <WebRequestCommon>
            ...
            <FUNDSTRANSFERLATAMFICOCHQWSType>
                {
...
declare variable $tasaCompra as xs:string external;
declare variable $tasaVenta as xs:string external;
declare variable $uuid as xs:string external;

xf:pagoRecaudoLocalChequePropioIn($autenticacionRequestHeader,
    $pagoRecaudo,
    $outputParameters,
    $uuid)