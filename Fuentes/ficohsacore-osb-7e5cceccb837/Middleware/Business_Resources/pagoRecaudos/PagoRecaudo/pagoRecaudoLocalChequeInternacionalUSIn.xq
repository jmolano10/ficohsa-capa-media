...
(:: pragma bea:global-element-return element="ns0:Pagoderecaudolocalylineachqin" location="../Resources/XMLSchema_-258408779.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/pagoRecaudos/PagoRecaudo/pagoRecaudoLocalChequeInternacionalUSIn/";
...
declare function xf:pagoRecaudoLocalChequeInternacionalUSIn($autenticacionRequestHeader as element(ns3:AutenticacionRequestHeader),
...
xf:pagoRecaudoLocalChequeInternacionalUSIn($autenticacionRequestHeader,
    $pagoRecaudo,
    $outputParameters,
    $uuid)