...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/pagoRecaudos/PagoRecaudo/pagoRecaudoEnLineaEfectivoIn/";
...
declare function xf:pagoRecaudoEnLineaEfectivoIn($autenticacionRequestHeader as element(ns3:AutenticacionRequestHeader),
...
xf:pagoRecaudoEnLineaEfectivoIn($autenticacionRequestHeader,
    $pagoRecaudo,
    $outputParameters,
    $uuid)