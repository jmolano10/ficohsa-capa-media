...
(:: pragma bea:global-element-return element="ns0:Pagoderecaudolocalylineaefec" location="../Resources/XMLSchema_-258408779.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/pagoRecaudos/PagoRecaudo/pagoRecaudoLocalEfectivoIn/";
...
declare function xf:pagoRecaudoLocalEfectivoIn($autenticacionRequestHeader as element(ns3:AutenticacionRequestHeader),
    $pagoRecaudo as element(ns1:pagoRecaudo),
    $outputParameters as element(ns2:OutputParameters),
    $uuid as xs:string)
    as element(ns0:Pagoderecaudolocalylineaefec) {
        <ns0:Pagoderecaudolocalylineaefec>
            <WebRequestCommon>
...
xf:pagoRecaudoLocalEfectivoIn($autenticacionRequestHeader,
    $pagoRecaudo,
    $outputParameters,
    $uuid)