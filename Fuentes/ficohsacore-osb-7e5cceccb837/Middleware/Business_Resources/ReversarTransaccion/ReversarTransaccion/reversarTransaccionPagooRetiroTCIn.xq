...
(:: pragma bea:global-element-return element="ns0:ReversionpagooretiroTC" location="../Resources/XMLSchema_-193201527.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/ReversarTransaccion/ReversarTransaccion/reversarTransaccionPagooRetiroTCIn/";
...
declare function xf:reversarTransaccionPagooRetiroTCIn($autenticacionRequestHeader as element(ns2:AutenticacionRequestHeader),
    ...
    as element(ns0:ReversionpagooretiroTC) {
        <ns0:ReversionpagooretiroTC>
            <WebRequestCommon>
