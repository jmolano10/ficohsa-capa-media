...
(:: pragma bea:global-element-return element="ns0:Reversionpagorecaudorefdbcta" location="../Resources/XMLSchema_-193201527.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/ReversarTransaccion/ReversarTransaccion/reversarTransaccionPagoRecaudoIn/";
...
declare function xf:reversarTransaccionPagoRecaudoIn($autenticacionRequestHeader as element(ns2:AutenticacionRequestHeader),
...
xf:reversarTransaccionPagoRecaudoIn($autenticacionRequestHeader,
    $reversarTransaccion)