...
(:: pragma bea:global-element-return element="ns0:AutorizacionreversionTT" location="../Resources/XMLSchema_-193201527.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/ReversarTransaccion/ReversarTransaccion/AutorizarReversionTTIn/";
...
declare function xf:AutorizarReversionTTIn($autenticacionRequestHeader as element(ns2:AutenticacionRequestHeader),
...
xf:AutorizarReversionTTIn($autenticacionRequestHeader,
    $reversarTransaccion)