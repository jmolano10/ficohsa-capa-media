...
(:: pragma bea:global-element-return element="ns0:Consultadesubastaporadjudicar" location="../Resources/XMLSchema_-1390898219.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/subasta/consultaSolicitudSubasta/consultaSubastaPorAdjudicarIn/";
...
declare function xf:consultaSubastaPorAdjudicarIn($autenticacionRequestHeader as element(ns2:AutenticacionRequestHeader),
    $consultaSolicitudSubasta as element(ns1:consultaSolicitudSubasta))
    as element(ns0:Consultadesubastaporadjudicar) {
        <ns0:Consultadesubastaporadjudicar>
             <WebRequestCommon>
...
xf:consultaSubastaPorAdjudicarIn($autenticacionRequestHeader,
