...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/subasta/consultaSolicitudSubasta/consultaCuentaServicioIn/";
...
declare function xf:consultaCuentaServicioIn($autenticacionRequestHeader as element(ns2:AutenticacionRequestHeader),
...
xf:consultaCuentaServicioIn($autenticacionRequestHeader,
