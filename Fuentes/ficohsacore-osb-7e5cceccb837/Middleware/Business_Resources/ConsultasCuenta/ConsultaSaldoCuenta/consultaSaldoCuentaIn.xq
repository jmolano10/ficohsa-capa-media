(:: pragma bea:global-element-parameter parameter="$consultaSaldoCuenta1" element="ns2:consultaSaldoCuenta" location="../Resources/consultasGeneralesCuentasTypes.xsd" ::)
...
declare function xf:consultaSaldoCuentaIn($consultaSaldoCuenta1 as element(ns2:consultaSaldoCuenta),
...
declare variable $consultaSaldoCuenta1 as element(ns2:consultaSaldoCuenta) external;
declare variable $autenticacionRequestHeader1 as element(ns1:AutenticacionRequestHeader) external;

xf:consultaSaldoCuentaIn($consultaSaldoCuenta1,
