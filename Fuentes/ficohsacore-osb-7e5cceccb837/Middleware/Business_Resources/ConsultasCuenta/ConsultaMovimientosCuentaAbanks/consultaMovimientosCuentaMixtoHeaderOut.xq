        ...
        <ns2:ResponseHeader>
            {
	        	if ( fn:string($respuestaT24/Status/successIndicator) = "Success" and 
	        		 fn:empty($respuestaT24/WSACCOUNTENTRIESType[1]/ZERORECORDS) and
	        		 ...
	        		 <successIndicator>{data($respuestaAbanks/ns1:ERROR_CODE)}</successIndicator>
			        		 ...
			        		 fn:string($respuestaT24/WSACCOUNTENTRIESType[1]/ZERORECORDS) != "" and
			        		 fn:string($respuestaAbanks/ns1:ERROR_CODE) = "SUCCESS" and
			        		 count($respuestaAbanks/ns1:REF_NO/ns1:ITEM) = 0 ) then (
			        		 
			        		 <successIndicator>NO RECORDS</successIndicator>,
			        		 <messages>{ concat(data($respuestaT24/WSACCOUNTENTRIESType[1]/ZERORECORDS), ". ", data($respuestaAbanks/ns1:ERROR_MESSAGE))}</messages>
