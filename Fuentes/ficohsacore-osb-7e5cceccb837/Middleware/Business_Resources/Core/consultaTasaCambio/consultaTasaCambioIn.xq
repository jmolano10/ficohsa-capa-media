...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/Core/consultaTasaCambio/consultaTasaCambioIn/";
...
declare function xf:consultaTasaCambioIn($autenticacionRequestHeader1 as element(ns2:AutenticacionRequestHeader),
        ...
        <ns1:Consultadetasadecambiolcy>
            ...
            <WSLCYEXCHRATEType>
                <enquiryInputCollection>
                	...
                	<criteriaValue>{ data($consultaTasaCambio1/TARGET_CURRENCY) }</criteriaValue>
                	<operand>EQ</operand>
                </enquiryInputCollection>
            </WSLCYEXCHRATEType>
        </ns1:Consultadetasadecambiolcy>
...
xf:consultaTasaCambioIn($autenticacionRequestHeader1,
    $consultaTasaCambio1)