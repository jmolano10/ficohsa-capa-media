...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/consultaDetalleTransferencia/consultaDetalleTransaccion/consultaDetalleTransaccionHistTTHeaderOut/";

declare function xf:consultaDetalleTransaccionHistTTHeaderOut($consultadetransaccionhistTTResponse as element(ns0:ConsultadetransaccionhistTTResponse))
...
xf:consultaDetalleTransaccionHistTTHeaderOut($consultadetransaccionhistTTResponse)