...
(:: pragma bea:global-element-return element="ns0:ConsultaChequesPagadosFT" location="../Resources/XMLSchema_516353548.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/consultaCheque/ConsultaChequesPagados/consultaChequesPagadosFTIn/";
...
declare function xf:consultaChequesPagadosFTIn($autenticacionRequestHeader as element(ns2:AutenticacionRequestHeader),
    $consultaChequesPagados as element(ns1:consultaChequesPagados))
    as element(ns0:ConsultaChequesPagadosFT) {
        <ns0:ConsultaChequesPagadosFT>
             <WebRequestCommon>
...
xf:consultaChequesPagadosFTIn($autenticacionRequestHeader,
