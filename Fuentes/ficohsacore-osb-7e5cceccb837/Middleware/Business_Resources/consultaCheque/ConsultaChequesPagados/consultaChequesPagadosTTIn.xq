...
(:: pragma bea:global-element-return element="ns0:ConsultaChequesPagadosTT" location="../Resources/XMLSchema_516353548.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/consultaCheque/ConsultaChequesPagados/consultaChequesPagadosTTIn/";
...
declare function xf:consultaChequesPagadosTTIn($autenticacionRequestHeader as element(ns2:AutenticacionRequestHeader),
    $consultaChequesPagados as element(ns1:consultaChequesPagados))
    as element(ns0:ConsultaChequesPagadosTT) {
        <ns0:ConsultaChequesPagadosTT>
             <WebRequestCommon>
...
xf:consultaChequesPagadosTTIn($autenticacionRequestHeader,
