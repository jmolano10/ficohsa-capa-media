...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/cancelacionCuentaAhorros/CancelacionCuentaAhorros/cancelacionCuentaAhorrosHeaderOut/";

declare function xf:cancelacionCuentaAhorrosHeaderOut($cancelaciondecuentaparte2Response1 as element(ns0:Cancelaciondecuentaparte2Response))
    as element(ns1:ResponseHeader) {
        ...
        return
            <ns1:ResponseHeader>
                ...
                {
                    for $VALUEDATE1 in $cancelaciondecuentaparte2Response1/TELLERType/VALUEDATE1
                    return
...
xf:cancelacionCuentaAhorrosHeaderOut($cancelaciondecuentaparte2Response1)