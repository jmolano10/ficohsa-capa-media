...
(:: pragma bea:global-element-return element="ns1:consultaFICOPENResponse" location="consultaFICOPENTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/Ficopen/ConsultaFICOPEN/consultaFICOPENOut/";
...
declare function xf:consultaFICOPENOut($outputParameters1 as element(ns0:OutputParameters))
    as element(ns1:consultaFICOPENResponse) {
        <ns1:consultaFICOPENResponse>
            ...
            <ns1:consultaFICOPENResponseType>
            {
                ...
                return
                    <ns1:consultaFICOPENResponseRecordType>
