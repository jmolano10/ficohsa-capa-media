...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/Core/consultaPaises/consultaPaisesIn/";
...
declare function xf:consultaPaisesIn($autenticacionRequestHeader1 as element(ns2:AutenticacionRequestHeader),
...
xf:consultaPaisesIn($autenticacionRequestHeader1,
    $consultaPaises1)