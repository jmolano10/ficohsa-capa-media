...
(:: pragma bea:global-element-return element="ns0:Reclamoswitchvisaenficohsa" location="../Resources/XMLSchema_-1759531368.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/reclamosSwitch/RegistroReclamoTransaccionSwitch/registroReclamoTransaccionSwitchCVRFIn/";
...
declare function xf:registroReclamoTransaccionSwitchCVRFIn($autenticacionRequestHeader as element(ns2:AutenticacionRequestHeader),
    $registroReclamoTransaccionSwitch as element(ns1:registroReclamoTransaccionSwitch))
    as element(ns0:Reclamoswitchvisaenficohsa) {
        <ns0:Reclamoswitchvisaenficohsa>
			<WebRequestCommon>
            ...
            <FUNDSTRANSFERFICOVISACUSTCLAIMType>
...
xf:registroReclamoTransaccionSwitchCVRFIn($autenticacionRequestHeader,
