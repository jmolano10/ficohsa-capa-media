...
(:: pragma bea:global-element-return element="ns0:Reclamoswitchficoenotrobanco" location="../Resources/XMLSchema_-1759531368.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/reclamosSwitch/RegistroReclamoTransaccionSwitch/registroReclamoTransaccionSwitchCFRGIn/";
...
declare function xf:registroReclamoTransaccionSwitchCFRGIn($autenticacionRequestHeader as element(ns2:AutenticacionRequestHeader),
    $registroReclamoTransaccionSwitch as element(ns1:registroReclamoTransaccionSwitch))
    as element(ns0:Reclamoswitchficoenotrobanco) {
        <ns0:Reclamoswitchficoenotrobanco>
			<WebRequestCommon>
            ...
            <FUNDSTRANSFERFICOCLAIMCUSTType>
...
xf:registroReclamoTransaccionSwitchCFRGIn($autenticacionRequestHeader,
