...
(:: pragma bea:global-element-return element="ns0:Reclamoswitchficohsaenvisa" location="../Resources/XMLSchema_-1759531368.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/reclamosSwitch/RegistroReclamoTransaccionSwitch/registroReclamoTransaccionSwitchCFRVIn/";
...
declare function xf:registroReclamoTransaccionSwitchCFRVIn($autenticacionRequestHeader as element(ns2:AutenticacionRequestHeader),
    $registroReclamoTransaccionSwitch as element(ns1:registroReclamoTransaccionSwitch))
    as element(ns0:Reclamoswitchficohsaenvisa) {
        <ns0:Reclamoswitchficohsaenvisa>
			<WebRequestCommon>
            ...
            <FUNDSTRANSFERFICOCUSTVISACLAIMType>
...
xf:registroReclamoTransaccionSwitchCFRVIn($autenticacionRequestHeader,
