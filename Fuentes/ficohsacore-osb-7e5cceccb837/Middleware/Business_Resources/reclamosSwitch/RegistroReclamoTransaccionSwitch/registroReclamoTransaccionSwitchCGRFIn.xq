...
(:: pragma bea:global-element-return element="ns0:Reclamoswitchotrobancoenfico" location="../Resources/XMLSchema_-1759531368.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/reclamosSwitch/RegistroReclamoTransaccionSwitch/registroReclamoTransaccionSwitchCGRFIn/";
...
declare function xf:registroReclamoTransaccionSwitchCGRFIn($autenticacionRequestHeader as element(ns2:AutenticacionRequestHeader),
    $registroReclamoTransaccionSwitch as element(ns1:registroReclamoTransaccionSwitch))
    as element(ns0:Reclamoswitchotrobancoenfico) {
        <ns0:Reclamoswitchotrobancoenfico>
			<WebRequestCommon>
            ...
            <FUNDSTRANSFERFICOCLAIMOTHERBANKCUSTType>
                ...
                {
                    for $NETWORK_ID in $registroReclamoTransaccionSwitch/NETWORK_ID
                    return
                        <ATMBICACCT>{ data($NETWORK_ID) }</ATMBICACCT>
                }
                {
                    for $CLAIM_TYPE in $registroReclamoTransaccionSwitch/CLAIM_TYPE
                    return
                        <CLAIMPROCESSED>{ data($CLAIM_TYPE) }</CLAIMPROCESSED>
                }
            </FUNDSTRANSFERFICOCLAIMOTHERBANKCUSTType>
        </ns0:Reclamoswitchotrobancoenfico>
};
...
xf:registroReclamoTransaccionSwitchCGRFIn($autenticacionRequestHeader,
