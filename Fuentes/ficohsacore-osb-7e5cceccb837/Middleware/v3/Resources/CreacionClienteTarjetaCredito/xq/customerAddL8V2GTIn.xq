...
(:: pragma bea:global-element-return element="ns1:CustomerAddL8V2Request" location="../../../../v2/BusinessServices/VisionPlus/visionPlus/xsd/XMLSchema_769155616.xsd" ::)
(:: pragma bea:global-element-parameter parameter="$consultaEquivalenciasCatalogos" element="ns2:OutputParameters"  location="../../../../v2/BusinessServices/MDW/consultaEquivalenciasCatalogos_v2/xsd/consultaEquivalenciasCatalogos_v2_sp.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/CreacionClienteTarjetaCredito/xq/customerAddL8V2GTIn/";
...
declare function valorCatalogoOSBToAPP($valor as xs:string,
	...
	let $retorno := string($equivalenciasCatalogos/ns2:PT_EQUIVALENCIAS_SALIDA/ns2:PT_EQUIVALENCIAS_SALIDA_ITEM[ns2:CATALOGO_ID = $catalogoId and ns2:VALOR_CATALOGO = $valor][2]/ns2:EQUIVALENCIAS/ns2:EQUIVALENCIAS_ITEM[ns2:APLICACION = $aplicacion]/ns2:VALOR_EQUIVALENCIA/text())
	return
		if($retorno != "") then (
			$retorno
		) else ( 
...
declare function xf:customerAddL8V2GTIn($creacionClienteTarjetaCredito1 as element(ns0:creacionClienteTarjetaCredito),
    ...
    as element(ns1:CustomerAddL8V2Request) {
        ...
        <ns1:CustomerAddL8V2Request>
            <AZXNAI-LOCAL-ACCT-ORG>{ data($creacionClienteTarjetaCredito1/ORG) }</AZXNAI-LOCAL-ACCT-ORG>
            <AZXNAI-CUST-NBR>{ fn-bea:pad-left($codigoCliente, 19, '0') }</AZXNAI-CUST-NBR>
            <AZXNAI-BS-ACCT/>
            {
            	let $MAKER_INDICATOR := string($creacionClienteTarjetaCredito1/MAKER_INDICATOR/text())
            	return(
            ...
            {
            	let $DOUBLE_CURRENCY_INDICATOR := string($creacionClienteTarjetaCredito1/DOUBLE_CURRENCY_INDICATOR/text())
            	return(
            ...
            {
            	let $VIP_CLIENT_INDICATOR := string($creacionClienteTarjetaCredito1/VIP_CLIENT_INDICATOR/text())
	            return(
            ...
            <AZXNAI-M-TITLE/>
            {
            	let $MARITAL_STATUS := string($creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/MARITAL_STATUS/text())
	            return(
		            if($MARITAL_STATUS  != "")then(
		            	<AZXNAI-M-MARITAL-STATUS>{ valorCatalogoOSBToAPP($MARITAL_STATUS, 'VISION+GT', '2', $consultaEquivalenciasCatalogos) }</AZXNAI-M-MARITAL-STATUS>    	
		            )else(
            ...
            {
	            let $rowResidencia := ($creacionClienteTarjetaCredito1/ns0:CUSTOMER_ADDRESSES/ns0:CUSTOMER_ADDRESS[ADDRESS_TYPE_CODE/text() = '1'])[1]
	            let $rowTrabajo := ($creacionClienteTarjetaCredito1/ns0:CUSTOMER_ADDRESSES/ns0:CUSTOMER_ADDRESS[ADDRESS_TYPE_CODE/text() = '2'])[1]
	            let $rowCorrespondencia := ($creacionClienteTarjetaCredito1/ns0:CUSTOMER_ADDRESSES/ns0:CUSTOMER_ADDRESS[ADDRESS_TYPE_CODE/text() = '5'])[1]
	            return(       
		            ...
		            return(
			            if($DEPARMENT_CODE  != "")then(
			            	<AZXNAI-M-CITY>{ valorCatalogoOSBToAPP($DEPARMENT_CODE, 'VISION+GT', '8', $consultaEquivalenciasCatalogos) }</AZXNAI-M-CITY>,
			            	<AZXNAI-M-STATE/>
			            )else(
			            	<AZXNAI-M-CITY/>
			            )
		            ...
		            return(
			            if($MUNICIPALITY_CODE  != "")then(
			            	<AZXNAI-M-PSTL-CD>{ valorCatalogoOSBToAPP($MUNICIPALITY_CODE, 'VISION+GT', '7', $consultaEquivalenciasCatalogos) }</AZXNAI-M-PSTL-CD>
			            )else(
			            	<AZXNAI-M-PSTL-CD/>	            	
			            )
		            ),
		            ...
		            return(
			            if($COUNTRY_CODE  != "")then(
			            	<AZXNAI-M-CNTRY-CD>{ valorCatalogoOSBToAPP($COUNTRY_CODE, 'VISION+GT', '9', $consultaEquivalenciasCatalogos) }</AZXNAI-M-CNTRY-CD>
			            )else(
			            	<AZXNAI-M-CNTRY-CD/>	            	
			            )
		            ),
	            	let $RESIDENCE_TYPE := string($creacionClienteTarjetaCredito1/RESIDENCE_TYPE/text())
		            return(
					...
					return(
						<AZXNAI-M-GENDER-CODE>{ valorCatalogoOSBToAPP($GENDER, 'VISION+GT', '1', $consultaEquivalenciasCatalogos) }</AZXNAI-M-GENDER-CODE>
					), 
			        ...
			        let $DATE_OF_BIRTH := $creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/DATE_OF_BIRTH
		            return(
	            	...
	            	let $DRIVERS_LICENCE := string($creacionClienteTarjetaCredito1/DRIVERS_LICENCE/text())
		            return(
	            	...
	            	<AZXNAI-M-DL-STATE/>,	            
	            	let $COUNTRY_OF_ISSUE_DOCUMENT := string($creacionClienteTarjetaCredito1/COUNTRY_OF_ISSUE_DOCUMENT/text())
		            return(
					...
					return(
						<AZXNAI-M-SSAN-FLAG>{ valorCatalogoOSBToAPP($IDENTIFICATION_TYPE, 'VISION+GT', '4', $consultaEquivalenciasCatalogos) }</AZXNAI-M-SSAN-FLAG>
					),	            			
				    <AZXNAI-M-SSAN>{ data($creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/IDENTIFICATION_NUMBER) }</AZXNAI-M-SSAN>,           
		            <AZXNAI-M-1099C-W9-DATE-FILED>2000-01-01</AZXNAI-M-1099C-W9-DATE-FILED>,
		            <AZXNAI-M-STMT-MSG-INDIC>0</AZXNAI-M-STMT-MSG-INDIC>,	      
	            	let $COMPANY_NAME := string($creacionClienteTarjetaCredito1/ns0:CUSTOMER_TYPE_OF_EMPLOYMENTS/ns0:CUSTOMER_TYPE_OF_EMPLOYMENT/COMPANY_NAME/text())
		            return(
	            	...
	            	let $PROFESSION_CODE := string($creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/PROFESSION_CODE/text())
		            return(
			            if($PROFESSION_CODE  != "")then(
			            	<AZXNAI-M-POSITION>{ valorCatalogoOSBToAPP($PROFESSION_CODE, 'VISION+GT', '3', $consultaEquivalenciasCatalogos) }</AZXNAI-M-POSITION>
			            )else(
			            	<AZXNAI-M-POSITION/>	            	
			            )
		            ),
	            	let $SPOUSE_NAME := string($creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/SPOUSE_NAME/text())
		            return(
			            if($SPOUSE_NAME  != "")then(
	            	...
	            	let $CHILDREN_NUMBERS := string($creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/CHILDREN_NUMBERS/text())
		            return(
	            	...
	            	let $CHANNEL_CODE := string($creacionClienteTarjetaCredito1/ns0:LIST_OF_CHANNELS/ns0:CHANNEL[1]/CHANNEL_CODE/text())
		            return(
	            	...
	            	let $CHANNEL_CODE := string($creacionClienteTarjetaCredito1/ns0:LIST_OF_CHANNELS/ns0:CHANNEL[2]/CHANNEL_CODE/text())
		            return(
			            if($CHANNEL_CODE  != "")then(
	            	...
	            	let $EMPLOYMENT_YEARS := string($creacionClienteTarjetaCredito1/EMPLOYMENT_YEARS/text())
		            return(
	            	...
	            	let $EMPLOYMENT_MONTHS := string($creacionClienteTarjetaCredito1/EMPLOYMENT_MONTHS/text())
		            return(
					...
					let $position:= string($creacionClienteTarjetaCredito1/ns0:CUSTOMER_TYPE_OF_EMPLOYMENTS/ns0:CUSTOMER_TYPE_OF_EMPLOYMENT/POSITION/text())
					return(
						if($position!= "")then(            
							<AZXNAI-M-USER-3>{ valorCatalogoOSBToAPP(data($position), 'VISION+', '11', $consultaEquivalenciasCatalogos) }</AZXNAI-M-USER-3>
					    )else(
					          <AZXNAI-M-USER-3/>  
						)
					),
		            ...
		            <AZXNAI-M-USER-6/>,
			        <AZXNAI-M-USER-7/>,
	            	let $PEPS := string($creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/PEPS/text())
		            return(
			            if($PEPS  != "")then(
	            	...
	            	<AZXNAI-M-USER-9/>,
	            	let $EXPIRATION_DATE := $creacionClienteTarjetaCredito1/EXPIRATION_DATE
		            return(
	            	...
	            	let $ISSUE_DATE := $creacionClienteTarjetaCredito1/ISSUE_DATE
		            return(
	            	...
	            	let $COUNTRY_OF_ISSUE_PASSAPORT := string($creacionClienteTarjetaCredito1/COUNTRY_OF_ISSUE_PASSAPORT/text())
		            return(
	            	...
	            	<AZXNAI-M-USER-13/>,
	            	let $EDUCATION_LEVEL := string($creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/EDUCATION_LEVEL/text())
		            return(
	            	...
	            	let $INCOMES := string($creacionClienteTarjetaCredito1/INCOMES/text())
		            return(
			            if($INCOMES  != "")then(
	            	...
	            	let $OTHERS_INCOMES := string($creacionClienteTarjetaCredito1/OTHERS_INCOMES/text())
		            return(
	            	...
	            	let $COUNTRY_CODE := string($creacionClienteTarjetaCredito1/ns0:CUSTOMER_ADDRESSES/ns0:CUSTOMER_ADDRESS[1]/COUNTRY_CODE/text())
		            return(
			            if($COUNTRY_CODE  != "")then(
			            	<AZXNAI-M-USER-DEMO-2>{ valorCatalogoOSBToAPP($COUNTRY_CODE, 'VISION+GT', '9', $consultaEquivalenciasCatalogos) }</AZXNAI-M-USER-DEMO-2>
			            )else(
			            	<AZXNAI-M-USER-DEMO-2/>	            	
			            )
		            ),             
		            let $FLYER_TYPE := string($creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/FLYER_TYPE/text())
					let $FREQUENT_FLYEER := string($creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/FREQUENT_FLYEER/text())
					return (
		            ...
		            <AZXNAI-M-LAST-NAME>{ concat(data($creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/FIRST_SURNAME)," ",data($creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/SECOND_SURNAME)) }</AZXNAI-M-LAST-NAME>,
		            <AZXNAI-M-MIDDLE-NAME/>,
		            <AZXNAI-M-FIRST-NAME>{ data($creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/NAMES) }</AZXNAI-M-FIRST-NAME>,
		            <AZXNAI-M-SUFFIX/>,
		            <AZXNAI-M-COUNTY/>,
		            let $FLYER_TYPE := string($creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/FLYER_TYPE/text())
					let $FREQUENT_FLYEER := string($creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/FREQUENT_FLYEER/text())
		            ...
		            return(
			            if($DEPARMENT_CODE  != "")then(
			            	<AZXNAI-M-CITY-2>{ valorCatalogoOSBToAPP($DEPARMENT_CODE, 'VISION+GT', '8', $consultaEquivalenciasCatalogos) }</AZXNAI-M-CITY-2>
			            )else(
			            	<AZXNAI-M-CITY-2/>	            	
			            )
		            ),
		            ...
		            return(
			            if($MUNICIPALITY_CODE  != "")then(
			            	<AZXNAI-M-PSTL-CD-2>{ valorCatalogoOSBToAPP($MUNICIPALITY_CODE, 'VISION+GT', '7', $consultaEquivalenciasCatalogos) }</AZXNAI-M-PSTL-CD-2>
			            )else(
			            	<AZXNAI-M-PSTL-CD-2/>	            	
			            )
		            ),
		            ...
		            return(
			            if($COUNTRY_CODE  != "")then(
			            	<AZXNAI-M-CNTRY-CD-2>{ valorCatalogoOSBToAPP($COUNTRY_CODE, 'VISION+GT', '9', $consultaEquivalenciasCatalogos) }</AZXNAI-M-CNTRY-CD-2>
			            )else(
			            	<AZXNAI-M-CNTRY-CD-2/>	            	
			            )
		            ),
		            ...
		            return(
			            if($DEPARMENT_CODE  != "")then(
			            	<AZXNAI-M-CITY-3>{ valorCatalogoOSBToAPP($DEPARMENT_CODE, 'VISION+GT', '8', $consultaEquivalenciasCatalogos) }</AZXNAI-M-CITY-3>
			            )else(
			            	<AZXNAI-M-CITY-3/>	            	
			            )
		            ),
		            ...
		            return(
			            if($MUNICIPALITY_CODE  != "")then(
			            	<AZXNAI-M-PSTL-CD-3>{ valorCatalogoOSBToAPP($MUNICIPALITY_CODE, 'VISION+GT', '7', $consultaEquivalenciasCatalogos) }</AZXNAI-M-PSTL-CD-3>
			            )else(
			            	<AZXNAI-M-PSTL-CD-3/>	            	
			            )
		            ),
		            ...
		            return(
			            if($COUNTRY_CODE  != "")then(
			            	<AZXNAI-M-CNTRY-CD-3>{ valorCatalogoOSBToAPP($COUNTRY_CODE, 'VISION+GT', '9', $consultaEquivalenciasCatalogos) }</AZXNAI-M-CNTRY-CD-3>
			            )else(
			            	<AZXNAI-M-CNTRY-CD-3/>	            	
			            )
		            )
            ...
            <AZXNAI-C-USER-DEMO-3>{ data($creacionClienteTarjetaCredito1/ns0:CUSTOMER_INFO/COUNTRY_ID) }</AZXNAI-C-USER-DEMO-3>
...
xf:customerAddL8V2GTIn($creacionClienteTarjetaCredito1,
    $codigoCliente,
