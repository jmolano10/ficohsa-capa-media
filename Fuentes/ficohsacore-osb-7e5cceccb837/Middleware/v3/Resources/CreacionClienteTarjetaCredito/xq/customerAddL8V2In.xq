        ...
        <ns0:CustomerAddL8V2Request>
            ...
            <AZXNAI-M-NAME-TYPE-IND-3>0</AZXNAI-M-NAME-TYPE-IND-3>
            {
	            ...
	            return(       
		            ...
		            let $FLYER_TYPE := string($creacionClienteTarjetaCredito/ns1:CUSTOMER_INFO/FLYER_TYPE/text())
					let $FREQUENT_FLYEER := string($creacionClienteTarjetaCredito/ns1:CUSTOMER_INFO/FREQUENT_FLYEER/text())
					return (
