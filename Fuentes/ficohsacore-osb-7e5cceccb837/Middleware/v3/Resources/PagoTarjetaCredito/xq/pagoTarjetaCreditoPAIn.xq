...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:global-element-parameter parameter="$pagoTarjetaCredito" element="ns1:pagoTarjetaCredito" location="../xsd/pagoTarjetaCreditoTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/ABKPA/pagoTarjetaCredito/xsd/pagoTarjetaCredito_sp.xsd" ::)
...
xf:pagoTarjetaCreditoPAIn($pagoTarjetaCredito,
    ...
    $destinationBank,
    $debitAccount,
    $paymentAmount)]]></con:xquery>
    <con:dependency location="../xsd/pagoTarjetaCreditoTypes.xsd">
        <con:schema ref="Middleware/v3/Resources/PagoTarjetaCredito/xsd/pagoTarjetaCreditoTypes"/>
    </con:dependency>
    <con:dependency location="../../../BusinessServices/ABKPA/pagoTarjetaCredito/xsd/pagoTarjetaCredito_sp.xsd">
        <con:schema ref="Middleware/v3/BusinessServices/ABKPA/pagoTarjetaCredito/xsd/pagoTarjetaCredito_sp"/>
    </con:dependency>
</con:xqueryEntry>