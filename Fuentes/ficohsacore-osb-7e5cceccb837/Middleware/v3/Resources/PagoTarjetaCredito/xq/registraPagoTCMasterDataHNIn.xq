(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/MasterData/conRegistraPagoTCRG/xsd/conRegistraPagoTCRG_sp.xsd" ::)

declare namespace ns0 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/conRegistraPagoTCRG";
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/PagoTarjetaCredito/xq/registraPagoTCMasterDataHNIn/";
...
declare function xf:registraPagoTCMasterDataHNIn($cardNumber as xs:string,
    ...
    as element(ns0:InputParameters) {
        <ns0:InputParameters>
            ...
            <ns0:TasaCambio>{ 
            	if(string(data($exchangeRate)) = '' or lower-case(string(data($exchangeRate))) = 'null')then(
            		1
            	)else(data($exchangeRate))
            }</ns0:TasaCambio>
