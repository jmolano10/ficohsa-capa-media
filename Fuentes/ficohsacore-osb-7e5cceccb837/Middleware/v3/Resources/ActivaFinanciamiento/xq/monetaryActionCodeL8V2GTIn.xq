...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ActivaFinanciamiento/xq/monetaryActionCodeL8V2GTIn/";

declare function xf:monetaryActionCodeL8V2GTIn($activaFinanciamiento1 as element(ns0:activaFinanciamiento),
...
xf:monetaryActionCodeL8V2GTIn($activaFinanciamiento1,
    $asm-user)