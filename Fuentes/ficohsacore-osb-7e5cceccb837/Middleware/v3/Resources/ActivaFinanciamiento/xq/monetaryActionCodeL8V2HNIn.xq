...
(:: pragma bea:global-element-parameter parameter="$activaFinanciamiento1" element="ns1:activaFinanciamiento" location="../xsd/activaFinanciamientoTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns0:MonetaryActionCodeL8V2Request" location="../../../../v2/BusinessServices/VisionPlus/visionPlus/xsd/XMLSchema_769155616.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ActivaFinanciamiento/xq/monetaryActionCodeL8V2HNIn/";
declare namespace ns1 = "http://www.ficohsa.com.hn/middleware.services/activaFinanciamientoTypes";
declare namespace ns0 = "http://www.procesa.com/fdcs";

declare function xf:monetaryActionCodeL8V2HNIn($activaFinanciamiento1 as element(ns1:activaFinanciamiento),
    $asm-user as xs:string)
    as element(ns0:MonetaryActionCodeL8V2Request) {
        <ns0:MonetaryActionCodeL8V2Request>
...
declare variable $activaFinanciamiento1 as element(ns1:activaFinanciamiento) external;
declare variable $asm-user as xs:string external;

xf:monetaryActionCodeL8V2HNIn($activaFinanciamiento1,
    $asm-user)