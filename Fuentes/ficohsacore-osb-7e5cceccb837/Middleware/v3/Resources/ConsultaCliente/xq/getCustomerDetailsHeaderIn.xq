(:: pragma bea:global-element-return element="ns0:RequestHeader" location="../../../../v2/BusinessServices/FPC/getCustomerDetails12c/xsd/autType.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/autType";
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ConsultaCliente/xq/getCustomerDetailsHeaderIn/";
...
declare function xf:getCustomerDetailsHeaderIn($serviceAccountName as xs:string,
...
xf:getCustomerDetailsHeaderIn($serviceAccountName,
    $sourceBank,
    $destinationBank)
