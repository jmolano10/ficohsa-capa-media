    ...
    as element(ns1:consultaClienteResponse) {
        <ns1:consultaClienteResponse>
           <ns1:CUSTOMER_ID>{data($outputParametersIN/ns0:RowSet[1]/ns0:Row[1]/ns0:Column[@name='CUSTOMER_ID'])}</ns1:CUSTOMER_ID>
				...
				<ns1:GIVEN_NAMES>{data($outputParametersIN/ns0:RowSet[1]/ns0:Row[1]/ns0:Column[@name='GIVEN_NAMES'])}</ns1:GIVEN_NAMES>
                <ns1:FAMILY_NAME>{data($outputParametersIN/ns0:RowSet[1]/ns0:Row[1]/ns0:Column[@name='FAMILY_NAMES'])}</ns1:FAMILY_NAME>
                <ns1:FULL_NAME>{data($outputParametersIN/ns0:RowSet[1]/ns0:Row[1]/ns0:Column[@name='FULL_NAME']/text())}</ns1:FULL_NAME>
                ...
                <ns1:LEGAL_HOLDER_NAME>{data($outputParametersIN/ns0:RowSet[1]/ns0:Row[1]/ns0:Column[@name='FULL_NAME'])}</ns1:LEGAL_HOLDER_NAME>
               { 
