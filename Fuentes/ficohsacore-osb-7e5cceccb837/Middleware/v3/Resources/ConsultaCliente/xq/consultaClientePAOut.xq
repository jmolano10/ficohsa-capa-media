(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns0:OutputParameters" location="../../../BusinessServices/ABKPA/consultaCliente/xsd/consultaCliente_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/abanksPA/consultaCliente/xq/consultaClienteOut2/";
        ...
        <ns1:consultaClienteResponse>
            ...
            <ns1:IDENTIFICATION_INFO>
                <ns1:LEGAL_IDENTIFICATION_ITEM>
                    <ns1:LEGAL_DOCUMENT_NAME>{ $outputParameters1/ns0:PV_LEGAL_DOC_NAME/@* , $outputParameters1/ns0:PV_LEGAL_DOC_NAME/node() }</ns1:LEGAL_DOCUMENT_NAME>
            ...
            <ns1:ADDRESS_INFO>
            {
	            ...
	            <ns1:ADDRESS_ITEM>
	                ...
	                <ns1:IS_MAIN_ADDRESS>{ data($isMainAddress[$i]) }</ns1:IS_MAIN_ADDRESS>
	            </ns1:ADDRESS_ITEM>
            }
            </ns1:ADDRESS_INFO>
            <ns1:EMAIL_INFO>
