...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../../v2/BusinessServices/MasterDataHN/conMaestroSaldos/xsd/ConsultaMaestroSaldosTarjetaCredito_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ConsultaMaestraSaldosTarjetaCredito/xq/conMaestroSaldosTCHNIn/";

declare function xf:conMaestroSaldosTCHNIn(
...
xf:conMaestroSaldosTCHNIn($cardNumber, 
	$codigoPais, 
	$org)