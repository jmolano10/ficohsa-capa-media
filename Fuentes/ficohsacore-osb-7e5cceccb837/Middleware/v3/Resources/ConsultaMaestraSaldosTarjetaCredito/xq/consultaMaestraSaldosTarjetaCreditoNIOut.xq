        ...
        <ns0:consultaMaestraSaldosTarjetaCreditoResponse>
            {
            	if(not(empty($outputParameters1/ns2:PT_MAESTRA_SALDOS_TC/ns2:PT_MAESTRA_SALDOS_TC_ITEM)))then(				   
	              ...
	              return(
			    	...
			    	let $sjConsultaMaestraSaldosTarjetaCredito :=  $sjConsultaMaestraSaldosTarjetaCreditoResponse/CREDIT_CARD_BALANCE_INFO[ORG = $org]        	 return(
		        		<CREDIT_CARD_BALANCE_INFO>
		        		{
		        	 	...
		        	 	<CURRENT_BALANCE>{ data($sjConsultaMaestraSaldosTarjetaCredito/CURRENT_BALANCE) }</CURRENT_BALANCE>
