...
declare function xf:registraMestroSaldosTCPAIn($outputParameters as element(ns1:OutputParameters),
...
xf:registraMestroSaldosTCPAIn($outputParameters,
    $sjConsultaMaestraSaldosTarjetaCreditoResponse,
    $valSaldoActualPuntos,
    $cardNumer,
    $countryCode,
    $valDisponibleCompras)
