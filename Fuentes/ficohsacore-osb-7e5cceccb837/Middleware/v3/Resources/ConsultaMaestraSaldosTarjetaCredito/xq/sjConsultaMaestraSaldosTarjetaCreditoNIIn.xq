...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../../v2/BusinessServices/MasterData/conSaldosCTS/xsd/consultaSaldosCTS_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ConsultaMaestraSaldosTarjetaCredito/xq/sjConsultaMaestraSaldosTarjetaCreditoNIIn/";
declare namespace ns0 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/consultaSaldosCTS";
declare namespace ns1 = "http://www.ficohsa.com.hn/middleware.services/sjConsultaMaestraSaldosTarjetaCreditoTypes";

declare function xf:sjConsultaMaestraSaldosTarjetaCreditoNIIn($outputParameters as element(ns0:OutputParameters),
...
xf:sjConsultaMaestraSaldosTarjetaCreditoNIIn($outputParameters,
    $cardNumber,
    $countryCode)
