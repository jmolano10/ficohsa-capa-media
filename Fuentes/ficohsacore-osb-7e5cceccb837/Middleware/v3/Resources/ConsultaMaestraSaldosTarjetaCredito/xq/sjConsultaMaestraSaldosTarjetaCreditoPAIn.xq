...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../../v2/BusinessServices/ProcesosPA/conMaestroSaldos/xsd/ConsultaMaestroSaldosTarjetaCredito_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/ConsultaMaestraSaldosTarjetaCredito/xq/sjConsultaMaestraSaldosTarjetaCreditoPAIn/";
...
declare function xf:sjConsultaMaestraSaldosTarjetaCreditoPAIn($outputParameters as element(ns0:OutputParameters),
...
xf:sjConsultaMaestraSaldosTarjetaCreditoPAIn($outputParameters,
    $cardNumber,
    $countryCode)
