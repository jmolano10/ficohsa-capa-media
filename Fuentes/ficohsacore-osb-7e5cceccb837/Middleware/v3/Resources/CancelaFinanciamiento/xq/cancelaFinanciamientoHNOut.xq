...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/CancelaFinanciamiento/xq/cancelaFinanciamientoHNOut/";

declare function xf:cancelaFinanciamientoHNOut($planLevelSettlementQuoteL8V1Response as element(ns0:PlanLevelSettlementQuoteL8V1Response))
...
xf:cancelaFinanciamientoHNOut($planLevelSettlementQuoteL8V1Response)
