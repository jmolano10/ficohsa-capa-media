...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/CancelaFinanciamiento/xq/cancelaFinanciamientoNIOut/";

declare function xf:cancelaFinanciamientoNIOut($planLevelSettlementQuoteL8V1Response as element(ns0:PlanLevelSettlementQuoteL8V1Response))
...
xf:cancelaFinanciamientoNIOut($planLevelSettlementQuoteL8V1Response)
