...
(:: pragma bea:schema-type-parameter parameter="$tELLERType" type="ns1:TELLERType" location="../../../../Business_Resources/pagoRecaudos/Resources/XMLSchema_-258408779.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v3/Resources/PagoRecaudo/xq/pagoRecaudoConsultaUsuarioTellerIn/";
...
declare function xf:pagoRecaudoConsultaUsuarioTellerIn($requestHeader as element(ns0:RequestHeader),
...
xf:pagoRecaudoConsultaUsuarioTellerIn($requestHeader,
    $tELLERType)