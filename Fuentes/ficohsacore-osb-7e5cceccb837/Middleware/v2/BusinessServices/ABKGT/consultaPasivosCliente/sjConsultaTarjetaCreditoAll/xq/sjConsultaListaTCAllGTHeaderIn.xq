...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/abanksGT/consultaPasivosCliente/sjConsultaTarjetaCreditoAll/sjConsultaListaTCAllHeaderIn/";

declare function xf:sjConsultaListaTCAllHeaderIn($requestHeader1 as element(ns0:RequestHeader))
...
xf:sjConsultaListaTCAllHeaderIn($requestHeader1)