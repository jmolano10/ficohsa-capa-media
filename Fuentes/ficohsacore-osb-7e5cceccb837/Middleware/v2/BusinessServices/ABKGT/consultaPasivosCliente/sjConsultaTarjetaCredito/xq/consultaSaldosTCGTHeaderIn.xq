(:: pragma bea:global-element-parameter parameter="$requestHeader1" element="ns0:RequestHeader" location="../../../../../Resources/esquemas_generales/HeaderElements.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/abanksGT/consultaPasivosCliente/sjConsultaTarjetaCredito/consultaSaldosTarjetaCreditoHeaderIn/";

declare function xf:consultaSaldosTarjetaCreditoHeaderIn($requestHeader1 as element(ns0:RequestHeader))
...
xf:consultaSaldosTarjetaCreditoHeaderIn($requestHeader1)