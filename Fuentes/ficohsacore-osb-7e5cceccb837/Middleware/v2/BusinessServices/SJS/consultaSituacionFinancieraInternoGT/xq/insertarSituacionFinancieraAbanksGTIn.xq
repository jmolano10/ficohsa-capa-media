(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../ABKGT/obtenerSitFinanciera/xsd/obtenerSitFinanciera_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/BusinessServices/SJS/consultaSituacionFinancieraInternoGT/xq/insertarSituacionFinancieraAbanksGTIn/";

declare function xf:insertarSituacionFinancieraAbanksGTIn($outputParameters as element(ns1:OutputParameters),
            ...
            <ns0:PV_REFERENCIA_LLAVE>{ $referenciaLlave }</ns0:PV_REFERENCIA_LLAVE>
	            {
	                ...
	                return
	                    <ns0:PV_REGION>{ data($PV_REGION) }</ns0:PV_REGION>
	            }
            ...
            <ns0:PT_SUCCESS_INDICADOR_IN>
                {
                    ...
                    return
                        <ns0:PT_APLICACION_CORE_ITEM>{ data($successIndicator) }</ns0:PT_APLICACION_CORE_ITEM>
                }
            </ns0:PT_SUCCESS_INDICADOR_IN>
...
xf:insertarSituacionFinancieraAbanksGTIn($outputParameters,
    $referenciaLlave,
    $usuario)
