...
(:: pragma bea:local-element-parameter parameter="$dEBTOR1" type="ns1:consultaRecaudoMultiple/AGREEMENTS/AGREEMENT/DEBTORS/DEBTOR" location="../xsd/sjConsultaRecaudoMultipleTypesPA.xsd" ::)
(:: pragma bea:schema-type-return type="ns1:debtorsResponseType" location="../xsd/sjConsultaRecaudoMultipleTypesPA.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/BusinessServices/SJS/consultaRecaudoMultiplePA/xq/sjConsRecaudoPAOut/";
...
declare function xf:sjConsRecaudoPAOut($responseHeader as element(ns0:ResponseHeader),
...
xf:sjConsRecaudoPAOut($responseHeader,
