...
declare namespace xf = "http://tempuri.org/Middleware/v2/BusinessServices/SJS/consultaActivosPasivosCliente/xq/ConsultaActivosClienteHeaderOUT/";

declare function xf:ConsultaActivosClienteHeaderOUT($responseHeaderIN as element(ns1:ResponseHeader))
...
xf:ConsultaActivosClienteHeaderOUT($responseHeaderIN)
