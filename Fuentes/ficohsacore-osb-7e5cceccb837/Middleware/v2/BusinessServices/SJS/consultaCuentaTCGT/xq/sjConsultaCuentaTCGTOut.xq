...
declare function xf:sjConsultaCuentaTCGTOut($resultGroup as element(*), $sjconsultaCuentaTC as element(ns0:sjconsultaCuentaTC))
        	...
        	for $datosCuenta at $i in $sjconsultaCuentaTC/ACCOUNT_INFORMATION
	        	...
	        	return
        	 		<BALANCE_INFORMATION>
			            ...
			            {
				           	for $currentBalance in string($balanceInquiryVAResponse/ARXBIO-CURR-BAL/text())
				            	return
			            ...
			            {(:for $availableWithdrawal in string($accountInquiryL8VLResponse/AZXAIO-AVAIL-CREDIT-WO-OVL/text()):)
...
xf:sjConsultaCuentaTCGTOut($resultGroup, $sjconsultaCuentaTC)