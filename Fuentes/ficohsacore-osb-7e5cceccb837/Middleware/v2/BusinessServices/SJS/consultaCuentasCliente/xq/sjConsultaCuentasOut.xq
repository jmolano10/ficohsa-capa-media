...
(:: pragma bea:global-element-return element="ns1:sjConsultaActivosClienteResponse" location="../../../../../Business_Resources/consultasCliente/consultaActivosCliente/sjConsultaActivosCliente.xsd" ::)

declare namespace ns1 = "http://www.ficohsa.com.hn/middleware.services/sjConsultaActivosCliente";
declare namespace ns0 = "T24WebServicesImpl";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/consultaActivosCliente/xq/sjConsultaCuentasOut/";
                ...
                <ns1:consultaActivoResponseRecords>
                    {
                        ...
                        return
                            <ns1:consultaActivoResponseRecord>
                                ...
                                {
                                    for $OPERATIONTYPE in $mWSFICOLINKSAVINGSACCTDetailType/OPERATIONTYPE
                                    return
                                        <ns1:PRODUCTTYPE>{ data($OPERATIONTYPE) }</ns1:PRODUCTTYPE>
                                }                                
                            </ns1:consultaActivoResponseRecord>
                    }
                </ns1:consultaActivoResponseRecords>
                ...
                <ns1:consultaActivoResponseRecords>
                    {
                        ...
                        return
                            <ns1:consultaActivoResponseRecord>
                                ...
                                {
                                    for $OPERATIONTYPE in $mWSFICOLINKCURRENTACCTDetailType/OPERATIONTYPE
                                    return
                                        <ns1:PRODUCTTYPE>{ data($OPERATIONTYPE) }</ns1:PRODUCTTYPE>
                                }
                            </ns1:consultaActivoResponseRecord>
