...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/abanksPA/consultaActivosCliente/xq/consultaListaCuentas/consultaActivosClienteIn/";
        ...
        <ns1:InputParameters>
            {
                ...
                return
                    <ns1:PV_CUSTOMER_ID>{ data($PV_CUSTOMER_ID) }</ns1:PV_CUSTOMER_ID>
            }
