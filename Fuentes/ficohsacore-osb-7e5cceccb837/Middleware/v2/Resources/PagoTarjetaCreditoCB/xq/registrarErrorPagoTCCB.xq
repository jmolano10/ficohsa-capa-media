...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoTarjetaCreditoCB/xq/registrarErrorPagoTCCB/";

declare function xf:registrarErrorPagoTCCB($uuid as xs:string,
    $etapa as xs:string,
...
xf:registrarErrorPagoTCCB($uuid,
    $etapa,
    $descripcionError,
    $msrequest,
    $msresponse)
