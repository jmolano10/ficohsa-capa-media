...
(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns0:OutputParameters" location="../../../BusinessServices/MasterDataGT/conResumenComprasCuotas/xsd/conResumenComprasCuotas_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaIntrasPorCuenta/xq/consultaIntrasPorCuentaGTOut/";
...
declare function xf:consultaIntrasPorCuentaGTOut($outputParameters1 as element(ns0:OutputParameters))
...
xf:consultaIntrasPorCuentaGTOut($outputParameters1)
