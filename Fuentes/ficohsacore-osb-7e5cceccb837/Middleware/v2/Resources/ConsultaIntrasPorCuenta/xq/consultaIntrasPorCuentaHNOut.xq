(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns0:OutputParameters" location="../../../BusinessServices/MasterDataHN/conResumenComprasCuotas/xsd/conResumenComprasCuotas_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaIntrasPorCuenta/xq/consultaIntrasPorCuentaHNOut/";

declare function xf:consultaIntrasPorCuentaHNOut($outputParameters1 as element(ns0:OutputParameters))
...
xf:consultaIntrasPorCuentaHNOut($outputParameters1)