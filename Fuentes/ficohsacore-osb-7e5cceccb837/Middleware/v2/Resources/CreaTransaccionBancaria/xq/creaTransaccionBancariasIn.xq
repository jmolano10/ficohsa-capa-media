...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:global-element-parameter parameter="$requestHeader1" element="ns2:RequestHeader" location="../../esquemas_generales/HeaderElements.xsd" ::)
...
xf:creaTransaccionBancariasIn($requestHeader1,
    $creaTransaccionBancaria1)]]></con:xquery>
    ...
    <con:dependency location="../../OperacionesACH/xsd/operacionesACHTypes.xsd">
        <con:schema ref="Middleware/v2/Resources/OperacionesACH/xsd/operacionesACHTypes"/>
    </con:dependency>
    <con:dependency location="../../../BusinessServices/T24/CreaTransaccionBancariaACH/xsd/creaTransaccionBancariaACH.xsd">
        <con:schema ref="Middleware/v2/BusinessServices/T24/CreaTransaccionBancariaACH/xsd/creaTransaccionBancariaACH"/>
    </con:dependency>
</con:xqueryEntry>