...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CalculaFinanciamientoTC/xq/calculaFinanciamientoTCOut/";

declare function xf:calculaFinanciamientoTCOut($CuotaCalculada as element(*),
...
xf:calculaFinanciamientoTCOut($CuotaCalculada,
    $totalAmount,
    $numberOfPayments)
