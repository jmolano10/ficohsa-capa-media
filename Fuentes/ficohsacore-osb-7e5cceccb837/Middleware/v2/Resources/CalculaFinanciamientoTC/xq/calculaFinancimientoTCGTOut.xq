...
(:: pragma  parameter="$CuotaCalculada" type="xs:anyType" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CalculaFinanciamientoTC/xq/calculaFinancimientoTCGTOut/";
declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/solicitudFinanciamientoTCTypes";

declare function xf:calculaFinancimientoTCGTOut($CuotaCalculada as element(*),
...
xf:calculaFinancimientoTCGTOut($CuotaCalculada,
    $totalAmount,
    $numberOfPayments)