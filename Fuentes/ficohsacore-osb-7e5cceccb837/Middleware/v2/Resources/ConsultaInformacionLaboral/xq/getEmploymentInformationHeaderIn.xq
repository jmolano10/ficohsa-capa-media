...
(:: pragma bea:global-element-return element="ns0:RequestHeader" location="../../../BusinessServices/FPC/getEmploymentInformation12c/xsd/HeaderElements.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaInformacionLaboral/xq/getEmploymentInformationHeaderIn/";
...
declare function xf:getEmploymentInformationHeaderIn($serviceAccountName as xs:string,
...
xf:getEmploymentInformationHeaderIn($serviceAccountName,
    $sourceBank,
    $destinationBank)