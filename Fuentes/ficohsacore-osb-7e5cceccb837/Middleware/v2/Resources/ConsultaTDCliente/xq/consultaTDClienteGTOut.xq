...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaTDCliente/xq/consultaTDClienteGTOut/";

declare function xf:consultaTDClienteGTOut($outputParameters1 as element(ns1:OutputParameters))
...
xf:consultaTDClienteGTOut($outputParameters1)