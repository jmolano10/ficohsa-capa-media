...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/TransaccionesAsincronas/DB/ConsultarEstadoTransaccionCB/xsd/consultaEstadoTransaccionCB_sp.xsd" ::)

declare namespace ns1 = "http://www.ficohsa.com.hn/middleware.services/consultaEstadoTransaccionTypes";
declare namespace ns0 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/consultaEstadoTransaccionCB";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaEstadoTransaccionCorr/xq/newConsultaEstadoTransaccionDBIn/";

declare function xf:newConsultaEstadoTransaccionDBIn($usuario as xs:string,
...
xf:newConsultaEstadoTransaccionDBIn($usuario,
