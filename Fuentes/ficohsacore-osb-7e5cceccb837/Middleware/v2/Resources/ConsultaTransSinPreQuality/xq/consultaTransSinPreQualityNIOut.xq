...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../BusinessServices/MasterData/conTransaccionesSinPreQ/xsd/conTransaccionesSinPreQ_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaTransSinPreQuality/xq/consultaTransSinPreQualityNIOUT/";
...
declare function xf:consultaTransSinPreQualityNIOUT($outputParameters as element(ns0:OutputParameters))
...
xf:consultaTransSinPreQualityNIOUT($outputParameters)