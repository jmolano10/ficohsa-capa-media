...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../BusinessServices/MasterDataGT/conTransaccionesSinPreQ/xsd/conTransaccionesSinPreQ_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaTransSinPreQuality/xq/consultaTransSinPreQualityGTOUT/";
...
declare function xf:consultaTransSinPreQualityGTOUT($outputParameters as element(ns0:OutputParameters))
...
xf:consultaTransSinPreQualityGTOUT($outputParameters)