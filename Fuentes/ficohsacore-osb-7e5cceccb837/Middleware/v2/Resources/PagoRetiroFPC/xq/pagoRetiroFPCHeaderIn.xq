(:: pragma bea:global-element-return element="ns0:RequestHeader" location="../../../BusinessServices/FPC/pagoRetiroFPC12c/xsd/Header11gMapper.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/autType";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoRetiroFPC/xq/pagoRetiroFPCHeaderIn/";
...
declare function xf:pagoRetiroFPCHeaderIn($serviceAccountName as xs:string,
...
xf:pagoRetiroFPCHeaderIn($serviceAccountName,
    $sourceBank,
    $destinationBank)
