...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoTarjetaCredito/xq/pagoTarjetaCreditoIn/";
...
declare function xf:pagoTarjetaCreditoIn($requestHeader as element(ns0:RequestHeader),
...
xf:pagoTarjetaCreditoIn($requestHeader,
    $pagoTarjetaCredito,
    $uuid,
    $currentBalance,
    $clientId)