(:: pragma bea:global-element-parameter parameter="$inputParameters1" element="ns0:InputParameters" location="../../../BusinessServices/ABKPA/pagoTarjetaCredito/xsd/pagoTarjetaCredito_sp.xsd" ::)
(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns0:OutputParameters" location="../../../BusinessServices/ABKPA/pagoTarjetaCredito/xsd/pagoTarjetaCredito_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoTarjetaCredito/xq/pagoTCPAOut/";

declare function xf:pagoTCPAOut($inputParameters1 as element(ns0:InputParameters),
...
xf:pagoTCPAOut($inputParameters1,
    $outputParameters1)