...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoRecaudoOnline/xq/pagoRecaudoOnlineDebitoCuentaIn/";
...
declare function xf:pagoRecaudoInternoOnlineCuentaIn($requestHeader as element(ns0:RequestHeader),
...
xf:pagoRecaudoInternoOnlineCuentaIn($requestHeader,
    $pagoRecaudoInterno,
    $outputParameters,
    $uuid)