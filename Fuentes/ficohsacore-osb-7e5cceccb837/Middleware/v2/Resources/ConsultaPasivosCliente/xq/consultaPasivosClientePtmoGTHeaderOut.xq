...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/abanksGT/consultaPasivosCliente/xq/consultaPasivosClienteHeaderOut/";

declare function xf:consultaPasivosClienteHeaderOut($outputParameters1 as element(ns1:OutputParameters))
...
xf:consultaPasivosClienteHeaderOut($outputParameters1)