...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/MasterDataPA/conDatosTarjetaCliente/xsd/conDatosTarjetaCliente_sp.xsd" ::)

declare namespace ns0 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/conDatosTarjetaCliente";
declare namespace ns1 = "http://www.ficohsa.com.hn/middleware.services/consultaClientesTypes";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaPasivosCliente/xq/conDatosTarjetaClientePAIn/";

declare function xf:conDatosTarjetaClientePAIn($consultaPasivosClienteRequest1 as element(ns1:consultaPasivosClienteRequest),
...
xf:conDatosTarjetaClientePAIn($consultaPasivosClienteRequest1,
    $codigoPais)