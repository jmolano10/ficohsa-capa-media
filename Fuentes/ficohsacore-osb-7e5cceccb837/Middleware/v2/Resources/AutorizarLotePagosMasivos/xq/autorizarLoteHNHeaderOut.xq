...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/AutorizarLotePagosMasivos/xq/autorizarLoteHNHeaderOut/";

declare function xf:autorizarLoteHNHeaderOut($outputParameters as element(ns1:OutputParameters))
...
xf:autorizarLoteHNHeaderOut($outputParameters)