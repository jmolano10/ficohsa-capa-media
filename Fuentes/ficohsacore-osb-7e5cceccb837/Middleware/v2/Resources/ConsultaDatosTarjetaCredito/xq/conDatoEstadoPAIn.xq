...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaDatosTarjetaCredito/xq/conDatoEstadoPAIn/";

declare function xf:conDatoEstadoPAIn($codigoPais as xs:string,
...
xf:conDatoEstadoPAIn($codigoPais,
