...
(:: pragma bea:global-element-return element="ns1:UpdateUser" location="../../../BusinessServices/CREDITFORCEPA/GestionAccesosUsuarios/xsd/XMLSchema_-336569570.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ModificaAccesoUsuario/xq/updateUserCFPAIn/";
...
declare function xf:updateUserCFPAIn($modificaAccesoUsuario as element(ns2:modificaAccesoUsuario),
    $token as xs:string,
...
xf:updateUserCFPAIn($modificaAccesoUsuario,
    $token,
    $userName)