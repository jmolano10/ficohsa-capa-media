(:: pragma bea:global-element-return element="ns0:RequestHeader" location="../../../BusinessServices/ConsultaRetiroFPC/Resources/v1_2.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/autType";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ProcesaMensajeGenericoT24/xq/consultaRetiroFPCHeaderIn/";
...
declare function xf:consultaRetiroFPCHeaderIn($serviceAccountName as xs:string,
...
xf:consultaRetiroFPCHeaderIn($serviceAccountName,
    $sourceBank,
    $destinationBank)