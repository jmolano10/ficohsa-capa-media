(:: pragma bea:global-element-return element="ns0:RequestHeader" location="../../../BusinessServices/ReversionRetiroFPC/Resources/v1_2.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/autType";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ProcesaMensajeGenericoT24/xq/reversaRetiroFPCHeaderIn/";
...
declare function xf:reversaRetiroFPCHeaderIn($serviceAccountName as xs:string,
...
xf:reversaRetiroFPCHeaderIn($serviceAccountName,
    $sourceBank,
    $destinationBank)