(:: pragma bea:global-element-return element="ns0:RequestHeader" location="../../../BusinessServices/FPC/getPensionFund12c/xsd/HeaderElements.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/autType";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaFondoPensiones/xq/getPensionFundHeaderIn/";
...
declare function xf:getPensionFundHeaderIn($serviceAccountName as xs:string,
...
xf:getPensionFundHeaderIn($serviceAccountName,
    $sourceBank,
    $destinationBank)
