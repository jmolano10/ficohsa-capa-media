...
(:: pragma bea:global-element-return element="ns1:recordCustomerData" location="../../../BusinessServices/ABKPA/actualizaClientes/wsdl/abandef_08032021.wsdl" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ActualizaSistemas/xq/actualizacionClienteAbanksPAIn/";
...
declare function xf:actualizacionClienteAbanksPAIn($actualizaSistemas as element(ns0:actualizaSistemas))
    as element(ns1:recordCustomerData) {
<ns1:recordCustomerData>
        {
            for $uuid in $actualizaSistemas/CUSTOMER_DATA/CUSTOMER_INFO/INFO[NAME = "UUID"]
            return  
            <UUID>{ data($uuid/VALUE) }</UUID>
        }
        <CUSTOMER_DATA>
                 {
                 let $actualizaSistemas := $actualizaSistemas/CUSTOMER_DATA
                 return(
                 	<CUSTOMER_INFO>
                   		{
...
xf:actualizacionClienteAbanksPAIn($actualizaSistemas)