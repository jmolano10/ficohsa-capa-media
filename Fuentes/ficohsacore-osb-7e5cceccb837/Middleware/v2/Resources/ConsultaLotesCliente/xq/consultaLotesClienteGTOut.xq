...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaLotesCliente/xq/consultaLotesClienteGTOut/";

declare function xf:consultaLotesClienteGTOut($consultaLotesCliente as element(ns0:consultaLotesCliente),
            ...
            <BATCHES>
            {
                ...
                return
	                <BATCH>
	                    ...
	                    {
	                    	for $APPLICATION_DATE in $customerBatchQueryResponse/batches/batch[$i]/applicationDate
	                    	return
	                    	if(string($APPLICATION_DATE/text()) != "") then (
	                    		<APPLICATION_DATE>{ fn:adjust-dateTime-to-timezone(data($APPLICATION_DATE), ()) }</APPLICATION_DATE>
	                    	) else ()
	                    }
...
xf:consultaLotesClienteGTOut($consultaLotesCliente,
