(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../BusinessServices/MasterDataGT/conDatoAutorizacionesHistorica/xsd/conDatoAutorizacionesHistorica_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaHistoricoAutorizaciones/xq/consultaHistoricoAutorizacionesGTOut/";

declare function xf:consultaHistoricoAutorizacionesGTOut($outputParameters as element(ns0:OutputParameters))
...
xf:consultaHistoricoAutorizacionesGTOut($outputParameters)