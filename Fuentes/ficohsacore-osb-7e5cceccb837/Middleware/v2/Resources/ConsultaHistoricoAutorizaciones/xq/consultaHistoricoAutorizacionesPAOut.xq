(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../BusinessServices/MasterDataPA/conDatoAutorizacionesHistorica/xsd/conDatoAutorizacionesHistorica_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaHistoricoAutorizaciones/xq/consultaHistoricoAutorizacionesPAOut/";

declare function xf:consultaHistoricoAutorizacionesPAOut($outputParameters as element(ns0:OutputParameters))
...
xf:consultaHistoricoAutorizacionesPAOut($outputParameters)