...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/VisionPlus/xq/cardActionUpdateIn/";

declare function xf:cardActionUpdateIn($org as xs:string,
    ...
    as element(ns0:CardActionUpdateRequest) {
        <ns0:CardActionUpdateRequest>
            ...
            <ARXPRI-NBR-REQ-CARDS>0</ARXPRI-NBR-REQ-CARDS>
