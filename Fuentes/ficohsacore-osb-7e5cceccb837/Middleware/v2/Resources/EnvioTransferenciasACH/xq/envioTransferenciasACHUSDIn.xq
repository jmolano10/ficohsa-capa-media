...
(:: pragma bea:global-element-return element="ns0:SendDebitUSD" location="../../../BusinessServices/PYST/envioTransfACH/xsd/XMLSchema_-1986733638.xsd" ::)

declare namespace ns0 = "http://tempuri.org/";
declare namespace ns1 = "http://www.ficohsa.com.hn/middleware.services/envioTransferenciasACHTypes";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/EnvioTransferenciasACH/xq/envioTransferenciasACHUSDIn/";

declare function xf:envioTransferenciasACHUSDIn($envioTransferenciasACH1 as element(ns1:envioTransferenciasACH))
    as element(ns0:SendDebitUSD) {
        <ns0:SendDebitUSD>
...
xf:envioTransferenciasACHUSDIn($envioTransferenciasACH1)