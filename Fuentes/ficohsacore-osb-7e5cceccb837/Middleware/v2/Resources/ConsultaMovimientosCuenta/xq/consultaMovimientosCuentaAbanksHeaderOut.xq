...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaMovimientosCuenta/xq/consultaMovimientosCuentaAbanksHeaderOut/";

declare function xf:consultaMovimientosCuentaAbanksHeaderOut($outputParameters1 as element(ns0:OutputParameters))
...
xf:consultaMovimientosCuentaAbanksHeaderOut($outputParameters1)
