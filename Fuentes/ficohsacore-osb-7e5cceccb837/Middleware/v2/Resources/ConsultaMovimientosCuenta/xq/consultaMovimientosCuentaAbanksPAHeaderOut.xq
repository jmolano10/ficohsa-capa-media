...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaMovimientosCuenta/xq/consultaMovimientosCuentaAbanksPAHeaderOut/";

declare function xf:consultaMovimientosCuentaAbanksPAHeaderOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaMovimientosCuentaAbanksPAHeaderOut($outputParameters)