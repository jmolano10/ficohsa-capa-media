...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/EliminarProveedores/xq/eliminarProveedoresNIIn/";

declare function xf:eliminarProveedoresNIIn($eliminarProveedores as element(ns1:eliminarProveedores),
...
xf:eliminarProveedoresNIIn($eliminarProveedores,
    $requestHeader)