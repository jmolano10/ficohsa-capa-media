...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaInventario/xq/consultaDetalleInventarioIn/";
...
declare function xf:consultaDetalleInventarioIn($requestHeader1 as element(ns0:RequestHeader),
...
xf:consultaDetalleInventarioIn($requestHeader1,
    $stockCode)