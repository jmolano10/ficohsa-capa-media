...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagosMasivosInterno/xq/pagosMasivosInternoGTHeaderOut/";

declare function xf:pagosMasivosInternoGTHeaderOut($cargarLotesResponse as element(ns1:cargarLotesResponse))
...
xf:pagosMasivosInternoGTHeaderOut($cargarLotesResponse)