...
xf:pagosMasivosInternoPAIn($requestHeader,
    ...
    <con:dependency location="../../../BusinessServices/MTR/cargadorArchivoLote/wsdl/cargadorArchivoLoteEndpoint.wsdl"/>
</con:xqueryEntry>