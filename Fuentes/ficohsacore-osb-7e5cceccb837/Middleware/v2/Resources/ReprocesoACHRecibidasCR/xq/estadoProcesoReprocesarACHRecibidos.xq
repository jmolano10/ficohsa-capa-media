...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/TransferenciasACHRecibidas/xq/estadoProcesoReprocesarACHRecibidos/";

declare function xf:estadoProcesoReprocesarACHRecibidos($successIndicator as xs:string,
...
xf:estadoProcesoReprocesarACHRecibidos($successIndicator,
    $messages)