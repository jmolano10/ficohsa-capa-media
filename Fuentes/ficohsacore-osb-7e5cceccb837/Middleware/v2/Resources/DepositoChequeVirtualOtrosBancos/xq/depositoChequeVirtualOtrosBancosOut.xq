...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/DepositoChequeVirtualOtrosBancos/xq/depositoChequeVirtualOtrosBancosOut/";

declare function xf:depositoChequeVirtualOtrosBancosOut($chequeType as xs:string,
...
xf:depositoChequeVirtualOtrosBancosOut($chequeType,
    $idRecordRef)