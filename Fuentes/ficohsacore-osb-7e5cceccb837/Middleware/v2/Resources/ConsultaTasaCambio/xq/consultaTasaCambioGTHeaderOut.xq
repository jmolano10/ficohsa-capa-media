...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/abanksGT/consultaTasaCambio/xq/consultaTasaCambioHeaderOut/";
    ...
    as element(ns0:ResponseHeader) {
        <ns0:ResponseHeader>
			...
			}
            {
                ...
                return
                if (($outputParameters1/ns1:ERROR_MESSAGE="Consulta Exitosa")) then
                (
                    <messages></messages>
                )
                else(
