(:: pragma bea:global-element-parameter parameter="$consultadetasadecambiofcyResponse" element="ns1:ConsultadetasadecambiofcyResponse" location="../../../../Business_Resources/Core/Resources/XMLSchema_1632682327.xsd" ::)
...
declare function xf:consultaTasaCambioExtranjeraOut($source as xs:string,
    ...
    as element(ns0:consultaTasaCambioResponse) {
        ...
        {
        	if(fn:upper-case($consultadetasadecambiofcyResponse/Status/successIndicator)="SUCCESS" and fn:upper-case($consultadetasadecambiofcyResponse/WSFCYEXCHRATEType[1]/ZERORECORDS)="" ) then(
