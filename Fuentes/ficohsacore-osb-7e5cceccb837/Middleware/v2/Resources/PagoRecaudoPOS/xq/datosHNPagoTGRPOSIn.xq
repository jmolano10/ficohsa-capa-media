(:: pragma bea:global-element-parameter parameter="$pagoRecaudo1" element="ns1:pagoRecaudo" location="pagoRecaudoTGRPOSTypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoRecaudoPOS/xsd/datosHNPagoTGRPOSIn/";

declare function xf:datosHNPagoTGRPOSIn($pagoRecaudo1 as element(ns1:pagoRecaudo),
...
xf:datosHNPagoTGRPOSIn($pagoRecaudo1,
    $nroReferencia,
    $mecanismo,
    $fecha,
    $estado,
