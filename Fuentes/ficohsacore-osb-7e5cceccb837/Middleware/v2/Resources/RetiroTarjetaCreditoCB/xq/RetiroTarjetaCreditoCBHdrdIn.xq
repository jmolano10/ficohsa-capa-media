...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/RetiroTarjetaCreditoCB/xq/RetiroTarjetaCreditoCBHdrdIn/";

declare function xf:RetiroTarjetaCreditoCBHdrdIn($requestHeader1 as element(ns0:RequestHeader))
...
xf:RetiroTarjetaCreditoCBHdrdIn($requestHeader1)
