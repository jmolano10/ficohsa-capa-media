(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns1:OutputParameters" location="../../../BusinessServices/ABKGT/consultaListaCuentas/xsd/consultaListaCuentas_sp.xsd" ::)
(:: pragma bea:global-element-parameter parameter="$outputParameters2" element="ns2:OutputParameters" location="../../../BusinessServices/ABKGT/consultaListaDepositos/xsd/consultaListaDepositosCliente_sp.xsd" ::)
(:: pragma bea:global-element-return element="ns0:OutputParameters" location="../../../BusinessServices/ABKGT/consultaActivosCliente/xsd/consultaActivosCliente_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/abanksGT/consultaActivosCliente/xq/consultaActivosClienteOut/";
