(:: pragma bea:global-element-parameter parameter="$activosResponse" element="ns0:sjConsultaActivosClienteResponse" location="../../../BusinessServices/SJS/consultaActivosCliente/xsd/sjConsultaActivosCliente.xsd" ::)
        ...
        <ns1:ResponseHeader>
            {
                ...
                let $successIndicatorPensiones := $activosResponse/ns0:consultaActivosClientePensionesResponseType/ns0:successIndicator/text()
                return
                	if ( data($successIndicatorAhorros) != "Success" and data($successIndicatorCorriente) != "Success" and data($successIndicatorDepositos) != "Success" and data($successIndicatorPensiones) != "SUCCESS") then (
                    	<successIndicator>ERROR</successIndicator>,
                    	for $messages in $activosResponse/ns0:consultaCuentaAhorrosResponse/ns0:messages union $activosResponse/ns0:consultaCuentaCorrienteResponse/ns0:messages union $activosResponse/ns0:consultaCertifDepositoResponse/ns0:messages union $activosResponse/ns0:consultaActivosClientePensionesResponseType/ns0:messages
                    	return
                    	...
                    	let $pensiones := count($activosResponse/ns0:consultaActivosClientePensionesResponseType/ns0:consultaActivoResponseRecords/ns0:consultaActivoResponseRecord)
                    	return 
