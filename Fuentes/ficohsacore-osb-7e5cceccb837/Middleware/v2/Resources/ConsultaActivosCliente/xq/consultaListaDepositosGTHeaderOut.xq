...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/abanksGT/consultaListaDepositos/xq/consultaActivosClienteHeaderOut/";

declare function xf:consultaActivosClienteHeaderOut($outputParameters1 as element(ns1:OutputParameters))
...
xf:consultaActivosClienteHeaderOut($outputParameters1)