...
declare function xf:consultaActivosClienteHeaderFPCOut($ahorroResponse as element(ns0:ConsultaCuentaAhorroxClienteResponse),
...
xf:consultaActivosClienteHeaderFPCOut($ahorroResponse,
    $corrienteResponse,
    $depositoResponse,
    $outputParameters)