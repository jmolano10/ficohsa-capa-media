...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:global-element-parameter parameter="$opConsultaActivosClienteRespuesta" element="ns1:opConsultaActivosClienteRespuesta" location="../../../BusinessServices/CTS/activos/xsd/services.xsd" ::)
...
xf:consultaActivosClienteNIOut($opConsultaActivosClienteRespuesta)]]></con:xquery>
    <con:dependency location="../../../BusinessServices/CTS/activos/xsd/services.xsd">
        <con:schema ref="Middleware/v2/BusinessServices/CTS/activos/xsd/services"/>
    </con:dependency>
    <con:dependency location="../xsd/consultaClientesTypes.xsd">
        <con:schema ref="Middleware/v2/Resources/ConsultaActivosCliente/xsd/consultaClientesTypes"/>
    </con:dependency>
</con:xqueryEntry>