    ...
    as element(ns1:consultaActivosClienteResponse) {
        <ns1:consultaActivosClienteResponse>
            ...
            <ns1:consultaActivosClientePensionesResponseType>
            	{
                    for $CODIGO_ERROR in $outputParameters/StatusInfo/Status
                    return
                        <SUCCESS_INDICATOR>{ mensajeRespuesta(data($CODIGO_ERROR), $outputParameters/PT_CUENTAS/CUENTA) }</SUCCESS_INDICATOR>
                }
                {
                    ...
                    return
                        <ns1:consultaActivosClienteResponseRecordType>
                            ...
                            <ASSET_NUMBER>{ data($CUENTA/NUMERO_CUENTA) }</ASSET_NUMBER>
                            <ASSET_NAME>{ data($CUENTA/DESCRIPCION_CUENTA) }</ASSET_NAME>
                            <ASSET_CURRENCY>{ data($CUENTA/MONEDA) }</ASSET_CURRENCY>
						    <ASSET_TOTAL_BALANCE>{ data($CUENTA/SALDO_TOTAL) }</ASSET_TOTAL_BALANCE>																			
                        </ns1:consultaActivosClienteResponseRecordType>
                }
            </ns1:consultaActivosClientePensionesResponseType> 
        </ns1:consultaActivosClienteResponse>
