...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoGOPDEI/xq/pagpGOPDEIReversarTransaccion/";

declare function xf:pagpGOPDEIReversarTransaccion($TRANSACTIONID as xs:string,
...
xf:pagpGOPDEIReversarTransaccion($TRANSACTIONID,
    $TRANSACTIONTYPE)