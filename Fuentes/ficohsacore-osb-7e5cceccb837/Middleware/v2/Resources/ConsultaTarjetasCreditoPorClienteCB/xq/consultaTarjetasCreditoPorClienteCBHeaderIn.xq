...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaTarjetasCreditoPorClienteCB/xq/consultaTarjetasCreditoPorClienteCBHeaderIn/";

declare function xf:consultaTarjetasCreditoPorClienteCBHeaderIn($requestHeader as element(ns0:RequestHeader))
...
xf:consultaTarjetasCreditoPorClienteCBHeaderIn($requestHeader)