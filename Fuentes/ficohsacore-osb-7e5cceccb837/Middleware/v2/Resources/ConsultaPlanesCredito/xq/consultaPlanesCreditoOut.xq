(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../BusinessServices/MasterData/conDatosPlanes/xsd/conDatosPlanes_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaPlanesCredito/xq/consultaPlanesCreditoOut/";

declare function xf:consultaPlanesCreditoOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaPlanesCreditoOut($outputParameters)