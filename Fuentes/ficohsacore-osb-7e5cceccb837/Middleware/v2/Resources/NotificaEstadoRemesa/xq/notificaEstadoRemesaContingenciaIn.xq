...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/Remesas/NotificaEstadoRemesa/xsd/notificaEstadoRemesaContingencia_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/NotificaEstadoRemesa/xq/notificaEstadoRemesaContingenciaIn/";

declare function xf:notificaEstadoRemesaContingenciaIn($notificaEstadoRemesaRequest as element(ns0:notificaEstadoRemesaRequest),
...
xf:notificaEstadoRemesaContingenciaIn($notificaEstadoRemesaRequest,
    $numeroContrato)