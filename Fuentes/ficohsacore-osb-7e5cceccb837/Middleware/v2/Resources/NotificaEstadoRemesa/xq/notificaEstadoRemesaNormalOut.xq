...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../BusinessServices/Remesas/NotificaEstadoRemesa/xsd/notificaEstadoRemesa_sp.xsd" ::)
(:: pragma bea:global-element-return element="ns0:notificaEstadoRemesaResponse" location="../xsd/notificaEstadoRemesaTypes.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/NotificaEstadoRemesa/xq/notificaEstadoRemesaNormalOut/";
...
declare function xf:notificaEstadoRemesaNormalOut($outputParameters as element(ns1:OutputParameters))
...
xf:notificaEstadoRemesaNormalOut($outputParameters)