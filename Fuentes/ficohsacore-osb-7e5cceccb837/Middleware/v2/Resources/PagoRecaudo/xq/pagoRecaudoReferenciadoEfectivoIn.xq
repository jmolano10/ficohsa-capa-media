...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/pagoRecaudos/pagoRecaudoReferenciadoEfectivoIn/";
...
declare function xf:pagoRecaudoReferenciadoEfectivoIn($requestHeader as element(ns0:RequestHeader),
...
xf:pagoRecaudoReferenciadoEfectivoIn($requestHeader,
    $pagoRecaudo,
    $uuid)