...
(:: pragma bea:global-element-return element="ns1:Pagoderecaudolocalylineachqpr" location="../../../../Business_Resources/pagoRecaudos/Resources/XMLSchema_-258408779.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/pagoRecaudos/pagoRecaudoEnLineaChequePropioIn/";
...
declare function xf:pagoRecaudoEnLineaChequePropioIn($requestHeader as element(ns0:RequestHeader),
    $pagoRecaudo as element(ns2:pagoRecaudo),
    $outputParameters as element(ns3:OutputParameters),
    $uuid as xs:string)
    as element(ns1:Pagoderecaudolocalylineachqpr) {
        <ns1:Pagoderecaudolocalylineachqpr>
            <WebRequestCommon>
...
xf:pagoRecaudoEnLineaChequePropioIn($requestHeader,
    $pagoRecaudo,
    $outputParameters,
    $uuid)