...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/pagoRecaudos/pagoRecaudoReferenciadoChequePropioIn/";
...
declare function xf:pagoRecaudoReferenciadoChequePropioIn($requestHeader as element(ns0:RequestHeader),
...
xf:pagoRecaudoReferenciadoChequePropioIn($requestHeader,
    $pagoRecaudo,
    $uuid)