...
(:: pragma bea:global-element-return element="ns0:Pagorecaudoreferenciadoficochq" location="../../../../Business_Resources/pagoRecaudos/Resources/XMLSchema_-258408779.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoRecaudo/xq/pagoRecaudoRefEnLineaChequePropioIn/";
...
declare function xf:PagoRecaudoReferenciadoEnLineaChequePropioIn($requestHeader as element(ns3:RequestHeader),
...
xf:PagoRecaudoReferenciadoEnLineaChequePropioIn($requestHeader,
    $pagoRecaudo,
    $outputParameters,
    $uuid)