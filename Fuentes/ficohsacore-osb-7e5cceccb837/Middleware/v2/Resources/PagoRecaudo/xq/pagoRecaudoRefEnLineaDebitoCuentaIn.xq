...
declare function xf:PagoRecaudoReferenciadoEnLineaDebitoCuentaIn($requestHeader as element(ns3:RequestHeader),
...
xf:PagoRecaudoReferenciadoEnLineaDebitoCuentaIn($requestHeader,
    $pagoRecaudo,
    $outputParameters,
    $uuid)