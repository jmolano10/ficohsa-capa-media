...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../../v3/BusinessServices/ABKGT/PagoRecaudo/xsd/PagoRecaudo_sp.xsd" ::)
    ...
    as element(ns0:InputParameters) {
        <ns0:InputParameters>
            ...
            }
            {
                ...
                return
                    <ns0:PV_DUE_DATE>{ data($DUE_DATE) }</ns0:PV_DUE_DATE>
            }
            {
