...
(:: pragma bea:global-element-parameter parameter="$pagoRecaudo1" element="ns1:pagoRecaudo" location="../../../../Business_Resources/pagoRecaudos/PagoRecaudo/pagoRecaudoTmpTypes.xsd" ::)
(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns2:OutputParameters" location="../../../../Business_Resources/recaudos/Resources/ConsultarRelacionOperacionRecaudo/xsd/FLINK_OSB_CONSULTAR_OPER_RECAUDO.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoRecaudo/xq/pagoRecaudoLocalDbCtaIn/";
...
declare function xf:pagoRecaudoLocalDbCtaIn($requestHeader1 as element(ns3:RequestHeader),
    ...
    as element(ns0:Pagoderecaudolocalylineadbcta) {
        <ns0:Pagoderecaudolocalylineadbcta>
            ...
            <FUNDSTRANSFERLATAMACCTTRFWSType>
                ...
                <PAYEECCY>{ data($pagoRecaudo1/PAYMENT_INFORMATION/PAYMENT_CURRENCY) }</PAYEECCY>
                ...
                <gLR.TAX.PAY.NAME>
                {
                    for $ITEM in $outputParameters1/ns2:NOMBRE_DEUDOR/ns2:ITEM
                    return
...
xf:pagoRecaudoLocalDbCtaIn($requestHeader1,
    $pagoRecaudo1,
    $outputParameters1,
    $uuid,
    $debitAcount)