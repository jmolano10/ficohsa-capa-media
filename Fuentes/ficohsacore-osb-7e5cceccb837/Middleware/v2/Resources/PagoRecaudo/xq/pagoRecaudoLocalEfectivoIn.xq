...
declare namespace xf = "http://tempuri.org/Middleware/Business_Resources/pagoPrestamo/pagoRecaudoLocalEfectivoIn/";
...
declare function xf:pagoRecaudoLocalEfectivoIn($requestHeader as element(ns0:RequestHeader),
...
xf:pagoRecaudoLocalEfectivoIn($requestHeader,
    $pagoRecaudo,
    $outputParameters,
    $uuid)