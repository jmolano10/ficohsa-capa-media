...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoRecaudo/xq/pagoRecaudoConsultaDetalleCuentaIn/";
...
declare function xf:pagoRecaudoConsultaDetalleCuentaIn($requestHeader1 as element(ns1:RequestHeader),
...
xf:pagoRecaudoConsultaDetalleCuentaIn($requestHeader1,
    $cuentaTemp)