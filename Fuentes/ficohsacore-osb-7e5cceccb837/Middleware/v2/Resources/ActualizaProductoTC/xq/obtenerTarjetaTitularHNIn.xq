...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/MasterDataHN/obtenerTarjetaTitular/xsd/obtenerTarjetaTitular_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ActualizaProductoTC/xq/obtenerTarjetaTitularHNIn/";

declare function xf:obtenerTarjetaTitularHNIn($actualizaProductoTC1 as element(ns0:actualizaProductoTC),$countryCode)
...
xf:obtenerTarjetaTitularHNIn($actualizaProductoTC1,$countryCode)