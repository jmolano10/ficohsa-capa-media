...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/MasterData/obtenerTarjetaTitular/xsd/obtenerTarjetaTitular_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ActualizaProductoTC/xq/obtenerTarjetaTitularNIIn/";

declare function xf:obtenerTarjetaTitularNIIn($actualizaProductoTC1 as element(ns0:actualizaProductoTC),$countryCode)
...
xf:obtenerTarjetaTitularNIIn($actualizaProductoTC1,$countryCode)