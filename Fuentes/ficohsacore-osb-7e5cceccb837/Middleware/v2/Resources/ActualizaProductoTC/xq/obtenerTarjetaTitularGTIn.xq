...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/MasterDataGT/obtenerTarjetaTitular/xsd/obtenerTarjetaTitular_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ActualizaProductoTC/xq/obtenerTarjetaTitularGTIn/";

declare function xf:obtenerTarjetaTitularGTIn($actualizaProductoTC1 as element(ns0:actualizaProductoTC),$countryCode)
...
xf:obtenerTarjetaTitularGTIn($actualizaProductoTC1,$countryCode)