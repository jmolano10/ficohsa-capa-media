...
declare function xf:accountAddNIIn($creacionCuentaFinanciamiento as element(ns0:creacionCuentaFinanciamiento))
    as element(ns1:AccountAddRequest) {
        <ns1:AccountAddRequest>
            ...
            <ARXAAI-USER-DATE-1>{ fn-bea:date-from-string-with-format('yyyy-MM-dd', data($creacionCuentaFinanciamiento/USER_DATE[IND=1]/VALUE)) }</ARXAAI-USER-DATE-1>
            <ARXAAI-USER-DATE-2>{ fn-bea:date-from-string-with-format('yyyy-MM-dd', data($creacionCuentaFinanciamiento/USER_DATE[IND=2]/VALUE)) }</ARXAAI-USER-DATE-2>
            <ARXAAI-USER-DATE-3>{ fn-bea:date-from-string-with-format('yyyy-MM-dd', data($creacionCuentaFinanciamiento/USER_DATE[IND=3]/VALUE)) }</ARXAAI-USER-DATE-3>
            <ARXAAI-USER-DATE-4>{ fn-bea:date-from-string-with-format('yyyy-MM-dd', data($creacionCuentaFinanciamiento/USER_DATE[IND=4]/VALUE)) }</ARXAAI-USER-DATE-4>
            <ARXAAI-USER-DATE-5>{ fn-bea:date-from-string-with-format('yyyy-MM-dd', data($creacionCuentaFinanciamiento/USER_DATE[IND=5]/VALUE)) }</ARXAAI-USER-DATE-5>
            <ARXAAI-USER-DATE-6>{ fn-bea:date-from-string-with-format('yyyy-MM-dd', data($creacionCuentaFinanciamiento/USER_DATE[IND=6]/VALUE)) }</ARXAAI-USER-DATE-6>
            <ARXAAI-USER-DATE-7>{ fn-bea:date-from-string-with-format('yyyy-MM-dd', data($creacionCuentaFinanciamiento/USER_DATE[IND=7]/VALUE)) }</ARXAAI-USER-DATE-7>
            <ARXAAI-USER-DATE-8>{ fn-bea:date-from-string-with-format('yyyy-MM-dd', data($creacionCuentaFinanciamiento/USER_DATE[IND=8]/VALUE)) }</ARXAAI-USER-DATE-8>
            <ARXAAI-USER-DATE-9>{ fn-bea:date-from-string-with-format('yyyy-MM-dd', data($creacionCuentaFinanciamiento/USER_DATE[IND=9]/VALUE)) }</ARXAAI-USER-DATE-9>
            <ARXAAI-USER-DATE-10>{ fn-bea:date-from-string-with-format('yyyy-MM-dd', data($creacionCuentaFinanciamiento/USER_DATE[IND=10]/VALUE)) }</ARXAAI-USER-DATE-10>
            <ARXAAI-USER-DATE-11>{ fn-bea:date-from-string-with-format('yyyy-MM-dd', data($creacionCuentaFinanciamiento/USER_DATE[IND=11]/VALUE)) }</ARXAAI-USER-DATE-11>
            <ARXAAI-USER-DATE-12>{ fn-bea:date-from-string-with-format('yyyy-MM-dd', data($creacionCuentaFinanciamiento/USER_DATE[IND=12]/VALUE)) }</ARXAAI-USER-DATE-12>
            <ARXAAI-USER-DATE-13>{ fn-bea:date-from-string-with-format('yyyy-MM-dd', data($creacionCuentaFinanciamiento/USER_DATE[IND=13]/VALUE)) }</ARXAAI-USER-DATE-13>
            <ARXAAI-USER-DATE-14>{ fn-bea:date-from-string-with-format('yyyy-MM-dd', data($creacionCuentaFinanciamiento/USER_DATE[IND=14]/VALUE)) }</ARXAAI-USER-DATE-14>
...
xf:accountAddNIIn($creacionCuentaFinanciamiento)