(:: pragma bea:global-element-parameter parameter="$creacionCuentaFinanciamiento" element="ns1:creacionCuentaFinanciamiento" location="../xsd/creacionCuentaFinanciamientoTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns0:AccountAddRequest" location="../../../BusinessServices/VisionPlusHN/visionPlus/xsd/XMLSchema_769155616.xsd" ::)

declare namespace ns1 = "http://www.ficohsa.com.hn/middleware.services/creacionCuentaFinanciamientoTypes";
declare namespace ns0 = "http://www.procesa.com/fdcs";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CreacionCuentaFinanciamiento/xq/accountAddHNIn/";
...
declare function CRLMTFLAG($org as xs:string) as xs:string{
		 if($org = "340" or $org = "341")then(
           let $value := "4"
           return $value
         )else(
           let $value := "1"
...
declare function xf:accountAddHNIn($creacionCuentaFinanciamiento as element(ns1:creacionCuentaFinanciamiento))
    as element(ns0:AccountAddRequest) {
         <ns0:AccountAddRequest>
            ...
            <AZXAAI-IB-CFIN-CRLMT-FLAG>{CRLMTFLAG(fn:string(data($creacionCuentaFinanciamiento/ORG)))}</AZXAAI-IB-CFIN-CRLMT-FLAG>
...
declare variable $creacionCuentaFinanciamiento as element(ns1:creacionCuentaFinanciamiento) external;

xf:accountAddHNIn($creacionCuentaFinanciamiento)
