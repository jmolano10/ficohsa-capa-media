...
(:: pragma bea:global-element-return element="ns1:RechazarLiberacionFondosChqVirt" location="../../../../Business_Resources/compensacion/resources/XMLSchema_1569843523.xsd" ::)

declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/autType";
declare namespace ns2 = "http://www.ficohsa.com.hn/middleware.services/confirmaChequeVirtualTypes";
declare namespace ns1 = "T24WebServicesImpl";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConfirmaChequeVirtual/xq/rechazarLiberacionFondosChqVirtIn/";
...
declare function xf:rechazarLiberacionFondosChqVirtIn($confirmaChequeVirtual as element(ns2:confirmaChequeVirtual),
    $requestHeader as element(ns0:RequestHeader))
    as element(ns1:RechazarLiberacionFondosChqVirt) {
        <ns1:RechazarLiberacionFondosChqVirt>
        	<WebRequestCommon>
                <userName>
                    {
...
xf:rechazarLiberacionFondosChqVirtIn($confirmaChequeVirtual,
    $requestHeader)