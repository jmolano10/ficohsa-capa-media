...
(:: pragma bea:global-element-return element="ns0:RequestHeader" location="../../esquemas_generales/HeaderElementsCB.xsd" ::)

declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/autType";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/Generales/xq/aplicarValoresPorDefectoRegionCB/";
...
declare function xf:aplicarValoresPorDefectoRegion($requestHeader as element(ns0:RequestHeader))
    as element(ns0:RequestHeader) {
        <ns0:RequestHeader>
            ...
            <BankingCorrespondent>{ $requestHeader/BankingCorrespondent/@* , $requestHeader/BankingCorrespondent/node() }</BankingCorrespondent>
        </ns0:RequestHeader>
};
