...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/abanksGT/consultaSaldosTarjetaCredito/xq/consultaSaldosTarjetaCreditoOut/";
...
declare function xf:consultaSaldosTarjetaCreditoOut($consultarSaldosVasaResponse1 as element(ns1:ConsultarSaldosVasaResponse), $puntosActualizado as xs:string)
    as element(ns0:consultaSaldosTarjetaCreditoResponse) {
            ...
            <ns0:consultaSaldosTarjetaCreditoResponseType>
                {
                    for $ArrayOfStrucSaldosConsulta in $consultarSaldosVasaResponse1/ns1:ConsultarSaldosVasaResult/ns1:saldos/ns1:ArrayOfStrucSaldosConsulta
                    return
...
xf:consultaSaldosTarjetaCreditoOut($consultarSaldosVasaResponse1, $puntosActualizado)