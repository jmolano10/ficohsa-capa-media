...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaSaldosTarjetaCredito/xq/consultaSaldosTarjetaCreditoGTOut/";
...
declare function xf:consultaSaldosTarjetaCreditoGTOut($outputParameters as element(ns2:OutputParameters)?,
...
xf:consultaSaldosTarjetaCreditoGTOut($outputParameters,
    $sjConsultaSaldosTarjetaCreditoResponse,
    $valSaldoActual,
    $saldosOffLine, $consultaSaldoSPMD, $consultaDatosTCSPMD)