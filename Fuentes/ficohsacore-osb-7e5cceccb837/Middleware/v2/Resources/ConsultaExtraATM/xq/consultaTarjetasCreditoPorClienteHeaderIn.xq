...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaExtraATM/xq/consultaTarjetasCreditoPorClienteHeaderIn/";

declare function xf:consultaTarjetasCreditoPorClienteHeaderIn($requestHeader as element(ns0:RequestHeader))
...
xf:consultaTarjetasCreditoPorClienteHeaderIn($requestHeader)