...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/MasterDataGT/conDatoTarjetasActivasCliente/xsd/conDatoTarjetasActivasCliente_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaTarjetasCreditoPorCliente/conDatosTarjetasActivasClienteGTIn/";

declare function xf:conDatosTarjetasActivasClienteGTIn($codigoPais as xs:string,
...
xf:conDatosTarjetasActivasClienteGTIn($codigoPais,$consultaTarjetasCreditoPorCliente)
