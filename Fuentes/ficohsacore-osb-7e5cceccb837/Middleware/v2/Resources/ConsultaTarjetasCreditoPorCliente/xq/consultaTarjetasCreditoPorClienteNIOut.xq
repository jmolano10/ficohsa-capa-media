...
(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns0:OutputParameters" location="../../../BusinessServices/MasterData/conDatosTarjetasActivasCliente/xsd/conDatosTarjetasActivasCliente_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaTarjetasCreditoPorCliente/xq/consultaTarjetasCreditoPorClienteNIOut/";
...
declare function xf:consultaTarjetasCreditoPorClienteNIOut($outputParameters1 as element(ns0:OutputParameters))
...
xf:consultaTarjetasCreditoPorClienteNIOut($outputParameters1)]]></con:xquery>
