...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaTarjetasCreditoPorCliente/xq/consultaTarjetasCreditoPorClientePAOut/";
...
declare function xf:consultaTarjetasCreditoPorClientePAOut($outputParameters1 as element(ns0:OutputParameters))
...
xf:consultaTarjetasCreditoPorClientePAOut($outputParameters1)]]></con:xquery>
    <con:dependency location="../../../BusinessServices/MasterDataPA/conDatosTarjetasActivasCliente/xsd/conDatosTarjetasActivasCliente_sp.xsd">
        <con:schema ref="Middleware/v2/BusinessServices/MasterDataPA/conDatosTarjetasActivasCliente/xsd/conDatosTarjetasActivasCliente_sp"/>
    </con:dependency>
