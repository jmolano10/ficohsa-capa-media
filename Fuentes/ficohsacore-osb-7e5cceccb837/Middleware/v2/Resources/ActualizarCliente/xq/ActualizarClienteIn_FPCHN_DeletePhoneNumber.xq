...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ActualizarCliente/xq/ActualizarClienteIn_FPCHN_DeletePhoneNumber/";
...
declare function xf:ActualizarClienteIn_FPCHN_DeletePhoneNumber($CUSTOMER_CODE as xs:string,
    $INFO_ITEM as element(), $ARRAYINDEX as xs:integer)
    as element(ns0:InputParameters) {
        <ns0:InputParameters>
            <ns0:PC_TIPO_ACCION>3</ns0:PC_TIPO_ACCION>
...
xf:ActualizarClienteIn_FPCHN_DeletePhoneNumber($CUSTOMER_CODE,
