...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ActualizarCliente/xq/ActualizarClienteIn_FPCHN_UpdateAddress/";
...
declare function xf:ActualizarClienteIn_FPCHN_UpdateAddress($customerCode as xs:string,
    $itemInfo as element(),
...
xf:ActualizarClienteIn_FPCHN_UpdateAddress($customerCode,
    $itemInfo,
    $ARRAYINDEX)