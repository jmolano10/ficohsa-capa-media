...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ActualizarCliente/xq/ActualizarClienteIn_FPCHN_DeleteEmail/";
...
declare function xf:ActualizarClienteIn_FPCHN_DeleteEmail($customerCode as xs:string,
    $itemInfo as element(),
...
xf:ActualizarClienteIn_FPCHN_DeleteEmail($customerCode,
    $itemInfo,
    $ARRAYINDEX)