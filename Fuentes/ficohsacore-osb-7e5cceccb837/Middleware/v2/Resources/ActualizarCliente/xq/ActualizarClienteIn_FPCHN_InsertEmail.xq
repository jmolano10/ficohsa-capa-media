...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ActualizarCliente/xq/ActualizarClienteIn_FPCHN_InsertEmail/";
...
declare function xf:ActualizarClienteIn_FPCHN_InsertEmail($customerCode as xs:string,
    $itemInfo as element(),
    ...
    as element(ns0:InputParameters) {
        <ns0:InputParameters>
            ...
            <ns0:PC_TIPO_ACCION>1</ns0:PC_TIPO_ACCION>
...
xf:ActualizarClienteIn_FPCHN_InsertEmail($customerCode,
    $itemInfo,
    $ARRAYINDEX)