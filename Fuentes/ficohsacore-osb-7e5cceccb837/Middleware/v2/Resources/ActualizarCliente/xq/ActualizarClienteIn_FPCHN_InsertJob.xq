...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ActualizarCliente/xq/ActualizarClienteIn_FPCHN_InsertJob/";
...
declare function xf:ActualizarClienteIn_FPCHN_InsertJob($customerCode as xs:string,
    $itemInfo as element(),
...
xf:ActualizarClienteIn_FPCHN_InsertJob($customerCode,
    $itemInfo,
    $ARRAYINDEX)