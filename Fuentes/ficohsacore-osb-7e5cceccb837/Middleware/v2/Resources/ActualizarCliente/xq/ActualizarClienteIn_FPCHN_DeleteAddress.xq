...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ActualizarCliente/xq/ActualizarClienteIn_FPCHN_DeleteAddress/";
...
declare function xf:ActualizarClienteIn_FPCHN_DeleteAddress($customerCode as xs:string,
    $itemInfo as element(),
    ...
    as element(ns0:InputParameters) {
        <ns0:InputParameters>
            ...
            <ns0:PC_TIP_ACCION>2</ns0:PC_TIP_ACCION>
...
xf:ActualizarClienteIn_FPCHN_DeleteAddress($customerCode,
    $itemInfo,
    $ARRAYINDEX)