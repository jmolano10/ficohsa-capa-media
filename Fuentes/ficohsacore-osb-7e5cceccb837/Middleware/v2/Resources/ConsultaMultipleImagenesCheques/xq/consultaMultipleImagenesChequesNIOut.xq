(:: pragma bea:global-element-parameter parameter="$consultaImagenesChequesResponse" element="ns1:ConsultaImagenesChequesResponse" location="../../../BusinessServices/ConsultaMultipleImagenesChequesNI/wsdl/ConsultaMultipleImagenesChequesNI.wsdl" ::)
