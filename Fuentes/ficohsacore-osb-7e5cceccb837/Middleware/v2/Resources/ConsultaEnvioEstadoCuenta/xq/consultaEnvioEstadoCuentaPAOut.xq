...
(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns1:OutputParameters" location="../../../BusinessServices/Strongview/obtenerbfemBitacoraEC/xsd/obtenerbfemBitacoraEC_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaEnvioEstadoCuenta/xq/consultaEnvioEstadoCuentaPAOut/";
...
declare function xf:consultaEnvioEstadoCuentaPAOut($outputParameters1 as element(ns1:OutputParameters))
...
xf:consultaEnvioEstadoCuentaPAOut($outputParameters1)