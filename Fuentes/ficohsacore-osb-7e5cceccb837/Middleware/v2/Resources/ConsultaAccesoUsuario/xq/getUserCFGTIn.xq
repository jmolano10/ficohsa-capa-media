...
(:: pragma bea:global-element-return element="ns0:GetUser" location="../../../BusinessServices/CREDITFORCEGT/GestionAccesosUsuarios/xsd/XMLSchema_-336569634.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaAccesoUsuario/xq/getUserCFGTIn/";
...
declare function xf:getUserCFGTIn($consultaAccesoUsuario as element(ns1:consultaAccesoUsuario),
    $token as xs:string,
...
xf:getUserCFGTIn($consultaAccesoUsuario,
    $token,
    $userName)