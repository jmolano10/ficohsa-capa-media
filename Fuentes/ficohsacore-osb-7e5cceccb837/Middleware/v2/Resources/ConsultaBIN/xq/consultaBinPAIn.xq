...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/ABKPA/consultaBin/xsd/consultaBin_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaBIN/xq/consultaBinPAIn/";

declare function xf:consultaBinPAIn($consultaBIN as element(ns0:consultaBIN))
...
xf:consultaBinPAIn($consultaBIN)