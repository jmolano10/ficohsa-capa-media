...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:global-element-parameter parameter="$generaEncabezadoTC" element="ns1:generaEncabezadoTC" location="../../GeneraEstadoCuenta/xsd/generaEstadoCuentaTypes.xsd" ::)
...
xf:obtenerEncabezadosHNIn($pais,
    $generaEncabezadoTC)]]></con:xquery>
    <con:dependency location="../../GeneraEstadoCuenta/xsd/generaEstadoCuentaTypes.xsd">
        <con:schema ref="Middleware/v2/Resources/GeneraEstadoCuenta/xsd/generaEstadoCuentaTypes"/>
    </con:dependency>
    <con:dependency location="../../../BusinessServices/VisionPlusHN/obtenerSerializado/xsd/bfemEECCHistorico.xsd">
        <con:schema ref="Middleware/v2/BusinessServices/VisionPlusHN/obtenerSerializado/xsd/bfemEECCHistorico"/>
    </con:dependency>
</con:xqueryEntry>