...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/MasterDataPA/conListadoPrestamos/xsd/conListadoPrestamos_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaFinanciamientosCliente/xq/conListadoPrestamosPAIn/";

declare function xf:conListadoPrestamosPAIn($consultaFinanciamientosCliente1 as element(ns0:consultaFinanciamientosCliente),
    $pais as xs:string)
...
xf:conListadoPrestamosPAIn($consultaFinanciamientosCliente1,
    $pais)