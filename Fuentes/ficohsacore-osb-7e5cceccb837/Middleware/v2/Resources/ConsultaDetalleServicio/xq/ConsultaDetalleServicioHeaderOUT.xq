...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaDetalleServicio/xq/ConsultaDetalleServicioHeaderOUT";
...
declare function xf:ConsultaDetalleServicioHeaderOUT($RSPServicioSara as element(ns8:GetServicePaymentEntityForSaraByIdMessageOut))
    as element(auth:ResponseHeader) {
        <auth:ResponseHeader>
        	<successIndicator>{ calcSuccessIndicator(data($RSPServicioSara/ns3:OperationResult/ns12:Value)) }</successIndicator>
        </auth:ResponseHeader>
};

declare variable $RSPServicioSara as element(ns8:GetServicePaymentEntityForSaraByIdMessageOut) external;

xf:ConsultaDetalleServicioHeaderOUT($RSPServicioSara)