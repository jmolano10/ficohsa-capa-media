...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaCuentasAfiliadasTarjetaDebito/xq/consultaDetalleCuentaIn/";
...
declare function xf:consultaDetalleCuentaIn($requestHeader as element(ns0:RequestHeader),
...
xf:consultaDetalleCuentaIn($requestHeader,
    $accountNumber)