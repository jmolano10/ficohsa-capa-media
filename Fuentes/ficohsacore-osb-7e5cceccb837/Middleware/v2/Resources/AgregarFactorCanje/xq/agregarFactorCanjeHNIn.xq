...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/ABK/agregarFactorCanje/xsd/agregarFactorCanje_sp.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/AgregarFactorCanje/xq/agregarFactorCanjeHNIn/";
...
declare function xf:agregarFactorCanjeHNIn($agregarFactorCanje1 as element(ns1:agregarFactorCanje),
...
xf:agregarFactorCanjeHNIn($agregarFactorCanje1,
    $userName)