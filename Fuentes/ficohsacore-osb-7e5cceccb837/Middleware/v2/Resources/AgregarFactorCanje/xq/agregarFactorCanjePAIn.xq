...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/ABKPA/agregarFactorCanje/xsd/agregarFactorCanje_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/AgregarFactorCanje/xq/agregarFactorCanjePAIn/";
...
declare function xf:agregarFactorCanjePAIn($agregarFactorCanje1 as element(ns1:agregarFactorCanje),
...
xf:agregarFactorCanjePAIn($agregarFactorCanje1,
    $userName)