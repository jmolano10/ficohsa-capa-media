...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/RegistroContratoACH/xq/registrarContratoACHDebitoSalienteIn/";
...
declare function xf:registrarContratoACHDebitoSalienteIn($requestHeader as element(ns0:RequestHeader),
    ...
    as element(ns1:RegistrodeContratoACHDebito) {
        <ns1:RegistrodeContratoACHDebito>
            ...
            <FICOACHDEBITOSINPUTWSType id = "{ data($registroContratoACH/ID_CONTRATO_ACH) }">
                ...
                <AUTHFIRM>{ data($registroContratoACH/datosBancoExternoType/DBE_MONEDA) }</AUTHFIRM>
                ...
                {
                    for $TIPO_CONTRATO in $registroContratoACH/TIPO_CONTRATO
                    return
                        <TIPOCONTRATO>{ data($TIPO_CONTRATO) }</TIPOCONTRATO>
                }
                <IDENTIFICACION2>{ data($registroContratoACH/datosBancoExternoType/DBE_IDENTIDAD) }</IDENTIFICACION2>
                <TIPOCUENTA2>{ data($registroContratoACH/datosBancoExternoType/DBE_TIPO_CUENTA) }</TIPOCUENTA2>
                {
...
xf:registrarContratoACHDebitoSalienteIn($requestHeader,
    $registroContratoACH)