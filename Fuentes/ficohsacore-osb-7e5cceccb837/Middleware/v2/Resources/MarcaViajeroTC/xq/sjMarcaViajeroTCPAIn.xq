...
(:: pragma bea:global-element-return element="ns0:sjMarcaViajeroTC" location="../../../BusinessServices/SJS/marcaViajeroTCPA/xsd/sjMarcaViajeroTCPATypes.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/MarcaViajeroTC/xq/sjMarcaViajeroTCPAIn/";

declare function xf:sjMarcaViajeroTCPAIn($sessionId as xs:string,
...
xf:sjMarcaViajeroTCPAIn($sessionId,
    $username,
    $password,
    $marcaViajeroTC)