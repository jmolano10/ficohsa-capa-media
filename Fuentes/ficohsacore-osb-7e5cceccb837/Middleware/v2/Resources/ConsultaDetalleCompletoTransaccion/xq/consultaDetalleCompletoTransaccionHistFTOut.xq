(:: pragma bea:global-element-parameter parameter="$consultadetransaccionhistFTResponse" element="ns1:ConsultadetransaccionhistFTResponse" location="../../../../Business_Resources/consultaTransacciones/Resources/XMLSchema_-1217682313.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaDetalleCompletoTransaccion/consultaDetalleCompletoTransaccionHistFTOut/";
...
declare function xf:consultaDetalleCompletoTransaccionHistFTOut($consultadetransaccionhistFTResponse as element(ns1:ConsultadetransaccionhistFTResponse))
    as element(ns0:consultaDetalleCompletoTransaccionResponse) {
        <ns0:consultaDetalleCompletoTransaccionResponse>
            <TYPE>FT</TYPE>
            {
                for $TRANSACTIONTYPE in $consultadetransaccionhistFTResponse/WSFTTRANSACTIONHISTType[1]/gWSFTTRANSACTIONHISTDetailType/mWSFTTRANSACTIONHISTDetailType[1]/TRANSACTIONTYPE
                return
                    <TRANSACTION_CODE>{ data($TRANSACTIONTYPE) }</TRANSACTION_CODE>
            }            
            {
			...
			{
			    let $DEBITCURRENCY := fn:string($consultadetransaccionhistFTResponse/WSFTTRANSACTIONHISTType[1]/gWSFTTRANSACTIONHISTDetailType/mWSFTTRANSACTIONHISTDetailType[1]/DEBITCURRENCY/text())
			    let $COMMAMOUNT := fn:string($consultadetransaccionhistFTResponse/WSFTTRANSACTIONHISTType[1]/gWSFTTRANSACTIONHISTDetailType/mWSFTTRANSACTIONHISTDetailType[1]/COMMAMOUNT/text())		    
			    let $COMMTYPE := fn:string($consultadetransaccionhistFTResponse/WSFTTRANSACTIONHISTType[1]/gWSFTTRANSACTIONHISTDetailType/mWSFTTRANSACTIONHISTDetailType[1]/COMMTYPE/text())
			    let $CHRGAMOUNT := fn:string($consultadetransaccionhistFTResponse/WSFTTRANSACTIONHISTType[1]/gWSFTTRANSACTIONHISTDetailType/mWSFTTRANSACTIONHISTDetailType[1]/CHRGAMOUNT/text())		    
			    let $CHRGTYPE := fn:string($consultadetransaccionhistFTResponse/WSFTTRANSACTIONHISTType[1]/gWSFTTRANSACTIONHISTDetailType/mWSFTTRANSACTIONHISTDetailType[1]/CHRGTYPE/text())
            ...
            {
                let $PARENTREFERENCE := fn:string($consultadetransaccionhistFTResponse/WSFTTRANSACTIONHISTType[1]/gWSFTTRANSACTIONHISTDetailType/mWSFTTRANSACTIONHISTDetailType[1]/PARENTREFERENCE/text())
                let $T24LOANTXNREF := fn:string($consultadetransaccionhistFTResponse/WSFTTRANSACTIONHISTType[1]/gWSFTTRANSACTIONHISTDetailType/mWSFTTRANSACTIONHISTDetailType[1]/T24LOANTXNREF/text())
                return
            ...
            {
                let $PAYMENTDETAILS := fn:string($consultadetransaccionhistFTResponse/WSFTTRANSACTIONHISTType[1]/gWSFTTRANSACTIONHISTDetailType/mWSFTTRANSACTIONHISTDetailType[1]/PAYMENTDETAILS/text())
                let $T24LOANNUMBER := fn:string($consultadetransaccionhistFTResponse/WSFTTRANSACTIONHISTType[1]/gWSFTTRANSACTIONHISTDetailType/mWSFTTRANSACTIONHISTDetailType[1]/T24LOANNUMBER/text())
                return
            ...
            {
                for $ORDERINGCUST in $consultadetransaccionhistFTResponse/WSFTTRANSACTIONHISTType[1]/gWSFTTRANSACTIONHISTDetailType/mWSFTTRANSACTIONHISTDetailType[1]/ORDERINGCUST
                return
