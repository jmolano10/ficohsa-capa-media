...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaEstadoLote/xq/consultaEstadoLoteGTHeaderOut/";

declare function xf:consultaEstadoLoteGTHeaderOut($consultarLoteResponse as element(ns1:consultarLoteResponse))
...
xf:consultaEstadoLoteGTHeaderOut($consultarLoteResponse)