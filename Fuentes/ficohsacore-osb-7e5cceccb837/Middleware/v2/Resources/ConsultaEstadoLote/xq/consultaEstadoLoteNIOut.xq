...
declare function xf:consultarEstadoLoteNIOut($consultarLoteResponse as element(ns1:consultarLoteResponse))
...
xf:consultarEstadoLoteNIOut($consultarLoteResponse)