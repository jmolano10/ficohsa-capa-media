(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../BusinessServices/ABKGT/consultaOficialesNegocio/xsd/consultaOficialesNegocio_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaOficialesNegocio/xq/consultaOficialesNegocioGTOut/";

declare function xf:consultaOficialesNegocioGTOut($outputParameters as element(ns0:OutputParameters))
...
xf:consultaOficialesNegocioGTOut($outputParameters)