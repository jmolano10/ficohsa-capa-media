(:: pragma bea:global-element-parameter parameter="$eCConRequestControl" element="ns1:OutputParameters" location="../../../BusinessServices/ProcesosHN/eCConRequestControl/xsd/eCConRequestControl_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaEstadoDatosPlantilla/xq/consultaEstadoDatosPlantillaHNOut/";

declare function xf:consultaEstadoDatosPlantillaHNOut($eCConRequestControl as element(ns1:OutputParameters),
...
xf:consultaEstadoDatosPlantillaHNOut($eCConRequestControl,
    $batch_id)