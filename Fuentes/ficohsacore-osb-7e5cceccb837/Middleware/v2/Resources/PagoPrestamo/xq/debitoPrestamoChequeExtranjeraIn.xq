...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoPrestamo/xq/debitoPrestamoChequeExtranjeraIn/";
...
declare function xf:debitoPrestamoChequeExtranjeraIn($requestHeader as element(ns0:RequestHeader),
...
xf:debitoPrestamoChequeExtranjeraIn($requestHeader,
    $pagoPrestamo,
    $depositAccount,
    $uuid)