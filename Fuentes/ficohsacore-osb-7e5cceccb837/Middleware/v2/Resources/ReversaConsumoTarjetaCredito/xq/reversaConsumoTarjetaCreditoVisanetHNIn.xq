...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ReversaConsumoTarjetaCredito/xq/reversaConsumoTarjetaCreditoVisanetHNIn/";

declare function xf:reversaConsumoTarjetaCreditoVisanetHNIn($reversaConsumoTarjetaCredito as element(ns1:reversaConsumoTarjetaCredito),
...
xf:reversaConsumoTarjetaCreditoVisanetHNIn($reversaConsumoTarjetaCredito,
    $posEntryMode,
    $track2Data,
    $paymentgwIP,
    $shopperIP,
