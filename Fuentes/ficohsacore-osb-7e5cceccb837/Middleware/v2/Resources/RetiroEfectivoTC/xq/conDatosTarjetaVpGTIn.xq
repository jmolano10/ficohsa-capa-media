...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/MasterDataGT/conDatosTarjetaVP/xsd/conDatosTarjetaVP_sp.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/RetiroEfectivoTC/xq/conDatosTarjetaVpGTIn/";
...
declare function xf:conDatosTarjetaVpGTIn($retiroEfectivoTC1 as element(ns0:retiroEfectivoTC))
...
xf:conDatosTarjetaVpGTIn($retiroEfectivoTC1)
