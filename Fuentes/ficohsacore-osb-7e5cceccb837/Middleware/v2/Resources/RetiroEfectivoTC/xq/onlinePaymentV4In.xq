...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/RetiroEfectivoTC/xq/onlinePaymentV4In/";

declare function xf:onlinePaymentV4In($retiroEfectivoTC1 as element(ns0:retiroEfectivoTC),
...
xf:onlinePaymentV4In($retiroEfectivoTC1,
    $outputParameters1)