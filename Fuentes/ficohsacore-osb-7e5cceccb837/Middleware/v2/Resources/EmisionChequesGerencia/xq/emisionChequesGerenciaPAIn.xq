...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/ABKPA/emisionChequesGerencia/xsd/emisionChequesGerencia_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/EmisionChequesGerencia/xq/EmisionChequesGerenciaPAIn/";

declare function xf:EmisionChequesGerenciaPAIn($emisionChequesGerencia as element(ns1:emisionChequesGerencia))
...
xf:EmisionChequesGerenciaPAIn($emisionChequesGerencia)
