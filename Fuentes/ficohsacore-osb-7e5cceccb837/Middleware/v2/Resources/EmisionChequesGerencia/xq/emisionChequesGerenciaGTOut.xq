(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../BusinessServices/ABKGT/emisionChequesGerencia/xsd/emisionChequesGerencia_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/EmisionChequesGerencia/xq/emisionChequesGerenciaGTOut/";

declare function xf:emisionChequesGerenciaGTOut($outputParameters as element(ns0:OutputParameters))
...
xf:emisionChequesGerenciaGTOut($outputParameters)
