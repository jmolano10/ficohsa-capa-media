...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CancelarTarjetaCredito/xq/actualizaCredencialesSalesforce/";

declare function xf:actualizaCredencialesSalesforce($sourceBank as xs:string,
    $sesion as xs:string)
...
xf:actualizaCredencialesSalesforce($sourceBank,
    $sesion)
