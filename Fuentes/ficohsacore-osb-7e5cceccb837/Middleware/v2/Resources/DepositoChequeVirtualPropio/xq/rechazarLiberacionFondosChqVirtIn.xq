...
(:: pragma bea:global-element-parameter parameter="$registrarChequePropioVirtualResponse" element="ns1:registrarChequePropioVirtualResponse" location="../../../BusinessServices/SACE/WS-QUICKDEPOSIT.asmx.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/DepositoChequeVirtualPropio/xq/rechazarLiberacionFondosChqVirtIn/";
...
declare function xf:rechazarLiberacionFondosChqVirtIn($requestHeader as element(ns2:RequestHeader),
    $registrarChequePropioVirtualResponse as element(ns1:registrarChequePropioVirtualResponse),
    $id as xs:string)
    as element(ns0:RechazarLiberacionFondosChqVirt) {
        <ns0:RechazarLiberacionFondosChqVirt>
            ...
            <FICOHCHEQUEVIRTUALRECHAZOWSType id = "{ $id }">
                <CODIGORECHAZO>{ data($registrarChequePropioVirtualResponse/ns1:registrarChequePropioVirtualResult/ns1:errId) }</CODIGORECHAZO>
                {
                    for $errMsg in $registrarChequePropioVirtualResponse/ns1:registrarChequePropioVirtualResult/ns1:errMsg
                    return
...
declare variable $registrarChequePropioVirtualResponse as element(ns1:registrarChequePropioVirtualResponse) external;
declare variable $id as xs:string external;

xf:rechazarLiberacionFondosChqVirtIn($requestHeader,
    $registrarChequePropioVirtualResponse,
    $id)