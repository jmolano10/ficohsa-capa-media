...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaEstadoBloqueoTC/xq/consultaEstadoBloqueoTCHNOut/";

declare function xf:consultaEstadoBloqueoTCHNOut($estadoTC as xs:string,
...
xf:consultaEstadoBloqueoTCHNOut($estadoTC,
    $tipoBloqueo)
