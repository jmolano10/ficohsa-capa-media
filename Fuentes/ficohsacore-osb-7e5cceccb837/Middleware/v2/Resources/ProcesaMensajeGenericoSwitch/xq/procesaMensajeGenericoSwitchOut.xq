(:: pragma bea:global-element-parameter parameter="$procesaMensajeGenericoSwitchFacadeRequest" element="ns0:procesaMensajeGenericoSwitchFacadeRequest" location="../xsd/procesaMensajeGenericoSwitchFacadeTypes.xsd" ::)
(:: pragma bea:local-element-return type="ns0:procesaMensajeGenericoSwitchFacadeResponse/ISO8583" location="../xsd/procesaMensajeGenericoSwitchFacadeTypes.xsd" ::)

declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/procesaMensajeGenericoSwitchFacadeTypes";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ProcesaMensajeGenericoSwitch/xq/procesaMensajeGenericoSwitchOut/";

declare function xf:procesaMensajeGenericoSwitchOut($successIndicator as xs:string,
	$procesaMensajeGenericoSwitchFacadeRequest as element(ns0:procesaMensajeGenericoSwitchFacadeRequest))
    as element() {
        <ISO8583>
                ...
                return
                    <ISO8583_XML_CONTENT>
                        ...
                        }
                        {
                            ...
                            return
                                <AmountTransaction_004>{ data($AmountTransaction_004) }</AmountTransaction_004>
                        }
                        {
                            for $AmountSettlement_005 in $ISO8583_XML_CONTENT/AmountSettlement_005
                            return
                                <AmountSettlement_005>{ data($AmountSettlement_005) }</AmountSettlement_005>
                        }
                        {
                            for $AmountCardholderBilling_006 in $ISO8583_XML_CONTENT/AmountCardholderBilling_006
                            return
                                <AmountCardholderBilling_006>{ data($AmountCardholderBilling_006) }</AmountCardholderBilling_006>
                        }
                        ...
                        }
                        {
                            ...
                            return
                                <ReservedForPrivateUse_121>{ fn:concat("Ficohsa;", data($ISO8583_XML_CONTENT/CardAcceptorNameLocation_043), ";", fn-bea:dateTime-to-string-with-format('yyyy-MM-dd HH:mm', adjust-dateTime-to-timezone(current-dateTime(), ())), ";", data($ISO8583_XML_CONTENT/SystemTraceAuditNumber_011), ";", "FT1861239;RETIRO BILLETERA; L.2000; BILLETERA ****1182; Comprometidos a ser los mejores GRACIAS POR USAR NUESTROS CAJEROS") }</ReservedForPrivateUse_121>
                        }
                        {
...
xf:procesaMensajeGenericoSwitchOut($successIndicator,
	$procesaMensajeGenericoSwitchFacadeRequest)
