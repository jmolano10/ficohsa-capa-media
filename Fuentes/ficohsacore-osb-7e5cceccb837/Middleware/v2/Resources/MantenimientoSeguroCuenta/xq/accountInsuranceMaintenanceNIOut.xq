...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/MantenimientoSeguroCuenta/xq/accountInsuranceMaintenanceNIOut/";

declare function xf:accountInsuranceMaintenanceNIOut($accountInsuranceMaintenanceResponse1 as element(ns1:AccountInsuranceMaintenanceResponse))
...
xf:accountInsuranceMaintenanceNIOut($accountInsuranceMaintenanceResponse1)