...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/MantenimientoSeguroCuenta/xq/accountInsuranceMaintenanceGTOut/";

declare function xf:accountInsuranceMaintenanceGTOut($accountInsuranceMaintenanceResponse1 as element(ns1:AccountInsuranceMaintenanceResponse))
...
xf:accountInsuranceMaintenanceGTOut($accountInsuranceMaintenanceResponse1)