...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/MantenimientoSeguroCuenta/xq/accountInsuranceMaintenanceGTIn/";

declare function xf:accountInsuranceMaintenanceGTIn($cancelacionSeguro1 as element(ns0:cancelacionSeguro),
    $Filler as xs:string,
...
xf:accountInsuranceMaintenanceGTIn($cancelacionSeguro1,
    $Filler,
    $UserFiller)