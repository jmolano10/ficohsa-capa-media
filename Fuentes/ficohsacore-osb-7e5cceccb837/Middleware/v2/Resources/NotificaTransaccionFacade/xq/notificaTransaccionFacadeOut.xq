...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/NotificaTransaccionFacade/xq/notificaTransaccionFacadeOut/";

declare function xf:notificaTransaccionFacadeOut($procesaMensajeGenericoSwitchFacadeRequest as element(ns0:procesaMensajeGenericoSwitchFacadeRequest),
                    ...
                    <ISO8583_XML_CONTENT>
                        {
                            ...
                            return
                                <MTI>{ concat(substring(data($MTI), 1, 2), '30') }</MTI>
                        }
                        {
...
xf:notificaTransaccionFacadeOut($procesaMensajeGenericoSwitchFacadeRequest, $successIndicator)