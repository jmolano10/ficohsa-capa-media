...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/RemplazoPlasticoTC/xq/cardActionUpdateGTIn/";
declare namespace ns0 = "http://www.procesa.com/fdcs";

declare function xf:cardActionUpdateGTIn($org as xs:string,
