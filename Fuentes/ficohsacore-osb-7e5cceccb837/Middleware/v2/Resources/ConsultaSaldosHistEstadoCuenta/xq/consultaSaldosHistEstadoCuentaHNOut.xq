...
(:: pragma bea:global-element-parameter parameter="$obtenerEncabezadosResponse" element="ns0:ObtenerEncabezadosResponse" location="../../../BusinessServices/ObtenerEncabezados/xsd/XMLSchema_-1464971485.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaSaldosHistEstadoCuenta/xq/consultaSaldosHistEstadoCuentaHNOut/";
...
declare function xf:consultaSaldosHistEstadoCuentaHNOut($obtenerEncabezadosResponse as element(ns0:ObtenerEncabezadosResponse))
    as element(ns2:consultaSaldosHistEstadoCuentaResponse) {
        <ns2:consultaSaldosHistEstadoCuentaResponse>
         {  
             for $rowEncabezados in $obtenerEncabezadosResponse/ns0:ObtenerEncabezadosResult/ns1:Encabezados/ns1:DatoObtenerEncabezados
             return(
            <BALANCE_INFORMATION>
               {
...
declare variable $obtenerEncabezadosResponse as element(ns0:ObtenerEncabezadosResponse) external;

xf:consultaSaldosHistEstadoCuentaHNOut($obtenerEncabezadosResponse)