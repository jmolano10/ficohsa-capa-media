...
(:: pragma bea:global-element-parameter parameter="$conDatoCuenta" element="ns4:OutputParameters" location="../../../BusinessServices/MasterData/conDatoCuenta/xsd/conDatoCuenta_sp.xsd" ::)
(:: pragma bea:global-element-parameter parameter="$conEncabezadoEstadoCuenta" element="ns0:OutputParameters" location="../../../BusinessServices/MasterData/conEncabezadoEstadoCuenta/xsd/conEncabezadoEstadoCuenta_sp.xsd" ::)
        	...
        	if(not(empty($consultaCuentaTC/ns1:PT_CUENTA_TC/ns1:ACCOUNT_NUMBER))) then (
                ...
                return(
              	 ...
              	 return(
                    <BALANCE_INFORMATION>
						...
						<RMT>{ string($BALANCE_INFORMATION/RMT/text())}</RMT>
                    </BALANCE_INFORMATION>
				...
				return(
					<BALANCE_INFORMATION>
			            ...
			            {
			           		let $currentBalance:= ($rowDatosCuenta/ns4:Column[@name = 'billed_bal']/text() - $sjconsultaCuentaTC/PENDING_PAYMENTS/text())
			            	return
						...
						<RMT>{ string($sjconsultaCuentaTC/RMT/text())}</RMT>
					</BALANCE_INFORMATION>		
				),
                ...
                for $rowDatosCuenta in $conDatoCuenta/ns1:RowSet/ns1:Row[1]
				return (
					for $rsncharges in fn:string($rowDatosCuenta/ns1:Column[@name = 'misc_user_1']/text())
					return
