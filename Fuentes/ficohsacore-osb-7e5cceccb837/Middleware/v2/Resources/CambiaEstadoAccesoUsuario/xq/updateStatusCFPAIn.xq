...
(:: pragma bea:global-element-return element="ns0:UpdateStatus" location="../../../BusinessServices/CREDITFORCEPA/GestionAccesosUsuarios/xsd/XMLSchema_-336569570.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CambiaEstadoAccesoUsuario/xq/updateStatusCFPAIn/";
...
declare function xf:updateStatusCFPAIn($cambiaEstadoAccesoUsuario as element(ns1:cambiaEstadoAccesoUsuario),
    $token as xs:string,
...
xf:updateStatusCFPAIn($cambiaEstadoAccesoUsuario,
    $token,
    $userName)