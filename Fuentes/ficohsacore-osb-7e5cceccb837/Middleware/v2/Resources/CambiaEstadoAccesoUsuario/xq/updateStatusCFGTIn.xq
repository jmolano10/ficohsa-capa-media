...
(:: pragma bea:global-element-return element="ns0:UpdateStatus" location="../../../BusinessServices/CREDITFORCEGT/GestionAccesosUsuarios/xsd/XMLSchema_-336569634.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CambiaEstadoAccesoUsuario/xq/updateStatusCFGTIn/";
...
declare function xf:updateStatusCFGTIn($cambiaEstadoAccesoUsuario as element(ns1:cambiaEstadoAccesoUsuario),
    $token as xs:string,
...
xf:updateStatusCFGTIn($cambiaEstadoAccesoUsuario,
    $token,
    $userName)