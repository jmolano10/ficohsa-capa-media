...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/MasterDataPA/conOrgSequence/xsd/osbConOrgSequence_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/MasterDataPA/xq/conOrgSequence/";

declare function xf:conOrgSequence($pagoRecaudo as element(ns1:pagoRecaudo))
