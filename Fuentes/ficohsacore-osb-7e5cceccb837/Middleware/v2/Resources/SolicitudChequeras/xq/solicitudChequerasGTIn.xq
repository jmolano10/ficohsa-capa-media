...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/ABKGT/solicitudChequeras/xsd/solicitudChequeras_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/SolicitudChequeras/xq/solicitudChequeraGTIn/";

declare function xf:solicitudChequeraGTIn($requestHeader as element(ns1:RequestHeader),
...
xf:solicitudChequeraGTIn($requestHeader,
    $solicitudChequeras,
    $uuid)