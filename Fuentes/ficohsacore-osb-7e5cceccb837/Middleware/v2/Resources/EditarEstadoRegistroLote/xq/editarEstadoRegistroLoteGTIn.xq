...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/EditarEstadoRegistroLote/xq/editarEstadoRegistroLoteGTIn/";

declare function xf:editarEstadoRegistroLoteGTIn($editarEstadoRegistroLote as element(ns0:editarEstadoRegistroLote),
...
xf:editarEstadoRegistroLoteGTIn($editarEstadoRegistroLote,
    $sourceBank)