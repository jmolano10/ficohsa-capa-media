(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/MasterDataGT/conDetalleComprasCuotas/xsd/conDetalleComprasCuotas_sp.xsd" ::)

declare namespace ns0 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/conDetalleComprasCuotas";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/MasterData/xq/conDetalleComprasCuotasInGTIn/";

declare function xf:conDetalleComprasCuotasInGTIn($pais as xs:string,
    $org as xs:string,
...
xf:conDetalleComprasCuotasInGTIn($pais,
    $org,
    $numCuenta,
    $tipo,
    $originalInstall)
