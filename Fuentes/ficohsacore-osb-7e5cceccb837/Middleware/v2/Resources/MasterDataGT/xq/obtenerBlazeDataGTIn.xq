...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/MasterDataGT/obtenerBlazeData/xsd/obtenerBlazeData_sp.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/MasterDataGT/xq/obetenerBlazeDataGTIn/";
...
declare function xf:obtenerBlazeDataGTIn($numCuenta as xs:string,
    $tipo as xs:string,
...
xf:obtenerBlazeDataGTIn($numCuenta,
    $tipo,
    $codigoPais)