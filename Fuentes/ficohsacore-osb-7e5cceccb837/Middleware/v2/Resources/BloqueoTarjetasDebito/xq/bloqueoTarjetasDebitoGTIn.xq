...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/ABKGT/bloqueoTarjetaDebito/xsd/bloqueoTarjetaDebito_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/BloqueoTarjetasDebito/xq/bloqueoTarjetasDebitoGTIn/";

declare function xf:bloqueoTarjetasDebitoGTIn($bloqueoTarjetasDebito as element(ns1:bloqueoTarjetasDebito))
...
xf:bloqueoTarjetasDebitoGTIn($bloqueoTarjetasDebito)