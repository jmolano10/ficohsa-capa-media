...
(:: pragma bea:global-element-return element="ns1:buyPack" location="../../../BusinessServices/Claro/Paquetes/xsd/PackageWebService_1.xsd" ::)

declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/compraPaqueteTypes";
declare namespace ns1 = "http://opit.claro.com.hn/";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CompraPaquete/compraPaquetesMovilClaroIn/";
...
declare function xf:compraPaquetesMovilClaroIn($compraPaquete as element(ns0:compraPaquete),
    ...
    as element(ns1:buyPack) {
        <ns1:buyPack>
            ...
            <phone>{  fn:concat('504',data($compraPaquete/PHONE_NUMBER)) }</phone>
