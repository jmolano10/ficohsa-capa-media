...
declare function xf:consultaComisionInternacionalOut($consultaComisionSwiftResponse as element(ns1:consultaComisionSwiftResponse))
...
xf:consultaComisionInternacionalOut($consultaComisionSwiftResponse)