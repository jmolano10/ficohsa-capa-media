...
(:: pragma bea:global-element-return element="ns2:InputParameters" location="../../../BusinessServices/ABKGT/consultaComisionRegional/xsd/consultaComisionRegional_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaComisiones/xq/consultaComisionesRegionalGTIn/";

declare function xf:consultaComisionesRegionalGTIn($consultaComisiones as element(ns1:consultaComisiones), $destinationCountry as xs:string)
...
xf:consultaComisionesRegionalGTIn($consultaComisiones, $destinationCountry)