...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaComisiones/xq/consultaComisionesRegionalPAOut/";

declare function xf:consultaComisionesRegionalPAOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaComisionesRegionalPAOut($outputParameters)
