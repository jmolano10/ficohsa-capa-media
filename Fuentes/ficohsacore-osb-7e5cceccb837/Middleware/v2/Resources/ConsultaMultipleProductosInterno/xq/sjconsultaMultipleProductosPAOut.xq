(:: pragma bea:global-element-parameter parameter="$sjConsultaMultiplesProductosPAResponse" element="ns0:sjConsultaMultiplesProductosPAResponse" location="../../../BusinessServices/SJS/consultaMultipleProductosPA/xsd/sjConsultaMultipleProductosPA.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaMultipleProductosInterno/xq/sjconsultaMultipleProductosPAOut/";

declare function xf:sjconsultaMultipleProductosPAOut($sjConsultaMultiplesProductosPAResponse as element(ns0:sjConsultaMultiplesProductosPAResponse))
    as element(ns1:consultaMultipleProductosInternoResponse) {
        <ns1:consultaMultipleProductosInternoResponse>
            {
                for $ASSETS in $sjConsultaMultiplesProductosPAResponse/ns0:ASSETS
                return
                    <ASSETS>
                        {
            ...
            {
                for $LIABILITIES in $sjConsultaMultiplesProductosPAResponse/ns0:LIABILITIES
                return
                    <LIABILITIES>
                        {
...
declare variable $sjConsultaMultiplesProductosPAResponse as element(ns0:sjConsultaMultiplesProductosPAResponse) external;

xf:sjconsultaMultipleProductosPAOut($sjConsultaMultiplesProductosPAResponse)