...
declare namespace xf = "http://tempuri.org/Middleware/v2/ProxyServices/getInteractionGTIn/";

declare function xf:getInteractionGTIn($marcadoPredictivo as element(ns0:marcadoPredictivo))
...
xf:getInteractionGTIn($marcadoPredictivo)
