...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaPuntosLealtad/xq/consultaPuntosLealtadNIOut/";

declare function xf:consultaPuntosLealtadNIOut($legalId as xs:string,
...
xf:consultaPuntosLealtadNIOut($legalId,
    $customerName,
    $availablePoints,
    $cashEquivalent,
    $cashCurrency,
