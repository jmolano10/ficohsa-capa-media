...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:global-element-parameter parameter="$requestHeader" element="ns1:RequestHeader" location="../../esquemas_generales/HeaderElements.xsd" ::)
...
xf:registraPuntosLealtadIn($requestHeader,
    ...
    <con:dependency location="../../../BusinessServices/CLIENTDATA/registraPuntosLealtad/xsd/registraPuntosLealtad_sp.xsd"/>
</con:xqueryEntry>