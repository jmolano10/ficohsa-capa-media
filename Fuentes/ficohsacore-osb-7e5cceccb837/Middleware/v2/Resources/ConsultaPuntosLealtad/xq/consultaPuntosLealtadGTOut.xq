...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaPuntosLealtad/xq/canjearPuntosLealtadGTOut/";

declare function xf:canjearPuntosLealtadGTOut(
    ...
    as element(ns0:consultaPuntosLealtadResponse) {
        <ns0:consultaPuntosLealtadResponse>
            ...
            {
            	if(string($availablePoints) != "") then (
...
xf:canjearPuntosLealtadGTOut($legalId,
    $customerName,
    $availablePoints,
    $cashEquivalent,
    $cashCurrency,
