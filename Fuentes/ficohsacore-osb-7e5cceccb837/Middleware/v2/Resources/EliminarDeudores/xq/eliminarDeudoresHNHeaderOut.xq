...
declare namespace xf = "http://tempuri.org/Middleware/eliminarDeudoresHNHeaderOut/";

declare function xf:eliminarDeudoresHNHeaderOut($outputParameters1 as element(ns1:OutputParameters))
...
xf:eliminarDeudoresHNHeaderOut($outputParameters1)