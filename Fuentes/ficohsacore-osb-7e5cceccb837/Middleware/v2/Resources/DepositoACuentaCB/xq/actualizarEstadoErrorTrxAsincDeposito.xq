...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/DepositoACuentaCB/xq/actualizarEstadoErrorTrxAsincDeposito/";

declare function xf:actualizarEstadoErrorTrxAsincDeposito($UUID as xs:string,
...
xf:actualizarEstadoErrorTrxAsincDeposito($UUID,
    $indicador)
