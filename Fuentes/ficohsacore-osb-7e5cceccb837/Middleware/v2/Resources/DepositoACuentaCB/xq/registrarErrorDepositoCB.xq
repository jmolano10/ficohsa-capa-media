...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/DepositoACuentaCB/xq/registrarErrorDepositoCB/";

declare function xf:registrarErrorDepositoCB($uuid as xs:string,
    $etapa as xs:string,
...
xf:registrarErrorDepositoCB($uuid,
    $etapa,
    $descripcionError,
    $msrequest,
    $msresponse)
