...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/DepositoACuentaCB/xq/obtenerParametrosTengoDeposito/";
declare namespace ns0 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/obtenerParametrizacionTengo";

declare function xf:obtenerParametrosTengoDeposito($codigoServicio as xs:string,
...
xf:obtenerParametrosTengoDeposito($codigoServicio,
    $paisOrigen,
    $paisDestino,
    $usuarioCorres,
    $tipoTransaccion,
