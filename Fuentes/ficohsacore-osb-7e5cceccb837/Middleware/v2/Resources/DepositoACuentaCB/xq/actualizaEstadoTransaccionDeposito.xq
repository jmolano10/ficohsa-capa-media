...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/DepositoACuentaCB/actualizaEstadoTransaccionDeposito/";

declare function xf:actualizaEstadoTransaccionDeposito($tipoTransaccion as xs:string,
...
xf:actualizaEstadoTransaccionDeposito($tipoTransaccion,
    $tipoConsulta,
    $codigoOperacion,
    $estadoTransaccion,
    $FT,
