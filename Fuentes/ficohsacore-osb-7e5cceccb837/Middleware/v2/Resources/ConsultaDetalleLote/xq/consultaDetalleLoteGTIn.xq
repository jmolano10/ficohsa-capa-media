...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaDetalleLote/xq/consultaDetalleLoteGTIn/";
...
declare function xf:consultaDetalleLoteGTIn($requestHeader as element(ns0:RequestHeader),
...
xf:consultaDetalleLoteGTIn($requestHeader,
    $consultaDetalleLote)