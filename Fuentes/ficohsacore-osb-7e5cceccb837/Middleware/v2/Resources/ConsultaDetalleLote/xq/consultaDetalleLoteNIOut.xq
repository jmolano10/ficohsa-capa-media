(:: pragma bea:global-element-parameter parameter="$consultarDetalleLoteResponse" element="ns2:consultarDetalleLoteResponse" location="../../../BusinessServices/MTR/consultorDetalleLote/wsdl/consultorDetalleLoteEndpoint.wsdl" ::)
(:: pragma bea:global-element-return element="ns0:consultaDetalleLoteResponse" location="../../PagosMasivos/xsd/pagosMasivosTypes.xsd" ::)

declare namespace ns2 = "http://servicio.consultadetallelotepmsws.mtrpmsv.cidenet.com.co/";
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaDetalleLote/xq/consultaDetalleLoteNIOut/";

declare function xf:consultaDetalleLoteNIOut($consultarDetalleLoteResponse as element(ns2:consultarDetalleLoteResponse))
...
declare variable $consultarDetalleLoteResponse as element(ns2:consultarDetalleLoteResponse) external;

xf:consultaDetalleLoteNIOut($consultarDetalleLoteResponse)