...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaDetalleLote/xq/consultaDetalleLotePAOut/";

declare function xf:consultaDetalleLotePAOut($consultarDetalleLoteResponse as element(ns1:consultarDetalleLoteResponse))
...
xf:consultaDetalleLotePAOut($consultarDetalleLoteResponse)