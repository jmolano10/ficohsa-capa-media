...
declare namespace xf = "http://tempuri.org/Middleware/v2/ExternalServices/pagoRemesaHCB/";

declare function xf:pagoRemesaHCB($requestHeader as element(ns0:RequestHeader))
...
xf:pagoRemesaHCB($requestHeader)