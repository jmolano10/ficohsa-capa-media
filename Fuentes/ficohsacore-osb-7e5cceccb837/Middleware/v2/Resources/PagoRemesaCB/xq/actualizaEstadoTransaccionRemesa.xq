...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/PagoRemesaCB/xq/actualizaEstadoTransaccionRemesa/";

declare function xf:actualizaEstadoTransaccionRemesa($tipoTransaccion as xs:string,
...
xf:actualizaEstadoTransaccionRemesa($tipoTransaccion,
    $tipoConsulta,
    $codigoOperacion,
    $estadoTransaccion,
    $FT,
