...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaAgenciasBanco/xq/consultaAgenciasBancoPAHeaderOut/";

declare function xf:consultaAgenciasBancoPAHeaderOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaAgenciasBancoPAHeaderOut($outputParameters)