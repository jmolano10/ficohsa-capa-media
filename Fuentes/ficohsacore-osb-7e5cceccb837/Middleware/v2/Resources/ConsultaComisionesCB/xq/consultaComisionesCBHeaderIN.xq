...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaComisionesCB/xq/consultaComisionesCBHeaderIN/";

declare function xf:consultaComisionesCBHeaderIN($requestHeader1 as element(ns0:RequestHeader))
...
xf:consultaComisionesCBHeaderIN($requestHeader1)