(:: pragma bea:global-element-parameter parameter="$consultaFICOPENResponse" element="ns0:consultaFICOPENResponse" location="../../../BusinessServices/FPC/getFicopen12c/xsd/GetFicopenTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns0:consultaFICOPENResponse" location="../xsd/consultaFICOPENTypes.xsd" ::)

declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/consultaFICOPENTypes";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaFICOPEN/xq/getFICOPENOut/";
...
declare function xf:getFICOPENOut($consultaFICOPENResponse as element(ns0:consultaFICOPENResponse))
    as element(ns0:consultaFICOPENResponse) {
        <ns0:consultaFICOPENResponse>
            ...
            {
                for $ACCOUNT_CURRENCY in $consultaFICOPENResponse/ACCOUNT_CURRENCY
                return
                    <ACCOUNT_CURRENCY>{ data($ACCOUNT_CURRENCY) }</ACCOUNT_CURRENCY>
            }
            {
