(:: pragma bea:global-element-return element="ns0:AutenticacionRequestHeader" location="../../../BusinessServices/FPC/getFicopen12c/xsd/HeaderElements.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/autType";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaFICOPEN/xq/getFICOPENHeaderIn/";
...
declare function xf:getFICOPENHeaderIn($serviceAccountName as xs:string,
...
xf:getFICOPENHeaderIn($serviceAccountName,
    $sourceBank,
    $destinationBank)