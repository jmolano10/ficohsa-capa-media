...
(:: pragma bea:global-element-return element="ns0:RequestHeader" location="../../../BusinessServices/FPC/getFundPensionClient12c/xsd/HeaderElements.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaFondosPensionesCliente/xq/getFundPensionClientHeaderIn/";
...
declare function xf:getFundPensionClientHeaderIn($serviceAccountName as xs:string,
...
xf:getFundPensionClientHeaderIn($serviceAccountName,
    $sourceBank,
    $destinationBank)
