...
(:: pragma bea:global-element-return element="ns0:ConfirmacionACHEnviados" location="../../../BusinessServices/ACH/Enviado/SvcACHEnviado/xsd/XMLSchema_-1255526967.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace ns0 = "T24WebServicesImpl";
declare namespace ns1 = "http://www.ficohsa.com.hn/middleware.services/autType";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/TransferenciasACH/xq/confirmacionACHEnviadoIn/";
...
declare function xf:confirmacionACHEnviadoIn($requestHeader1 as element(ns1:RequestHeader),
    $id as xs:string,
    $legendBankUser as xs:string,
    $pxpResult as xs:string,
    $pxpErrorCode as xs:string)
    as element(ns0:ConfirmacionACHEnviados) {
        <ns0:ConfirmacionACHEnviados>
            <WebRequestCommon>
                <userName>
                    {
            ...
            <FICOHNACHONLINEACHOCONFIRMWSType id = "{ $id }">
                <LEGENDBANKISSUER>{ $legendBankUser }</LEGENDBANKISSUER>
