...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/TransferenciasACH/xq/estadoProcesoConfirmacionACHEnviado/";

declare function xf:estadoProcesoConfirmacionACHEnviado($successIndicator as xs:string,
...
xf:estadoProcesoConfirmacionACHEnviado($successIndicator,
    $messages)