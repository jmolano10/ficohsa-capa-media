...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns3:OutputParameters" location="../../../BusinessServices/MDW/consultarCorresponsalB/xsd/consultarCorresponsalB_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/RetiroEfectivoCBS/xq/retiroEfectivoTransferenciaCuentasIn/";
declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/autType";
declare namespace ns2 = "http://www.ficohsa.com.hn/middleware.services/retiroEfectivoCBTypes";
declare namespace ns1 = "T24WebServicesImpl";
declare namespace ns3 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/consultarCorresponsalB";
...
declare function xf:retiroEfectivoTransferenciaCuentasIn($requestHeader as element(ns0:RequestHeader),
    ...
    as element(ns1:Transfmodelbankentrecuentas) {
        ...
        <WebRequestCommon>
            ...
            <FUNDSTRANSFERRETAILINTSALEWSType>
                <TRANSACTIONTYPE>{ data($outputParameters/ns3:PV_TIPO_TRANSACCION) }</TRANSACTIONTYPE>
                <DEBITACCTNO>{ data($retiroEfectivo/ACCOUNT_NUMBER) }</DEBITACCTNO>
                <DEBITCURRENCY>{ data($retiroEfectivo/CURRENCY) }</DEBITCURRENCY>
                <DEBITAMOUNT>{ data($retiroEfectivo/AMOUNT) }</DEBITAMOUNT>
                <CREDITACCTNO>{ data($outputParameters/ns3:PV_CUENTA_CREDITO) }</CREDITACCTNO>
            </FUNDSTRANSFERRETAILINTSALEWSType>
		</ns1:Transfmodelbankentrecuentas>
};
...
xf:retiroEfectivoTransferenciaCuentasIn($requestHeader,
    $retiroEfectivo,
    $outputParameters)