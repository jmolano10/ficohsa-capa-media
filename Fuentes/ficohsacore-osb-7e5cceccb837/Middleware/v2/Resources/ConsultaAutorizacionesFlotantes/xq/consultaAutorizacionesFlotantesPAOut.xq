...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaAutorizacionesFlotantes/xq/consultaAutorizacionesFlotantesPAOut/";
...
declare function xf:consultaAutorizacionesFlotantesPAOut($resultGroup as element(*),
	    				...
	    				<AUTHORIZATION_ITEMS>
	    					{
	    						...
	    						return(
	    							<AUTHORIZATION_ITEM>
		                    			...
		                    			<TRANSACTION_DATE>{ data($authorization/OFXOAO-B013-LCL-TXN-DTE) }</TRANSACTION_DATE>
		                    			<REFERENCE_NUMBER>{ data($authorization/OFXOAO-REF-NBR) }</REFERENCE_NUMBER>
...
xf:consultaAutorizacionesFlotantesPAOut($resultGroup,$FlotantesDBOut)
