(:: pragma bea:global-element-parameter parameter="$transferenciaInternacionalRequest1" element="ns0:transferenciaInternacionalRequest" location="../xsd/transferenciaInternacionalType.xsd" ::)
...
declare function xf:transferenciaInternacionalIn($transferenciaInternacionalRequest1 as element(ns0:transferenciaInternacionalRequest),
    ...
    as element(ns1:InputParameters) {
        <ns1:InputParameters>
            ...
            <ns1:DESCRIPTION>{ data($transferenciaInternacionalRequest1/DESCRIPTION) }</ns1:DESCRIPTION>
             <ns0:CHANNEL>{ 
