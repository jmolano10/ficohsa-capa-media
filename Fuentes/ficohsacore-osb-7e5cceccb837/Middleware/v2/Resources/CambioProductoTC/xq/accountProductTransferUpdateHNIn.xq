...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CambioProductoTC/xq/accountProductTransferUpdateHNIn/";
...
declare function xf:accountProductTransferUpdateHNIn($cambioProductoTC as element(ns0:cambioProductoTC),
    $org as xs:string,
    $ciclo as xs:string)
...
xf:accountProductTransferUpdateHNIn($cambioProductoTC,
    $org,
    $ciclo)