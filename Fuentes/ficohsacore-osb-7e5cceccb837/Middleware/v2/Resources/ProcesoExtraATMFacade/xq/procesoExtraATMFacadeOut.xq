...
(:: pragma bea:local-element-complex-return type="ns0:ISO8583Request/ISO8583" location="../../ProcesaMensajeGenericoSwitch/xsd/procesaMensajeGenericoSwitchFacadeTypes.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ProcesoExtraATMFacade/xq/procesoExtraATMFacadeOut/";
declare namespace ns0 = "http://www.ficohsa.com.hn/middleware.services/procesaMensajeGenericoSwitchFacadeTypes";

declare function xf:procesoExtraATMFacadeOut($procesaMensajeGenericoSwitchFacadeRequest as element(ns0:procesaMensajeGenericoSwitchFacadeRequest),
    $successIndicator as xs:string, $availableAmount as xs:string)
    as element() {
        <ISO8583>
...
xf:procesoExtraATMFacadeOut($procesaMensajeGenericoSwitchFacadeRequest,
    $successIndicator,
    $availableAmount)