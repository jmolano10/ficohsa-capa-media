...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/MasterData/conDatosPlanes/xsd/conDatosPlanes_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/MasterData/xq/conDatosPlanesIn/";

declare function xf:conDatosPlanesIn($consultaPlanesCredito as element(ns0:consultaPlanesCredito),
...
xf:conDatosPlanesIn($consultaPlanesCredito,
    $codigoPais)