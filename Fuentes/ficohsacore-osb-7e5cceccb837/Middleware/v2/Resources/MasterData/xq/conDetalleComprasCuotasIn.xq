(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/MasterData/conDetalleComprasCuotas/xsd/conDetalleComprasCuotas_sp.xsd" ::)

declare namespace ns0 = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/conDetalleComprasCuotas";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/MasterData/xq/conDetalleComprasCuotas/";

declare function xf:conDetalleComprasCuotas($pais as xs:string,
    $org as xs:string,
...
xf:conDetalleComprasCuotas($pais,
    $org,
    $numCuenta,
    $tipo,
    $originalInstall)