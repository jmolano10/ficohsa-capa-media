...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaGestionesMonetarias/xq/consultaGestionesMonetariasPAIn/";

declare function xf:consultaGestionesMonetariasPAIn($consultaGestionesMonetarias as element(ns0:consultaGestionesMonetarias))
...
xf:consultaGestionesMonetariasPAIn($consultaGestionesMonetarias)
