...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaGestionesMonetarias/xq/consultaGestionesMonetariasPAHeaderOut/";

declare function xf:consultaGestionesMonetariasPAHeaderOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaGestionesMonetariasPAHeaderOut($outputParameters)
