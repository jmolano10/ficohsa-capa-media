(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns1:OutputParameters" location="../../../BusinessServices/ABKPA/consultaDetalleTransaccion/xsd/ORA_BANK_OSB_CON_DETALLE_MOV.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaDetalleTransaccionAbanks/xq/consultaDetalleTransaccionPAOut/";

declare function xf:consultaDetalleTransaccionPAOut($outputParameters1 as element(ns1:OutputParameters),
...
xf:consultaDetalleTransaccionPAOut($outputParameters1,
    $details)
