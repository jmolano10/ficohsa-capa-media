...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaProductoOnBaseHN/xq/consultaProductoOnBaseTRCHNIn/";
...
declare function xf:consultaProductoOnBaseTRCHNIn($requestHeader as element(ns0:RequestHeader),
        ...
        <ns2:Tarjetasdecreditoporcliente>
            ...
            <FICOLISTCLIENTCARDCPType>
                <enquiryInputCollection>
                    ...
                    <criteriaValue>{ data($consultaProductoOnBase/CUSTOMER_ID) }</criteriaValue>
                    <operand>EQ</operand>
                </enquiryInputCollection>
            </FICOLISTCLIENTCARDCPType>
        </ns2:Tarjetasdecreditoporcliente>
...
xf:consultaProductoOnBaseTRCHNIn($requestHeader,
