...
(:: pragma bea:global-element-return element="ns0:RequestHeader" location="../../../BusinessServices/FPC/getProductOnbase12c/xsd/HeaderElements.xsd" ::)

declare namespace con = "http://www.bea.com/wli/sb/services/security/config";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaProductoOnBaseHN/xq/getProductOnBaseHeaderIn/";
...
declare function xf:getProductOnBaseHeaderIn($serviceAccountName as xs:string,
...
xf:getProductOnBaseHeaderIn($serviceAccountName,
    $sourceBank,
    $destinationBank)
