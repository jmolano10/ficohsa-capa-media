(:: pragma bea:global-element-return element="ns0:EmbosserUpdateRequest" location="../../../BusinessServices/VisionPlusHN/vmx/wsdl/VMX.wsdl" ::)

declare namespace ns0 = "http://www.procesa.com/fdcs";
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/VisionPlusHN/xq/embosserUpdateIn/";
...
declare function xf:embosserUpdateIn($org as xs:string,
    ...
    as element(ns0:EmbosserUpdateRequest) {
        <ns0:EmbosserUpdateRequest>
            ...
            <ARXEUI-USER-4>{ data($blockReason) }</ARXEUI-USER-4>
            {
