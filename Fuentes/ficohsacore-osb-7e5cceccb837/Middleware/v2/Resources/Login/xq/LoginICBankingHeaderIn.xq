...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/Login/xq/LoginICBankingHeaderIn/";
...
declare function xf:LoginICBankingHeaderIn($serviceAccount as xs:string)
    as element(*) {
	      ...
	      <wsa:To soap:mustUnderstand="1">https://hnbnkpqawicbkap.gfficohsa.hn/UPD_01.Tailored.ICBanking.ServiceHost/Administration/UsersValidationCustomService.svc</wsa:To>
	      <wsa:Action>urn:tailored.icbanking.services.administration.users.UsersValidationCustomService.LoginAHM</wsa:Action>
	   </soap:Header>
};

declare variable $serviceAccount as xs:string external;

xf:LoginICBankingHeaderIn($serviceAccount)