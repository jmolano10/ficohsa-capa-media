(:: pragma bea:global-element-parameter parameter="$outputParameters1" element="ns1:OutputParameters" location="../../../BusinessServices/TSP/consultaMontoTSPCliente/xsd/consultaMontoTSPCliente_sp.xsd" ::)
(:: pragma bea:global-element-return element="ns0:consultaMontoTSPClienteResponse" location="../xsd/consultaMontoTSPTransferenciaTypes.xsd" ::)
...
declare function xf:consultaMontoTSPTransferenciaOut($outputParameters1 as element(ns1:OutputParameters))
    as element(ns0:consultaMontoTSPClienteResponse) {
        <ns0:consultaMontoTSPClienteResponse>
