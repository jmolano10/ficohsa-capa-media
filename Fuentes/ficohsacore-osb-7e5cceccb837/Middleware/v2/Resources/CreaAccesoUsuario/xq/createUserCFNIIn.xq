...
(:: pragma bea:global-element-return element="ns1:CreateUser" location="../../../BusinessServices/CREDITFORCENI/GestionAccesosUsuarios/xsd/XMLSchema_-336569572.xsd" ::)

declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/CreaAccesoUsuario/xq/createUserCFNIIn/";
...
declare function xf:createUserCFNIIn($creaAccesoUsuario as element(ns2:creaAccesoUsuario),
    $token as xs:string,
...
xf:createUserCFNIIn($creaAccesoUsuario,
    $token,
    $userName)