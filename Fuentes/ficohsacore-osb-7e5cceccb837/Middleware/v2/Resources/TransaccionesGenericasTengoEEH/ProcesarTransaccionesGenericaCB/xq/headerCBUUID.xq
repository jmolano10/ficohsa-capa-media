...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/TransaccionesGenericasTengoEEH/ProcesarTransaccionesGenericaCB/xq/headerCBUUID/";

declare function xf:headerCBUUID($requestHeader1 as element(ns0:RequestHeader))
...
xf:headerCBUUID($requestHeader1)
