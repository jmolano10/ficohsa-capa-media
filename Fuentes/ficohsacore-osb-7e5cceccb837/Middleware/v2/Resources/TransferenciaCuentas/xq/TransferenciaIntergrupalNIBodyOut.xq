...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:global-element-parameter parameter="$opTransferenciaRegionalRespuesta" element="ns3:opTransferenciaRegionalRespuesta" location="../../../BusinessServices/CTS/transferencia/xsd/services.xsd" ::)
...
xf:TransferenciaIntergrupalNIOut($opTransferenciaRegionalRespuesta)]]></con:xquery>
    <con:dependency location="../../../BusinessServices/CTS/transferencia/xsd/services.xsd">
        <con:schema ref="Middleware/v2/BusinessServices/CTS/transferencia/xsd/services"/>
    </con:dependency>
    <con:dependency location="../xsd/transferenciaCuentasType.xsd">
        <con:schema ref="Middleware/v2/Resources/TransferenciaCuentas/xsd/transferenciaCuentasType"/>
    </con:dependency>
</con:xqueryEntry>