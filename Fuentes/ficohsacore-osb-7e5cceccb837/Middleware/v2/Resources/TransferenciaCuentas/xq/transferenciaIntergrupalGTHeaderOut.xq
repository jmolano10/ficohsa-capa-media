(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../BusinessServices/ABKGT/transferenciaIntergrupal/xsd/transferenciaIntergrupal_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/TransferenciaCuentas/xq/transferenciaIntergrupalGTHeaderOut/";

declare function xf:transferenciaIntergrupalGTHeaderOut($outputParameters as element(ns0:OutputParameters))
...
xf:transferenciaIntergrupalGTHeaderOut($outputParameters)