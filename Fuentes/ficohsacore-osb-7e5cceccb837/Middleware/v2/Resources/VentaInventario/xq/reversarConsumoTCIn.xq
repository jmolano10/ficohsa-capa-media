...
(:: pragma bea:global-element-parameter parameter="$consumoNORResponse1" element="ns1:ConsumoNORResponse" location="../../../BusinessServices/transaccionesAlcance/wsdl/wsinfotarjetas.asmx.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/VentaInventario/xq/reversarConsumoTCIn/";

declare function xf:reversarConsumoTCIn($ventaInventario1 as element(ns0:ventaInventario),
...
xf:reversarConsumoTCIn($ventaInventario1,
    $consumoNORResponse1,
    $purchaseDescription,
    $purchaseRefNumber,
    $paymentAmount)