...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../../../BusinessServices/MasterDataPA/conDatoComportamientoCuenta/xsd/conDatoComportamientoCuenta_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaComportamientoCuenta/xq/conDatoComportamientoCuentaPAIn/";

declare function xf:conDatoComportamientoCuentaPAIn($consultaComportamientoCuenta1 as element(ns0:consultaComportamientoCuenta),
...
xf:conDatoComportamientoCuentaPAIn($consultaComportamientoCuenta1,
    $countryCode)