...
(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns1:OutputParameters" location="../../../BusinessServices/MasterData/conDatoComportamientoCuenta/xsd/conDatoComportamientoCuenta_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaComportamientoCuenta/xq/consultaComportamientoCuentaNIOut/";
...
declare function xf:consultaComportamientoCuentaNIOut($outputParameters as element(ns1:OutputParameters))
...
xf:consultaComportamientoCuentaNIOut($outputParameters)