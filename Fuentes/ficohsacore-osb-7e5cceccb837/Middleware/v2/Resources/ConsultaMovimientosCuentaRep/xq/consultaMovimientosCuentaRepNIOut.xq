            ...
            <ns3:consultaMovimientosCuentaRepResponseType>
                {
                    ...
                    (
                    	<ns3:consultaMovimientosCuentaRepResponseRecordType>
                    		...
                    		<TNX_CODE>{ data($opConsultaMovimientoCuentaRespuesta/ns1:movimiento[$i]/ns1:codTransaccion) }</TNX_CODE>
                    		<TNX_AGN_CODE>{ data($opConsultaMovimientoCuentaRespuesta/ns1:movimiento[$i]/ns1:oficina/ns1:codOficina) }</TNX_AGN_CODE>
                    		<TNX_AGN_NAME>{ data($opConsultaMovimientoCuentaRespuesta/ns1:movimiento[$i]/ns1:oficina/ns1:valOficina) }</TNX_AGN_NAME>                    		                    		
                    		...
                    		(:campos nuevos solicitados por Nicaragua:)
