...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/RetiroTarjetaCredito/xq/onlinePaymentV4ReversaGTIn/";
...
declare function xf:onlinePaymentV4ReversaGTIn($retiroTarjetaCredito as element(ns0:retiroTarjetaCredito),
    $org as xs:string,
    $rrn37 as xs:string,
...
xf:onlinePaymentV4ReversaGTIn($retiroTarjetaCredito,
    $org,
    $rrn37,
    $merchantNumber)
