...
(:: pragma bea:global-element-return element="ns0:InputParameters" location="../../../BusinessServices/ABKGT/consultaUsuariosSistema/xsd/consultaUsuariosSistema_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaUsuariosSistema/xq/consultaUsuariosSistemaGTIn/";

declare function xf:consultaUsuariosSistemaGTIn($consultaUsuariosSistema as element(ns1:consultaUsuariosSistema))
...
xf:consultaUsuariosSistemaGTIn($consultaUsuariosSistema)