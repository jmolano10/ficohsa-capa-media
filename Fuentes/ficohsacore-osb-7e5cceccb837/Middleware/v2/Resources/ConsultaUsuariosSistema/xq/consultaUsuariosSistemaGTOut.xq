(:: pragma bea:global-element-parameter parameter="$outputParameters" element="ns0:OutputParameters" location="../../../BusinessServices/ABKGT/consultaUsuariosSistema/xsd/consultaUsuariosSistema_sp.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaUsuariosSistema/xq/consultaUsuariosSistemaGTOut/";

declare function xf:consultaUsuariosSistemaGTOut($outputParameters as element(ns0:OutputParameters))
...
xf:consultaUsuariosSistemaGTOut($outputParameters)