...
(:: pragma bea:global-element-parameter parameter="$transferenciasACHRecibidas" element="ns1:transferenciasACHRecibidas" location="../xsd/transferenciasACHRecibidasTypes.xsd" ::)
(:: pragma bea:global-element-return element="ns2:RegistrarACHRecibidos" location="../../../BusinessServices/ACH/Recibido/SvcACHRecibido/xsd/XMLSchema_478367602.xsd" ::)
...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/TransferenciasACHRecibidas/xq/registroACHRecibidaHNIn/";
...
declare function xf:registroACHRecibidaHNIn($requestHeader1 as element(ns0:RequestHeader),
    $transferenciasACHRecibidas as element(ns1:transferenciasACHRecibidas),
        ...
        return
            <ns2:RegistrarACHRecibidos>
                ...
                <FICOHNACHONLINEINPUTACHINType>
                    ...
                    <CREDITACCTNO>{ $accountNumber }</CREDITACCTNO>
...
declare variable $transferenciasACHRecibidas as element(ns1:transferenciasACHRecibidas) external;
...
xf:registroACHRecibidaHNIn($requestHeader1,
