...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/TransferenciasACHRecibidas/xq/registroNuevoACHRecibidoIn/";

declare function xf:registroNuevoACHRecibidoIn($transferenciasACHRecibidas as element(ns0:transferenciasACHRecibidas))
    as element(ns1:InputParameters) {
    	...
    	return
	        <ns1:InputParameters>
	            ...
	            <ns1:PV_CUENTADESTINO>{ data($transactionDetail/DESTINATION) }</ns1:PV_CUENTADESTINO>
...
xf:registroNuevoACHRecibidoIn($transferenciasACHRecibidas)