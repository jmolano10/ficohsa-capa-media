...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/TransferenciasACHRecibidas/xq/estadoProcesoConsultaPagoPrestamo/";

declare function xf:estadoProcesoConsultaPagoPrestamo($successIndicator as xs:string,
...
xf:estadoProcesoConsultaPagoPrestamo($successIndicator,
	$zeroRecords, 
	$messages,
	$txnStatus,
	$idRejection)