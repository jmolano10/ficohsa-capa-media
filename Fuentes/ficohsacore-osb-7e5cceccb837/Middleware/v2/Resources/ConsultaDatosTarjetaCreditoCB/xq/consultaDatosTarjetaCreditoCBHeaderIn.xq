...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaDatosTarjetaCreditoCB/xq/consultaDatosTarjetaCreditoCBHeaderIn/";

declare function xf:consultaDatosTarjetaCreditoCBHeaderIn($requestHeader as element(ns0:RequestHeader))
...
xf:consultaDatosTarjetaCreditoCBHeaderIn($requestHeader)