...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ValidaLoteBilletera/xq/validaLoteBilleteraHeaderIn/";

declare function xf:validaLoteBilleteraHeaderIn($requestHeader as element(ns0:RequestHeader))
...
xf:validaLoteBilleteraHeaderIn($requestHeader)
