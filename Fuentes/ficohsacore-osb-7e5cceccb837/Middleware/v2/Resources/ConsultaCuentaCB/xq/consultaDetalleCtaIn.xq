...
declare namespace xf = "http://tempuri.org/Middleware/v2/Resources/ConsultaCuentaCB/xq/consultaDetalleCtaIn/";
...
declare function xf:consultaDetalleCtaIn($requestHeader1 as element(ns0:RequestHeader),
    $cuentaFormatCorr as xs:string)
        ...
        <ns1:Consultadedetallesdelacuenta>
            ...
            <WSACCOUNTLISTType>
                <enquiryInputCollection>
                    ...
                    <criteriaValue>{ $cuentaFormatCorr }</criteriaValue>
                    <operand>EQ</operand>
                </enquiryInputCollection>
            </WSACCOUNTLISTType>
        </ns1:Consultadedetallesdelacuenta>
...
declare variable $cuentaFormatCorr as xs:string external;

xf:consultaDetalleCtaIn($requestHeader1,
    $cuentaFormatCorr)